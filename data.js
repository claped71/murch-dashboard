...
// CACHE BUSTER: Jul 28, 2026 (Tue) PM-2 — LATNOVVA CLOSEOUT (Jose): Latnovva has FINISHED its activities on the project; remaining scope TRANSFERRED to United Services (already running Zone G). No further Latnovva progress data expected — all 'Latnovva silent/logs owed' items retired. United is now the sole pile contractor (D, F, G + transferred B/E remainders); ECCS keeps its Area E control share. Latnovva final: 13,954 piles (scope closed at installed). Jul 28 workbook basis 26,736 stands.
...
window.MURCH_DATA = {
    ...
    contractors: [
      ...
      { name: 'Project Total', scope: 31352, installed: 26736, remaining: 4616, done: 85.3, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 26,736 (85.3%) — Jul 28 DELIVERY workbook roll-up, block map FULLY RECONCILED (supersedes the 22,900 + field-logs formula; net +177 over the Jul 25 field basis). Latnovva closed out (scope transferred to United); Jul 28 production day pending EOD capture." }
    ],
    zones: [
      ...
      { zone: 'Zone E', contractor: 'ECCS / United (ex-Latnovva share)', scope: 8456, installed: 8012, remaining: 444, done: 94.7, status: 'Active', note: 'Jul 28 workbook roll-up: 8,012 (94.7%) — the prior 8,204 field-log figure included entries the block-map reconciliation re-mapped; workbook is now the controlling basis.' },
    ...
    risks: [
      ...
      { title: 'Pile finish ~Aug 7 now rides entirely on United — Latnovva closed out, scope transferred', level: 'Critical', owner: 'United / Audelio Zuniga / Manuel Ramirez', note: 'LATNOVVA HAS FINISHED its activities on the project (Jose, Jul 28) — final 13,954 piles credited, and all remaining Latnovva scope is TRANSFERRED to United Services, which is already running Zone G. United now carries the full 4,440-pile remainder: G 2,479, D 1,468, B 214, E 268 (non-ECCS share) and the last 11 in F. Pile stock is comfortable (1,607-unit buffer on 28,343 delivered). Levers: repair confirmation on the 2 rigs down since Sat Jul 25, the Zone G change-order signature, and Saturday work. Jose (Jul 22): "We are drastically reducing pile production — we are now heading to Aug 7." The ~Aug 7 finish needs 462/day on the re-based 26,736.' },
