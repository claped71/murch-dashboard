...
window.MURCH_DATA = {
    ...
    production: [
      { name: 'Project pile installation', remaining: '5,029 piles', target: '~1,677 piles/day required for Jul 28 (560/day stated capacity) — finish projects ~Aug 7', latest: 'Jul 24: 364 — United, all Zone G (~91/rig). Jul 23: 284', cumulative: '26,323 / 31,352 executed (84.0%) — 22,900 official block-map + 3,423 field logs not yet mapped', status: 'Critical', note: 'Field logs (26,323) are the controlling basis; block-map 22,900 lags. Latnovva logs owed since Jul 22; finish projects ~Aug 7.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the 834 piles/day install burn', latest: 'Jul 24 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; 2,020 available above the 26,323 executed', status: 'On Track', note: 'Stock = delivered minus executed. Delivery is not the constraint.' },
      ...
      { name: 'Tracker completion incl. purlins', remaining: '1,635 to build · 2,251 to QA-release', target: '53 completed rows/day now required for Aug 30', latest: 'Jul 24: 30 (ECCS, E); WF racking closing EW rows', note: 'Row counts complete only with purlins. Released split (235) stale since Jul 20 — updated QA count owed; workbook reconciliation open.', cumulative: '851 done (34.2%): 235 QA-released + 616 pending Quality / 2,486 total', status: 'Critical' },
      ...
      { name: 'Module installation', remaining: '140,690 modules', target: '3,803 modules/day required for Sep 6 (5,531/day full-field capacity)', latest: 'Jul 24: 3,134 (Workforce 1,730 + Brumont 1,404)', cumulative: '30,780 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'Four days near 3,000+; record 3,601. Gap to 3,803/day = Brumont re-man (14 -> 18) + Saturdays.' }
    ],
