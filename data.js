...
window.MURCH_DATA = {
    ...
    production: [
      { name: 'Project pile installation', remaining: '12,078 piles', target: '~711 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 8: 640 piles — FIRST DAY ABOVE the 560 capacity line (United 490 + 1 inverter at 70/rig-day; Latnovva 150 in B6)', cumulative: '19,274 / 31,352 installed (61.5%) — official Jul 8 evening workbook', status: 'Critical', note: 'July 7 official output was 399 piles. United held 54 piles/rig-day; Latnovva produced 16 piles with a single machine — an unacceptable rate that must be escalated. Holding Jul 28 requires ~711/day over the 17 remaining working days. Jul 8 output of 640 breaks the 560 capacity line for the first time. Latnovva's third rig (in assembly) is expected to work Jul 9: 10 rigs at the ~72/rig-day fleet average gives ~715-720/day — enough to hold Jul 28 if sustained every working day. Areas A, C and EW COMPLETE; B 1,570 (56.3%); E 8,012 (94.7%); F 2,066 (27.0%).' },
      ...
      { name: 'ITS HDD boring', remaining: '10 of 20 bores', target: 'Minimum 1 completed bore/day', latest: 'Week Jul 1-7: 315 ft (52.5 ft/day avg); one bore in progress', cumulative: '11 / 20 bores complete (55%); 1 in progress, 8 pending', status: 'Watch', note: 'Jul 8 PM ITS tracker (Axel): one more bore closed today. Footage update pending the daily log.' },
      { name: 'ITS MV plowing', remaining: '30 of 46 segments', target: 'Minimum 1 completed segment/day', latest: 'Week Jul 1-7: 12,870 ft plowed (2,145 ft/day avg); no new segments closed', cumulative: '21 / 46 segments complete (44.7% of plan); 1 in progress', status: 'Watch', note: 'Jul 8 PM ITS tracker (Axel): five more plow segments closed today — strong recovery. Footage update pending the daily log.' },
      ...
      { name: 'Module installation', remaining: '169,598 modules', target: '5,531 modules/day acceleration target', latest: 'Jul 8: 936 modules — Workforce 780 + Brumont 156 (new second crew)', cumulative: '1,872 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'July 8 doubled module output to 936/day with Brumont mobilized as a second crew — still below the ~3,325/day now required. Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. Module work requires fully released tracker rows.' }
    ],
    dailyProductionHistory: [
      ...
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 7', minimum: '48 tracker units/day', above: 4, below: 10, latest: 'Jul 7: 29 tracker units (ECCS)', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 535 rows — 235 released by Quality and 300 pending QA approval — after 29 units on July 7, still below the 48/day target.', daily: [{ day: 'Jun 17', value: 15, target: 48, unit: 'units' }, { day: 'Jun 18', value: 35, target: 48, unit: 'units' }, { day: 'Jun 19', value: 26, target: 48, unit: 'units' }, { day: 'Jun 20', value: 31, target: 48, unit: 'units' }, { day: 'Jun 21', value: 0, target: 48, unit: 'units' }, { day: 'Jun 22', value: 48, target: 48, unit: 'units' }, { day: 'Jun 23', value: 31, target: 48, unit: 'units' }, { day: 'Jun 24', value: 0, target: 48, unit: 'units' }, { day: 'Jun 25', value: 57, target: 48, unit: 'units' }, { day: 'Jun 26', value: 26, target: 48, unit: 'units' }, { day: 'Jun 29', value: 29, target: 48, unit: 'units' }, { day: 'Jun 30', value: 30, target: 48, unit: 'units' }, { day: 'Jul 1', value: 51, target: 48, unit: 'units' }, { day: 'Jul 7', value: 29, target: 48, unit: 'units' }, { day: 'Jul 8', value: 0, target: 48, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 7 field start', minimum: '5,531 modules/day', above: 0, below: 3, latest: 'Jul 7: 156 modules — far below the ramp', note: 'Workforce reported only 156 modules on July 7 — far below the ramp requirement. Cumulative 936 field-reported; modules must finish by Sep 6, one week after tracker completion.', daily: [{ day: 'Jul 3', value: 234, target: 5531, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 5531, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 5531, unit: 'modules' }, { day: 'Jul 8', value: 936, target: 5531, unit: 'modules' }] },
    ...
    risks: [
      ...
      { title: 'Jul 9 is the proof day: 10-rig fleet must hold ~711 piles/day with ZERO margin', level: 'Critical', owner: 'Audelio Zuniga / United / Latnovva / Manuel Ramirez', note: 'Jul 8 delivered 640 piles — first day above the 560 capacity line (United 490 at 70/rig-day; Latnovva 150 with 2 rigs at 75/rig-day; both near the 80/day criterion). Latnovva\'s third rig, in assembly, is expected to work Jul 9: the 10-rig fleet at ~72/rig-day gives ~715-720/day, matching the ~711/day required for the Jul 28 gate for the first time. BUT the margin is zero working days: any weather day, rig breakdown, or sub-criterion day between now and Jul 28 must be recovered SAME-DAY via overtime or Saturday extension. If the third rig does not start Jul 9, escalate immediately — the week cannot be lost.' },
