...
window.MURCH_DATA = {
    ...
    weeklyPlan: [
      ...
      { area: '<u>SET, inverter foundations and inverter arrival</u>',
        ...
        minimum: 'All 23 inverter foundations released before first delivery; hold the SET civil rate that lifted overall progress from 8.7% to 16.0% in a week.',
    ...
    civilKpis: [
      ...
      { title: 'SET tracker', metric: '16.0% overall', note: 'Jul 20 SET tracker: overall progress 16.0% (civil 49.4%, structural 7.5%, electrical 4.3%) — up from 16.0% on Jul 13. Control building on site since Jul 7. Jul 12 (Sun): transformer-foundation containment berm complete at the substation. Jul 12: all 18 inverter stations available on site have their base plates welded.' }
    ],
    civilActivities: [
    ...
    production: [
      ...
      { name: 'SET construction', remaining: '84.0% of overall scope', target: '— No approved daily progress target in source', latest: 'Jul 20 SET tracker: overall 16.0% (civil 49.4%, structural 7.5%, electrical 4.3%) — up from 16.0% Jul 13', cumulative: '16.0% overall (civil 49.4%, structural 7.5%, electrical 4.3%) per the Jul 20 SET tracker', status: 'Critical', note: 'Overall SET progress up from 16.0% (Jul 13) to 16.0% (Jul 20), driven by civil. Transformer and structural steel remain in fabrication — the controlling items for energization. Jul 17 procurement review: AB Power has presented no SET work plan and no material-delivery plan; Greensol is pulling partial scope to a third party (Michael Power) and self-buying missing materials (BUS-connectors urgent). Portico steel structure arriving Jul 16-17; oil-pit grating (tramex) procured separately to close the SET payment milestone and avoid Heelstone objections.' },
