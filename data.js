...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 8, 2026',
      piles:    { installed: 18634, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 707, capacity: 560, name: 'Piles', unit: 'piles/day' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (18,634 installed, 59.4% — Jul 8 basis), GameChange SAT tracker assembly incl. purlins (535 done — 235 QA-released, 300 pending Quality), and module placement. D&F pre-drilling complete (7,694/7,694).' },
    ...
    contractors: [
      ...
      { name: 'United', scope: 7658, installed: 1576, remaining: 6082, done: 20.6, zones: 'Zone F', status: 'Active', note: 'Jul 8 PROGRESS table: 1,576 installed in Zone F. United reported 380 piles on July 7 with 7 rigs; continuity depends on hard-soil mitigation and confirmed pile deliveries.' },
      { name: 'Project Total', scope: 31352, installed: 18634, remaining: 12718, done: 59.4, zones: "All zones | Construction Manager report", status: 'Critical', note: "Audelio / Construction Manager July 6 Delivery/Mechanical workbook is the official installed-production basis." }
    ],
    zones: [
      ...
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 1420, remaining: 1368, done: 50.9, status: 'Active', note: 'Jul 8 PROGRESS table: 1,420 installed (50.9%). July 7 field output of 16 piles with a single machine remains an unacceptable daily rate.' },
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 1576, remaining: 6082, done: 20.6, status: 'Active', note: 'Jul 8 PROGRESS table: 1,576 installed. July 7 field report: 380 piles with 7 rigs; hard soil remains the critical productivity risk.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '12,718 piles', target: '~707 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 8 workbook rev 2 (PROGRESS pile-installation table): 18,634 installed; official Jul 7 log 399 piles', cumulative: '18,634 / 31,352 installed (59.4%) — official Jul 8 basis', status: 'Critical', note: 'July 7 official output was 399 piles. United held 54 piles/rig-day; Latnovva produced 16 piles with a single machine — an unacceptable rate that must be escalated. Holding Jul 28 requires ~707/day over the 18 remaining working days. The Jul 8 workbook PROGRESS pile-installation table is the controlling roll-up: Areas A (3,834), C (2,946) and EW (846) are COMPLETE; B 1,420 (50.9%); E 8,012 (94.7%); F 1,576 (20.6%). Jul 7 official log: 399 piles.' },
      { name: 'Pile delivery / site stock', remaining: '5,843 piles undelivered', target: 'Receipts must exceed 560 piles/day burn', latest: 'Jul 6 workbook: delivered piles increased to 25,509', cumulative: '25,509 delivered; 6,875 available above installed', status: 'Watch', note: 'Available stock equals delivered piles less officially installed piles (18,634 per the Jul 8 workbook PROGRESS table). The buffer covers about 12.3 production days at the acceleration-capacity assumption.' },
    ...
    schedule: [
      ...
      { activity: 'Current pile delivery burn', contractor: 'ECCS / LATNOVVA / United', start: '2026-06-16', end: '2026-07-08', status: 'Watch', note: 'Jul 8 workbook PROGRESS table: 18,634 officially installed and 25,509 delivered, leaving a 6,875-pile buffer, about 12.3 days at the 560/day acceleration capacity.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', note: '12,718 piles remain on the Jul 8 official workbook (18,634 installed, 59.4%): holding July 28 now requires ~707 piles/day, above the stated 560/day capacity. July 7 output was 396 (United 380 with 7 rigs; Latnovva an unacceptable 16 with one machine) — additional/stronger rigs and Latnovva escalation are the remaining levers.' },
    ...
    risks: [
      { title: 'Pile delivery buffer improved, but July 7 loads still need POD confirmation', level: 'Watch', owner: 'GameChange / Shreeya Devkota / Karina Mucino / Manuel Ramirez / Audelio Zuniga', note: 'The Jul 8 workbook shows 6,875 piles available above installed production, about 12.3 days at the 560-pile/day acceleration capacity. Shreeya confirmed 11 named loads for July 7; treat them as scheduled until POD/site receipt, material type, and actual quantities are confirmed.' },
