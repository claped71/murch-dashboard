...
window.MURCH_DATA = {
    ...
    civilActivities: [
      ...
      { activity: 'Foundation SET', company: 'AB Power', done: 16.3, remaining: 83.7, status: 'Active', note: 'Jul 20 SET workbook: overall substation progress 16.0% (up from 11.8% on Jul 13); civil 51.1%, structural 5.7%, electrical 5.2%. Containment berm and transformer foundation complete Jul 12. PIERS STARTED Jul 21 — 1 of 17 (E5); plan 3-4/day, first pour Thu Jul 23. AB Power SET scope at risk — no work or delivery plan (Jul 17 review); partial scope moving to Michael Power.' }
    ],
    contractors: [
