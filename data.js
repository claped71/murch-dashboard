...
window.MURCH_DATA = {
    ...
    weeklyPlan: [
      ...
      { area: '<u>Pile production — rig availability, Zones B / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: '6,754 piles remain to the Jul 28 gate (24,598 of 31,352 executed, 78.5%). At ~560/day crew capacity only ~3,900 more are physically possible before Jul 28 — the pile gate is now unrecoverable and slips to ~early August (≈ Aug 4-5 at the current fleet) unless the broken rigs return. Jul 18 (Sat) ran 608 — United 415 (4 of 6 rigs) + Latnovva 193 (2 rigs), the best per-rig day in a week, but trackers and modules sat idle Saturday.', minimum: 'Holding Jul 28 would need ~965 piles/day (6,754 over ~7 working days) — roughly 2x capacity. The realistic floor: get every rig running and sustain the fleet maximum daily, then re-baseline the pile finish to early August.', gate: 'Rig repairs are the binding constraint — United on 4 of 6 (2 damaged), Latnovva on 2. Material is not a restriction: 28,343 piles delivered, a 3,745-unit buffer.', owners: 'United / LATNOVVA | Audelio Zuniga | Manuel Ramirez | Joshua Spalding' },
