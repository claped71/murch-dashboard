...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 28, 2026',
      piles:    { installed: 27175, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 4177, capacity: null, name: 'Piles', unit: 'piles/day' },
    ...
    contractorScore: [
      ...
      { date: 'Jul 28 Tue', contractor: 'United', trade: 'Piles + Racking', output: 339, resource: '44 people — 339 piles ALL Zone G; racking crew distributing + installing saddles/bearings (cabezales) in Zone F', perUnit: 339, criterion: 500, critLabel: 'Zone G ground is VERY HARD (as Zone F at start) — rate capped; best day since the weather stop. United tracker numbers expected Thursday' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (27,175 executed, 86.7%), GameChange SAT tracker assembly incl. purlins (881 done, 35.4% — 606 QA-released, 275 pending Quality), and module placement (33,880 executed, 19.8%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      ...
      { area: '<u>Pile production — B / F / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '27,175 / 31,352 (86.7%) — 4,177 left. Close E (344) and F (11); B 214; G 300+/day on hard ground (2,140); D opens ~Aug 5-7 (demo done).',
        minimum: '>= 464/day from Jul 29 holds ~Aug 7 (Jul 28: 439 — best day since the weather stop, still under rate).',
    ...
    contractors: [
      ...
      { name: 'United', scope: 12964, installed: 8863, remaining: 4101, done: 68.4, zones: 'Zones D + F + G + ALL scope transferred from Latnovva (B/E remainders)', status: 'Active', note: 'Jul 28: 44 people, 339 piles all Zone G (ground very hard — as F at start) -> 8,863. Racking crew on saddles/bearings distribution + install in Zone F; United tracker numbers expected from Thursday. Carries ALL remaining pile scope (4,101) incl. B 214 and the non-ECCS E remainder; Zone D start ~1.5 weeks.' },
      { name: 'Project Total', scope: 31352, installed: 27175, remaining: 4177, done: 86.7, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 27,175 (86.7%) — Jul 28 workbook roll-up 26,736 + 439 field-reported Jul 28 (ECCS 100 Zone E + United 339 Zone G). Latnovva closed out (scope transferred to United)." }
    ],
    zones: [
      ...
      { zone: 'Zone E', contractor: 'ECCS', scope: 674, installed: 344, released: 73, remaining: 330, done: 51.0, status: 'Critical', note: 'Active assembly front — running ~30 rows/day vs the 57/day project requirement. Released 73 rows covering E1/E2 only; release cadence must match the build rate.' },
      { zone: 'Zone EW', contractor: 'Workforce (racking)', scope: 67, installed: 0, released: 0, remaining: 67, done: 0, status: 'Active', note: 'Jul 28: 20 rows at 95% — final components (dampers/actuators) close them. Rows count only complete incl. purlins.' },
      { zone: 'Zone F', contractor: 'United (racking ramp)', scope: 595, installed: 0, released: 0, remaining: 595, done: 0, status: 'Mobilizing', note: 'United racking crew distributing and installing saddles/bearings (Jul 28); material separated. First completed-row numbers expected from Thursday; ~1.5 wks to full rate.' },
      { zone: 'Zone B', contractor: 'United (transferred)', scope: 220, installed: 0, released: 0, remaining: 220, done: 0, status: 'Pending', note: 'Sequenced behind the F ramp; piles 92.3% (214 left) so the zone is nearly released for assembly.' },
      { zone: 'Zone G', contractor: 'United', scope: 256, installed: 0, released: 0, remaining: 256, done: 0, status: 'Pending', note: 'Piling front active (36.2%, hard ground) — tracker assembly follows pile completion by block.' },
    ...
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 28 measured days', minimum: '464 piles/day floor holds ~Aug 7 (4,177 left over 9 working days from Jul 29)', above: 0, below: 31, latest: 'Jul 28: 439 — ECCS 100 (E) + United 339 (G, hard ground)', note: 'Jul 28: 439 piles (ECCS 100 + United 339). Zone G ground very hard — as F at start; F 11 from close; D starts ~1.5 wks (slab demo done). ~Aug 7 finish needs 464/day.', daily: [{ day: 'Jun 18', value: 20, target: 1022, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 1022, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 1022, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 1022, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 1022, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 1022, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 1022, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 1022, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 1022, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 1022, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 1022, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 1022, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 1022, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 1022, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 1022, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 1022, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 1022, unit: 'piles' }, { day: 'Jul 16', value: 504, target: 1022, unit: 'piles' }, { day: 'Jul 17', value: 472, target: 1022, unit: 'piles' }, { day: 'Jul 18', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 20', value: 622, target: 1022, unit: 'piles' }, { day: 'Jul 21', value: 253, target: 1176, unit: 'piles' }, { day: 'Jul 22', value: 202, target: 1419, unit: 'piles' }, { day: 'Jul 23', value: 284, target: 1419, unit: 'piles' }, { day: 'Jul 24', value: 364, target: 1349, unit: 'piles' }, { day: 'Jul 25', value: 236, target: 1677, unit: 'piles' }, { day: 'Jul 27', value: 0, target: 2397, unit: 'piles' }, { day: 'Jul 28', value: 439, target: 462, unit: 'piles' }] },
    ...
    schedule: [
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 85.3, baseline: 48.4, note: '4,177 piles remain (27,175 executed — workbook roll-up + Jul 28 field logs); ~Aug 7 finish needs 464/day. Jul 28: 439 (ECCS 100 Zone E + United 339 Zone G — hard ground). Saturday work (mandatory), rig health and the Zone G ChO are the escalated levers; United carries all remaining pile scope (Latnovva closed out).' },
    ...
    risks: [
      ...
      { title: 'Pile finish ~Aug 7 now rides entirely on United — Latnovva closed out, scope transferred', level: 'Critical', owner: 'United / Audelio Zuniga / Manuel Ramirez', note: 'LATNOVVA HAS FINISHED its activities on the project (Jose, Jul 28) — final 13,954 piles credited, and all remaining Latnovva scope is TRANSFERRED to United Services, which is already running Zone G. United now carries the full remainder: G 2,140, D 1,468, B 214, the non-ECCS Zone E balance and the last 11 in F (4,177 total left project-wide). Jul 28: 339 in G with 44 people — the ground there is VERY HARD (as F at start), capping the rate; Zone D opens ~Aug 5-7 now that the slab demolition is finished. Pile stock is comfortable (1,607-unit buffer on 28,343 delivered). Levers: repair confirmation on the 2 rigs down since Sat Jul 25, the Zone G change-order signature, and Saturday work. Jose (Jul 22): "We are drastically reducing pile production — we are now heading to Aug 7." The ~Aug 7 finish needs 464/day on the 27,175 executed basis.' },
