...
window.MURCH_DATA = {
    ...
    weeklyPlan: [
      { area: '<u>Tracker assembly and QA release — Zones C1/C2 / A / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        ...
        minimum: '>= 53 completed rows/day to hold Aug 30 (1,635 rows over 31 working days, Mon-Sat). ECCS ran 28 + 30 on Jul 23-24 — barely half the floor. QA is the real floor: clear the 616-row pending backlog now that C1/C2 are unlocked.',
    ...
    production: [
      ...
      { name: 'Tracker completion incl. purlins', remaining: '1,635 to build · 2,251 to QA-release', target: '53 completed rows/day now required for Aug 30', latest: 'Jul 23 (Thu): 28 rows (ECCS, E) + 17 rows at 50% (Workforce racking, EW) · Jul 24 (Fri): 30 rows (ECCS, E); WF racking on dampers/actuators', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 851 rows — 235 released by Quality and 616 pending QA approval; the released count is STALE since Jul 20 (C1/C2 released with Client that day — updated split owed by Daniel/Jose). NOTE: cumulative under reconciliation — the workbook shows 715 pre-assembled / 311 complete; Maurin walked all rows Jul 14 and Daniel is recounting manually.', cumulative: '851 done (34.2%): 235 QA-released + 616 pending Quality / 2,486 total', status: 'Critical' },
    ...
    dailyProductionHistory: [
      ...
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 24', minimum: '53 rows/day (required for Aug 30)', above: 4, below: 24, latest: 'Jul 24 (Fri): 30 rows (ECCS, Zone E) — 851 done (235 released / 616 pending; released split stale since Jul 20)', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 851 rows — 235 released by Quality and 616 pending QA approval; the released split is STALE since the Jul 20 C1/C2 release — updated count owed by QA. United racking crew ramping (~1.5 wks to full rate, Manuel Jul 23); Workforce racking had 17 rows at 50% (EW) Jul 23 and dampers/actuators Jul 24. Cumulative under reconciliation — workbook shows 715 pre-assembled / 311 complete.', daily: [{ day: 'Jun 17', value: 15, target: 50, unit: 'units' }, { day: 'Jun 18', value: 35, target: 50, unit: 'units' }, { day: 'Jun 19', value: 26, target: 50, unit: 'units' }, { day: 'Jun 20', value: 31, target: 50, unit: 'units' }, { day: 'Jun 21', value: 0, target: 50, unit: 'units' }, { day: 'Jun 22', value: 48, target: 50, unit: 'units' }, { day: 'Jun 23', value: 31, target: 50, unit: 'units' }, { day: 'Jun 24', value: 0, target: 50, unit: 'units' }, { day: 'Jun 25', value: 57, target: 50, unit: 'units' }, { day: 'Jun 26', value: 26, target: 50, unit: 'units' }, { day: 'Jun 29', value: 29, target: 50, unit: 'units' }, { day: 'Jun 30', value: 30, target: 50, unit: 'units' }, { day: 'Jul 1', value: 51, target: 50, unit: 'units' }, { day: 'Jul 7', value: 29, target: 50, unit: 'units' }, { day: 'Jul 8', value: 0, target: 50, unit: 'units' }, { day: 'Jul 9', value: 0, target: 50, unit: 'units' }, { day: 'Jul 10', value: 0, target: 50, unit: 'units' }, { day: 'Jul 13', value: 29, target: 50, unit: 'units' }, { day: 'Jul 14', value: 49, target: 50, unit: 'units' }, { day: 'Jul 15', value: 35, target: 50, unit: 'units' }, { day: 'Jul 16', value: 35, target: 50, unit: 'units' }, { day: 'Jul 17', value: 25, target: 50, unit: 'units' }, { day: 'Jul 18', value: 0, target: 50, unit: 'units' }, { day: 'Jul 20', value: 21, target: 50, unit: 'units' }, { day: 'Jul 21', value: 25, target: 51, unit: 'units' }, { day: 'Jul 22', value: 39, target: 51, unit: 'units' }, { day: 'Jul 23', value: 28, target: 51, unit: 'units' }, { day: 'Jul 24', value: 30, target: 52, unit: 'units' }] },
    ...
    equipmentNotes: [
      ...
      { contractor: 'Workforce', equipment: 'Module installation hand tools / torque equipment.', output: 'Jul 24 (Fri): 1,730 modules Zone C (16 people) + racking crew (15) on dampers/actuators. Jul 23: 1,456 modules + 17 rows at 50% (EW).' },
    ...
    risks: [
      ...
      { title: 'Trackers remain the controlling front: 28-30 rows/day vs 53 required', level: 'Critical', owner: 'ECCS / Daniel Morilla / Manuel Ramirez / United / Workforce', note: 'ECCS logged 28 rows Jul 23 and 30 rows Jul 24 (Zone E) — the best back-to-back days since Jul 14, but still barely half the 53/day now required for Aug 30. 851 done / 235 released / 616 pending — the released split is STALE since the Jul 20 C1/C2 release; an updated QA count is owed. Manuel (Jul 23): United is now receiving racking people — expect a step-up in ~1.5 weeks; Workforce racking ran 17 rows at 50% (EW) Jul 23 and dampers/actuators Jul 24; Jose pressed the team Jul 23 to repeat the mechanical recovery on the electrical side. Torque tubes are no longer the constraint (all 9 trucks landed Jul 24). Field cumulative under reconciliation vs the workbook (715 pre-assembled / 311 complete).' },
