...
// CACHE BUSTER: Aug 1, 2026 (Sat) EOD FINAL - piles 28,678 (91.5%) / trackers 986 built (39.7%), 296 CLIENT-released, earned 42.8% / modules 45,063 (26.3%). AUG 1 IS THE DAY LV CAME OFF ZERO: 478 lf of DC cable pulled in Area A1 (LBDs 1-4 of INV-1) - the FIRST measured cable footage on the project - plus 1,083 lf messenger wire in A2 and 7 LBDs -> 110/419. Otherwise a thin Saturday: modules 780 (Workforce only, Brumont filed nothing) against 4,214/day required; ZERO tracker rows completed by anyone; ZERO piles - neither United nor Latnovva filed. NEW TRACKER FRONT: Workforce racking moved to ZONE B with 19 people, 11 rows at step 2. Zone EW rows finally moved - torquing and QA, step 4 complete, still not closeable. AB POWER ABSENT FROM THE SUBSTATION on a Saturday (Luis escalated). ITS fifth day at zero. WIP SNAPSHOT RULE: unfinished-tracker counts are a photograph of open rows per crew, never additive.
...
window.MURCH_DATA = {
    control: {
      ...
      trackers: { installed: 986, released: 296, releasedGS: 492, total: 2486, gate: '2026-08-30', gateLabel: 'Aug 30', required: 63, capacity: 48, name: 'Trackers incl. purlins', unit: 'rows/day', wipRows: 109, wipEquivalent: 77.6, earnedEquivalent: 1063.6, earnedPct: 42.8, earnedBasis: '5-step weighted ladder (adopted Jul 30, 2026)', releaseBasis: 'RELEASED = CLIENT-approved (Heelstone) per the Jul 30 QA sheet - NO new QA cut was filed on Jul 31, so the release figures are one day stale. Greensol-approved is carried separately as releasedGS.' },
      modules:  { installed: 45063, total: 171470, gate: '2026-09-06', gateLabel: 'Sep 6', required: 4214, capacity: null, name: 'Modules', unit: 'mod/day' },
    ...
    contractorScore: [
      ...
      { date: 'Aug 1 Sat', contractor: 'ECCS', trade: 'Trackers', output: 0, resource: 'NO REPORT FILED - the 53-person tracker crew that closed 40 rows on Jul 31 filed nothing on Saturday', perUnit: 0, criterion: 63, critLabel: 'The only crew closing rows all week filed no log. A missing report is not a zero-production day, but Zone E is the module front and it went dark on a mandatory Saturday.' },
      ...
      { date: 'Aug 1 Sat', contractor: 'Brumont', trade: 'Modules', output: 0, resource: 'NO REPORT FILED - 20 people on Jul 31 delivering 2,100 modules', perUnit: 0, criterion: 4214, critLabel: 'The crew that set a project record on Friday filed nothing on Saturday. Confirm whether Brumont worked at all.' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles \u00b7 2,486 trackers', note: 'Piles 91.5% \u00b7 trackers 39.7% \u00b7 modules 26.3%.' },
    ...
    weeklyPlan: [
      { area: '<u>Tracker assembly & QA release</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '986 / 2,486 done (39.7%) — NO row completed on Aug 1 by any crew. 296 CLIENT-released, 492 Greensol-approved. Open rows now 109 across four zones: F 68 at step 3, EW 20 at step 4 (torque and QA), E 10 at step 3, B 11 at step 2 (new front).',
        minimum: '>= 63/day for Aug 30 — 1,500 rows over 24 working days, up from 60.',
        gate: 'TWO GATES NOW. (1) Client release: 296 accepted of 986 built, blocked on the damper change-out and blind since Jul 30. (2) Closing rate: NOBODY closed a row on Aug 1. Convert EW first — 20 rows at step 4, in torque and QA, one step from complete — then the 68 F rows at step 3.',
      ...
      { area: '<u>Pile production — B / F / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '28,678 / 31,352 (91.5%) — 2,674 left, unchanged: no crew filed a pile figure on Aug 1. Close B (36, under one shift), F (11) and E (224); G 535+/day (935 left); D opens ~Aug 5-7.',
        minimum: '>= 535/day from Aug 2 holds ~Aug 7 — the rate rose from 446 because a working day passed with no record.',
      ...
      { area: '<u>Module installation ramp</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '45,063 / 171,470 (26.3%) — Aug 1: 780, a fifth of Friday. Brumont filed nothing after a 2,100 record; Workforce held 29 people at 27 modules each. Week ask >= 25,300; SATURDAYS MANDATORY (Jose).',
        minimum: '>= 4,214/day for Sep 6, up from 4,103. Both crews at full strength are needed every single day — one absent crew costs the whole rate.',
      ...
      { area: '<u>LV electrical — START</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: 'Aug 1: <strong>THE PULL STARTED — 478 lf of DC cable in Area A1 on LBDs 1-4 of INV-1</strong>, the first measured footage on the project. Also 1,083 lf messenger wire in A2 E-W, hangers in A1/A3, +7 LBDs -> 110/419 (26.3%). GOAL: Area A LV-cabled for the Mike/client visit.',
        minimum: '>= 6,689 lf/day from Aug 2 to hold Sep 18. 478 lf is 7% of ONE day at rate — the crew of 6 labourers must become a real pull operation this week.',
        gate: 'CREW SIZE. German (COO) has asked for GreenSol people to be put on cable and box mounting. Then Chemik arrival dates (air confirmed Jul 28) and the E-W routing review (Unistrut) before standardizing.',
      ...
      { area: '<u>SET & inverter foundations</u>',
        target: 'SET 24.7%; PIERS 14/17 — last 3 drilled Mon Aug 3, concrete Tue Aug 4, which finishes every substation foundation. INVERTERS 18/23 set and welded; last 5 due Monday. NO AB CREW WORKED SATURDAY Aug 1 — raised by Luis. Station pile-sets 21/23 — close 10-D and 16-F.',
      ...
      { area: '<u>MV plowing & HDD</u>',
        target: 'MV bores 17/20 \u00b7 segments 36/46 (120,738 ft) \u00b7 DC ducts 3/14 — FIVE consecutive days at zero. MVHB-12 committed to close Sunday Aug 2. Close >= 2 MV bores + 5 segments next week.',
    ...
    zones: [
      ...
      { zone: 'TOTAL', contractor: 'All tracker crews', scope: 2486, installed: 986, released: 296, releasedGS: 492, remaining: 1500, done: 39.7, wipRows: 109, wipStep: null, wipEquiv: 77.6, earnedPct: 42.8, status: 'Critical', note: '986 built (39.7%) — NOT ONE ROW COMPLETED ON Aug 1 by any crew · RELEASE UNCHANGED at 296 accepted by Heelstone (11.9%) and 492 approved by Greensol, both now two days stale; 690 built rows carry no client acceptance · 109 rows in progress worth 77.6 row-equivalents -> 1,063.6 earned (42.8%) · 63 completed rows/day now required for Aug 30, up from 60. THE OPEN ROWS ARE NOW SPREAD ACROSS FOUR ZONES AND THREE LADDER STEPS: F 68 at step 3, EW 20 at step 4 (torque and QA), E 10 at step 3, B 11 at step 2. Open rows are a SNAPSHOT per crew, never cumulative.' }
    ],
    ...
    modulesByZone: [
      ...
      { zone: 'Zone E', contractor: 'Workforce + Brumont', scope: 52234, installed: 10253, remaining: 41981, done: 19.6, status: 'Critical', note: 'Aug 1: +780 (Workforce only, 29 people). Brumont filed no report at all after setting a project record of 2,100 the day before. ZERO tracker rows in Zone E are released by Greensol or by the client, so all ~156 rows now carrying modules here are unreleased.' },
      ...
      { zone: 'TOTAL', contractor: 'All module crews', scope: 171470, installed: 45063, remaining: 126407, done: 26.3, status: 'Critical', note: '45,063 executed (26.3%) — 4,214/day over the 30 working days to Sep 6, up from 4,103. Aug 1 delivered 780, a fifth of Friday and 19% of the required rate, with only one of the two crews reporting. The rate reached on Jul 31 was given back in a single day; the required figure now rises every day it is not held.' }
    ],
    mvProgress: {
      asOf: 'Jul 31, 2026',
    ...
    projectTotal: {
      ...
      components: [
        ...
        { name: 'Trackers', weight: 22, gate: 39.7, earned: 42.8 },
        { name: 'Modules', weight: 26, gate: 26.3, earned: 26.3 },
    ...
    earnedMethod: {
      ...
      scopes: [
        ...
        { scope: 'Modules', instrument: 'Atomic unit count', gate: '45,063 / 171,470 = 26.3%', earned: 'n/a — no intermediate state', note: 'Placed and torqued or not placed.' },
        { scope: 'Tracker rows', instrument: '5-step weighted ladder', gate: '986 / 2,486 = 39.7%', earned: '1,063.6 equivalents = 42.8%', note: 'See trackerWip. 109 rows open across four zones at three different steps.' },
    ...
    production: [
      ...
      { name: 'Tracker completion incl. purlins', remaining: '1,500 to build Â· 2,190 to client release', target: '63 completed rows/day now required for Aug 30', latest: 'Aug 1: ZERO rows completed by any crew. Workforce racking opened Zone B (11 rows at step 2) and moved the EW rows into torque and QA; ECCS and United filed nothing', note: 'RELEASE RE-BASED Jul 30 to the CLIENT-approved column of the QA sheet: 296 rows accepted by Heelstone, 492 approved by Greensol, 986 built. The 606 previously published was the QA sheet’s executed column, not a release. Client acceptance exists only in Zone A. NO QA CUT HAS BEEN FILED SINCE Jul 30, so the release figures are two days stale. Separately tracked (trackerWip): 109 open rows worth 77.6 row-equivalents, earned 42.8% against this 39.7% gate, spread over four zones and three ladder steps. THE 20 ZONE EW ROWS ARE IN TORQUE AND QA — the nearest completions on the project. Open-row counts are a SNAPSHOT per crew, never cumulative.', cumulative: '986 done (39.7%): 296 client-released Â· 492 Greensol-approved / 2,486 total', status: 'Critical' },
      ...
      { name: 'Panel delivery', remaining: 'NONE — delivery complete', target: '— Scope closed, no further deliveries due', latest: 'Module deliveries CLOSED — full BOM quantity received on site', cumulative: '171,470 / 171,470 delivered (100.0%)', status: 'Complete', note: 'MODULE DELIVERY IS COMPLETE. The full 171,470-module quantity is on site; there are no pending module deliveries. 126,407 modules stand in stock above the 45,063 executed, so material is not a constraint on the module front at any point between here and the Sep 6 gate — the constraint is QA release and crew size.' },
      { name: 'Module installation', remaining: '126,407 modules', target: '4,214 modules/day required for Sep 6', latest: 'Aug 1: 780 (Workforce only, 29 people) — Brumont filed nothing', cumulative: '45,063 modules field-reported (26.3%)', status: 'Critical', note: 'THE GAIN WAS GIVEN BACK IN ONE DAY. Jul 31 beat the rate for the first time at 4,136; Aug 1 delivered 780, a fifth of that and 19% of what the gate needs. Workforce held 29 people and produced 27 modules each, against 84 the day before. Brumont — 20 people and a project record of 2,100 on Friday — filed no report at all on a mandatory Saturday; confirm whether they worked. The required rate has risen from 4,103 to 4,214/day and rises again every day it is not met.' }
    ],
    dailyProductionHistory: [
      ...
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 31', minimum: '63 rows/day (required for Aug 30)', above: 4, below: 30, latest: 'Aug 1: ZERO completed by any crew; Workforce opened Zone B at step 2 and moved the EW rows into torque and QA', note: 'Row counts complete only with purlins installed. 986 built and none added on Aug 1. Release holds at 296 client-accepted — no QA cut since Jul 30. The 20 Zone EW rows are in torque and QA and are the nearest completions available.', daily: [{ day: 'Jun 17', value: 15, target: 50, unit: 'units' }, { day: 'Jun 18', value: 35, target: 50, unit: 'units' }, { day: 'Jun 19', value: 26, target: 50, unit: 'units' }, { day: 'Jun 20', value: 31, target: 50, unit: 'units' }, { day: 'Jun 21', value: 0, target: 50, unit: 'units' }, { day: 'Jun 22', value: 48, target: 50, unit: 'units' }, { day: 'Jun 23', value: 31, target: 50, unit: 'units' }, { day: 'Jun 24', value: 0, target: 50, unit: 'units' }, { day: 'Jun 25', value: 57, target: 50, unit: 'units' }, { day: 'Jun 26', value: 26, target: 50, unit: 'units' }, { day: 'Jun 29', value: 29, target: 50, unit: 'units' }, { day: 'Jun 30', value: 30, target: 50, unit: 'units' }, { day: 'Jul 1', value: 51, target: 50, unit: 'units' }, { day: 'Jul 7', value: 29, target: 50, unit: 'units' }, { day: 'Jul 8', value: 0, target: 50, unit: 'units' }, { day: 'Jul 9', value: 0, target: 50, unit: 'units' }, { day: 'Jul 10', value: 0, target: 50, unit: 'units' }, { day: 'Jul 13', value: 29, target: 50, unit: 'units' }, { day: 'Jul 14', value: 49, target: 50, unit: 'units' }, { day: 'Jul 15', value: 35, target: 50, unit: 'units' }, { day: 'Jul 16', value: 35, target: 50, unit: 'units' }, { day: 'Jul 17', value: 25, target: 50, unit: 'units' }, { day: 'Jul 18', value: 0, target: 50, unit: 'units' }, { day: 'Jul 20', value: 21, target: 50, unit: 'units' }, { day: 'Jul 21', value: 25, target: 51, unit: 'units' }, { day: 'Jul 22', value: 39, target: 51, unit: 'units' }, { day: 'Jul 23', value: 28, target: 51, unit: 'units' }, { day: 'Jul 24', value: 30, target: 52, unit: 'units' }, { day: 'Jul 27', value: 0, target: 55, unit: 'units' }, { day: 'Jul 28', value: 30, target: 56, unit: 'units' }, { day: 'Jul 29', value: 35, target: 57, unit: 'units' }, { day: 'Jul 30', value: 30, target: 59, unit: 'units' }, { day: 'Jul 31', value: 40, target: 59, unit: 'units' }, { day: 'Aug 1', value: 0, target: 60, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 31 field start', minimum: '4,214 modules/day (required for Sep 6)', above: 1, below: 23, latest: 'Aug 1: 780 (Workforce only) — Brumont filed nothing', note: 'ONE DAY ABOVE RATE, THEN A FIFTH OF IT. Jul 31 hit 4,136 against 4,104; Aug 1 delivered 780 against 4,103. Workforce kept 29 people but produced 27 modules each against 84 the day before, and Brumont filed nothing after a 2,100 record. Every module again went into Zone E, which has no QA release of any kind.', daily: [{ day: 'Jul 3', value: 234, target: 3738, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 3738, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 3738, unit: 'modules' }, { day: 'Jul 8', value: 936, target: 3738, unit: 'modules' }, { day: 'Jul 9', value: 1308, target: 3738, unit: 'modules' }, { day: 'Jul 10', value: 1802, target: 3738, unit: 'modules' }, { day: 'Jul 11', value: 517, target: 3738, unit: 'modules' }, { day: 'Jul 13', value: 2922, target: 3738, unit: 'modules' }, { day: 'Jul 14', value: 2335, target: 3738, unit: 'modules' }, { day: 'Jul 15', value: 780, target: 3738, unit: 'modules' }, { day: 'Jul 16', value: 858, target: 3738, unit: 'modules' }, { day: 'Jul 17', value: 2226, target: 3738, unit: 'modules' }, { day: 'Jul 18', value: 0, target: 3738, unit: 'modules' }, { day: 'Jul 20', value: 3601, target: 3738, unit: 'modules' }, { day: 'Jul 21', value: 3082, target: 3754, unit: 'modules' }, { day: 'Jul 22', value: 2887, target: 3776, unit: 'modules' }, { day: 'Jul 23', value: 3456, target: 3776, unit: 'modules' }, { day: 'Jul 24', value: 3134, target: 3785, unit: 'modules' }, { day: 'Jul 27', value: 0, target: 3908, unit: 'modules' }, { day: 'Jul 28', value: 3100, target: 4020, unit: 'modules' }, { day: 'Jul 29', value: 3109, target: 4047, unit: 'modules' }, { day: 'Jul 30', value: 3158, target: 4104, unit: 'modules' }, { day: 'Jul 31', value: 4136, target: 4104, unit: 'modules' }, { day: 'Aug 1', value: 780, target: 4103, unit: 'modules' }] },
    ...
    successors: [
      ...
      { activity: 'Commissioning and MC', dependency: 'Continuous mechanical completion by zone', impact: 'On the re-cascaded dates (trackers Aug 30, modules Sep 6, LV/DC Sep 18) the Sep 25 MC target is achievable with limited float; pre-commissioning Sep 14 - Oct 15 protects the Oct 16 PIS.', mitigation: 'Convert the 109 open rows into completions starting with the 20 in torque and QA, close the last 2,674 piles by ~Aug 7, get the module rate back to 4,214/day with BOTH crews, and prepare weekend/OT acceleration. Saturdays remain mandatory and Aug 1 was not worked.' }
    ],
    schedule: [
      ...
      { activity: 'Final module installation completion', contractor: 'Workforce / Brumont', start: '2026-07-03', end: '2026-09-06', status: 'Critical', progress: 26.3, baseline: 0, note: 'Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. 45,063 executed (26.3%); 4,214/day now required over 30 working days. Jul 31 was the first day at or above rate at 4,136; Aug 1 fell to 780 with Brumont filing nothing. The rate is achievable with both crews at strength and unreachable without one of them.' },
    ...
    resourcePlan: [
      ...
      { label: 'Module full-field crew', actual: 48, committed: 48, target: 40, targetLabel: '40 by Jul 13+', note: 'Jul 31: 49 installers (Workforce 29 + Brumont 20) delivered 4,136 against 4,103 required — the rate was met at 84.4 modules per installer. Aug 1: Workforce alone, 29 people, 780 modules — 27 each. Brumont filed nothing. The rate is reachable with both crews at strength and unreachable without one of them, so the exposure is ATTENDANCE, not headcount.' },
    ...
    risks: [
      { title: 'Tracker closure \u2014 nobody closed a row on Aug 1', level: 'Critical', owner: 'Manuel Ramirez | ECCS | United | Workforce', note: '<strong>Zero rows completed by any crew.</strong> ECCS and United filed nothing. Workforce moved: EW 20 rows now in <strong>torque and QA</strong> (step 4 done) and a new front opened in Zone B (11 at step 2). 109 open rows, 1,500 to build, <strong>63/day</strong> needed for Aug 30.' },
      ...
      { title: 'Modules running ahead of QA release', level: 'Critical', owner: 'Daniel Morilla | Maurin Moure', note: '<strong>~380 rows</strong> carry modules with no client acceptance. No QA cut has been filed since Jul 30 \u2014 release is now two days stale. Damper change-out is the stated blocker; the combined racking+module inspection proposal is still unanswered.' },
      ...
      { title: 'Saturday reporting discipline', level: 'High', owner: 'Manuel Ramirez | Audelio Zuniga | Luis Romero', note: 'Saturdays are mandatory, but Aug 1 produced logs from only <strong>3 of 8 crews</strong> \u2014 60 people reported. ECCS trackers, United, Latnovva and Brumont filed nothing and AB Power was absent. A missing report is not a zero-production day, and the dashboard cannot tell the difference. Fix the log, then the output.' },
