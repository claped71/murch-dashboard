...
// CACHE BUSTER: Aug 4, 2026 - Aug 3 (Mon) EOD, THE BEST DAY OF THE PROJECT. 86 tracker rows COMPLETED (ECCS 41 Zone E + Workforce 45 Zone EW) against 60/day required - the first day ever above the tracker rate. Modules 4,279 (WF 2,028 + Brumont 2,173 + United 78 golden row) against 4,180 - second day above rate. Piles 205 Zone G. LV 403 lf more DC cable -> 881 lf, plus 2,814 lf of CAB messenger wire. ALL 23 INVERTERS NOW SET AND WELDED (0 terminated). Trackers 1,112 (44.7%), modules 50,342 (29.4%), piles 28,883 (92.1%). PROJECT TOTAL 54.4/55.8, up 1.6 points in a day. PARTIAL-ROW CREDIT SUSPENDED (Jose, Aug 4): the WIP register is emptied and earned = gate on trackers until the subs report reliably against the 5-step ladder. The ladder itself stays published as the reporting standard.
...
window.MURCH_DATA = {
 ...
 manpowerMixToday: { day: 'Aug 3, 2026', total: 243, mix: [
 { trade: 'Trackers & Piling', people: 128, color: '#0c5f43' },
 { trade: 'Module Installation', people: 43, color: '#168a5b' },
 { trade: 'Electrical & SET', people: 42, color: '#2769a8' },
 { trade: 'Civil & Fencing', people: 5, color: '#b96f18' },
 { trade: 'GreenSol EPC', people: 25, color: '#66716d' }
 ] },
 manpowerNote: '<strong>Aug 3 site board</strong>: 245 on the sheet, 243 PEOPLE (Crane 2 is equipment, not headcount) - down 10 on the Jul 30 board of 253. ECCS 66 (53 trackers + 13 LV) - UNITED 54 - WORKFORCE 47 - GREENSOL 25 - BRUMONT 15 - ITS 13 - <strong>Ab power 8</strong> - <strong>Dig it 5</strong> - <strong>Hi tech 3</strong> - TOPLAND 2 - LATNOVVA 2 - WESTWOOD 1 - SWCA 1 - <strong>Roveri security 1</strong> - Kalamazoo, Hurricane, Lounsbury, ECS, SII, Brightfield and TVANT all zero. <strong>the number that matters is latnovva at</strong> 2: the crew stood at 9-11 through the end of July and has effectively demobilised while Zone B sits 36 piles from close, and it has filed no pile quantity since Jul 29. <strong>Brumont is down to</strong> 15 from the 19 it actually worked on Saturday - the module rate needs both crews at strength. <strong>Eight new contractor lines</strong> have appeared on the board (Bierlein, Hoffman, MTC, Storm Water, AES, SII, Brightfield, TVANT), all blank - mobilisation dates unconfirmed, chase Audelio. PRIOR Jul 30 board = 253.',
 contractorScore: [
 ...
 { zone: 'Zone E', contractor: 'ECCS', scope: 674, installed: 530, released: 0, releasedGS: 0, remaining: 144, done: 78.6, wipRows: 0, wipStep: null, wipEquiv: 0, earnedPct: 78.6, status: 'Critical', note: 'Aug 3: 41 more rows closed - a third consecutive 40-plus day (40, 40, 41). Zone E is 78.6% built and Jose has set closing the zone this week as the target. <strong>Release is still zero</strong> in both columns. PRIOR Aug 1: 40 rows closed — two 40-row days running, the only crew on the project delivering completions. Zone E is now 72.6% built. <strong>No open-row snapshot</strong> was filed with the Aug 1 block, so the register is set to zero rather than carrying the 10 from Jul 31, which are presumed inside the 40 credited complete. <strong>Release is still zero</strong> in both columns against 489 built rows; roughly 156 rows in E carry modules with no release of any kind.' },
 { zone: 'Zone EW', contractor: 'Workforce (racking)', scope: 67, installed: 45, released: 0, releasedGS: 0, remaining: 22, done: 67.2, wipRows: 0, wipStep: null, wipEquiv: 0, earnedPct: 67.2, status: 'Active', note: 'CLOSED OUT Aug 3: 45 rows completed at 100% in a single day, the largest single-crew tracker day of the project. The crew worked late to correct dampers that had been fitted wrong on 11 lines, so modules can go on immediately. PRIOR: After five days frozen at step 3, Manuel confirmed on Aug 1 that the 20 Zone EW rows are being <strong>torqued and presented to QA</strong> — step 4 (damper, actuator, drive line) is complete and they sit at 90% on the ladder. He was explicit that they CANNOT yet be counted finished. These are the nearest 20 completions on the project and the single cheapest movement available on the Aug 30 gate.' },
 { zone: 'Zone F', contractor: 'United (racking ramp)', scope: 595, installed: 0, released: 0, releasedGS: 0, remaining: 595, done: 0, wipRows: 0, wipStep: null, wipEquiv: 0, earnedPct: 0, status: 'Critical', note: '<strong>Still not one row completed</strong> after five working days. United reported 30 rows partially built on Aug 3 - <strong>Not credited, and</strong> Jose has queried directly whether 30 is really the cumulative total. PRIOR SNAPSHOT: 68 rows standing at step 3 of 5 — Manuel confirmed this is the CUMULATIVE open figure for United, not a daily increment (31 rows advanced to step 3 on the day). Purlins in, dampers, actuators and torque outstanding. <strong>Four working days and not one row closed</strong>: 68 partial rows over four days is about 17 rows/day of partial work against 60 completed rows/day required. Jose has put the subcontract itself on the table if the assembly procedure does not change on Monday.' },
 { zone: 'Zone B', contractor: 'Workforce (racking)', scope: 220, installed: 0, released: 0, remaining: 220, done: 0, wipRows: 0, wipStep: null, wipEquiv: 0, earnedPct: 0, status: 'Active', note: 'Front opened Aug 1; 12 rows reported partially built on Aug 3, NOT CREDITED while partial-row reporting is being bedded in. Workforce racking grew 14 to 19 people and moved into Zone B: 11 rows at step 2 of 5 on a cumulative basis, confirmed by Manuel as level 2 of the step table — torque tubes installed and spliced, purlins still to come. Zone B piles are 98.7% complete with 36 left, so the zone is effectively released for assembly.' },
 ...
 { zone: 'TOTAL', contractor: 'All tracker crews', scope: 2486, installed: 1112, released: 296, releasedGS: 492, remaining: 1374, done: 44.7, wipRows: 0, wipStep: null, wipEquiv: 0, earnedPct: 44.7, status: 'Critical', note: '1,112 built (44.7%) - <strong>Aug 3 closed 86 rows</strong> (ECCS 41 Zone E + Workforce 45 Zone EW) against 60/day required, <strong>the first day ever above the tracker rate</strong>. <strong>Partial rows are not credited</strong> while the crews learn to report against the 5-step ladder, so earned equals the gate. <strong>Release unchanged a</strong>t 296 client-accepted; 816 built rows carry no client acceptance. PRIOR: 1,112 built (41.3%) — ECCS closed 40 on Aug 1, its second 40-row day running; United and Workforce closed nothing · <strong>Release unchanged a</strong>t 296 accepted by Heelstone (11.5%) and 492 approved by Greensol, both stale since Jul 30; 730 built rows carry no client acceptance · 99 rows in progress worth 70.6 row-equivalents -> 1,096.6 earned (44.1%) · 61 completed rows/day required for Aug 30. OPEN ROWS: F 68 at step 3, EW 20 at step 4 (torque and QA), B 11 at step 2 — 88 of the 99 sit with the two crews that have closed nothing. Open rows are a SNAPSHOT per crew, never cumulative.' }
 ],
 ...
 { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 2752, remaining: 36, done: 98.7, status: 'Active', note: '<strong>No pile count filed</strong> for a third consecutive day. Latnovva reported 11 people and 1 rig on refusal work on Jul 31 with no quantity. Zone B has been 36 piles from close since Jul 29 — well under one shift.' },
 { zone: 'Zone G', contractor: 'United', scope: 3356, installed: 2626, remaining: 730, done: 78.2, status: 'Active', note: 'Aug 3: +205 tracker piles plus 9 combiner-box piles (outside the 31,352 scope). 730 left. PRIOR Jul 31: +337 (55 people) — below the 430/day rate after the 507 of Jul 30, but the zone has still gone 47.0% to 72.1% in three days. 935 piles left; at the Jul 29-31 average of 402/day Zone G closes in the first week of August. Signed ChO still owed for full release.' },
 ...
 { zone: 'TOTAL', contractor: 'All pile crews', scope: 31352, installed: 28883, remaining: 2469, done: 92.1, status: 'Critical', note: '28,883 executed (92.1%) - Aug 3: +205 (United, Zone G). 2,469 remain against 617/day over the 4 working days to Aug 7, so the ~Aug 7 finish now needs three times the Aug 3 rate. Latnovva is at 2 people and has filed nothing since Jul 29 with Zone B 36 from close. PRIOR Aug 1: no pile report from any crew. Neither United nor Latnovva filed on a mandatory Saturday, so the front shows zero for the day. 2,674 remain; 535/day over the 5 working days to Aug 7, up from 446 because a working day was consumed with nothing recorded. <strong>Material position now open</strong>: GameChange is chasing the exact quantity and colour breakdown of piles the site team reported SHORT SHIPPED (Jul 29), with a replacement lead time of several weeks. Until that count is filed, the pile-delivery-complete position cannot be relied on.' }
 ],
 modulesByZone: [
 ...
 { zone: 'Zone E', contractor: 'Workforce + Brumont', scope: 52234, installed: 15454, remaining: 36780, done: 29.6, status: 'Critical', note: 'Aug 3: +4,201 (Workforce 2,028 + Brumont 2,173), both crews above their 2,000 target. PRIOR Aug 1: +1,780 (Workforce 780 with 29 people, Brumont 1,000 with 19). zero tracker rows in Zone E are released by Greensol or by the client, so all ~171 rows now carrying modules here are unreleased, against 489 built.' },
 { zone: 'Zone F', contractor: 'United', scope: 44642, installed: 78, remaining: 44564, done: 0.2, status: 'Active', note: 'Aug 3: United placed 78 modules as a <strong>golden row for</strong> evaluation - the first modules outside Zones A, C and E. <strong>Confirm the count</strong>: Manuel reported 78 and Audelio reported 156 the same evening, and the zone allocation of the golden row has not been stated.' },
 ...
 { zone: 'TOTAL', contractor: 'All module crews', scope: 171470, installed: 50342, remaining: 121128, done: 29.4, status: 'Critical', note: '50,342 executed (29.4%) - Aug 3 delivered 4,279 (Workforce 2,028 + Brumont 2,173 + United 78 golden row) against 4,180 required, the second day above rate and a full recovery from the Saturday. 4,177/day over the 29 working days left. PRIOR: 46,063 (26.9%) — 4,180/day over the 30 working days to Sep 6. Aug 1 delivered 1,780 (Workforce 780 + Brumont 1,000), 43% of the required rate: 48 installers at 37 modules each against 84 on Jul 31. Saturday productivity, not absence, is the story — both crews were on site.' }
 ],
 mvProgress: {
 asOf: 'Jul 31, 2026',
 ...
 actualResources: [
 { contractor: 'ECCS', people: 66, label: '66 · 53 trackers + 13 LV' },
 { contractor: 'UNITED', people: 54, label: '54 · G piling + F racking' },
 { contractor: 'WORKFORCE', people: 47, label: '47 · 28 modules + 19 racking' },
 ...
 { contractor: 'SWCA', people: 1, label: '1 · environmental' }
 ],
 todayFieldSnapshot: {
 date: 'Aug 3, 2026',
 total: 243,
 rows: [
 { contractor: 'ECCS', people: 66, category: 'tracker', note: 'Largest crew on site: 53 on tracker assembly in Zone E and 13 on LV electrical. Closed 40 rows on Aug 1 and placed the first 478 lf of DC cable on the project.' },
 { contractor: 'UNITED', people: 54, category: 'pile', note: 'Zone G piling and the Zone F racking ramp. Filed NOTHING for Aug 1 - no pile figure and no racking snapshot. Holds 68 open Zone F rows at step 3 and 935 piles in Zone G.' },
 { contractor: 'WORKFORCE', people: 47, category: 'module', note: 'TWO crews: about 28 on modules and 19 on racking. Opened the Zone B tracker front on Aug 1 and moved the 20 Zone EW rows into torque and QA.' },
 { contractor: 'GREENSOL', people: 25, category: 'epc', note: 'Up 5 on the Jul 30 board - EPC management, QA/QC, safety and self-perform supervision. Consistent with putting GreenSol labour onto the LV cable pull.' },
 { contractor: 'BRUMONT', people: 15, category: 'module', note: '<strong>Down from the</strong> 19 <strong>it worked on saturday</strong>. Delivered 1,000 modules on Aug 1. The module rate needs both crews at full strength every day.' },
 { contractor: 'ITS', people: 13, category: 'electrical', note: 'MV plowing and HDD. Fifth consecutive day with no bore and no plow segment closed; all 13 on MVHB-12, committed to close Sunday.' },
 { contractor: 'AB POWER', people: 8, category: 'electrical', note: 'Back on the board after working NOBODY on Saturday Aug 1. Piers 14 of 17, last 3 due today/tomorrow; ALL 23 inverter stations now set and welded, none terminated.' },
 { contractor: 'DIG IT', people: 5, category: 'electrical', note: 'Substation piers (AB Power sub) - the last three piers are drilled today and poured tomorrow.' },
 ...
 { contractor: 'LATNOVVA', people: 2, category: 'pile', note: '<strong>Collapsed from 9</strong>-11 TO 2. No pile quantity filed since Jul 29. Zone B is 36 piles from close - under one shift - and the Workforce racking crew is already assembling trackers in that zone. Establish today whether this is a scope handover or a walk-off.' },
 { contractor: 'TOPLAND', people: 2, category: 'civil', note: 'Internal roads, halved from 4. Roads still at 72% with their target date already passed.' },
 { contractor: 'WESTWOOD', people: 1, category: 'support', note: 'Civil consulting - back on site.' },
 { contractor: 'SWCA', people: 1, category: 'support', note: 'Environmental monitoring.' },
 { contractor: 'ROVERI SECURITY', people: 1, category: 'support', note: 'Site security - new line on the board.' },
 { contractor: 'KALAMAZOO', people: 0, category: 'support', note: 'No crew on site - D&F pre-drilling scope closed at 7,694.' },
 { contractor: 'HURRICANE', people: 0, category: 'civil', note: 'No fencing crew - fence 95%, Zone G remainder and gates left.' },
 ...
 { contractor: 'NEW LINES - UNCONFIRMED', people: 0, category: 'support', note: 'Bierlein, Hoffman, MTC, Storm Water, AES, SII, Brightfield and TVANT have appeared as contractor lines on the Aug 3 board, all blank. Mobilisation dates are unconfirmed - chase Audelio before they are treated as resource.' }
 ],
 note: 'Source: the on-site headcount board dated 8/3/2026 (Monday). The sheet totals 245; Crane 2 is equipment, not headcount, so the people figure is 243 - down 10 on the Jul 30 board of 253. <strong>the signal is not the total, it is the mix</strong>: Latnovva has gone from 9-11 to 2 with Zone B unfinished, Brumont has dropped from the 19 it worked on Saturday to 15 while the module rate needs both crews, Topland has halved, and Kalamazoo is off site. Against that, GreenSol is up 5 and the electrical group holds at 42. Eight new contractor lines appear blank on the board - unconfirmed mobilisations.'
 },
 equipmentNotes: [
 ...
 resourcePlan: [
 { label: 'Total site resources', actual: 243, target: 105, targetLabel: 'Acceleration peak 95-105', note: 'Aug 3 on-site headcount board: 243 people (245 on the sheet, less Crane 2 which is equipment) — down 10 on the Jul 30 board and still 2.3x the acceleration-plan peak.' },
 { label: 'Tracker / piling crew', actual: 128, target: 85, targetLabel: 'ECCS (50) + United (35)', note: 'ECCS trackers (53) + United (54, split G piling / F racking) + Workforce racking (19) + Latnovva (2) = 128. <strong>Latnovva has effectively left</strong>: 2 people against 9-11 a week ago, with Zone B 36 piles from close.' },
 ...
 { label: 'Module full-field crew', actual: 43, committed: 43, target: 40, targetLabel: '40 by Jul 13+', note: 'Jul 31: 49 installers (Workforce 29 + Brumont 20) delivered 4,136 against 4,103 required — the rate was met at 84.4 modules per installer. Aug 1: 48 installers (Workforce 29 + Brumont 19) delivered 1,780 — 37 each. Same crews, same size, less than half the output. The exposure is <strong>productivity on the sixth day</strong>, not headcount and not attendance. <strong>And now both</strong>: the Aug 3 board carries only 43 installers (Workforce 28 + Brumont 15), down from 48 on Saturday, so the crew is shrinking as the required rate rises.' },
 { label: 'Electrical & SET crew', actual: 42, committed: 42, target: 25, targetLabel: '25 electrical + SET', note: 'Aug 3: ECCS electrical (13) + ITS (13) + AB POWER (8) + DIG IT (5) + HI TECH (3) = 42 — unchanged, and the only trade group that has not shrunk. AB Power is back on the board after working nobody on Saturday.' },
 { label: 'Greensol site team', actual: 25, target: 20, targetLabel: '13 staff + 7 labor', note: 'Aug 3: 25, up 5 on Jul 30 — management, QA/QC, safety and self-perform supervision. The increase is consistent with the request to put GreenSol people onto the LV cable pull.' },
 { label: 'Civil & environmental crew', actual: 5, committed: 5, target: 15, targetLabel: '15 civil/environmental', note: 'Aug 3: TOPLAND (2, internal roads) + WESTWOOD (1) + SWCA (1) + ROVERI SECURITY (1) = 5. Kalamazoo, Hurricane, Lounsbury and ECS all at zero. Internal roads are still open at 72% with a two-person crew.' }
 ],
