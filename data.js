...
window.MURCH_DATA = {
    ...
    weeklyPlan: [
      ...
      { area: '<u>SET, inverter foundations and inverter arrival</u>',
        target: 'SET at 16.0% overall (civil 49.4%, structural 7.5%, electrical 4.3%). Close the last 4 inverter pile foundations — D10, E12, F16, G20 (190 of 230 piles, 82.6%) — before the end-July arrival of the 23 inverter units. AB Power has presented no work or material-delivery plan; Greensol is pulling partial scope to Michael Power and self-procuring material.',
        minimum: 'All 23 inverter foundations released before first delivery; hold the SET civil rate that lifted overall progress from 11.8% to 16.0% in the last week.',
    ...
    civilKpis: [
      ...
      { title: 'SET tracker', metric: '16.0% overall', note: 'Jul 20 SET tracker: overall progress 16.0% (civil 49.4%, structural 7.5%, electrical 4.3%) — up from 11.8% on Jul 13. Control building on site since Jul 7. Jul 12 (Sun): transformer-foundation containment berm complete at the substation. Jul 12: all 18 inverter stations available on site have their base plates welded.' }
    ],
    civilActivities: [
      ...
      { activity: 'Foundation SET', company: 'AB Power', done: 16.0, remaining: 84.0, status: 'Active', note: 'Jul 20 SET workbook: overall substation progress 16.0% (up from 11.8% on Jul 13); civil 49.4%, structural 7.5%, electrical 4.3%. Containment berm and transformer foundation complete Jul 12. AB Power SET scope at risk — no work or delivery plan (Jul 17 review); partial scope moving to Michael Power.' }
    ],
    contractors: [
    ...
    production: [
      ...
      { name: 'SET construction', remaining: '84.0% of overall scope', target: '— No approved daily progress target in source', latest: 'Jul 20 SET tracker: overall 16.0% (civil 49.4%, structural 7.5%, electrical 4.3%) — up from 11.8% Jul 13', cumulative: '16.0% overall (civil 49.4%, structural 7.5%, electrical 4.3%) per the Jul 20 SET tracker', status: 'Critical', note: 'Overall SET progress up from 11.8% (Jul 13) to 16.0% (Jul 20), driven by civil. Transformer and structural steel remain in fabrication — the controlling items for energization. Jul 17 procurement review: AB Power has presented no SET work plan and no material-delivery plan; Greensol is pulling partial scope to a third party (Michael Power) and self-buying missing materials (BUS-connectors urgent). Portico steel structure arriving Jul 16-17; oil-pit grating (tramex) procured separately to close the SET payment milestone and avoid Heelstone objections.' },
    ...
    risks: [
      ...
      { title: 'SET foundation, delivery dates, and equipment commitments all need closure', level: 'Critical', owner: 'Axel Cano / AB Power / Karina Mucino / Joshua Spalding / Project Management', note: 'Jul 20 SET tracker shows 16.0% overall progress (civil 49.4%, structural 7.5%, electrical 4.3%), up from 11.8% on Jul 13. The control building is set and the transformer-foundation containment berm was completed Jul 12. Main transformer AND breakers are still awaited (0% of main equipment on site vs the Jul 10 100% gate); structural steel also remains in fabrication, and several electrical items show committed dates after the July 10 required-on-site gate.' },
