...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 12, 2026',
      piles:    { installed: 20464, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 729, capacity: 560, name: 'Piles', unit: 'piles/day' },
    ...
    contractors: [
      ...
      { name: 'United', scope: 7658, installed: 3406, remaining: 4252, done: 44.5, zones: 'Zone F', status: 'Active', note: 'Jul 11 workbook: 3,406 installed in Zone F (44.5%) + 446 Sat field-reported pending allocation (~3,852, 50.3%). Jul 11 (Sat): 446 piles with 6 rigs (2 damaged).' },
    ...
    zones: [
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 3406, remaining: 4252, done: 44.5, status: 'Active', note: 'Jul 11 workbook: 3,406 installed (44.5%) + 446 Sat field pending allocation (~3,852, 50.3%) — Zone F closing fast; hard-soil risk beaten by rate.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '10,888 piles', target: '~726 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 11 (Sat): 680 piles — FOURTH straight day above 560 (United 446 with 6 rigs, 2 damaged; Latnovva 234 at 117/rig-day, best rate yet). ECCS Saturday figure still pending', cumulative: '20,464 / 31,352 official (65.3%) + 680 Sat field-reported pending workbook (~21,144)', status: 'Critical', note: 'Jul 11 workbook roll-up remains the official basis (Zone B still held at 1,420; Zone F Sat +446 also pending allocation). Four straight days above capacity — 646, 669, 680, 680 — the Saturday 680 achieved with a partial fleet (United down to 4 healthy rigs of 6). Holding Jul 28 needs ~729/day over 14 working days (Mon-Sat); rig repairs and the 3rd Latnovva rig are the levers.' },
      { name: 'Pile delivery / site stock', remaining: '5,843 piles undelivered', target: 'Receipts must exceed 560 piles/day burn', latest: 'Jul 6 workbook: delivered piles increased to 25,509', cumulative: '25,509 delivered; 5,045 available above installed', status: 'Watch', note: 'Available stock equals delivered piles less officially installed piles (20,464 per the Jul 11 workbook) — 5,045 official, ~4,365 after the Saturday 680 field-reported piles (~7.8 days at the 560/day capacity assumption).' },
