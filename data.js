...
// CACHE BUSTER: Jul 24, 2026 (Fri) [rev c: MAIN TRANSFORMER SET + Workforce tracker lines + QC rebase] — Jul 23: piles +284 (United 30 motor F + 192 G + ECCS 62 E; +15 CB/TP electrical outside scope), trackers +28, modules +3,456 (Brumont 2,000 + Workforce 1,456). Jul 24: piles +364 (United, ALL Zone G; +30 CB/TP electrical — log received late via Jose), trackers +30 (ECCS E), modules +3,134 (Workforce 1,730 + Brumont 1,404). Basis: piles 26,323 (84.0%, req 1,677/day to Jul 28 — finish projects ~Aug 7); trackers 851 (34.2%, req 53/day); modules 30,780 (18.0%, req 3,803/day). SET 20.0%, piers 6/17. All 9 GameChange tube trucks landed Fri Jul 24; 16 purple tubes remain (Wed Jul 29).
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 24, 2026',
      piles:    { installed: 26323, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 1677, capacity: null, name: 'Piles', unit: 'piles/day' },
    ...
    contractorScore: [
      ...
      { date: 'Jul 24 Fri', contractor: 'United', trade: 'Piles', output: 364, resource: '27 people — 364 piles ALL Zone G; plus 7 CB + 23 TP electrical piles (F); refusal-pile reinstalls + tap-downs continue', perUnit: 91, criterion: 80, critLabel: '80 piles/rig-day — ~91/rig on 4 running rigs: ABOVE criterion, best United day; the Zone G front is at full speed' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (26,323 executed, 84.0%), GameChange SAT tracker assembly incl. purlins (851 done, 34.2% — 235 QA-released, 616 pending Quality; released count stale since Jul 20), and module placement (30,780 executed, 18.0%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      { area: '<u>Tracker assembly & QA release</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '851 / 2,486 done (34.2%) — 235 released, 616 pending QA. Turn pending rows into released workfront.',
        minimum: '>= 53 rows/day for Aug 30 (now running 28-30).',
        gate: 'QA release cadence — updated split owed (stale since Jul 20).',
      ...
      { area: '<u>Pile production — B / F / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '26,323 / 31,352 (84.0%) — 5,029 left. Close B (165) and F (429); hold G at 350+/day.',
        minimum: '>= 1,677/day for Jul 28 — unrecoverable; working finish ~Aug 7.',
        gate: 'Rig repairs (2 of 6 United down) + Latnovva silent since Jul 22.',
      ...
      { area: '<u>Module installation ramp</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '30,780 / 171,470 (18.0%) — four straight days near 3,000+; record 3,601.',
        minimum: '>= 3,803/day for Sep 6 — re-man Brumont (14 -> 18) and work Saturdays.',
        gate: 'Released tracker rows + crew size.',
      ...
      { area: '<u>LV electrical — START</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '274,720 lf at 0% — 21 points of schedule gone. Start the pull this week.',
        minimum: '>= 5,723 lf/day from Jul 27 to hold Sep 18.',
        gate: 'Chemik air shipments (all packages on site by end-Aug) + crew stand-up.',
        owners: 'ECCS · East Carolina · Self-Perform | Luis Romero | Clara Lopez' },
      { area: '<u>GameChange deliveries</u>',
        target: 'Tube outage CLOSED (9 trucks Jul 24). Land the last 16 purple tubes Wed Jul 29.',
        minimum: 'Chase the claim: 1 purple bundle missing on PL-3295-094-HT.',
      ...
      { area: '<u>SET & inverter foundations</u>',
        target: 'TRANSFORMER SET Jul 24. SET 20.0%; piers 6/17 — hold 3-4/day. Close the last inverter foundation.',
        minimum: 'All 23 inverter foundations ready before the end-July inverter arrivals.',
        gate: 'Breakers + structural steel (in fabrication); AB Power plan gaps.',
        owners: 'AB Power / Michael Power / Dig It | Axel Cano | Joshua Spalding' },
      { area: '<u>MV plowing & HDD</u>',
        target: 'MV bores 17/20 · segments 36/46 · DC ducts 2/14 — two drills running.',
      ...
      { area: '<u>Civil Area G & roads</u>',
        target: 'Finish G basins (83%) then start G cut/fill; roads 72% (target Jul 31); fence 95%.',
    ...
    contractors: [
      ...
      { name: 'United', scope: 11014, installed: 7870, remaining: 3144, done: 71.5, zones: 'Zones F + G', status: 'Active', note: 'Executed: 7,870 piles — Zone F 7,229 (94.4%) + Zone G 641 (accelerating: 192 Jul 23 -> 364 Jul 24, best United day, ~91/rig). Jul 24 also 7 CB + 23 TP electrical piles (outside the 31,352); refusal-pile reinstalls and tap-downs continue. Combined F+G 71.5%. United holds full mechanical (piles + trackers + modules) in F & G; racking crew building up (~1.5 wks to full rate).' },
      { name: 'Project Total', scope: 31352, installed: 26323, remaining: 5029, done: 84.0, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 26,323 — official block-map 22,900 plus 3,423 field logs not yet mapped. Jul 24 (Fri): 364 tracker piles (United, ALL Zone G — best United day) + 30 CB/TP electrical outside the 31,352. Jul 23 (Thu): 284 (United 192 G + 30 F + ECCS 62 E) + 15 electrical. Latnovva has not reported since Jul 22 — logs owed." }
    ],
    zones: [
      ...
      { zone: 'Zone G', contractor: 'United', scope: 3356, installed: 641, remaining: 2715, done: 19.1, status: 'Active', note: 'STARTED Jul 21 (22); Jul 22: +63; Jul 23: +192; Jul 24: +364 — 641 total (19.1%), the ramp Manuel predicted is real and accelerating. FULL Zone G start needs only the SIGNED CHANGE ORDER (ChO) — chase signature. ECCS also completed 1 inverter foundation in Zone G Jul 21. United holds full mechanical in F & G. Area G released for pile driving; cut/fill after basin completion.' }
    ],
    production: [
      { name: 'Project pile installation', remaining: '5,029 piles', target: '~1,677 piles/day required for Jul 28 (560/day stated capacity) — finish projects ~Aug 7', latest: 'Jul 24 (Fri): 364 tracker piles — United, ALL Zone G (best United day, ~91/rig); +30 CB/TP electrical outside the 31,352. Jul 23 (Thu): 284 (United 192 G + 30 F + ECCS 62 E)', cumulative: '26,323 / 31,352 executed (84.0%) — 22,900 official block-map + 3,423 field logs not yet mapped', status: 'Critical', note: 'Executed 26,323 of 31,352 (84.0%). The official block-map roll-up is 22,900; field daily logs add 3,423 piles not yet mapped (mostly Zones B and G, where field logs lead the block map). Jul 24 (Fri): 364 counted piles — United, ALL Zone G, the best United day yet (~91/rig on 4 running rigs, above the 80 criterion); another 30 electrical piles (7 CB, 23 TP, Zone F) stay outside the 31,352. Jul 23 (Thu): 284 (United 192 G + 30 F; ECCS 62 E). Still under the 1,677/day required over 3 working days to Jul 28 — the gate projects to ~Aug 7 (Jose, Jul 22). Latnovva has not reported since Jul 22 — logs owed. RECONCILIATION FLAG (Jul 20): Audelio DELIVERY workbook is internally inconsistent on piles — the PROGRESS summary shows 22,900 installed, but his detail tabs (Production Q PILE DRIVING + COMPLETED-by-zone block logs) sum to only 17,678, lagging badly in the active zones (Zone F detail 1,743 vs 5,805 summary; Zone B 500 vs 1,457), and a planning tab shows ~15,550. The field WhatsApp daily logs (26,323) are the controlling production basis; Audelio has been asked to reconcile the summary-vs-detail gap in his file.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the 834 piles/day install burn', latest: 'Jul 24 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; 2,020 available above the 26,323 executed', status: 'On Track', note: 'Available stock equals delivered piles less executed piles — 2,020 units.  Delivery is no longer the pile-programme constraint.' },
    ...
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 24 measured days', minimum: '1,677 piles/day (required for Jul 28)', above: 0, below: 28, latest: 'Jul 24 (Fri): 364 — United, ALL Zone G (best United day, ~91/rig). Jul 23 (Thu): 284', note: 'Jul 24 logged 364 counted piles (United log received late) — the Zone G ramp is real: 22 -> 63 -> 192 -> 364. Still far short of the 1,677/day single goal; the finish projects ~Aug 7 (Jose, Jul 22). (560/day is nominal crew capacity, not a target.) Executed 26,323 = official block-map 22,900 + 3,423 field logs not yet mapped. Latnovva silent since Jul 22.', daily: [{ day: 'Jun 18', value: 20, target: 1022, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 1022, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 1022, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 1022, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 1022, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 1022, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 1022, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 1022, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 1022, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 1022, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 1022, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 1022, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 1022, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 1022, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 1022, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 1022, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 1022, unit: 'piles' }, { day: 'Jul 16', value: 504, target: 1022, unit: 'piles' }, { day: 'Jul 17', value: 472, target: 1022, unit: 'piles' }, { day: 'Jul 18', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 20', value: 622, target: 1022, unit: 'piles' }, { day: 'Jul 21', value: 253, target: 1176, unit: 'piles' }, { day: 'Jul 22', value: 202, target: 1419, unit: 'piles' }, { day: 'Jul 23', value: 284, target: 1419, unit: 'piles' }, { day: 'Jul 24', value: 364, target: 1349, unit: 'piles' }] },
    ...
    schedule: [
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 84.0, baseline: 48.4, note: '5,029 piles remain (official block-map 22,900 + 3,423 field logs not yet mapped): holding July 28 would need ~1,677 piles/day vs ~560 crew capacity — the finish projects ~Aug 7 (Jose, Jul 22). Jul 24: 364, the best United day, ALL Zone G (~91/rig, above the 80 criterion); Jul 23: 284. Rig repairs and the missing Latnovva logs are the escalated levers.' },
    ...
    equipmentNotes: [
      ...
      { contractor: 'United', equipment: '6 ramming machines on site — 2 damaged (4 running).', output: 'Jul 24 (Fri): 364 tracker piles, ALL Zone G (best day, ~91/rig) + 7 CB + 23 TP electrical (F) — 27 people; refusal reinstalls + tap-downs. Jul 23: 222 (192 G + 30 F).' },
    ...
    risks: [
      ...
      { title: 'Pile finish projects ~Aug 7 — Zone G is accelerating but Latnovva is silent and rigs stay down', level: 'Critical', owner: 'United / LATNOVVA / Audelio Zuniga / Manuel Ramirez', note: 'Pile stock is comfortable — 28,343 delivered vs 26,323 executed, a 2,020-unit buffer. United is delivering: 364 piles Jul 24 (ALL Zone G, ~91/rig on 4 running rigs — above the 80 criterion; Zone G ramp 22 -> 63 -> 192 -> 364), but 2 of 6 rigs remain damaged and Latnovva has not reported production since Jul 22. Jose (Jul 22): "We are drastically reducing pile production — we are now heading to Aug 7. Make the effort to hit the piling completion milestone." Holding Jul 28 would need ~1,677/day vs ~560 capacity; the working projection is ~Aug 7. Rig repairs, the Latnovva daily logs, and Saturday work are the recovery levers.' },
