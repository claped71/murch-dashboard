...
window.MURCH_DATA = {
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (18,097 installed, 57.7%), GameChange SAT tracker assembly incl. purlins (535 done — 235 QA-released, 300 pending Quality), and module placement. D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      { area: '<u>Pile production acceleration — Zones B / F / D-G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: 'Recover ramming output: 13,710 piles remain to the Jul 28 pile-complete gate (re-baselined Jul 8 workbook). July 7 output was 396 piles (United 380 with 7 rigs; Latnovva 16 with one machine — unacceptable).', minimum: '>= 762 piles/day now required to hold Jul 28 (13,710 piles over 18 remaining working days) — above the 560/day stated capacity; at 560/day the gate lands ~Aug 5', gate: 'Area F hard soil, rig availability, and daily pile-stock re-feed. United reports 7 ramming machines; Latnovva had one damaged rig and one rig being assembled.', owners: 'LATNOVVA / United | Audelio Zuniga | Manuel Ramirez | Joshua Spalding' },
    ...
    civilKpis: [
      ...
      { title: 'SET tracker', metric: '23 complete / 3 in progress', note: 'Jul 8 SET tracker: 23 complete, 3 in progress, 237 pending (~8.9% by activity count); $301,824 billed this period for the steel-structures advance. Jul 6 discipline split: civil 33.8%, structural 1.9%, electrical 2.3%.' }
    ],
    civilActivities: [
    ...
    contractors: [
      { name: 'LATNOVVA / assigned areas', scope: 19260, installed: 11833, remaining: 7427, done: 61.4, zones: 'Zones A, B, C, D, G, EW + shared Area E control', status: 'Watch', note: "Area-based control allocation only; it is not a new manpower or subcontractor headcount report." },
      ...
      { name: 'United', scope: 7658, installed: 1743, remaining: 5915, done: 22.8, zones: 'Zone F', status: 'Active', note: 'United installed 380 piles on July 7 with 7 ramming machines. Continuity depends on hard-soil mitigation and confirmed pile deliveries.' },
      { name: 'Project Total', scope: 31352, installed: 17642, remaining: 13710, done: 56.3, zones: "All zones | Construction Manager report", status: 'Critical', note: "Audelio / Construction Manager July 6 Delivery/Mechanical workbook is the official installed-production basis." }
    ],
    zones: [
      ...
      { zone: 'Zone E', contractor: 'ECCS / Latnovva', scope: 8456, installed: 7776, remaining: 680, done: 92.0, status: 'Active', note: 'Jul 8 workbook re-baselines Zone E down 236 piles vs the prior roll-up — verify the QC adjustment with Audelio.' },
      ...
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 500, remaining: 2288, done: 17.9, status: 'Active', note: 'July 7 field report adds 16 Latnovva piles with a single machine — an unacceptable daily rate.' },
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 1743, remaining: 5915, done: 22.8, status: 'Active', note: 'July 7 field report: 380 piles with 7 ramming machines. Hard soil remains the critical productivity risk.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '13,710 piles', target: '~762 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 7 field: United 380 piles (7 rigs); Latnovva 16 piles (1 machine) — unacceptable', cumulative: '17,642 / 31,352 installed (56.3%) — official Jul 8 basis', status: 'Critical', note: 'July 7 field output was 396 piles. United held 54 piles/rig-day; Latnovva produced 16 piles with a single machine — an unacceptable rate that must be escalated. Holding Jul 28 requires ~762/day over the 18 remaining working days. The Jul 8 Delivery/Mechanical workbook re-baselines the official roll-up (Zone E adjusted −236; EW complete at 846; B 500; F 1,743); Jul 7 field output remains the daily-rate context.' },
      { name: 'Pile delivery / site stock', remaining: '5,843 piles undelivered', target: 'Receipts must exceed 560 piles/day burn', latest: 'Jul 6 workbook: delivered piles increased to 25,509', cumulative: '25,509 delivered; 7,867 available above installed', status: 'Watch', note: 'Available stock equals delivered piles less officially installed piles (17,642 per the re-baselined Jul 8 workbook). The buffer covers about 14.0 production days at the acceleration-capacity assumption.' },
      ...
      { name: 'ITS HDD boring', remaining: '10 of 20 bores', target: 'Minimum 1 completed bore/day', latest: 'Week Jul 1-7: 315 ft (52.5 ft/day avg); one bore in progress', cumulative: '10 / 20 bores complete (50%); 3,554.2 ft installed', status: 'Watch', note: 'Jul 8 ITS workbook. Boring output fell week-over-week (315 ft vs 1,905 ft); one bore in progress, nine pending.' },
      { name: 'ITS MV plowing', remaining: '30 of 46 segments', target: 'Minimum 1 completed segment/day', latest: 'Week Jul 1-7: 12,870 ft plowed (2,145 ft/day avg); no new segments closed', cumulative: '16 / 46 segments complete (34%); 43,128 ft installed', status: 'Watch', note: 'Jul 8 ITS workbook. Plowing footage slowed week-over-week (12,870 ft vs 30,221 ft); keep daily LF and segment reporting active.' },
      { name: 'SET construction', remaining: '91.3% of overall scope', target: '— No approved daily progress target in source', latest: 'Jul 8 tracker: 23 complete, 3 in progress, 237 pending', cumulative: '~8.9% by activity count; steel-structures advance billed $301,824', status: 'Critical', note: 'Jul 8 SET tracker — two more activities closed since Jul 6. Jul 6 discipline split: civil 33.8%, structural 1.9%, electrical 2.3%.' },
      ...
      { name: 'Module installation', remaining: '170,534 modules', target: '5,531 modules/day acceleration target', latest: 'Jul 7: 156 modules — far below the ramp target', cumulative: '936 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'July 7 output of 156 modules is far below the required ramp. Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. Module work requires fully released tracker rows.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 7 measured days', minimum: '560 piles/day', above: 0, below: 11, latest: 'Jul 7 field: 396 piles (United 380 / Latnovva 16)', note: 'July 7 field report: United 380 piles with 7 ramming machines; Latnovva 16 piles with one machine — an unacceptable output. Official cumulative is 17,642 (56.3%) per the re-baselined Jul 8 workbook.', daily: [{ day: 'Jun 18', value: 20, target: 560, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 560, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 560, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 560, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 560, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 560, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 560, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 560, unit: 'piles' }, { day: 'Jul 1', value: 270, target: 560, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 560, unit: 'piles' }, { day: 'Jul 7', value: 396, target: 560, unit: 'piles' }] },
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 7', minimum: '48 tracker units/day', above: 4, below: 10, latest: 'Jul 7: 29 tracker units (ECCS)', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 535 rows — 235 released by Quality and 300 pending QA approval — after 29 units on July 7, still below the 48/day target.', daily: [{ day: 'Jun 17', value: 15, target: 48, unit: 'units' }, { day: 'Jun 18', value: 35, target: 48, unit: 'units' }, { day: 'Jun 19', value: 26, target: 48, unit: 'units' }, { day: 'Jun 20', value: 31, target: 48, unit: 'units' }, { day: 'Jun 21', value: 0, target: 48, unit: 'units' }, { day: 'Jun 22', value: 48, target: 48, unit: 'units' }, { day: 'Jun 23', value: 31, target: 48, unit: 'units' }, { day: 'Jun 24', value: 0, target: 48, unit: 'units' }, { day: 'Jun 25', value: 57, target: 48, unit: 'units' }, { day: 'Jun 26', value: 26, target: 48, unit: 'units' }, { day: 'Jun 29', value: 29, target: 48, unit: 'units' }, { day: 'Jun 30', value: 30, target: 48, unit: 'units' }, { day: 'Jul 1', value: 51, target: 48, unit: 'units' }, { day: 'Jul 7', value: 29, target: 48, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 7 field start', minimum: '5,531 modules/day', above: 0, below: 3, latest: 'Jul 7: 156 modules — far below the ramp', note: 'Workforce reported only 156 modules on July 7 — far below the ramp requirement. Cumulative 936 field-reported; modules must finish by Sep 6, one week after tracker completion.', daily: [{ day: 'Jul 3', value: 234, target: 5531, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 5531, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 5531, unit: 'modules' }] },
    ...
    schedule: [
      ...
      { activity: 'Current pile delivery burn', contractor: 'ECCS / LATNOVVA / United', start: '2026-06-16', end: '2026-07-08', status: 'Watch', note: 'Jul 8 workbook: 17,642 officially installed and 25,509 delivered, leaving a 7,867-pile buffer, about 14.0 days at the 560/day acceleration capacity.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', note: '13,710 piles remain on the re-baselined Jul 8 official workbook (56.3%): holding July 28 now requires ~762 piles/day, above the stated 560/day capacity. July 7 output was 396 (United 380 with 7 rigs; Latnovva an unacceptable 16 with one machine) — additional/stronger rigs and Latnovva escalation are the remaining levers.' },
