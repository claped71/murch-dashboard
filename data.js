...
// CACHE BUSTER: Jul 17, 2026 — Jul 16 field logs added (piles 23,518, trackers 683, modules 12,394; req 870/49/3,699)
...
window.MURCH_DATA = {
    ...
    contractors: [
      { name: 'LATNOVVA / assigned areas', scope: 19260, installed: 13701, remaining: 5559, done: 71.1, zones: 'Zones A, B, C, D, G, EW + shared Area E control', status: 'Watch', note: "Area-based control allocation only; it is not a new manpower or subcontractor headcount report." },
      ...
      { name: 'United', scope: 7658, installed: 5721, remaining: 1937, done: 74.7, zones: 'Zone F', status: 'Active', note: 'Executed: 5,721 in Zone F (74.7%) — through Jul 16. Jul 16: 364 piles, United ran 4 of 6 rigs (2 damaged).' },
