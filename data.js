...
window.MURCH_DATA = {
    ...
    manpowerNote: 'NO HEADCOUNT BOARD WAS FILED FOR Jul 31 - the mix below is the Jul 30 board carried forward. Jul 31 REPORTED headcount across the five subs that filed: ECCS 53 (trackers) + United 55 + Workforce 29 (ALL on modules) + Brumont 20 + Latnovva 11 = 168 people. THE WORKFORCE RACKING CREW DISAPPEARED FROM THE REPORT: 14 people were on Zone EW racking on Jul 30 and Jul 31 shows 29 people, all on modules. Either the crew was reallocated to panels - which would explain the module jump - or it was not reported. Confirm with Manuel before Monday. No electrical report was filed at all despite Luis asking for it. PRIOR Jul 30 site board = 253 (Jul 29: 248). ECCS 66 (53 trackers + 13 LV) - United 55 - Workforce 48 - GreenSol 20 (carried forward, card left blank on the board) - Brumont 19 - ITS 13 - Latnovva 9 - ABPower 8 - Dig It 5 - Topland 4 - Hi Tech 3 - Kalamazoo 2 - SWCA 1. Crane 2 is equipment, not headcount. PRODUCTION WAS FILED FOR ONLY ~190 OF THE 253 PEOPLE ON SITE: the United report of 507 piles and 37 open racking rows arrived late in the day, and United counted 51 of its own people against 55 on the board; LATNOVVA (9 people) STILL FILED NOTHING, and ABPower, Dig It, Topland, Hi Tech, Kalamazoo and SWCA filed nothing at all. Missing output is a reporting failure, not a zero-production day.',
    contractorScore: [
      ...
      { date: 'Jul 31 Fri', contractor: 'ECCS (electrical)', trade: 'LV', output: 0, resource: 'NO LV REPORT FILED - Luis Romero asked for the electrical report and none was posted', perUnit: 0, criterion: 0, critLabel: 'LBDs hold at 78 of 419 and cable footage holds at ZERO against 6,541 lf/day now required for Sep 18. A missing report is not a zero-production day, but LV is the largest single exposure on the energization path and it went unreported.' },
      { date: 'Jul 31 Fri', contractor: 'ITS', trade: 'MV / HDD', output: 0, resource: '13 people - still drilling MVHB-12; the ITS control sheet records 0 ft bored and 0 ft plowed for the day and for the week', perUnit: 0, criterion: 1, critLabel: 'FOURTH straight day with no bore and no plow segment closed. MV bores hold 17/20, segments 36/46 (120,738 ft), DC ducts 3/14. MVHB-12 was estimated to close Sunday - hold ITS to that date.' },
    ...
    weeklyPlan: [
      ...
      { area: '<u>LV electrical — START</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: 'NO LV REPORT WAS FILED ON Jul 31 despite Luis asking for it. Position carried from Jul 30: LBDs 78/419 (18.6%), Area A complete at 50/50; supports N-S 100% in A1/A3/A5, E-W 100% in A6/A7; MW N-S 100%, MW E-W A5 50%. STILL ZERO measured cable footage. GOAL: Area A LV-cabled for the Mike/client visit.',
    ...
    electricalTotal: {
      ...
      earnedPct: 25.1,
      components: [
        { name: 'LV / DC installation', weight: 45, gate: 0.0, earned: 1.9, note: '274,720 lf of cable, 419 boxes. 78 boxes mounted; still zero measured cable footage. NO LV REPORT WAS FILED ON Jul 31.' },
    ...
    projectTotal: {
      ...
      components: [
        ...
        { name: 'Electrical (LV + MV + inverters + SET)', weight: 14, gate: 16.8, earned: 25.1 },
    ...
    lvComposite: {
      asOf: 'Jul 31, 2026 (no LV report filed - Jul 30 basis carried)',
    ...
    production: [
      ...
      { name: 'ITS HDD boring', remaining: '3 of 20 MV bores · 11 of 14 DC bores', target: 'Minimum 1 completed bore/day', latest: 'Jul 31: ZERO ft bored — the ITS control sheet records 0 ft for the day and 0 ft for the week; MVHB-12 still open, committed to Sunday — 13 people', cumulative: '17 / 20 MV bores (85%, 5,462 ft) + 3 / 14 DC bores (21.4%, 647 LF)', status: 'Watch', note: 'MVHB-12 is being drilled deliberately slowly to avoid a frack-out on the wetland crossing — correct practice, and the reason MV bores have held at 17/20 for four days. Two drills since Jul 24; EGLE ruled the last MV bores stay bores.' },
    ...
    risks: [
      ...
      { title: 'Chemik LV material \u2014 critical path to energization', level: 'Critical', owner: 'Luis Romero | Clara Lopez', note: 'Air freight agreed Jul 28; Chemik still owes arrival dates. <strong>0 lf placed against 6,541 lf/day</strong> required for Sep 18. Largest single exposure on the PIS path.' },
