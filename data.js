...
window.MURCH_DATA = {
    ...
    contractorScore: [
      { date: 'Jul 29 Wed', contractor: 'ECCS', trade: 'Trackers', output: 35, resource: '53 people zone E — 35 rows closed at 100% + 34 rows at 75% (Zone E now 379 / 56.2%)', perUnit: 35, criterion: 58, critLabel: '58 rows/day required for Aug 30 — best ECCS day since Jul 14 (30 -> 35) but still 40% under rate; 34 more rows sit at 75% and convert tomorrow' },
      { date: 'Jul 29 Wed', contractor: 'United', trade: 'Piles + Racking', output: 361, resource: '55 people (up from 44) — 361 piles all Zone G (now 1,577 / 47.0%); racking: 82 rows at 20% in Zone F', perUnit: 361, criterion: 500, critLabel: 'Hard Zone G ground still caps the rate, but +22 over Jul 28 on 11 more people. First United racking quantity reported — 82 F rows opened at 20%, no rows closed yet' },
      ...
      { date: 'Jul 29 Wed', contractor: 'Workforce (racking)', trade: 'Trackers', output: 0, resource: '15 people — the 20 Zone EW rows reported at 75%; no row closed', perUnit: 0, criterion: 58, critLabel: 'PERCENTAGE WENT BACKWARDS: the same 20 EW rows were logged at 95% on Jul 28 and at 75% on Jul 29 — needs a straight answer on what is actually left on those rows' },
    ...
    weeklyPlan: [
      { area: '<u>Tracker assembly & QA release</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        ...
        gate: 'QA release STALLED at 606 while 310 built rows wait — the release backlog, not the build rate, now caps the module front.',
    ...
    production: [
      ...
      { name: 'Tracker completion incl. purlins', remaining: '1,570 to build · 1,880 to QA-release', target: '58 completed rows/day now required for Aug 30', latest: 'Jul 29: 35 (ECCS, E) + 34 E rows at 75%; WF racking 20 EW rows at 75%; United 82 F rows at 20%', note: 'Row counts complete only with purlins. Released still 606 / 310 pending on 916 built — no new QA release logged Jul 29, so the release backlog grew by 35 rows in a day.', cumulative: '916 done (36.8%): 606 QA-released + 310 pending Quality / 2,486 total', status: 'Critical' },
