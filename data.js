...
// CACHE BUSTER: Jul 28, 2026 (Tue) EOD-2 — UNITED EOD CAPTURED: 44 people, 339 piles ALL Zone G (ground very hard, as F at start) + racking saddles/bearings (cabezales) distribution/install in Zone F. Jul 28 pile day = 439 (ECCS 100 E + United 339 G) -> 27,175 (86.7%). Zone G 1,216 (36.2%). Zone D: slab demolition FINISHED (Luis); United piling start ~1.5 weeks (~Aug 5-7). United tracker numbers expected Thursday. Floor 464/day (4,177 / 9 wd) holds ~Aug 7. Client report (murch-project-report) synced same basis.
...
window.MURCH_DATA = {
    ...
    zones: [
      ...
      { zone: 'Zone D', contractor: 'United', scope: 1468, installed: 0, remaining: 1468, done: 0, status: 'Ready', note: 'Zone D concrete slab demolition FINISHED (Luis, Jul 28) — area clear. United starts Zone D piling in ~1.5 weeks (~Aug 5-7) per Manuel.' },
      ...
      { zone: 'Zone G', contractor: 'United', scope: 3356, installed: 1216, remaining: 2140, done: 36.2, status: 'Active', note: 'Jul 28: +339 (United, 44 people) -> 1,216 (36.2%). Manuel: Zone G ground is VERY HARD — same as Zone F at its start — capping the daily rate. FULL Zone G still needs the SIGNED CHANGE ORDER — chase signature. United holds full mechanical in F & G.' }
    ],
    production: [
