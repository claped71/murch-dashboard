...
window.MURCH_DATA = {
    ...
    contractors: [
      { name: 'LATNOVVA / assigned areas', scope: 19260, installed: 11941, remaining: 7319, done: 62.0, zones: 'Zones A, B, C, D, G, EW + shared Area E control', status: 'Watch', note: "Area-based control allocation only; it is not a new manpower or subcontractor headcount report." },
      ...
      { name: 'United', scope: 7658, installed: 2090, remaining: 5568, done: 27.3, zones: 'Zone F', status: 'Active', note: 'United installed 380 piles on July 7 with 7 ramming machines. Continuity depends on hard-soil mitigation and confirmed pile deliveries.' },
      { name: 'Project Total', scope: 31352, installed: 18097, remaining: 13255, done: 57.7, zones: "All zones | Construction Manager report", status: 'Critical', note: "Audelio / Construction Manager July 6 Delivery/Mechanical workbook is the official installed-production basis." }
    ],
    zones: [
      ...
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 395, remaining: 2393, done: 14.2, status: 'Active', note: 'July 7 field report adds 16 Latnovva piles with a single machine — an unacceptable daily rate.' },
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 2090, remaining: 5568, done: 27.3, status: 'Active', note: 'July 7 field report: 380 piles with 7 ramming machines. Hard soil remains the critical productivity risk.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '13,255 piles', target: '~736 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 7 field: United 380 piles (7 rigs); Latnovva 16 piles (1 machine) — unacceptable', cumulative: '18,097 / 31,352 installed (57.7%)', status: 'Critical', note: 'July 7 field output was 396 piles. United held 54 piles/rig-day; Latnovva produced 16 piles with a single machine — an unacceptable rate that must be escalated. Holding Jul 28 requires ~736/day over the 18 remaining working days.' },
      { name: 'Pile delivery / site stock', remaining: '5,843 piles undelivered', target: 'Receipts must exceed 560 piles/day burn', latest: 'Jul 6 workbook: delivered piles increased to 25,509', cumulative: '25,509 delivered; 7,412 available above installed', status: 'Watch', note: 'Available stock equals delivered piles less officially installed piles (18,097 through Jul 7). The current buffer covers about 13.2 production days at the acceleration-capacity assumption.' },
      ...
      { name: 'Tracker completion incl. purlins', remaining: '1,958 to build · 2,251 to QA-release', target: '48 completed tracker rows/day acceleration target', latest: 'Jul 7: 22 tracker units (ECCS) — below the 48/day target', cumulative: '528 done (21.2%): 235 QA-released + 293 pending Quality · 493 rows pre-assembled / 2,486 total', status: 'Critical', note: 'Purlins are installed together with the trackers (delivery no longer a restriction). 528 trackers are physically done, of which Quality has released 235; the 293-row QA backlog is the immediate module-workfront lever. Best-estimate completion for all trackers is August 30.' },
      ...
      { name: 'Module installation', remaining: '170,533 modules', target: '5,531 modules/day acceleration target', latest: 'Jul 7: 157 modules — far below the ramp target', cumulative: '937 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'July 7 output of 157 modules is far below the required ramp. Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. Module work requires fully released tracker rows.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 7 measured days', minimum: '560 piles/day', above: 0, below: 11, latest: 'Jul 7 field: 396 piles (United 380 / Latnovva 16)', note: 'July 7 field report: United 380 piles with 7 ramming machines; Latnovva 16 piles with one machine — an unacceptable output. Cumulative installed production is 18,097 (57.7%).', daily: [{ day: 'Jun 18', value: 20, target: 560, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 560, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 560, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 560, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 560, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 560, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 560, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 560, unit: 'piles' }, { day: 'Jul 1', value: 270, target: 560, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 560, unit: 'piles' }, { day: 'Jul 7', value: 396, target: 560, unit: 'piles' }] },
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 7', minimum: '48 tracker units/day', above: 4, below: 10, latest: 'Jul 7: 22 tracker units (ECCS)', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 528 rows — 235 released by Quality and 293 pending QA approval — after 22 units on July 7, still below the 48/day target.', daily: [{ day: 'Jun 17', value: 15, target: 48, unit: 'units' }, { day: 'Jun 18', value: 35, target: 48, unit: 'units' }, { day: 'Jun 19', value: 26, target: 48, unit: 'units' }, { day: 'Jun 20', value: 31, target: 48, unit: 'units' }, { day: 'Jun 21', value: 0, target: 48, unit: 'units' }, { day: 'Jun 22', value: 48, target: 48, unit: 'units' }, { day: 'Jun 23', value: 31, target: 48, unit: 'units' }, { day: 'Jun 24', value: 0, target: 48, unit: 'units' }, { day: 'Jun 25', value: 57, target: 48, unit: 'units' }, { day: 'Jun 26', value: 26, target: 48, unit: 'units' }, { day: 'Jun 29', value: 29, target: 48, unit: 'units' }, { day: 'Jun 30', value: 30, target: 48, unit: 'units' }, { day: 'Jul 1', value: 51, target: 48, unit: 'units' }, { day: 'Jul 7', value: 22, target: 48, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 7 field start', minimum: '5,531 modules/day', above: 0, below: 3, latest: 'Jul 7: 157 modules — laughably low vs the ramp', note: 'Workforce reported only 157 modules on July 7 — far below the ramp requirement. Cumulative 937 field-reported; modules must finish by Sep 6, one week after tracker completion.', daily: [{ day: 'Jul 3', value: 234, target: 5531, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 5531, unit: 'modules' }, { day: 'Jul 7', value: 157, target: 5531, unit: 'modules' }] },
    ...
    schedule: [
      ...
      { activity: 'Current pile delivery burn', contractor: 'ECCS / LATNOVVA / United', start: '2026-06-16', end: '2026-07-07', status: 'Watch', note: 'Through July 7: 18,097 installed and 25,509 delivered piles, leaving a 7,412-pile buffer, about 13.2 days at the 560/day acceleration capacity.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', note: '13,255 piles remain after July 7: holding July 28 now requires ~736 piles/day, above the stated 560/day capacity. July 7 output was 396 (United 380 with 7 rigs; Latnovva an unacceptable 16 with one machine) — additional/stronger rigs and Latnovva escalation are the remaining levers.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', note: '528 trackers done — 235 QA-released plus 293 pending Quality approval (Jul 7: 22 units by ECCS, below the 48/day target); 493 rows pre-assembled. Purlins are installed together with the trackers — delivery is no longer a restriction and purlin work finishes with tracker completion. Best-estimate completion for all trackers is August 30.' },
      ...
      { activity: 'Final module installation completion', contractor: 'Workforce', start: '2026-07-03', end: '2026-09-06', status: 'Critical', note: 'Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. Cumulative 937 modules field-reported through July 7 (157 on Jul 7 — far below the ramp); full-field production depends on released tracker rows and the module crew ramp.' },
    ...
    risks: [
      ...
      { title: 'Area F hard soil is still limiting pile output', level: 'Critical', owner: 'Audelio Zuniga / United / Manuel Ramirez', note: 'July 7: United 380 piles with 7 ramming machines (54/rig-day) while Latnovva delivered only 16 piles with a single machine — an unacceptable output that must be escalated (rig deployment and manning). Hard soil in Area F continues to require stronger machines or additional rigs to protect the July 28 pile gate.' },
      { title: 'QA release backlog controls module workfront', level: 'Critical', owner: 'Daniel Morilla (QA/QC) / ECCS / Manuel Ramirez', note: '293 done tracker rows are awaiting Quality approval on top of the 235 already released. Clearing this QA backlog immediately unlocks module workfront — at the current 157-modules/day output, released rows are not yet the binding constraint, but they will be as the module crew ramps.' },
