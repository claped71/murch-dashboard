...
// CACHE BUSTER: Jul 30, 2026 (Thu) EOD FINAL - piles 28,341 (90.4%) / trackers 946 built (38.1%), 296 CLIENT-released, earned 40.4% / modules 40,147 (23.4%). Jul 30: United 507 piles Zone G (51 ppl, best United day) + ECCS 120 Zone E = 627, best since the weather stop and above the 430/day rate. United racking advanced to 37 rows at step 3 of 5. ECCS 30 rows closed Zone E; WF 1,749 + Brumont 1,409 = 3,158 modules all in unreleased Zone E; ECCS-elec 22 LBDs -> 78/419; WF racking 0 rows closed (EW, 3rd day). LATNOVVA STILL FILED NO LOG. PILE STOCK = 2. WIP SNAPSHOT RULE: unfinished-tracker counts are a photograph of open rows per crew, never additive. Modules: DELIVERY COMPLETE 171,470/171,470.
...
window.MURCH_DATA = {
    ...
    production: [
      { name: 'Project pile installation', remaining: '3,011 piles', target: 'Floor 430/day holds ~Aug 7 (3,011 remain, 7 working days)', latest: 'Jul 30: 627 (United 507 Zone G + ECCS 120 Zone E) — BEST DAY SINCE THE WEATHER STOP. Jul 29: 539', cumulative: '28,341 / 31,352 executed (90.4%) — workbook roll-up 26,736 + 1,605 field (Jul 28-30)', status: 'Critical', note: 'SECOND CONSECUTIVE DAY ABOVE RATE and the best since the weather stop — 627 against 430 required, with Zone G going 47.0% to 62.1% in two days on ground that was capping production a week ago. Latnovva still filed nothing with 9 people on the board, so Zone B (36 from close) is missing. THE CONSTRAINT IS NO LONGER PRODUCTION: 28,343 delivered against 28,341 executed leaves TWO PILES. The crews have proved the rate and will stop for want of material tomorrow morning unless receipts land.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the install burn to zone close', latest: 'Jul 28 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; TWO piles above the 28,341 executed', status: 'Critical', note: 'STOCK IS GONE. 28,343 delivered against 28,341 executed leaves TWO PILES, against 3,011 still to drive. No receipt has been reported since the Jul 28 workbook. THIS IS THE SINGLE BINDING CONSTRAINT ON THE PROJECT: Jul 30 proved the crews can beat the required rate, and tomorrow they stop for want of material rather than capacity. Receipts must land before the first shift or the ~Aug 7 finish is lost to delivery, not to production.' },
    ...
    risks: [
      ...
      { title: 'PILE STOCK IS GONE — TWO piles above executed, on the day the crews proved the rate', level: 'Critical', owner: 'Audelio Zuniga / Procurement / GameChange / Luis Romero Montero', note: 'Jul 30 was the best pile day since the weather stop and the second consecutive day above rate: 627 piles (United 507 in Zone G at 51 people, the best United day of the project, plus ECCS 120 in Zone E) against 430/day needed to hold ~Aug 7. Zone G went 47.0% to 62.1% in two days on ground that was capping the rate a week ago. THAT MAKES DELIVERY THE ONLY REMAINING CONSTRAINT AND IT IS ALREADY BINDING: 28,343 delivered against 28,341 executed leaves TWO PILES, with 3,011 still to drive and no receipt reported since the Jul 28 workbook. Tomorrow the crews stop for want of material, not capacity. Receipts must land before the first shift. Latnovva remains a separate problem: 9 people on the board on Jul 30 and no log filed for a front that is 36 piles from closing Zone B.' },
