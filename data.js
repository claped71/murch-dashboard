...
// CACHE BUSTER: Jul 28, 2026 (Tue) PM-3 — INVERTER 06 SET in Zone C 14:36: ZONES A AND C INVERTER STATIONS ARE NOW ALL INSTALLED (5 of 23 stations — A: 01/02/03, C: 05/06), pending LV/MV terminations. Latnovva closeout + workbook re-base 26,736 stand.
...
window.MURCH_DATA = {
    ...
    weeklyPlan: [
      ...
      { area: '<u>SET & inverter foundations</u>',
        target: 'SET 20.0%; piers 6/17 — all 17 this week. Jul 28: Zones A AND C inverter stations ALL SET (5/23; pending LV/MV terminations). Station pile-sets 21/23 — close 10-D and 16-F.',
