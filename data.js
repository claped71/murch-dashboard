...
window.MURCH_DATA = {
    ...
    contractorScore: [
      ...
      { date: 'Jul 21 Tue', contractor: 'United', trade: 'Piles', output: 169, resource: '24 people · 6 rigs — 147 Zone F + 22 Zone G (FIRST Zone G piles); plus 13 CB + 32 TP electrical piles', perUnit: 28, criterion: 80, critLabel: '80 piles/rig-day — 28/rig on 6 rigs; day split with 45 electrical (CB/TP) piles and the Zone G opening' },
    ...
    zones: [
      ...
      { zone: 'Zone G', contractor: 'United', scope: 3356, installed: 22, remaining: 3334, done: 0.7, status: 'Active', note: 'STARTED Jul 21: first 22 Zone G piles (United). ECCS also completed 1 inverter foundation in Zone G Jul 21. United holds full mechanical in F & G (Jul 17 scope change). Area G released for pile driving; civil cut/fill starts after basin completion.' }
    ],
    production: [
