...
// CACHE BUSTER: Jul 16, 2026 (rev2) — Latnovva Jul 15 confirmed 95 piles added (piles 23,014, req 834)
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 15, 2026',
      piles:    { installed: 23014, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 834, capacity: null, name: 'Piles', unit: 'piles/day' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (23,014 executed, 73.4%), GameChange SAT tracker assembly incl. purlins (648 done, 26.1% — 235 QA-released, 413 pending Quality), and module placement (11,536 executed, 6.7%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      ...
      { area: '<u>Pile production — rig availability, Zones B / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: '8,338 piles remain to the Jul 28 gate (23,014 of 31,352 executed, 73.4%). Jul 15 fell to 481 (United 386 + Latnovva 95) — United down to 2 of 5 running rigs, Latnovva on one. The fleet is degrading, not recovering. Get the broken rigs back immediately to hold the gate.', minimum: '>= 834 piles/day (8,338 over 10 remaining working days, Mon-Sat) — far above the ~560/day crew capacity. Every sub-800 day pushes Jul 28 further out.', gate: 'Rig repairs are the binding constraint — United down to 2 of 5 running and Latnovva 1 of 2. Material is no longer a restriction: 28,343 piles delivered, a 5,329-unit buffer (~6.4 days at the required rate).', owners: 'United / LATNOVVA | Audelio Zuniga | Manuel Ramirez | Joshua Spalding' },
    ...
    contractors: [
      { name: 'LATNOVVA / assigned areas', scope: 19260, installed: 13591, remaining: 5669, done: 70.6, zones: 'Zones A, B, C, D, G, EW + shared Area E control', status: 'Watch', note: "Area-based control allocation only; it is not a new manpower or subcontractor headcount report." },
      ...
      { name: 'Project Total', scope: 31352, installed: 23014, remaining: 8338, done: 73.4, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 23,014 — Audelio's workbook (20,550, official basis, block-map roll-up still through Jul 10 in the Jul 16 re-export) plus 2,464 field-reported piles since (Sat 680; Mon 608; Tue 695; Wed Jul 15: 481 — United 386 F + Latnovva 95 B), pending workbook incorporation." }
    ],
    zones: [
      ...
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 2019, remaining: 769, done: 72.4, status: 'Active', note: 'Executed: 2,019 (72.4%) — workbook + field through Jul 15 (198 Tue + 95 Wed). Latnovva running a single rig with the 2nd in repair; the damaged unit is the production lever.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '8,338 piles', target: '~834 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 15 (Wed): 481 piles — United 386 (2 of 5 rigs) + Latnovva 95 (single rig)', cumulative: '23,014 / 31,352 executed (73.4%) — 20,550 workbook + 2,464 field-reported (Sat 680 + Mon 608 + Tue 695 + Wed 481)', status: 'Critical', note: 'The workbook roll-up (20,550) still carries field production only through Jul 10 in the Jul 16 re-export, so Sat-Wed output is added on top. Jul 15 fell to 481 (United 386 + Latnovva 95) with the fleet degraded — United down to 2 of 5 running rigs, Latnovva on one. Required rate ~834/day over 10 working days; rig repairs are the single biggest lever, and every weak day pushes it higher.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the 834 piles/day install burn', latest: 'Jul 15 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; 5,329 available above the 23,014 executed', status: 'On Track', note: 'Available stock equals delivered piles less executed piles — 5,329 units, about 6.4 days at the 834/day required rate. Delivery is no longer the pile-programme constraint.' },
    ...
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 15 measured days', minimum: '834 piles/day (required for Jul 28)', above: 0, below: 20, latest: 'Jul 15 (Wed): 481 piles — United 386 (2 of 5 rigs) + Latnovva 95 (single rig)', note: 'Jul 15 fell to 481 with the fleet degraded (United 2 of 5 running, Latnovva on one) — well short of the 834/day single goal. (560/day is nominal crew capacity, not a target.) Cumulative 20,550 official + 2,464 field (Sat 680, Mon 608, Tue 695, Wed 481) pending workbook.', daily: [{ day: 'Jun 18', value: 20, target: 834, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 834, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 834, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 834, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 834, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 834, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 834, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 834, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 834, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 834, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 834, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 834, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 834, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 834, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 834, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 834, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 834, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 834, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 834, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 834, unit: 'piles' }] },
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', progress: 90, baseline: 55, note: 'Consolidated delivery line; final tracker-post containers slipped to a 7/14 port arrival, so post deliveries complete the week of 7/20 (node controllers Monday). Site pile stock: 28,343 delivered vs 23,014 executed — 5,329-pile buffer (~6.4 days at the 834/day required rate). Receiving cap 14 pile + 8 racking loads/day; loads count as scheduled until POD/site receipt.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 73.4, baseline: 48.4, note: '8,338 piles remain (20,550 official workbook + 2,464 field: Sat 680, Mon 608, Tue 695, Wed 481): holding July 28 requires ~834 piles/day vs ~560 crew capacity. Jul 15 fell to 481 (United 386 + Latnovva 95) as United dropped to 2 of 5 running rigs; rig repairs (United 3 down, Latnovva 1 down) are the escalated levers.' },
    ...
    equipmentNotes: [
      ...
      { contractor: 'Latnovva', equipment: '2 ramming machines on site — 1 broken, leaving a single working rig (escalated).', output: 'Jul 15 (Wed): 95 piles in Zone B on the single working rig; 2nd rig in repair.' },
    ...
    risks: [
      { title: 'Rig availability, not delivery, now caps pile production', level: 'Critical', owner: 'United / LATNOVVA / Audelio Zuniga / Manuel Ramirez', note: 'Pile stock is comfortable — 28,343 delivered vs 23,014 executed, a 5,329-unit buffer (~6.4 days at the required 834/day). The constraint is mechanical and worsening: United fell to 2 of 5 running rigs Jul 15 and Latnovva is on 1 of 2, so the day fell to 481 (United 386 + Latnovva 95). Every sub-800 day pushes the Jul 28 gate further out and lifts the required rate (now 834/day); rig repairs are the recovery lever and are now urgent.' },
