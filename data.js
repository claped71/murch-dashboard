...
// CACHE BUSTER: Jul 28, 2026 (Tue) PM — WORKBOOK RE-BASE: Jul 28 DELIVERY roll-up = 26,736 piles (85.3%) — block map fully reconciled, SUPERSEDES 22,900+field formula (zones: A 3,834 / B 2,574 / C 2,946 / D 0 / E 8,012 / F 7,647 / G 877 / EW 846; F now 11 from done). Floor 462/day holds ~Aug 7 (4,616 left / 10 wd). AIR CONFIRMED to Chemik Jul 28 (Luis) — arrival dates owed. Borins: DC16HB-03 reported done (Audelio); E-F stays HDD (Road 50); EW/A trench options costed. LV support piles: inverter 210/230 (21/23 stations), CH 10/10, TP 54/615, LBD 97/418. Zone A inverters set + 17 LV boxes stand.
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 27, 2026',
      piles:    { installed: 26736, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 4616, capacity: null, name: 'Piles', unit: 'piles/day' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (26,736 executed, 85.3% — Jul 28 workbook), GameChange SAT tracker assembly incl. purlins (851 done, 34.2% — 606 QA-released, 245 pending Quality (Maurin QA report Jul 27)), and module placement (30,780 executed, 18.0%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      ...
      { area: '<u>Pile production — B / F / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '26,736 / 31,352 (85.3%, Jul 28 workbook) — 4,616 left. CLOSE F (11 left) and B (214); hold G at 300+/day (2,479); D (1,468) to open.',
        minimum: '>= 462/day every working day holds ~Aug 7 (Jul 28 workbook re-base absorbed the lost Monday).',
      ...
      { area: '<u>SET & inverter foundations</u>',
        target: 'SET 20.0%; piers 6/17 — all 17 this week. Jul 28: ALL Zone A inverter stations SET + Inverter 05 in Zone C (pending LV/MV terminations). Station pile-sets 21/23 — close 10-D and 16-F.',
    ...
    contractors: [
      { name: 'LATNOVVA / assigned areas', scope: 15904, installed: 13954, remaining: 1950, done: 87.7, zones: 'Zones A, B, C, D, EW + shared Area E control (Zone G removed Jul 17)', status: 'Watch', note: "Area-based control allocation only; it is not a new manpower or subcontractor headcount report." },
      ...
      { name: 'United', scope: 12482, installed: 8524, remaining: 3958, done: 68.3, zones: 'Zones D + F + G', status: 'Active', note: 'Jul 28 workbook: 8,524 piles — Zone F 7,647 (99.9%, 11 from close) + Zone G 877 (26.1%) + Zone D 0 (workbook assigns D to United). 3 rig breakdowns Sat (2 pending repair confirmation after the Mon weather stop); Zone F racking material separation started.' },
      { name: 'Project Total', scope: 31352, installed: 26736, remaining: 4616, done: 85.3, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 26,736 (85.3%) — Jul 28 DELIVERY workbook roll-up, block map FULLY RECONCILED (supersedes the 22,900 + field-logs formula; net +177 over the Jul 25 field basis). Latnovva silent since Jul 22 — logs owed; Jul 28 production day pending EOD capture." }
    ],
    zones: [
      ...
      { zone: 'Zone E', contractor: 'ECCS / Latnovva', scope: 8456, installed: 8012, remaining: 444, done: 94.7, status: 'Active', note: 'Jul 28 workbook roll-up: 8,012 (94.7%) — the prior 8,204 field-log figure included entries the block-map reconciliation re-mapped; workbook is now the controlling basis.' },
      ...
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 2574, remaining: 214, done: 92.3, status: 'Active', note: 'Jul 28 workbook roll-up: 2,574 (92.3%) — block map fully reconciled (prior field self-report 2,623 re-mapped). Latnovva logs still owed since Jul 22.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '4,793 piles', target: 'Jul 28 gate out of reach — floor 462/day holds ~Aug 7 (4,616 remain, Jul 28 workbook)', latest: 'Jul 27 (Mon): 0 — WEATHER DAY. Jul 25: 236 (United, Zone G)', cumulative: '26,736 / 31,352 executed (85.3%) — Jul 28 workbook roll-up, block map fully reconciled', status: 'Critical', note: 'The Jul 28 DELIVERY workbook roll-up (26,736) is now the controlling basis — it supersedes the 22,900-block-map + field-logs formula. Latnovva logs owed since Jul 22; finish projects ~Aug 7 at 462/day.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the install burn to zone close', latest: 'Jul 28 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; 1,607 available above the 26,736 executed', status: 'On Track', note: 'Stock = delivered minus executed. Delivery is not the constraint.' },
      ...
      { name: 'Module installation', remaining: '140,690 modules', target: '4,020 modules/day required for Sep 6 (66 released-row buffer feeds it; 4,680/day Tue-Sat recovers the week)', latest: 'Jul 27 (Mon): 0 — WEATHER DAY. Jul 24: 3,134', cumulative: '30,780 modules field-reported — Jul 28 workbook now carries 29,526 (A 19,860 + C 9,666), closing on the field basis', status: 'Critical', note: 'Four days near 3,000+; record 3,601. Gap to 3,908/day = Brumont re-man (14 -> 18) + Saturdays.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 25 measured days', minimum: '462 piles/day floor holds ~Aug 7 (4,616 left over 10 working days, Jul 28 workbook basis)', above: 0, below: 30, latest: 'Jul 27 (Mon): 0 — WEATHER DAY, site stopped', note: 'Mon Jul 27 lost to rain — zero piles. Jul 28 workbook re-base: 26,736 executed (85.3%), F only 11 from close. 2 rigs pending repair verification; Latnovva logs owed; ~Aug 7 finish needs 462/day.', daily: [{ day: 'Jun 18', value: 20, target: 1022, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 1022, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 1022, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 1022, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 1022, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 1022, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 1022, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 1022, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 1022, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 1022, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 1022, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 1022, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 1022, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 1022, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 1022, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 1022, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 1022, unit: 'piles' }, { day: 'Jul 16', value: 504, target: 1022, unit: 'piles' }, { day: 'Jul 17', value: 472, target: 1022, unit: 'piles' }, { day: 'Jul 18', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 20', value: 622, target: 1022, unit: 'piles' }, { day: 'Jul 21', value: 253, target: 1176, unit: 'piles' }, { day: 'Jul 22', value: 202, target: 1419, unit: 'piles' }, { day: 'Jul 23', value: 284, target: 1419, unit: 'piles' }, { day: 'Jul 24', value: 364, target: 1349, unit: 'piles' }, { day: 'Jul 25', value: 236, target: 1677, unit: 'piles' }, { day: 'Jul 27', value: 0, target: 2397, unit: 'piles' }] },
    ...
    schedule: [
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 85.3, baseline: 48.4, note: '4,793 piles remain (block-map 22,900 + 3,659 field) — Jul 28 gate out of reach; ~Aug 7 finish needs 462/day after Mon Jul 27 was LOST TO WEATHER (0 piles) and the Jul 28 workbook re-base. Jul 25 (Sat): 236 (all Zone G; 3 rig breakdowns). Rig repairs, weather recovery and the missing Latnovva logs are the escalated levers.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', progress: 34.2, baseline: 0, note: 'Jul 23-24: 28 + 30 rows (ECCS, Zone E) — 851 done / 606 QA-released / 245 pending QA (Maurin QA report Jul 27). United racking crew ramping (~1.5 wks to full rate); Workforce racking on dampers/actuators Jul 24. Workbook reconciliation closing: Jul 28 cut shows 715 pre-assembled / 567 complete vs the 851 field basis. QA release cadence is the controlling item for the module front.' },
    ...
    risks: [
      ...
      { title: 'Pile finish projects ~Aug 7 — Zone G is accelerating but Latnovva is silent and rigs stay down', level: 'Critical', owner: 'United / LATNOVVA / Audelio Zuniga / Manuel Ramirez', note: 'Pile stock is comfortable — 28,343 delivered vs 26,736 executed (Jul 28 workbook), a 1,607-unit buffer. United worked Saturday Jul 25: 236 piles (all Zone G) with 14 pull tests, but 3 rigs broke down during the day (1 fixed, 2 open into Monday) and Latnovva has not reported production since Jul 22. Jose (Jul 22): "We are drastically reducing pile production — we are now heading to Aug 7. Make the effort to hit the piling completion milestone." Mon Jul 27 was then lost entirely to weather (0 piles) — the ~Aug 7 finish now needs 462/day on the re-based 26,736; the working projection is ~Aug 7. Rig repairs, the Latnovva daily logs, and Saturday work are the recovery levers.' },
