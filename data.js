...
window.MURCH_DATA = {
    ...
    schedule: [
      ...
      { activity: 'Substation (SET) construction', contractor: 'AB Power / Michael Power / SET team', start: '2026-06-01', end: '2026-09-25', status: 'Critical', progress: 16.0, baseline: 40, note: 'Jul 20 SET tracker: 16.0% overall (civil 49.4%, structural 7.5%, electrical 4.3%) against a ~40% plan-to-date on a linear baseline to the Sep 25 MC — about 24 points behind, the lagging critical path. Transformer and structural steel remain in fabrication (the controlling items for energization); AB Power has presented no work or delivery plan and Greensol is pulling partial scope to Michael Power. Inverter steel-pile welding procedure received Jul 21 (Daniel Morilla).' },
