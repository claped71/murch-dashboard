...
// CACHE BUSTER: Jul 15, 2026 (rev4) — consolidated each category to one milestone-required daily goal (piles 802, trackers 48, modules 3,571)
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 14, 2026',
      piles:    { installed: 22533, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 802, capacity: null, name: 'Piles', unit: 'piles/day' },
      trackers: { installed: 613, released: 235, total: 2486, gate: '2026-08-30', gateLabel: 'Aug 30', required: 48, capacity: 48, name: 'Trackers incl. purlins', unit: 'rows/day' },
      modules:  { installed: 10756, total: 171470, gate: '2026-09-06', gateLabel: 'Sep 6', required: 3571, capacity: null, name: 'Modules', unit: 'mod/day' },
    ...
    contractorScore: [
      ...
      { date: 'Jul 13 Mon', contractor: 'ECCS', trade: 'Trackers', output: 29, resource: '54 people · zone C · plus 4 inverter piles driven in zone E', perUnit: 29, criterion: 48, critLabel: '48 rows/day — Jose: this must at least double; Brumont enters C with only 13 released rows' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (22,533 executed, 71.9%), GameChange SAT tracker assembly incl. purlins (613 done, 24.7% — 235 QA-released, 378 pending Quality), and module placement (10,756 executed, 6.3%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      { area: '<u>Tracker completion and QA release — Zones C / A / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: 'THE controlling front this week. 613 rows done (235 QA-released, 378 pending) of 2,486. ECCS ramped from 29 rows Monday to 49 on Tuesday in Zone C with 54 people — first day at the required rate. Brumont moved into Zone C Wed Jul 15 against only 13 QA-released rows — barely a day and a half of module workfront. Break the QA freeze (still nothing released Jul 10-14: rows driven but not levelled/aligned) and convert Zone C rows into released workfront ahead of the module crew.', minimum: '>= 48 completed rows/day required to hold Aug 30 (1,873 rows / 39 working days). ECCS has hit the rate once (49 Tue) — hold and exceed it. QA: Daniel is now concentrating crews on tracker release; post Zone F progress and clear the A6/A7 backlog this week.', gate: 'QA turnover of finished rows, not assembly. OPEN ACTION: some Area F zones were released internally without the subcontractor submitting quality documents — recover those documents this week.', owners: 'ECCS | Daniel Morilla (QA/QC) | Audelio Zuniga | Manuel Ramirez' },
      { area: '<u>Pile production — rig availability, Zones B / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: '8,819 piles remain to the Jul 28 gate (22,533 of 31,352 executed, 71.9%). Six straight production days above the 560 line (646, 669, 680, 680, 608, 695) — Jul 14 was United 497 in Zone F plus a Latnovva rebound to 198 in Zone B on a single working rig. The fleet is still degraded: United runs 6 of 8 rigs and Latnovva 1 of 2. Get the broken rigs back this week to hold the gate.', minimum: '>= 802 piles/day (8,819 over 11 remaining working days, Mon-Sat) — well above the 560/day stated capacity. Every sub-800 day pushes Jul 28 further out; at 560/day the gate lands into early August.', gate: 'Rig repairs are the binding constraint — 2 United units and 1 Latnovva unit down. Material is no longer a restriction: 28,343 piles delivered, a 5,810-unit buffer (~7.2 days at the required rate).', owners: 'United / LATNOVVA | Audelio Zuniga | Manuel Ramirez | Joshua Spalding' },
      { area: '<u>Module installation ramp — Zone A into Zone C</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: 'Two days above 2,000: record 2,922 Monday (Brumont 1,858 + Workforce 1,064) then 2,335 Tuesday (Brumont 1,165 + Workforce 1,170). 10,756 of 171,470 executed (6.3%). Jose set the bar at more than 3,000/day this week. Brumont moved into Zone C Wed Jul 15.', minimum: '>= 3,000 modules/day with both crews this week; ~3,571/day required to hold the Sep 6 finish, ramping toward the 5,531/day full-field rate.', gate: 'QA-released tracker rows — with only 13 released in Zone C, the crews will outrun the workfront within days. Module-spacing QC control (Golden Row slot-tolerance finding) stays in force.', owners: 'Workforce / Brumont | Audelio Zuniga | Daniel Morilla (QA/QC) | Manuel Ramirez' },
      ...
      { area: 'SET, inverter foundations and inverter arrival', target: 'SET at 11.8% overall (civil 44.9%, structural 5.7%). Containment berm and transformer foundation complete Jul 12; base plates welded on all 18 inverter stations delivered. Close the last inverter pile foundations — D10, E12, F16, G20 (195 of 230 piles, 84.8%, +1 in zone F on Jul 14) — before the end-July arrival of the 23 inverter units.', minimum: 'All 23 inverter foundations released before first delivery; keep the SET civil rate that took overall progress from 8.7% to 11.8% in a week.', gate: 'Transformer and structural steel remain in fabrication — the controlling items for energization. Several electrical items still show committed dates after the Jul 10 required-on-site gate.', owners: 'AB Power / SET team | Axel Cano | Joshua Spalding | Karina Mucino' },
      ...
      { area: 'Electrical MV plowing and HDD closeout', target: 'ITS is ahead of the electrical sequence: 33 of 46 plow segments complete (109,152 ft, +6,978 ft on Jul 14 on the two ESMT segments MV12A-S02 and MV12B-S02) and 16 of 20 bores closed (5,026 ft). Close the last 4 bores and keep segments falling on MV11A (5/10) and MV12A (10/13).', minimum: '>= 1 plow segment/day and >= 1 completed bore/day with measured footage reporting.', gate: 'Crossing approvals, access continuity and equipment availability. Keep the daily LF reporting cadence — boring logged 0 ft Jul 13-14.', owners: 'ITS | Angel Urbina | Joshua Spalding' },
    ...
    civilActivities: [
      ...
      { activity: 'PS foundations', company: 'United', done: 84.3, remaining: 15.7, status: 'Active', note: 'Jul 15 workbook: 195 of 230 inverter piles complete (84.8%) — plus 1 more pile driven in zone F on Jul 14. Pending stations: D10, E12, F16, G20. Work planned through August 10.' },
    ...
    contractors: [
      { name: 'LATNOVVA / assigned areas', scope: 19260, installed: 13496, remaining: 5764, done: 70.1, zones: 'Zones A, B, C, D, G, EW + shared Area E control', status: 'Watch', note: "Area-based control allocation only; it is not a new manpower or subcontractor headcount report." },
      ...
      { name: 'United', scope: 7658, installed: 4971, remaining: 2687, done: 64.9, zones: 'Zone F', status: 'Active', note: 'Executed: 4,971 in Zone F (64.9%) — 3,492 Jul 13 workbook + 446 Sat + 536 Mon + 497 Tue field. Jul 14: 497 piles with 6 of 8 rigs running (83/rig-day).' },
      { name: 'Project Total', scope: 31352, installed: 22533, remaining: 8819, done: 71.9, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 22,533 — Audelio's workbook (20,550, official basis, block-map roll-up still through Jul 10 in the Jul 15 re-export) plus 1,983 field-reported piles since (Sat Jul 11: 680; Mon Jul 13: 608; Tue Jul 14: 695 — United 497 F + Latnovva 198 B), pending workbook incorporation." }
    ],
    zones: [
      ...
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 1924, remaining: 864, done: 69.0, status: 'Active', note: 'Executed: 1,924 (69.0%) — Jul 13 workbook 1,420 + 234 Sat + 72 Mon + 198 Tue field. Latnovva put up 198 on a single working rig Jul 14; the damaged units are still the production lever.' },
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 4971, remaining: 2687, done: 64.9, status: 'Active', note: 'Executed: 4,971 (64.9%) — 3,492 Jul 13 workbook + 446 Sat + 536 Mon + 497 Tue field. Zone F closing fast; United carries the pile programme with 6 of 8 rigs running.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '8,819 piles', target: '~802 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 14 (Tue): 695 piles — United 497 (zone F) + Latnovva 198 (zone B, on a single working rig)', cumulative: '22,533 / 31,352 executed (71.9%) — 20,550 workbook + 1,983 field-reported (Sat 680 + Mon 608 + Tue 695)', status: 'Critical', note: 'The workbook block-map roll-up (20,550) still carries field production only through Jul 10 in the Jul 15 re-export, so Sat/Mon/Tue output is added on top. Jul 14 held at 695 — the best run of the job (646, 669, 680, 680, 608, 695) but still under the 802/day single goal, with Latnovva rebounding to 198 on one working rig. Holding Jul 28 needs ~802/day over 11 working days (Mon-Sat); rig repairs remain the single biggest lever.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the 802 piles/day install burn', latest: 'Jul 15 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; 5,810 available above the 22,533 executed', status: 'On Track', note: 'Available stock equals delivered piles less executed piles — 5,810 units, about 7.2 days at the 802/day required rate. Delivery is no longer the pile-programme constraint.' },
      ...
      { name: 'Tracker completion incl. purlins', remaining: '1,873 to build · 2,251 to QA-release', target: '48 completed rows/day now required for Aug 30', latest: 'Jul 14 (Tue): 49 rows in zone C with 54 people — first day at the required rate, nearly double Monday\u2019s 29', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 613 rows — 235 released by Quality and 378 pending QA approval, and QA still released nothing new Jul 10-14 (Daniel now focusing crews on tracker QA). Brumont moved into zone C on Wed Jul 15 against only 13 released rows there. Trackers remain the controlling risk for the module front.', cumulative: '613 done (24.7%): 235 QA-released + 378 pending Quality · 594+ rows pre-assembled / 2,486 total', status: 'Critical' },
      { name: 'ITS HDD boring', remaining: '4 of 20 bores', target: 'Minimum 1 completed bore/day', latest: 'Jul 14 (Tue): no bores closed, 0 ft bored — 16 / 20 complete (80%)', cumulative: '16 / 20 bores complete (80%); 5,026 ft installed', status: 'Watch', note: 'Jul 14 ITS tracker: 16 done / 0 in progress / 4 pending. No boring progress Jul 14; the last 4 bores (HB-01, HB-10, HB-11, HB-12) remain.' },
      { name: 'ITS MV plowing', remaining: '13 of 46 segments', target: 'Minimum 1 completed segment/day', latest: 'Jul 14 (Tue): +2 ESMT segments (MV12A-S02, MV12B-S02) and 6,978 ft — 33 / 46 complete (71.7%)', cumulative: '33 / 46 segments complete; 109,152 ft installed', status: 'On Track', note: 'Jul 14 ITS tracker: 33 done / 0 in progress / 13 pending. Line status: MV11A 5/10, MV11B 9/12, MV12A 10/13, MV12B 9/11. Plowing comfortably leads the electrical sequence.' },
      ...
      { name: 'Panel delivery', remaining: '14,230 modules to deliver', target: '— No approved daily delivery target in source', latest: '— Latest daily receipt not reported', cumulative: '157,240 / 171,470 delivered (91.7%)', status: 'On Track', note: 'Jul 15 Construction Manager workbook cumulative delivery quantity; 146,484 modules on site above the 10,756 executed.' },
      { name: 'Module installation', remaining: '160,714 modules', target: '3,571 modules/day required for Sep 6 (5,531/day full-field capacity)', latest: 'Jul 14 (Tue): 2,335 modules (Brumont 1,165 + Workforce 1,170) — second straight day above the 2,000 line', cumulative: '10,756 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'Second day above 2,000 (record 2,922 on Jul 13). ~3,571/day now required. The binding constraint is QA-released tracker rows: only 13 released in zone C, where Brumont moved in Wed Jul 15. Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 14 measured days', minimum: '802 piles/day (required for Jul 28)', above: 0, below: 19, latest: 'Jul 14 (Tue): 695 piles — United 497 (zone F) + Latnovva 198 (zone B)', note: 'Best run of the job — 646, 669, 680, 680, 608, 695 — but every day is still short of the single goal, the 802/day required to hold Jul 28. (560/day is nominal crew capacity, no longer shown as a target.) Cumulative 20,550 official + 1,983 field (Sat 680, Mon 608, Tue 695) pending workbook.', daily: [{ day: 'Jun 18', value: 20, target: 802, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 802, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 802, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 802, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 802, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 802, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 802, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 802, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 802, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 802, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 802, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 802, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 802, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 802, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 802, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 802, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 802, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 802, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 802, unit: 'piles' }] },
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 14', minimum: '48 rows/day (required for Aug 30)', above: 4, below: 15, latest: 'Jul 14 (Tue): 49 rows in zone C — first day at the required rate, nearly double Monday\u2019s 29', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 613 rows — 235 released by Quality and 378 pending QA approval, still no new QA releases Jul 10-14. ECCS ran 54 people and hit 49 rows on Jul 14 after Jose directed the rate to at least double; Brumont moved into zone C Wed Jul 15 against only 13 released rows.', daily: [{ day: 'Jun 17', value: 15, target: 48, unit: 'units' }, { day: 'Jun 18', value: 35, target: 48, unit: 'units' }, { day: 'Jun 19', value: 26, target: 48, unit: 'units' }, { day: 'Jun 20', value: 31, target: 48, unit: 'units' }, { day: 'Jun 21', value: 0, target: 48, unit: 'units' }, { day: 'Jun 22', value: 48, target: 48, unit: 'units' }, { day: 'Jun 23', value: 31, target: 48, unit: 'units' }, { day: 'Jun 24', value: 0, target: 48, unit: 'units' }, { day: 'Jun 25', value: 57, target: 48, unit: 'units' }, { day: 'Jun 26', value: 26, target: 48, unit: 'units' }, { day: 'Jun 29', value: 29, target: 48, unit: 'units' }, { day: 'Jun 30', value: 30, target: 48, unit: 'units' }, { day: 'Jul 1', value: 51, target: 48, unit: 'units' }, { day: 'Jul 7', value: 29, target: 48, unit: 'units' }, { day: 'Jul 8', value: 0, target: 48, unit: 'units' }, { day: 'Jul 9', value: 0, target: 48, unit: 'units' }, { day: 'Jul 10', value: 0, target: 48, unit: 'units' }, { day: 'Jul 13', value: 29, target: 48, unit: 'units' }, { day: 'Jul 14', value: 49, target: 48, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 14 field start', minimum: '3,571 modules/day (required for Sep 6)', above: 0, below: 9, latest: 'Jul 14 (Tue): 2,335 modules (Brumont 1,165 + Workforce 1,170) — second straight day above 2,000', note: 'Second day above 2,000 after the Jul 13 record of 2,922, but still short of the single goal — 3,571/day required to hold Sep 6. (5,531/day is the full-field capacity, no longer shown as a target.) Released tracker rows — not crew size — are the constraint, and Brumont moved into zone C Wed Jul 15.', daily: [{ day: 'Jul 3', value: 234, target: 3571, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 3571, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 3571, unit: 'modules' }, { day: 'Jul 8', value: 936, target: 3571, unit: 'modules' }, { day: 'Jul 9', value: 1308, target: 3571, unit: 'modules' }, { day: 'Jul 10', value: 1802, target: 3571, unit: 'modules' }, { day: 'Jul 11', value: 517, target: 3571, unit: 'modules' }, { day: 'Jul 13', value: 2922, target: 3571, unit: 'modules' }, { day: 'Jul 14', value: 2335, target: 3571, unit: 'modules' }] },
      { task: 'ITS MV plowing', period: 'Jun 17-Jul 14', minimum: '1 completed segment/day', above: 10, below: 12, latest: 'Jul 14 (Tue): 2 ESMT segments closed — 33 of 46 cumulative; 6,978 ft plowed', note: 'Jul 14 ITS tracker: 33 of 46 segments complete (71.7%), 0 in progress. 109,152 ft installed. MV11A 5/10, MV11B 9/12, MV12A 10/13, MV12B 9/11.', daily: [{ day: 'Jun 17', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 18', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 19', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 20', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 21', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 22', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 23', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 24', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 25', value: 3, target: 1, unit: 'seg' }, { day: 'Jun 26', value: 4, target: 1, unit: 'seg' }, { day: 'Jun 27', value: 1, target: 1, unit: 'seg' }, { day: 'Jun 28', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 29', value: 2, target: 1, unit: 'seg' }, { day: 'Jun 30', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 1', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 2', value: 1, target: 1, unit: 'seg' }, { day: 'Jul 6', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 7', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 8', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 9', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 10', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 11', value: 1, target: 1, unit: 'seg' }, { day: 'Jul 13', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 14', value: 2, target: 1, unit: 'seg' }] },
      { task: 'ITS HDD boring', period: 'Jul 2-Jul 14 measured days', minimum: '1 completed bore/day', above: 3, below: 5, latest: 'Jul 14 (Tue): no bores closed — 16 of 20 cumulative (80%)', note: 'Jul 14 ITS tracker: 16 done / 0 in progress / 4 pending. 5,026 ft installed; 0 ft bored on Jul 14. The last 4 bores remain.', daily: [{ day: 'Jul 2', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 6', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 7', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 8', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 9', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 10', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 11', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 13', value: 2, target: 1, unit: 'bores' }, { day: 'Jul 14', value: 0, target: 1, unit: 'bores' }] }
    ],
    successors: [
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', progress: 90, baseline: 55, note: 'Consolidated delivery line; final tracker-post containers slipped to a 7/14 port arrival, so post deliveries complete the week of 7/20 (node controllers Monday). Site pile stock: 28,343 delivered vs 22,533 executed — 5,810-pile buffer (~7.2 days at the 802/day required rate). Receiving cap 14 pile + 8 racking loads/day; loads count as scheduled until POD/site receipt.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 71.9, baseline: 48.4, note: '8,819 piles remain (20,550 official workbook + 1,983 field: Sat 680, Mon 608, Tue 695): holding July 28 requires ~802 piles/day vs 560 stated capacity. Six straight production days above the line (646, 669, 680, 680, 608, 695); Jul 14 was United 497 plus a Latnovva rebound to 198. Rig repairs (United 2 down, Latnovva 1 down) are the escalated levers.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', progress: 24.7, baseline: 0, note: 'Jul 14: 49 rows completed in Zone C with 54 people (29 Monday) — 613 done / 235 QA-released / 378 pending QA (still no releases Jul 10-14). Required rate is now 48 rows/day, hit once on Jul 14. Completing and releasing the C rows is the controlling item for the module front — German: piles are no longer the problem; trackers and panels must take the rhythm.' },
      { activity: 'ITS HDD boring', contractor: 'ITS', start: '2026-06-12', end: '2026-08-15', status: 'Active', progress: 80, baseline: 0, note: 'Jul 14 ITS tracker: 16 of 20 bores complete (80%), 0 in progress, 4 pending — no bores closed Jul 14. 5,026 ft installed.' },
      { activity: 'ITS MV cable plowing', contractor: 'ITS', start: '2026-06-25', end: '2026-08-15', status: 'Active', progress: 71.7, baseline: 0, note: 'Jul 14 ITS tracker: 33 of 46 segments complete (71.7%) — +2 on Jul 14 (MV12A-S02, MV12B-S02); 109,152 ft installed, 6,978 ft plowed on Jul 14.' },
      ...
      { activity: 'Inverter foundation readiness', contractor: 'EPC / Civil / Electrical', start: '2026-06-20', end: '2026-07-25 provisional', status: 'Critical', progress: 84.8, baseline: 0, note: 'Jul 15 workbook: inverter piling at 195/230 piles (84.8%, incl. 1 pile driven in F on Jul 14) — pending D10, E12, F16, G20. Base-plate welding complete on all 18 inverter stations delivered to site (Axel Cano, Jul 12) — the remainder wait on inverter deliveries. On pace ahead of the end-July arrival of the 23 units.' },
      ...
      { activity: 'Final module installation completion', contractor: 'Workforce', start: '2026-07-03', end: '2026-09-06', status: 'Critical', progress: 6.3, baseline: 0, note: 'Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. 10,756 modules executed through Jul 14 (record 2,922 on Jul 13, 2,335 on Jul 14); ~3,571/day now required — full-field production depends on released tracker rows and the module crew ramp.' },
    ...
    equipmentNotes: [
      ...
      { contractor: 'ECCS', equipment: 'Tracker structural installation crew; equipment count varies by workfront.', output: 'Largest crew on site; Jul 14: 49 trackers completed in Zone C — first day at the 48/day required rate.' },
      { contractor: 'United', equipment: '8 ramming machines on site — 2 broken (rig repairs escalated).', output: 'Jul 14 (Tue): 497 piles in Zone F with 24 people (83/rig-day on the 6 running rigs).' },
      { contractor: 'Latnovva', equipment: '2 ramming machines on site — 1 broken, leaving a single working rig (escalated).', output: 'Jul 14 (Tue): 198 piles in Zone B on a single working rig — a strong rebound from Monday\u2019s 72.' },
      { contractor: 'Workforce', equipment: 'Module installation hand tools / torque equipment.', output: 'Jul 14 (Tue): 1,170 modules in Zone A with 28 people.' },
      { contractor: 'Brumont', equipment: 'Module installation tools; 18-person crew.', output: 'Jul 14 (Tue): 1,165 modules in Zone A; moved into Zone C Wed Jul 15.' },
      { contractor: 'ITS', equipment: 'HDD boring rig and MV cable-plowing machine.', output: 'Jul 14 ITS tracker: 33/46 plow segments (109,152 ft) and 16/20 bores (80%) complete.' },
    ...
    risks: [
      { title: 'Rig availability, not delivery, now caps pile production', level: 'Critical', owner: 'United / LATNOVVA / Audelio Zuniga / Manuel Ramirez', note: 'Pile stock is comfortable — 28,343 delivered vs 22,533 executed, a 5,810-unit buffer (~7.2 days at the required 802/day). The constraint is mechanical: United is running 6 of 8 rigs and Latnovva 1 of 2, yet Jul 14 reached 695 (United 497 + a Latnovva rebound to 198 on one rig) — the best day of the job but still under the 802/day single goal. Every sub-800 day pushes the Jul 28 gate further out; repairs and the replacement rig are the recovery levers.' },
      { title: 'Trackers remain the controlling front: 49 rows vs 48 required', level: 'Critical', owner: 'ECCS / Daniel Morilla / Manuel Ramirez', note: 'ECCS ramped from 29 rows Monday to 49 on Jul 14 in Zone C using 54 people — first day at the 48 completed rows/day now required for Aug 30. Module crews are running above 2,000/day. Brumont moved into Zone C Wed Jul 15 against only 13 QA-released rows there — roughly a day and a half of module workfront. Hold and exceed the 49-row rate and clear the QA release backlog, or the module ramp starves within two weeks.' },
      { title: 'QA release backlog now binds the module front — and Area F was released without sub documents', level: 'Critical', owner: 'Daniel Morilla (QA/QC) / ECCS / Manuel Ramirez', note: '378 completed tracker rows await Quality approval on top of the 235 released, and still nothing was released between Jul 10 and Jul 14 (rows driven but not levelled/aligned). Daniel is now concentrating crews on tracker QA; the A6/A7 backlog and Area F progress must clear this week. Open item flagged by QA: some Area F zones were released internally without the subcontractor submitting quality documents — those documents must be recovered. With modules above 2,000/day, released rows are the binding constraint.' },
      ...
      { title: 'ITS is ahead of the electrical sequence — keep the reporting cadence', level: 'On Track', owner: 'ITS / Audelio Zuniga / Angel Urbina', note: 'Jul 14 ITS tracker: 33 of 46 plow segments complete (109,152 ft) and 16 of 20 bores closed (5,026 ft). Plowing added 6,978 ft on Jul 14 (MV12A-S02, MV12B-S02); boring logged 0 ft Jul 13-14. Only 4 bores and 13 segments remain; the LV kick-off meeting Jose called for Jul 14 should confirm crews and work plan for the follow-on scope.' },
