...
window.MURCH_DATA = {
    ...
    weeklyPlan: [
      { area: '<u>Tracker closure</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '986 / 2,486 (39.7%). Close the 109 open rows — EW 20 first (in torque and QA), then F 68. Week ask >= 378.',
        minimum: '>= 63/day. Zero closed on Aug 1.',
        gate: 'Closing rate: 88 of the 109 open rows sit with the two crews that closed nothing last week.',
      ...
      { area: '<u>Module rate</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '45,063 / 171,470 (26.3%). Week ask >= 25,300.',
        minimum: '>= 4,214/day — and it needs BOTH crews every day. 780 on Aug 1 with one absent.',
        gate: 'Crew attendance first, then released rows: Zone E carries none.',
