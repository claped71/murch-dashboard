...
window.MURCH_DATA = {
    ...
    successors: [
      ...
      { activity: 'Commissioning and MC', dependency: 'Continuous mechanical completion by zone', impact: 'Unconfirmed post receipts and the incomplete purlin plan consume remaining float and make Sep 25 MC more difficult unless early material waves are converted immediately into finished tracker/module work.', mitigation: 'Convert on-site purlin stock into completed tracker rows at >= 48 units/day, prepare weekend/OT acceleration, and track daily pile burn versus confirmed receipts.' }
    ],
    schedule: [
      ...
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', note: 'Official cumulative counts remain 213 complete trackers and 493 pre-assembled rows (Jul 6 workbook). Purlins are installed together with the trackers: enough purlin units are on site, so purlin delivery is no longer a restriction and purlin work finishes with tracker completion. Best-estimate completion for all trackers is August 30.' },
    ...
    milestones: [
      { name: 'Mechanical Completion', target: 'Sep 25, 2026', forecast: 'Oct 10-15, 2026 provisional', status: 'Critical', note: 'The revised late-July pile forecast and the August 30 tracker-completion estimate (purlins installed with the trackers) leave no acceleration margin; MC still depends on modules by October 9.' },
