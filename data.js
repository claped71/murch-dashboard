...
// CACHE BUSTER: Jul 20, 2026 (PM) — Saturday Jul 18 production added: +608 piles (United 415 Zone F + Latnovva 193 Zone B); trackers & modules idle Saturday. Executed piles 25,304 (80.7%), required 1,210/day to Jul 28 (unrecoverable, slips ~early Aug). Trackers 754 hold (Daniel Jul 20: Zones C1 & C2 released today with Client — first since Jul 10); modules 21,303 hold. ITS Bore-10 frac-outs, DC bore restarts Jul 21.
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 21, 2026',
      piles:    { installed: 25304, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 1210, capacity: null, name: 'Piles', unit: 'piles/day' },
    ...
    contractorScore: [
      ...
      { date: 'Jul 21 Tue', contractor: 'United', trade: 'Piles', output: 0, resource: 'NO REPORT received for Jul 21 — production not logged', perUnit: 0, criterion: 80, critLabel: 'No daily report — chase United; last logged Jul 20: 444 piles' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (25,304 executed, 80.7%), GameChange SAT tracker assembly incl. purlins (754 done, 30.3% — 235 QA-released, 519 pending Quality), and module placement (21,303 executed, 12.4%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      ...
      { area: '<u>Pile production — rig availability, Zones B / F, open D / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '6,048 piles remain to the Jul 28 gate (25,304 of 31,352 executed, 80.7%). Saturday Jul 18 ran 608 — United 415 (Zone F) + Latnovva 193 (Zone B) — the best per-rig day in a week (104 and 97 per rig), but the Jul 28 gate is unrecoverable at ~560/day fleet capacity and slips to ~early August (~Aug 4-5). Close Zone B (381 left) and drive Zone F (1,154 left); open the released Zone D/G fronts as rigs free up.',
        minimum: 'Holding Jul 28 would need ~1,210 piles/day (6,048 over 7 working days) — roughly 2x capacity. Realistic floor: get every rig running and sustain the fleet maximum daily (~600-700), targeting ~4,000+ piles this week, then re-baseline the pile finish to early August. Saturdays must be worked — Jul 18 trackers and modules were idle.',
        gate: 'Rig repairs are the binding constraint — United on 4 of 6 (2 damaged), Latnovva on 2. Material is not a restriction: 28,343 piles delivered, a 3,039-unit buffer.',
    ...
    contractors: [
      ...
      { name: 'United', scope: 11014, installed: 6948, remaining: 4066, done: 63.1, zones: 'Zones F + G', status: 'Active', note: 'Executed: 6,948 piles in Zone F (90.7% of F) — Jul 20: 444, United ran 4 of 6 rigs (2 broken). Zone G (3,356 piles) newly transferred from Latnovva Jul 17, 0 started — combined F+G 63.1%. United now holds full mechanical (piles + trackers + modules) in F & G.' },
      { name: 'Project Total', scope: 31352, installed: 25304, remaining: 6048, done: 80.7, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 25,304 — official block-map 22,900 plus 2,404 field logs not yet mapped (mostly Zone B Latnovva). Jul 21 (Tue): 84 piles (Latnovva B — United NOT reported); +25 trackers (E), +3,082 modules." }
    ],
    zones: [
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 6948, remaining: 710, done: 90.7, status: 'Active', note: 'Executed: 6,948 (90.7%) — through Jul 20 (+444 Mon). Jul 21: NO United report received — chase. Rig repairs still the lever (4 of 6).' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '6,048 piles', target: '~1,210 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 21 (Tue): 84 piles — Latnovva 84 (Zone B, 1 rig); United did NOT report', cumulative: '25,304 / 31,352 executed (80.7%) — 22,900 official block-map + 2,404 field logs not yet mapped (through Jul 20 Monday)', status: 'Critical', note: 'Executed 25,304 of 31,352 (80.7%). The official block-map roll-up is 22,900; field daily logs add 2,404 piles not yet mapped (mostly Zone B, where Latnovva self-reports lead the block map). Jul 21 (Tue) logged only 84 (Latnovva Zone B on 1 rig; United submitted NO daily report — chase before counting the day closed) against the 1,210/day now required over 5 working days to Jul 28. Rig availability keeps degrading: Latnovva down to 1 running rig, United last known 4 of 6. RECONCILIATION FLAG (Jul 20): Audelio DELIVERY workbook is internally inconsistent on piles — the PROGRESS summary shows 22,900 installed, but his detail tabs (Production Q PILE DRIVING + COMPLETED-by-zone block logs) sum to only 17,678, lagging badly in the active zones (Zone F detail 1,743 vs 5,805 summary; Zone B 500 vs 1,457), and a planning tab shows ~15,550. The field WhatsApp daily logs (25,304) are the controlling production basis; Audelio has been asked to reconcile the summary-vs-detail gap in his file.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the 834 piles/day install burn', latest: 'Jul 15 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; 3,039 available above the 25,304 executed', status: 'On Track', note: 'Available stock equals delivered piles less executed piles — 3,039 units, about 3 days at the 1,210/day required rate. Delivery is no longer the pile-programme constraint.' },
    ...
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 21 measured days', minimum: '1,210 piles/day (required for Jul 28)', above: 0, below: 25, latest: 'Jul 21 (Tue): 84 piles — Latnovva 84 (Zone B, 1 rig); United did NOT report', note: 'Jul 21 (Tue) logged 84 piles (Latnovva Zone B, single rig; NO United report) — far short of the 1,210/day single goal. (560/day is nominal crew capacity, not a target.) Executed 25,304 = official block-map 22,900 + 2,404 field logs not yet mapped (field logs through Jul 20 Monday).', daily: [{ day: 'Jun 18', value: 20, target: 1022, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 1022, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 1022, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 1022, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 1022, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 1022, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 1022, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 1022, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 1022, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 1022, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 1022, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 1022, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 1022, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 1022, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 1022, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 1022, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 1022, unit: 'piles' }, { day: 'Jul 16', value: 504, target: 1022, unit: 'piles' }, { day: 'Jul 17', value: 472, target: 1022, unit: 'piles' }, { day: 'Jul 18', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 20', value: 622, target: 1022, unit: 'piles' }, { day: 'Jul 21', value: 84, target: 1210, unit: 'piles' }] },
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', progress: 90, baseline: 55, note: 'Consolidated delivery line; final tracker-post containers slipped to a 7/14 port arrival, so post deliveries complete the week of 7/20 (node controllers Monday). Site pile stock: 28,343 delivered vs 25,304 executed — 3,039-pile buffer (~4 days at the ~1,210/day rate now needed to hold Jul 28). Receiving cap 14 pile + 8 racking loads/day; loads count as scheduled until POD/site receipt.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 78.5, baseline: 48.4, note: '6,048 piles remain (official block-map 22,900 + 2,404 field logs not yet mapped): holding July 28 would need ~1,210 piles/day vs ~560 crew capacity, so the gate is unrecoverable and slips to ~early August (≈ Aug 4-5). Jul 18 Sat: 608 (United 415 + Latnovva 193); United ran 4 of 6 rigs, Latnovva 2 — rig repairs remain the escalated lever; trackers & modules did not work Saturday.' },
    ...
    equipmentNotes: [
      ...
      { contractor: 'United', equipment: '6 ramming machines on site — 2 damaged (4 running; rig repairs urgent).', output: 'Jul 21: NO daily report — last logged Jul 20: 444 piles, Zone F (4 of 6 rigs).' },
    ...
    risks: [
      ...
      { title: 'Rig availability, not delivery, now caps pile production', level: 'Critical', owner: 'United / LATNOVVA / Audelio Zuniga / Manuel Ramirez', note: 'Pile stock is comfortable — 28,343 delivered vs 25,304 executed, a 3,039-unit buffer (~5.5 days at the required 1,210/day). The constraint is mechanical: United ran 4 of 6 rigs and Latnovva 2 on Jul 18 Sat (2 United rigs damaged); the day hit 608, but trackers and modules did not work Saturday. At ~560/day capacity only ~3,900 more piles are possible before Jul 28, so the gate is now unrecoverable and slips to ~early August (≈ Aug 4-5); holding Jul 28 would need ~1,210/day. Rig repairs are the recovery lever and are urgent.' },
