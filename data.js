...
// CACHE BUSTER: Aug 3, 2026 (Mon) - LATE ECCS REPORT FOR Aug 1 FOLDED IN: 53 people, 40 COMPLETED TRACKER ROWS in Zone E, the same as Jul 31. Trackers 1,026 built (41.3%), earned 44.1%. Saturday was not a blank on trackers after all - ECCS delivered two 40-row days running; United and Workforce closed nothing. Aug 1 also placed the FIRST 478 lf of DC cable in Area A1. Modules 45,063 (26.3%), piles 28,678 (91.5%) - no pile crew filed. Weekly plan rewritten for Aug 3-8. ZONE E OPEN-ROW SNAPSHOT SET TO ZERO pending a fresh count from ECCS - the last snapshot of 10 is presumed inside the 40 credited complete, and rows are never counted twice.
...
window.MURCH_DATA = {
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles \u00b7 2,486 trackers', note: 'Piles 91.5% \u00b7 trackers 41.3% \u00b7 modules 26.3%.' },
    ...
    risks: [
      ...
      { title: 'Late and missing daily reports', level: 'High', owner: 'Manuel Ramirez | Audelio Zuniga | Luis Romero', note: 'Aug 1 logs arrived from <strong>4 of 8 crews</strong> and the ECCS block \u2014 40 completed rows \u2014 came in two days late, after the day had been published as a blank. United, Latnovva and Brumont still filed nothing; AB Power was absent. <strong>A missing report is not a zero-production day and the dashboard cannot tell the difference.</strong>' },
