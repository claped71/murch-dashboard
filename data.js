...
window.MURCH_DATA = {
    ...
    actualResources: [
      { contractor: 'GreenSol', people: 14, label: 'EPC management/safety/QC staff' },
      { contractor: 'GreenSol Construction', people: 6, label: 'Self-perform labor' },
      { contractor: 'ECS', people: 2, label: 'Environmental controls crew' },
      { contractor: 'Hurricane', people: 3, label: 'Civil / fence crew' },
      { contractor: 'Topland', people: 6, label: 'Civil / roads crew' },
      { contractor: 'Lounsbury', people: 3, label: 'Civil / grading crew' },
      { contractor: 'ECCS', people: 46, label: 'Tracker structural / mechanical crew' },
      { contractor: 'United', people: 23, label: 'Pile driving crew, Zone F (7 rigs)' },
      { contractor: 'Latnovva', people: 19, label: 'Pile driving crew, Zone B (3rd rig expected today)' },
      { contractor: 'Workforce', people: 18, label: 'Module installation crew, Zone A' },
      { contractor: 'Brumont', people: 20, label: 'Module installation crew, Zone A (2nd module crew)' },
      ...
      { contractor: 'Westwood', people: 0, label: 'No crew on site Jul 9' },
