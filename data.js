...
// CACHE BUSTER: Jul 30, 2026 (Thu) EOD FINAL - piles 28,341 (90.4%) / trackers 946 built (38.1%), 296 CLIENT-released, earned 40.4% / modules 40,147 (23.4%). Jul 30: United 507 piles Zone G (51 ppl, best United day) + ECCS 120 Zone E = 627, best since the weather stop and above the 430/day rate. United racking advanced to 37 rows at step 3 of 5. WF 1,749 + Brumont 1,409 = 3,158 modules all in unreleased Zone E; ECCS-elec 22 LBDs -> 78/419; WF racking 0 rows closed (EW, 3rd day). LATNOVVA STILL FILED NO LOG. PILE AND MODULE DELIVERY BOTH COMPLETE - full quantities on site, no delivery constraint on either front; only 16 purple torque tubes outstanding. WIP SNAPSHOT RULE: unfinished-tracker counts are a photograph of open rows per crew, never additive.
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 30, 2026',
      piles:    { installed: 28341, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 3011, capacity: null, name: 'Piles', unit: 'piles/day' },
      trackers: { installed: 946, released: 296, releasedGS: 492, total: 2486, gate: '2026-08-30', gateLabel: 'Aug 30', required: 59, capacity: 48, name: 'Trackers incl. purlins', unit: 'rows/day', wipRows: 85, wipEquivalent: 59.5, earnedEquivalent: 1005.5, earnedPct: 40.4, earnedBasis: '5-step weighted ladder (adopted Jul 30, 2026)', releaseBasis: 'RELEASED = CLIENT-approved (Heelstone) per the Jul 30 QA sheet. Greensol-approved is carried separately as releasedGS.' },
    ...
    manpowerNote: 'Jul 30 site board = 253 (Jul 29: 248). ECCS 66 (53 trackers + 13 LV) - United 55 - Workforce 48 - GreenSol 20 (carried forward, card left blank on the board) - Brumont 19 - ITS 13 - Latnovva 9 - ABPower 8 - Dig It 5 - Topland 4 - Hi Tech 3 - Kalamazoo 2 - SWCA 1. Crane 2 is equipment, not headcount. PRODUCTION WAS FILED FOR ONLY ~190 OF THE 253 PEOPLE ON SITE: the United report of 507 piles and 37 open racking rows arrived late in the day, and United counted 51 of its own people against 55 on the board; LATNOVVA (9 people) STILL FILED NOTHING, and ABPower, Dig It, Topland, Hi Tech, Kalamazoo and SWCA filed nothing at all. Missing output is a reporting failure, not a zero-production day.',
    contractorScore: [
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (28,341 executed, 90.4%), GameChange SAT tracker assembly incl. purlins (946 done, 38.1% — 296 client-released, 492 Greensol-approved), and module placement (40,147 executed, 23.4%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      ...
      { area: '<u>Pile production — B / F / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '28,341 / 31,352 (90.4%) — 3,011 left. Close B (36), F (11) and E (224); G 430+/day on hard ground (1,779); D opens ~Aug 5-7.',
        minimum: '>= 455/day from Jul 30 holds ~Aug 7 (Jul 29: 539 — FIRST day over the required rate since the weather stop).',
        gate: 'Zone G ground and the change-order signature still owed. MATERIAL IS NOT A GATE — pile delivery is complete at 31,352. Latnovva back with 2 rigs in B.',
      ...
      { area: '<u>GameChange deliveries</u>',
        target: 'BOM confirmed COMPLETE minus 16 purple tubes (Shreeya, Jul 27) — due Wed Jul 29; no site receipt reported. That is the ONLY outstanding delivery on the project: piles and modules are both complete on site.',
    ...
    contractors: [
      ...
      { name: 'United', scope: 12630, installed: 9731, remaining: 2899, done: 77.0, zones: 'Zones D + F + G + the non-ECCS Zone E remainder', status: 'Active', note: 'Jul 30: 51 people reported (board 55), 507 piles all Zone G -> 9,731, the best United day of the project. Racking snapshot: 37 Zone F rows standing at step 3 of 5, up two ladder steps in a day; no row reported complete. Carries 2,899 remaining piles: G 1,272, D 1,468, E 148 and the last 11 in F. Zone D opens ~Aug 5-7.' },
      { name: 'Project Total', scope: 31352, installed: 28341, remaining: 3011, done: 90.4, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 28,341 (90.4%) — Jul 28 workbook roll-up 26,736 + 1,605 field-reported over Jul 28-30. Jul 30 = 627 (United 507 Zone G + ECCS 120 Zone E), the best day since the weather stop. LATNOVVA STILL FILED NO LOG with 9 people on the board, so Zone B is missing. 3,011 remain, all covered from stock on site — pile delivery is complete." }
    ],
    zones: [
      ...
      { zone: 'Zone F', contractor: 'United (racking ramp)', scope: 595, installed: 0, released: 0, releasedGS: 0, remaining: 595, done: 0, wipRows: 37, wipStep: 3, wipEquiv: 25.9, earnedPct: 4.4, status: 'Active', note: 'Jul 30 SNAPSHOT: 37 rows standing at step 3 of 5 — purlins in, dampers and actuators outstanding. The United racking ramp advanced TWO ladder steps in a day (step 1 on Jul 29 to step 3 now), so these rows are close to closing. Per the snapshot rule the 37 REPLACES the 82 reported Jul 29 rather than adding to it. Still ZERO rows reported complete, so 45 rows have left the register with no completion filed; query United before assuming they closed.' },
      ...
      { zone: 'TOTAL', contractor: 'All tracker crews', scope: 2486, installed: 946, released: 296, releasedGS: 492, remaining: 1540, done: 38.1, wipRows: 85, wipStep: null, wipEquiv: 59.5, earnedPct: 40.4, status: 'Critical', note: '946 built (38.1%) · RELEASE RE-BASED Jul 30 to the CLIENT-approved column: 296 accepted by Heelstone (11.9%), 492 approved by Greensol, 650 built rows with no client acceptance · 85 rows in progress worth 59.5 row-equivalents -> 1,005.5 earned (40.4%) · 59 completed rows/day required for Aug 30. ALL 85 OPEN ROWS NOW SIT AT STEP 3 OF 5 across E, EW and F — purlins in, dampers and actuators outstanding. Open rows are a SNAPSHOT per crew, never cumulative.' }
    ],
    ...
    pilesByZone: [
      ...
      { zone: 'Zone G', contractor: 'United', scope: 3356, installed: 2084, remaining: 1272, done: 62.1, status: 'Active', note: 'Jul 30: +507 (51 people) — the best United day of the project, well above the required rate in ground that was capping production a week ago. Zone G has gone 47.0% to 62.1% in two days. Signed ChO still owed for full release.' },
      ...
      { zone: 'TOTAL', contractor: 'All pile crews', scope: 31352, installed: 28341, remaining: 3011, done: 90.4, status: 'Critical', note: '28,341 executed (90.4%) — Jul 30: 627 (United 507 Zone G + ECCS 120 Zone E), the best day since the weather stop and well above rate. Latnovva still filed no log with 9 people on the board, so Zone B has no Jul 30 figure. 3,011 remain; 430/day over the 7 working days to Aug 7. MATERIAL IS NOT A CONSTRAINT — pile delivery is complete at 31,352 and the balance is in the laydown areas. Crew rate and the Zone G ground are the only variables.' }
    ],
    modulesByZone: [
    ...
    projectTotal: {
      ...
      components: [
        { name: 'Piles', weight: 28, gate: 90.4, earned: 90.4 },
        { name: 'Trackers', weight: 22, gate: 38.1, earned: 40.4 },
    ...
    earnedMethod: {
      ...
      scopes: [
        { scope: 'Piles', instrument: 'Atomic unit count', gate: '28,341 / 31,352 = 90.4%', earned: 'n/a — no intermediate state', note: 'Driven or not driven. Pull tests and inspection are QA gates, not construction steps.' },
        ...
        { scope: 'Tracker rows', instrument: '5-step weighted ladder', gate: '946 / 2,486 = 38.1%', earned: '1,005.5 equivalents = 40.4%', note: 'See trackerWip. 136 rows open across three zones.' },
    ...
    trackerWip: {
      ...
      items: [
        ...
        { zone: 'Zone F', contractor: 'United (racking)', rows: 37, stepReached: 3, stepName: 'Purlins (both types) installed', pctStep: 70, equiv: 25.9, pctReported: 75, note: 'Jul 30 SNAPSHOT: 37 rows at step 3 of 5, up from step 1 on Jul 29 — the United racking ramp advanced two ladder steps in a day and these rows are now two steps from closing. Per the snapshot rule the 37 REPLACES the 82 reported Jul 29 rather than adding to it. No row has been reported complete, so the 45-row drop is unexplained and must be queried before any completion is credited.' }
      ],
      steps: [
      ...
      rule: 'TWO MEASURES, NEVER MIXED. (1) GATE / CONTRACT MEASURE — a tracker row counts at 100% only, purlins included: 946 of 2,486 (38.1%). This is the only figure that drives the Aug 30 gate, the S-curves, the module release and any client or Heelstone submission. Partial rows earn NOTHING here. (2) PRODUCTIVITY MEASURE — row-equivalents earned per subcontractor per day, so a day of genuine work never scores as zero: 85 rows are open across three zones, worth 59.5 row-equivalents on the step ladder, putting earned progress at 40.4% against the 38.1% gate figure. All 85 now sit at STEP 3 OF 5 — purlins in, dampers and actuators outstanding. OPEN-ROW COUNTS ARE SNAPSHOTS PER CREW, never cumulative across days. Report both, labelled, side by side.',
      reportingRule: 'ADOPTED Jul 30, 2026 (Jose): partial tracker rows are reported by STEP REACHED, not by a percentage. Each daily block gives, per zone, the number of rows sitting at each step of the 5-step ladder; the equivalents are derived from the fixed weights above. Every step is a physically verifiable state a superintendent can confirm in one pass, so the figure is auditable and cannot drift backwards. A row leaves this register the moment it is credited complete — no double counting. AND (Jose, Jul 30) A REPORTED COUNT OF UNFINISHED ROWS IS A SNAPSHOT OF THE TOTAL PARTIAL ROWS STANDING FOR THAT CREW, NOT AN INCREMENT: it replaces the previous open figure and is never added to earlier days. QA release is NOT a step: release is a separate gate applied only to finished rows. On the ladder the current 85 open rows are worth 59.5 equivalents against 63.8 under the old free-text percentages — that 12% gap is the optimism the previous method carried.'
    },
    production: [
      { name: 'Project pile installation', remaining: '3,011 piles', target: 'Floor 430/day holds ~Aug 7 (3,011 remain, 7 working days)', latest: 'Jul 30: 627 (United 507 Zone G + ECCS 120 Zone E) — BEST DAY SINCE THE WEATHER STOP. Jul 29: 539', cumulative: '28,341 / 31,352 executed (90.4%) — workbook roll-up 26,736 + 1,605 field (Jul 28-30)', status: 'Critical', note: 'SECOND CONSECUTIVE DAY ABOVE RATE and the best since the weather stop — 627 against 430 required, with Zone G going 47.0% to 62.1% in two days on ground that was capping production a week ago. Latnovva still filed nothing with 9 people on the board, so Zone B (36 from close) is missing. MATERIAL IS NOT A CONSTRAINT: pile delivery is complete at 31,352 and every one of the 3,011 remaining piles is on site. The only variables left are crew rate, the Zone G ground and the outstanding change-order signature.' },
      { name: 'Pile delivery', remaining: 'NONE — delivery complete', target: '— Scope closed, no further pile deliveries due', latest: 'Pile deliveries CLOSED — the full BOM quantity is on site', cumulative: '31,352 / 31,352 delivered (100.0%)', status: 'Complete', note: 'PILE DELIVERY IS COMPLETE. The full 31,352-pile quantity was received on site as part of the BOM closeout confirmed Jul 24, so the 3,011 piles still to drive are all covered from the laydown areas. Material does not constrain the pile front at any point to the ~Aug 7 finish — crew rate and ground conditions are the only variables. The 16 outstanding purple torque tubes are a tracker item, not piles.' },
      ...
      { name: 'Tracker completion incl. purlins', remaining: '1,540 to build Â· 2,190 to client release', target: '59 completed rows/day now required for Aug 30', latest: 'Jul 30: 30 (ECCS, E) + 28 E rows at step 3; WF racking closed nothing in EW for a third day; United snapshot 35 open rows in F, none reported complete', note: 'RELEASE RE-BASED Jul 30 to the CLIENT-approved column of the QA sheet: 296 rows accepted by Heelstone, 492 approved by Greensol, 946 built. The 606 previously published was the QA sheet’s executed column, not a release. Client acceptance exists only in Zone A. Separately tracked (trackerWip): 85 open rows worth 59.5 row-equivalents, earned 40.4% against this 38.1% gate, all of them at step 3 of 5. Open-row counts are a SNAPSHOT per crew, never cumulative.', cumulative: '946 done (38.1%): 296 client-released Â· 492 Greensol-approved / 2,486 total', status: 'Critical' },
    ...
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 28 measured days', minimum: '430 piles/day floor holds ~Aug 7 (3,011 left over 7 working days from Jul 31)', above: 2, below: 31, latest: 'Jul 30: 627 (United 507 Zone G + ECCS 120 Zone E) — best day since the weather stop', note: 'SECOND STRAIGHT DAY ABOVE RATE: 627 vs 430. Zone G 47.0% to 62.1% in two days. Latnovva still filed nothing with 9 people on the board, so Zone B is missing. E 224 from close; F 11 from close; D opens ~Aug 5-7. MATERIAL IS NOT AN ISSUE — pile delivery is complete at 31,352 and every remaining pile is on site.', daily: [{ day: 'Jun 18', value: 20, target: 1022, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 1022, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 1022, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 1022, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 1022, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 1022, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 1022, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 1022, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 1022, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 1022, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 1022, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 1022, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 1022, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 1022, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 1022, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 1022, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 1022, unit: 'piles' }, { day: 'Jul 16', value: 504, target: 1022, unit: 'piles' }, { day: 'Jul 17', value: 472, target: 1022, unit: 'piles' }, { day: 'Jul 18', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 20', value: 622, target: 1022, unit: 'piles' }, { day: 'Jul 21', value: 253, target: 1176, unit: 'piles' }, { day: 'Jul 22', value: 202, target: 1419, unit: 'piles' }, { day: 'Jul 23', value: 284, target: 1419, unit: 'piles' }, { day: 'Jul 24', value: 364, target: 1349, unit: 'piles' }, { day: 'Jul 25', value: 236, target: 1677, unit: 'piles' }, { day: 'Jul 27', value: 0, target: 2397, unit: 'piles' }, { day: 'Jul 28', value: 439, target: 462, unit: 'piles' }, { day: 'Jul 29', value: 539, target: 464, unit: 'piles' }, { day: 'Jul 30', value: 627, target: 430, unit: 'piles' }] },
    ...
    schedule: [
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 88.4, baseline: 48.4, note: '3,011 piles remain (28,341 executed — workbook roll-up 26,736 + 1,605 field logs Jul 28-29); ~Aug 7 finish needs 455/day over 8 working days. Jul 29: 539 — United 361 Zone G (55 people) + Latnovva 178 Zone B (back on site, 2 rigs, covers Jul 28-29) — the first day over the required rate since the weather stop. Zone B is 36 from close. Levers: the Zone G change-order signature and Saturday work — material is not one, pile delivery is complete.' },
    ...
    risks: [
      ...
      { title: 'Piles beat the required rate for a second day — and material is NOT a constraint, delivery is complete', level: 'Watch', owner: 'Audelio Zuniga / Manuel Ramirez / United / Latnovva', note: 'Jul 30 was the best pile day since the weather stop and the second consecutive day above rate: 627 piles (United 507 in Zone G at 51 people, the best United day of the project, plus ECCS 120 in Zone E) against 430/day needed to hold ~Aug 7. Zone G went 47.0% to 62.1% in two days on ground that was capping the rate a week ago. PILE DELIVERY IS COMPLETE — the full 31,352 quantity was received as part of the BOM closeout confirmed Jul 24, so all 3,011 remaining piles are on site and there is NO delivery exposure on this front. The remaining variables are crew rate, the hard Zone G ground and the outstanding Zone G change-order signature. Latnovva is the open item: 9 people on the board on Jul 30 and no production log filed for a front that is 36 piles from closing Zone B.' },
