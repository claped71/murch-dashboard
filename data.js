...
window.MURCH_DATA = {
    ...
    weeklyPlan: [
      ...
      { area: '<u>GameChange tracker-material deliveries</u>',
        target: 'POSTS LANDED: 5 truckloads Mon Jul 20 + final 5 Tue Jul 21 (expedited port release) — tracker-post delivery complete, no installation gap. Close the open POD (PL-3295-084-HT) and hold GameChange to the no-staging-on-public-roads rule (Road Commission watching).',
