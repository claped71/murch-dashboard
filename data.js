...
// CACHE BUSTER: Jul 12, 2026 — Saturday Jul 11 production sweep
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 12, 2026',
      piles:    { installed: 20464, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 761, capacity: 560, name: 'Piles', unit: 'piles/day' },
      ...
      modules:  { installed: 5499, total: 171470, gate: '2026-09-06', gateLabel: 'Sep 6', required: 3458, capacity: 5531, name: 'Modules', unit: 'mod/day' },
    ...
    contractorScore: [
      ...
      { date: 'Jul 10', contractor: 'United', trade: 'Piles', output: 496, resource: '23 people · 7 rigs (1 damaged) — no Saturday report', perUnit: 71, criterion: 80, critLabel: '80 piles/rig-day' },
            { date: 'Jul 10', contractor: 'ECCS', trade: 'Trackers', output: 0, resource: '46 people · 18 rows at 75% in C · +2 inverter stations (E) — no Saturday report', perUnit: 0, criterion: 48, critLabel: '48 rows/day' },
            { date: 'Jul 10', contractor: 'Workforce', trade: 'Modules', output: 702, resource: '15 people · zone A — no Saturday report', perUnit: 702, criterion: 2000, critLabel: '2,000 mod/day target' }
    ],
    scope: [
    ...
    civilKpis: [
      ...
      { title: 'SET tracker', metric: '25 complete / 5 in progress', note: 'Jul 11 SET tracker: 25 complete, 5 in progress, 233 pending (~9.5% by activity count); steel-structures advance certified. Control building on site since Jul 7.' }
    ],
    civilActivities: [
      ...
      { activity: 'PS foundations', company: 'United', done: 61.7, remaining: 38.3, status: 'Active', note: 'Rosario Jul 11 sheet: 61.7% weighted across the 23 power stations — consistent with 180/230 inverter piles complete (78%). Work planned through August 10.' },
    ...
    contractors: [
      { name: 'LATNOVVA / assigned areas', scope: 19260, installed: 12992, remaining: 6268, done: 67.5, zones: 'Zones A, B, C, D, G, EW + shared Area E control', status: 'Watch', note: "Area-based control allocation only; it is not a new manpower or subcontractor headcount report." },
      ...
      { name: 'United', scope: 7658, installed: 3406, remaining: 4252, done: 44.5, zones: 'Zone F', status: 'Active', note: 'Jul 11 workbook: 3,406 installed in Zone F (44.5%). Jul 10: 496 piles with 7 rigs (1 damaged).' },
      { name: 'Project Total', scope: 31352, installed: 20464, remaining: 10888, done: 65.3, zones: "All zones | Construction Manager report", status: 'Critical', note: "Audelio / Construction Manager July 6 Delivery/Mechanical workbook is the official installed-production basis." }
    ],
    zones: [
      ...
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 1420, remaining: 1368, done: 50.9, status: 'Active', note: 'Workbook roll-up holds B at 1,420 — Latnovva B field production (Jul 8-11: ~714 piles + inverter stations) is pending allocation. Verify with Audelio.' },
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 3406, remaining: 4252, done: 44.5, status: 'Active', note: 'Jul 11 workbook: 3,406 installed (44.5%) — Zone F closing fast; hard-soil risk beaten by rate.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '10,888 piles', target: '~726 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 11 (Sat): 234 piles — Latnovva-only Saturday crew at 117/rig-day, best rig-day rate yet; United/ECCS did not report', cumulative: '20,464 / 31,352 official (65.3%) + 234 Sat field-reported pending workbook (~20,698)', status: 'Critical', note: 'Jul 11 workbook roll-up remains the official basis (Zone B still held at 1,420 — Latnovva B field production pending allocation). Three straight full-fleet days above capacity (646, 669, 680) before the Saturday partial-fleet 234. Holding Jul 28 needs ~761/day over 14 working days (Mon-Sat) — the 3rd Latnovva rig remains the missing lever.' },
      { name: 'Pile delivery / site stock', remaining: '5,843 piles undelivered', target: 'Receipts must exceed 560 piles/day burn', latest: 'Jul 6 workbook: delivered piles increased to 25,509', cumulative: '25,509 delivered; 5,045 available above installed', status: 'Watch', note: 'Available stock equals delivered piles less officially installed piles (20,464 per the Jul 11 workbook) — 5,045 official, ~4,811 after the Saturday 234 field-reported piles (~8.6 days at the 560/day capacity assumption).' },
      ...
      { name: 'SET construction', remaining: '91.3% of overall scope', target: '— No approved daily progress target in source', latest: 'Jul 11 tracker: 25 complete, 5 in progress, 233 pending', cumulative: '~9.5% by activity count; steel-structures advance certified this period', status: 'Critical', note: 'Jul 8 SET tracker — two more activities closed since Jul 6. Jul 6 discipline split: civil 33.8%, structural 1.9%, electrical 2.3%.' },
      ...
      { name: 'Module installation', remaining: '166,488 modules', target: '5,531 modules/day acceleration target', latest: 'Jul 11 (Sat): 517 modules — Brumont-only Saturday crew; Workforce did not report', cumulative: '5,499 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'Record weekday ramp Thu/Fri (1,308 then 1,802) before the Saturday single-crew 517. Still below the ~3,458/day now required. Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. Module work requires fully released tracker rows.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 11 measured days', minimum: '560 piles/day', above: 3, below: 14, latest: 'Jul 11 (Sat): 234 piles — Latnovva-only Saturday crew at 117/rig-day', note: 'Saturday partial-fleet day (United/ECCS off): 234 by Latnovva alone at 117/rig-day — best rig-day rate yet. Three consecutive full-fleet days above the 560 line before it (646, 669, 680 — official log). ~761/day required for Jul 28; cumulative 20,464 official + 234 Sat pending workbook.', daily: [{ day: 'Jun 18', value: 20, target: 560, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 560, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 560, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 560, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 560, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 560, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 560, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 560, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 560, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 560, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 560, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 560, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 560, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 560, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 560, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 560, unit: 'piles' }, { day: 'Jul 11', value: 234, target: 560, unit: 'piles' }] },
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 7', minimum: '48 tracker units/day', above: 4, below: 10, latest: 'No Saturday report from ECCS; Jul 10: 0 rows — third straight zero day', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 535 rows — 235 released by Quality and 300 pending QA approval. Three straight zero-row days through Jul 10 and no Saturday report — trackers remain the controlling risk for the module front.', daily: [{ day: 'Jun 17', value: 15, target: 48, unit: 'units' }, { day: 'Jun 18', value: 35, target: 48, unit: 'units' }, { day: 'Jun 19', value: 26, target: 48, unit: 'units' }, { day: 'Jun 20', value: 31, target: 48, unit: 'units' }, { day: 'Jun 21', value: 0, target: 48, unit: 'units' }, { day: 'Jun 22', value: 48, target: 48, unit: 'units' }, { day: 'Jun 23', value: 31, target: 48, unit: 'units' }, { day: 'Jun 24', value: 0, target: 48, unit: 'units' }, { day: 'Jun 25', value: 57, target: 48, unit: 'units' }, { day: 'Jun 26', value: 26, target: 48, unit: 'units' }, { day: 'Jun 29', value: 29, target: 48, unit: 'units' }, { day: 'Jun 30', value: 30, target: 48, unit: 'units' }, { day: 'Jul 1', value: 51, target: 48, unit: 'units' }, { day: 'Jul 7', value: 29, target: 48, unit: 'units' }, { day: 'Jul 8', value: 0, target: 48, unit: 'units' }, { day: 'Jul 9', value: 0, target: 48, unit: 'units' }, { day: 'Jul 10', value: 0, target: 48, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 7 field start', minimum: '5,531 modules/day', above: 0, below: 7, latest: 'Jul 11 (Sat): 517 modules — Brumont-only Saturday crew', note: 'Brumont carried a Saturday shift alone with 517 modules after the record weekday ramp (1,308 Thu, 1,802 Fri). Cumulative 5,499 field-reported; modules must finish by Sep 6, one week after tracker completion.', daily: [{ day: 'Jul 3', value: 234, target: 5531, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 5531, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 5531, unit: 'modules' }, { day: 'Jul 8', value: 936, target: 5531, unit: 'modules' }, { day: 'Jul 9', value: 1308, target: 5531, unit: 'modules' }, { day: 'Jul 10', value: 1802, target: 5531, unit: 'modules' }, { day: 'Jul 11', value: 517, target: 5531, unit: 'modules' }] },
      { task: 'ITS MV plowing', period: 'Jun 17-Jul 11', minimum: '1 completed segment/day', above: 8, below: 12, latest: 'Jul 11 (Sat): 1 segment closed — 29 of 46 cumulative', note: 'Jul 11 field table: 29 of 46 segments complete (61.7% ft-weighted), 0 in progress — a Saturday segment closed after the +5/+2/+5 push. 88,596 ft installed through Jul 10.', daily: [{ day: 'Jun 17', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 18', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 19', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 20', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 21', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 22', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 23', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 24', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 25', value: 3, target: 1, unit: 'seg' }, { day: 'Jun 26', value: 4, target: 1, unit: 'seg' }, { day: 'Jun 27', value: 1, target: 1, unit: 'seg' }, { day: 'Jun 28', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 29', value: 2, target: 1, unit: 'seg' }, { day: 'Jun 30', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 1', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 2', value: 1, target: 1, unit: 'seg' }, { day: 'Jul 6', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 7', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 8', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 9', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 10', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 11', value: 1, target: 1, unit: 'seg' }] },
      { task: 'ITS HDD boring', period: 'Jul 2-Jul 11 measured days', minimum: '1 completed bore/day', above: 2, below: 4, latest: 'Jul 11 (Sat): 1 bore closed — 14 of 20 cumulative (70%)', note: 'Jul 11 field table: 14 done / 1 in progress / 5 pending — a bore closed on each of the last four reported days. 4,499.2 ft installed through Jul 10; boring remains the slower ITS front.', daily: [{ day: 'Jul 2', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 6', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 7', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 8', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 9', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 10', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 11', value: 1, target: 1, unit: 'bores' }] }
    ],
    successors: [
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', note: 'Single consolidated delivery line through the July 16 final tracker-material date. Site pile stock: 25,509 delivered vs 20,464 installed — 5,045-pile buffer (~9.0 days). Receiving cap 14 pile + 8 racking loads/day; loads count as scheduled until POD/site receipt. Purlin stock sufficient — delivery is not a production restriction.' },
      { activity: 'United Zone F mobilization and pile-spot marking', contractor: 'United', start: '2026-06-15', end: '2026-06-21', status: 'Complete', note: 'Completed on schedule: marking, mobilization and onboarding closed; United began ramming Jun 22 and has produced daily since.' },
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', note: '10,654 piles remain after the Saturday shift (20,464 official + 234 Sat field): holding July 28 requires ~761 piles/day vs 560 stated capacity. Three straight full-fleet days above the line (646, 669, 680), then a Latnovva-only Saturday at 117/rig-day — the 3rd rig is still out and remains the escalated lever.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', note: 'No Saturday report from ECCS after a third consecutive zero-row day (Jul 10: 18 rows sitting at 75% in Zone C) while crews also drove inverter stations. 535 done / 235 QA-released unchanged. Completing and releasing the C rows is now the controlling item for the module front — German: piles are no longer the problem; trackers and panels must take the rhythm.' },
      { activity: 'ITS HDD boring', contractor: 'ITS', start: '2026-06-12', end: '2026-08-15', status: 'Active', note: 'Jul 11 field table: 14 of 20 bores complete (70%), 1 in progress — a bore closed each of the last four reported days. Five pending; boring remains the slower ITS front.' },
      { activity: 'ITS MV cable plowing', contractor: 'ITS', start: '2026-06-25', end: '2026-08-15', status: 'Active', note: 'Jul 11 field table: 29 of 46 segments complete (61.7% ft-weighted) — +1 on the Saturday shift after the +5/+2/+5 push; 88,596 ft installed through Jul 10.' },
      { activity: 'Control building foundation and delivery gate', contractor: 'AB Power / SET team', start: '2026-06-20', end: '2026-07-10', status: 'Complete', note: 'GATE MET: control building delivered and set on its foundation the night of July 7, three days ahead of the July 10 required-on-site date.' },
      { activity: 'SET equipment required-on-site gate', contractor: 'SET team / Procurement / Suppliers', start: '2026-06-24', end: '2026-07-10', status: 'Critical', note: 'Jul 11 SET tracker: 25 complete, 5 in progress, 233 pending. Control building on site; transformer still in fabrication and several electrical items remain committed after the Jul 10 gate — procurement acceleration still needed.' },
      { activity: 'Inverter foundation readiness', contractor: 'EPC / Civil / Electrical', start: '2026-06-20', end: '2026-07-25 provisional', status: 'Critical', note: 'Jul 11 corrected field table (the prior day\'s had an errata): inverter piling complete at 18 of 23 stations (180/230 piles, 78%) — pending D10, E12, F17, G19, G20. Welding plates complete at 16 of 23 stations — pending B07, B08, D10, E12, F17, G19, G20. On pace ahead of the end-July arrival of the 23 units.' },
      ...
      { activity: 'Workforce module crew mobilization', contractor: 'Workforce', start: '2026-06-29', end: '2026-07-06', status: 'Complete', note: 'Module crews mobilized and producing (Workforce + Brumont, 38 installers on the Jul 9 board); manning stability is tracked in the risks section.' },
    ...
    risks: [
      ...
      { title: 'Trackers are now the controlling front: three straight zero-completion days', level: 'Critical', owner: 'ECCS / Daniel Morilla / Manuel Ramirez', note: 'Piles have run above capacity three days straight (646, 669, 680) even without the 3rd Latnovva rig — keep the rig escalation open, but the schedule risk has moved to trackers: 18 rows stuck at 75% in Zone C and zero completions since Jul 7 while module crews set records (1,802/day). If completed/QA-released rows do not resume immediately, the module ramp starves. As German put it: the piles are no longer the problem — trackers and panels must take the rhythm.' },
