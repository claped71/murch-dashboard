...
// CACHE BUSTER: Jul 27, 2026 (Mon) — WEEKLY-PLAN REWRITE for week Jul 27-Aug 1 (no new production files since the Jul 25 Sat update; basis unchanged: piles 26,559 / trackers 851 (235 rel) / modules 30,780). Pile week floor 436/day holds ~Aug 7; trackers 55/day; modules 3,908/day; LV 5,845 lf/day. Resolved wildfire H&S card removed.
...
window.MURCH_DATA = {
    ...
    weeklyPlan: [
      { area: '<u>Tracker assembly & QA release</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '851 / 2,486 done (34.2%) — 235 released, 616 pending QA. Week ask: >= 330 completed rows AND a fresh QA split.',
        minimum: '>= 55 rows/day for Aug 30 (running 28-30 — half rate).',
        gate: 'QA release cadence (split stale since Jul 20) + United racking ramp (~1.5 wks to full rate).',
      ...
      { area: '<u>Pile production — B / F / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        ...
        minimum: '>= 436/day every working day holds the ~Aug 7 finish (Jul 28 gate gone at 2,397/day).',
        gate: '2 rigs down into Monday + Latnovva silent since Jul 22 — repairs and logs first.',
      ...
      { area: '<u>Module installation ramp</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '30,780 / 171,470 (18.0%) — four straight days near 3,000+. Week ask: >= 23,400 modules.',
        minimum: '>= 3,908/day for Sep 6 — re-man Brumont (14 -> 18) and work Saturday.',
      ...
      { area: '<u>LV electrical — START</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '274,720 lf at 0%. CB/TP support piles started (Zone F) — open the pull on air-landed material this week.',
      ...
      { area: '<u>GameChange deliveries</u>',
        target: 'Land the last 16 purple tubes Wed Jul 29 — closes the tracker BOM.',
        minimum: 'Resolve the claim: 1 purple bundle missing on PL-3295-094-HT.',
      ...
      { area: '<u>SET & inverter foundations</u>',
        target: 'SET 20.0%; piers 6/17 at 3-4/day — all 17 this week. Close the last inverter foundation (22/23); inverter installation window opens Jul 27.',
