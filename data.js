...
// CACHE BUSTER: Jul 13, 2026 (evening) — Jul 13 production: piles 608, trackers 29, modules 2,922 (record); basis = Jul 13 workbook (20,550) + field
...
window.MURCH_DATA = {
    ...
    weeklyPlan: [
      { area: '<u>Pile production acceleration — Zones B / F / D-G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: '9,514 piles remain to the Jul 28 gate (21,838 of 31,352 executed, 69.7%). Five straight production days above the 560/day line: 646, 669, 680, 680 and 608 — the Jul 13 Monday 608 delivered with a degraded fleet (United 6 of 8 rigs running at 89/rig-day; Latnovva down to a single working rig, 72 piles).', minimum: '>= 732 piles/day now required to hold Jul 28 (9,514 piles over 13 remaining working days, Mon-Sat) — above the 560/day stated capacity; at 560/day the gate lands ~Aug 4', gate: 'Rig availability is now the binding constraint: United has 2 of 8 rigs broken and Latnovva 1 of 2. Area F hard soil and daily pile-stock re-feed remain secondary.', owners: 'LATNOVVA / United | Audelio Zuniga | Manuel Ramirez | Joshua Spalding' },
      { area: '<u>GameChange tracker-material deliveries</u>', target: 'Shreeya Devkota confirmed 7 loads for Jul 14 (4 Landstar, 2 NTG, 1 RE-HA) on 45-minute appointment slots from 07:00. Confirm POD/site receipt and close out remaining loads through Jul 16. Sufficient purlin units are on site — delivery is no longer a restriction on tracker completion.', minimum: 'From Jul 7 receive up to 14 pile loads/day plus 8 racking loads/day if appointments and offloading resources hold.', gate: 'Tracker material receipts remain a project gate, but daily production is controlled through completed tracker rows, not a separate purlin daily log.', owners: 'GameChange (Shreeya Devkota) | Manuel Ramirez | Karina Mucino' },
      { area: '<u>Module installation ramp — Area A</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: 'Record Monday: 2,922 modules (Brumont 1,858 + Workforce 1,064) — 8,421 total executed. Jose set the bar at >3,000/day this week with 41 module installers on the board. Modules must finish Sep 6 — one week after tracker completion.', minimum: 'Hold >= 3,000 modules/day with both crews and ramp toward the 5,531/day full-field acceleration rate (~3,469/day now required)', gate: 'QA-released complete tracker rows + measured module-spacing QC control (Golden Row slot-tolerance finding) + crew ramp on schedule.', owners: 'Workforce | Audelio Zuniga | Daniel Morilla (QA/QC) | Manuel Ramirez' },
      { area: 'Tracker assembly and completed row release', target: 'Jul 13 output was 29 tracker rows in zone C after three zero days. 564 trackers are done — 235 QA-released, 329 pending Quality approval. Brumont enters zone C on Wednesday against only 13 QA-released rows there: at 29 rows/day that is barely a day and a half of module workfront.', minimum: '>= 47 completed rows/day now required to hold Aug 30 (1,922 rows over 41 working days); Jose has directed ECCS to at least double the 29 and reinforce crews', gate: 'Complete tracker kits allocated by block and same-week QA turnover of finished rows. QA released nothing Jul 10-13; A6 and A7 are due for release Jul 14.', owners: 'ECCS | Audelio Zuniga | Manuel Ramirez | Daniel Morilla (QA/QC)' },
      ...
      { area: 'Electrical MV plowing and HDD closeout', target: 'Sustain plowing production (15 of 46 segments remaining, 102,174 ft installed) and close the last 4 bores.', minimum: '>= 1 plow segment/day and >= 1 completed bore/day with measured footage reporting', gate: 'Crossing approvals, access continuity, and equipment availability. Jul 13: 9,078 ft plowed on MV12A; 0 ft bored.', owners: 'ITS | Angel Urbina | Joshua Spalding' },
    ...
    schedule: [
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', note: '9,514 piles remain (20,550 official Jul 13 workbook + 1,288 field: Sat 680, Mon 608): holding July 28 requires ~732 piles/day vs 560 stated capacity. FIVE straight production days above the line (646, 669, 680, 680, 608). Rig repairs (United 2 down) and the 3rd Latnovva rig are the escalated levers.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', note: 'Jul 13: 29 rows completed in Zone C with 54 people after three zero days — 564 done / 235 QA-released / 329 pending QA (no releases Jul 10-13; A6 and A7 due Jul 14). Required rate is now 47 rows/day. Completing and releasing the C rows is the controlling item for the module front — German: piles are no longer the problem; trackers and panels must take the rhythm.' },
      { activity: 'ITS HDD boring', contractor: 'ITS', start: '2026-06-12', end: '2026-08-15', status: 'Active', note: 'Jul 13 ITS tracker: 16 of 20 bores complete (80%), 0 in progress, 4 pending — HB-17 and HB-18 closed on Jul 13. 5,444.2 ft installed.' },
      { activity: 'ITS MV cable plowing', contractor: 'ITS', start: '2026-06-25', end: '2026-08-15', status: 'Active', note: 'Jul 13 ITS tracker: 31 of 46 segments complete (67.4%) — +2 since Saturday; 102,174 ft installed, 9,078 ft plowed on Jul 13 (MV12A).' },
      ...
      { activity: 'Inverter foundation readiness', contractor: 'EPC / Civil / Electrical', start: '2026-06-20', end: '2026-07-25 provisional', status: 'Critical', note: 'Jul 13 workbook: inverter piling complete at 19 of 23 stations (194/230 piles, 84.3%, incl. 4 piles driven in E on Jul 13) — pending D10, E12, F16, G20. Base-plate welding complete on all 18 inverter stations delivered to site (Axel Cano, Jul 12) — the remainder wait on inverter deliveries. Prior status: pending B08, D10, E12, F17, G19, G20. On pace ahead of the end-July arrival of the 23 units.' },
