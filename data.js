...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 11, 2026',
      piles:    { installed: 20464, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 726, capacity: 560, name: 'Piles', unit: 'piles/day' },
      ...
      modules:  { installed: 4982, total: 171470, gate: '2026-09-06', gateLabel: 'Sep 6', required: 3398, capacity: 5531, name: 'Modules', unit: 'mod/day' },
    ...
    contractorScore: [
      { date: 'Jul 10', contractor: 'United', trade: 'Piles', output: 496, resource: '23 people · 7 rigs (1 damaged)', perUnit: 71, criterion: 80, critLabel: '80 piles/rig-day' },
      { date: 'Jul 10', contractor: 'LATNOVVA', trade: 'Piles', output: 184, resource: '16 people · 2 rigs · +2 inverter stations (B)', perUnit: 92, criterion: 80, critLabel: '80 piles/rig-day — ABOVE criterion' },
      { date: 'Jul 10', contractor: 'ECCS', trade: 'Trackers', output: 0, resource: '46 people · 18 rows at 75% in C · +2 inverter stations (E)', perUnit: 0, criterion: 48, critLabel: '48 rows/day' },
      { date: 'Jul 10', contractor: 'Brumont', trade: 'Modules', output: 1100, resource: '18 people · zone A', perUnit: 1100, criterion: 2000, critLabel: '2,000 mod/day target' },
      { date: 'Jul 10', contractor: 'Workforce', trade: 'Modules', output: 702, resource: '15 people · zone A', perUnit: 702, criterion: 2000, critLabel: '2,000 mod/day target' }
    ],
    scope: [
    ...
    zones: [
      ...
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 1420, remaining: 1368, done: 50.9, status: 'Active', note: 'Workbook roll-up holds B at 1,420 — Latnovva B6 field production (Jul 8-10: ~480 piles + inverter stations) is pending allocation. Verify with Audelio.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '10,888 piles', target: '~726 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 10: 680 piles — THIRD straight day above 560 (United 496; Latnovva 184 at 92/rig-day, above criterion, +2 inverter stations)', cumulative: '20,464 / 31,352 installed (65.3%) — Jul 11 official workbook', status: 'Critical', note: 'Jul 11 workbook roll-up is the official basis (Zone F 3,406; the workbook still shows Zone B at 1,420 — Latnovva B6 field production is pending allocation in the roll-up). Three straight days above capacity: 646, 669, 680. Holding Jul 28 needs ~726/day over 15 working days — the 3rd Latnovva rig remains the missing lever.' },
      { name: 'Pile delivery / site stock', remaining: '5,843 piles undelivered', target: 'Receipts must exceed 560 piles/day burn', latest: 'Jul 6 workbook: delivered piles increased to 25,509', cumulative: '25,509 delivered; 5,045 available above installed', status: 'Watch', note: 'Available stock equals delivered piles less officially installed piles (20,464 per the Jul 11 workbook). The buffer covers about 9.0 production days at the acceleration-capacity assumption.' },
      ...
      { name: 'Module installation', remaining: '166,488 modules', target: '5,531 modules/day acceleration target', latest: 'Jul 10: 1,802 modules — NEW RECORD (Brumont 1,100 + Workforce 702)', cumulative: '4,982 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'Jul 9: 1,308 modules — best day yet and rising, but Workforce lost most of its crew (6 people worked the full day; Brumont carried the output with 840). Still below the ~3,366/day now required. Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. Module work requires fully released tracker rows.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 10 measured days', minimum: '560 piles/day', above: 3, below: 13, latest: 'Jul 10: 680 piles (United 496 / Latnovva 184)', note: 'Three consecutive days above the 560 line (646, 669, 680 — official log). Latnovva hit 92/rig-day, above criterion. ~726/day required for Jul 28; cumulative 20,464 (65.3%).', daily: [{ day: 'Jun 18', value: 20, target: 560, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 560, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 560, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 560, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 560, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 560, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 560, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 560, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 560, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 560, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 560, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 560, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 560, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 560, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 560, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 560, unit: 'piles' }] },
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 7', minimum: '48 tracker units/day', above: 4, below: 10, latest: 'Jul 7: 29 tracker units (ECCS)', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 535 rows — 235 released by Quality and 300 pending QA approval — after 29 units on July 7, still below the 48/day target.', daily: [{ day: 'Jun 17', value: 15, target: 48, unit: 'units' }, { day: 'Jun 18', value: 35, target: 48, unit: 'units' }, { day: 'Jun 19', value: 26, target: 48, unit: 'units' }, { day: 'Jun 20', value: 31, target: 48, unit: 'units' }, { day: 'Jun 21', value: 0, target: 48, unit: 'units' }, { day: 'Jun 22', value: 48, target: 48, unit: 'units' }, { day: 'Jun 23', value: 31, target: 48, unit: 'units' }, { day: 'Jun 24', value: 0, target: 48, unit: 'units' }, { day: 'Jun 25', value: 57, target: 48, unit: 'units' }, { day: 'Jun 26', value: 26, target: 48, unit: 'units' }, { day: 'Jun 29', value: 29, target: 48, unit: 'units' }, { day: 'Jun 30', value: 30, target: 48, unit: 'units' }, { day: 'Jul 1', value: 51, target: 48, unit: 'units' }, { day: 'Jul 7', value: 29, target: 48, unit: 'units' }, { day: 'Jul 8', value: 0, target: 48, unit: 'units' }, { day: 'Jul 9', value: 0, target: 48, unit: 'units' }, { day: 'Jul 10', value: 0, target: 48, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 7 field start', minimum: '5,531 modules/day', above: 0, below: 3, latest: 'Jul 7: 156 modules — far below the ramp', note: 'Workforce reported only 156 modules on July 7 — far below the ramp requirement. Cumulative 936 field-reported; modules must finish by Sep 6, one week after tracker completion.', daily: [{ day: 'Jul 3', value: 234, target: 5531, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 5531, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 5531, unit: 'modules' }, { day: 'Jul 8', value: 936, target: 5531, unit: 'modules' }, { day: 'Jul 9', value: 1308, target: 5531, unit: 'modules' }, { day: 'Jul 10', value: 1802, target: 5531, unit: 'modules' }] },
      { task: 'ITS MV plowing', period: 'Jun 17-Jul 9', minimum: '1 completed segment/day', above: 8, below: 12, latest: 'Jul 9: 2 segments closed (23 of 46 cumulative)', note: 'Jul 10 ITS workbook: +5 segments on Jul 8 and +2 on Jul 9 — 23 of 46 complete, 74,838 ft installed. Best production week of the electrical scope.', daily: [{ day: 'Jun 17', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 18', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 19', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 20', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 21', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 22', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 23', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 24', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 25', value: 3, target: 1, unit: 'seg' }, { day: 'Jun 26', value: 4, target: 1, unit: 'seg' }, { day: 'Jun 27', value: 1, target: 1, unit: 'seg' }, { day: 'Jun 28', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 29', value: 2, target: 1, unit: 'seg' }, { day: 'Jun 30', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 1', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 2', value: 1, target: 1, unit: 'seg' }, { day: 'Jul 6', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 7', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 8', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 9', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 10', value: 5, target: 1, unit: 'seg' }] },
      { task: 'ITS HDD boring', period: 'Jul 2-Jul 9 measured days', minimum: '1 completed bore/day', above: 2, below: 4, latest: 'Jul 9: 1 bore closed (12 of 20 cumulative)', note: 'Bore completions from the ITS workbook cumulative counts: 10 complete through Jul 2, +1 on Jul 8 and +1 on Jul 9 — 12 of 20 (60%), 4,184.2 ft installed. Eight bores remain the slower ITS front.', daily: [{ day: 'Jul 2', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 6', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 7', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 8', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 9', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 10', value: 1, target: 1, unit: 'bores' }] }
    ],
    successors: [
    ...
    schedule: [
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', note: '10,888 piles remain (20,464 installed, 65.3%, Jul 11 workbook): holding July 28 requires ~726 piles/day vs 560 stated capacity. THREE straight days above the line (646, 669, 680); Latnovva at 92/rig-day above criterion — but the 3rd rig is still out and remains the escalated lever.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', note: 'THIRD consecutive day with zero completed rows (Jul 10: 18 rows sitting at 75% in Zone C) while crews also drove inverter stations. 535 done / 235 QA-released unchanged. Completing and releasing the C rows is now the controlling item for the module front — German: piles are no longer the problem; trackers and panels must take the rhythm.' },
      { activity: 'ITS HDD boring', contractor: 'ITS', start: '2026-06-12', end: '2026-08-15', status: 'Active', note: 'Jul 10 ITS workbook: 12 of 20 bores complete (60%), 4,184.2 ft installed — +1 bore on Jul 8 and +1 on Jul 9. Eight bores remain the slower ITS front.' },
      { activity: 'ITS MV cable plowing', contractor: 'ITS', start: '2026-06-25', end: '2026-08-15', status: 'Active', note: 'Jul 10 ITS workbook: 23 of 46 segments complete (50%), 74,838 ft installed — +5 segments Jul 8 and +2 Jul 9, the best week of the electrical scope.' },
      ...
      { activity: 'Inverter foundation readiness', contractor: 'EPC / Civil / Electrical', start: '2026-06-20', end: '2026-07-25 provisional', status: 'Critical', note: 'Jul 11 workbook: 180 of 230 inverter piles complete (78%) — big push (+66 this week incl. 2 stations by Latnovva in B and 2 by ECCS in E on Jul 10). On pace to be ready before the 23 units arrive at the end of July.' },
    ...
    equipmentNotes: [
      ...
      { contractor: 'ITS', equipment: 'HDD boring rig and MV cable-plowing machine.', output: 'Jul 11 workbook: 28/46 plow segments (88,596 ft) and 13/20 bores (4,499 ft) complete.' },
