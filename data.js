...
// CACHE BUSTER: Jul 27, 2026 (Mon) PM — QA RE-BASELINE from Maurin Moure's Jul 27 QA report: piles inspected 26,439 = 99.5% of the 26,559 executed (Jul 6/13 snapshot 15,274 superseded; paper backlog closed), trackers released 235 -> 606 (245 pending; A 311, C 222, E 73), module release today ~35% per inspections. Heelstone log still frozen at Jul 6/13.
...
window.MURCH_DATA = {
    control: {
      ...
      trackers: { installed: 851, released: 606, total: 2486, gate: '2026-08-30', gateLabel: 'Aug 30', required: 55, capacity: 48, name: 'Trackers incl. purlins', unit: 'rows/day' },
    ...
    weeklyPlan: [
      { area: '<u>Tracker assembly & QA release</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '851 / 2,486 done (34.2%) — 606 released, 245 pending QA (Maurin Jul 27). Week ask: >= 330 completed rows with QA release cadence matching the build rate.',
    ...
    production: [
      ...
      { name: 'Tracker completion incl. purlins', remaining: '1,635 to build · 1,880 to QA-release', target: '53 completed rows/day now required for Aug 30', latest: 'Jul 24: 30 (ECCS, E); WF racking closing EW rows', note: 'Row counts complete only with purlins. Released split updated Jul 27 (Maurin): 606 released / 245 pending; workbook reconciliation open.', cumulative: '851 done (34.2%): 606 QA-released + 245 pending Quality / 2,486 total', status: 'Critical' },
    ...
    dailyProductionHistory: [
      ...
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 24', minimum: '55 rows/day (required for Aug 30)', above: 4, below: 24, latest: 'Jul 24: 30 (ECCS, E); WF racking closing EW rows', note: 'Row counts complete only with purlins installed. Released split updated Jul 27 (Maurin): 606 released / 245 pending.', daily: [{ day: 'Jun 17', value: 15, target: 50, unit: 'units' }, { day: 'Jun 18', value: 35, target: 50, unit: 'units' }, { day: 'Jun 19', value: 26, target: 50, unit: 'units' }, { day: 'Jun 20', value: 31, target: 50, unit: 'units' }, { day: 'Jun 21', value: 0, target: 50, unit: 'units' }, { day: 'Jun 22', value: 48, target: 50, unit: 'units' }, { day: 'Jun 23', value: 31, target: 50, unit: 'units' }, { day: 'Jun 24', value: 0, target: 50, unit: 'units' }, { day: 'Jun 25', value: 57, target: 50, unit: 'units' }, { day: 'Jun 26', value: 26, target: 50, unit: 'units' }, { day: 'Jun 29', value: 29, target: 50, unit: 'units' }, { day: 'Jun 30', value: 30, target: 50, unit: 'units' }, { day: 'Jul 1', value: 51, target: 50, unit: 'units' }, { day: 'Jul 7', value: 29, target: 50, unit: 'units' }, { day: 'Jul 8', value: 0, target: 50, unit: 'units' }, { day: 'Jul 9', value: 0, target: 50, unit: 'units' }, { day: 'Jul 10', value: 0, target: 50, unit: 'units' }, { day: 'Jul 13', value: 29, target: 50, unit: 'units' }, { day: 'Jul 14', value: 49, target: 50, unit: 'units' }, { day: 'Jul 15', value: 35, target: 50, unit: 'units' }, { day: 'Jul 16', value: 35, target: 50, unit: 'units' }, { day: 'Jul 17', value: 25, target: 50, unit: 'units' }, { day: 'Jul 18', value: 0, target: 50, unit: 'units' }, { day: 'Jul 20', value: 21, target: 50, unit: 'units' }, { day: 'Jul 21', value: 25, target: 51, unit: 'units' }, { day: 'Jul 22', value: 39, target: 51, unit: 'units' }, { day: 'Jul 23', value: 28, target: 51, unit: 'units' }, { day: 'Jul 24', value: 30, target: 52, unit: 'units' }] },
