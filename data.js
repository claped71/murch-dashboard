...
// CACHE BUSTER: Jul 25, 2026 (Sat) — piles +236 (United, ALL Zone G; 19 CB + 3 TP electrical OUTSIDE the 31,352; 3 rig breakdowns, 2 open into Monday; 14 pull tests; racking material separation started Zone F). Basis: piles 26,559 (84.7%, req 2,397/day to Jul 28); trackers 851 (55/day) and modules 30,780 (3,908/day) — no tracker/module Sat logs yet. QC/delivery/plan re-swept.
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 25, 2026',
      piles:    { installed: 26559, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 2397, capacity: null, name: 'Piles', unit: 'piles/day' },
      trackers: { installed: 851, released: 235, total: 2486, gate: '2026-08-30', gateLabel: 'Aug 30', required: 55, capacity: 48, name: 'Trackers incl. purlins', unit: 'rows/day' },
      modules:  { installed: 30780, total: 171470, gate: '2026-09-06', gateLabel: 'Sep 6', required: 3908, capacity: null, name: 'Modules', unit: 'mod/day' },
      electrical: { installed: 0, total: 274720, gate: '2026-09-18', gateLabel: 'Sep 18', required: 5845, capacity: null, name: 'LV Electrical', unit: 'lf/day' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (26,559 executed, 84.7%), GameChange SAT tracker assembly incl. purlins (851 done, 34.2% — 235 QA-released, 616 pending Quality; released count stale since Jul 20), and module placement (30,780 executed, 18.0%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      { area: '<u>Tracker assembly & QA release</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        ...
        minimum: '>= 55 rows/day for Aug 30 (now running 28-30).',
      ...
      { area: '<u>Pile production — B / F / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        ...
        minimum: '>= 2,397/day for Jul 28 — unrecoverable; working finish ~Aug 7.',
        gate: 'Rig repairs (2 breakdowns open into Monday) + Latnovva silent since Jul 22.',
      ...
      { area: '<u>Module installation ramp</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        ...
        minimum: '>= 3,908/day for Sep 6 — re-man Brumont (14 -> 18) and work Saturdays.',
      ...
      { area: '<u>LV electrical — START</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        ...
        minimum: '>= 5,845 lf/day from Jul 27 to hold Sep 18.',
    ...
    production: [
      { name: 'Project pile installation', remaining: '4,793 piles', target: '~2,397 piles/day required for Jul 28 (560/day stated capacity) — finish projects ~Aug 7', latest: 'Jul 25: 236 — United, all Zone G. Jul 24: 364', cumulative: '26,559 / 31,352 executed (84.7%) — 22,900 official block-map + 3,659 field logs not yet mapped', status: 'Critical', note: 'Field logs (26,559) are the controlling basis; block-map 22,900 lags. Latnovva logs owed since Jul 22; finish projects ~Aug 7.' },
      ...
      { name: 'Module installation', remaining: '140,690 modules', target: '3,908 modules/day required for Sep 6 (5,531/day full-field capacity)', latest: 'Jul 24: 3,134 (Workforce 1,730 + Brumont 1,404)', cumulative: '30,780 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'Four days near 3,000+; record 3,601. Gap to 3,908/day = Brumont re-man (14 -> 18) + Saturdays.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 25 measured days', minimum: '2,397 piles/day (required for Jul 28)', above: 0, below: 29, latest: 'Jul 25 (Sat): 236 — United, all Zone G; 3 breakdowns', note: 'Zone G ramp 22 -> 63 -> 192 -> 364 -> 236 (Sat cut by 3 rig breakdowns); Latnovva logs owed; finish ~Aug 7.', daily: [{ day: 'Jun 18', value: 20, target: 1022, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 1022, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 1022, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 1022, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 1022, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 1022, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 1022, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 1022, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 1022, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 1022, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 1022, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 1022, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 1022, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 1022, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 1022, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 1022, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 1022, unit: 'piles' }, { day: 'Jul 16', value: 504, target: 1022, unit: 'piles' }, { day: 'Jul 17', value: 472, target: 1022, unit: 'piles' }, { day: 'Jul 18', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 20', value: 622, target: 1022, unit: 'piles' }, { day: 'Jul 21', value: 253, target: 1176, unit: 'piles' }, { day: 'Jul 22', value: 202, target: 1419, unit: 'piles' }, { day: 'Jul 23', value: 284, target: 1419, unit: 'piles' }, { day: 'Jul 24', value: 364, target: 1349, unit: 'piles' }, { day: 'Jul 25', value: 236, target: 1677, unit: 'piles' }] },
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 24', minimum: '55 rows/day (required for Aug 30)', above: 4, below: 24, latest: 'Jul 24: 30 (ECCS, E); WF racking closing EW rows', note: 'Row counts complete only with purlins installed. Released split (235) stale since Jul 20; workbook reconciliation open.', daily: [{ day: 'Jun 17', value: 15, target: 50, unit: 'units' }, { day: 'Jun 18', value: 35, target: 50, unit: 'units' }, { day: 'Jun 19', value: 26, target: 50, unit: 'units' }, { day: 'Jun 20', value: 31, target: 50, unit: 'units' }, { day: 'Jun 21', value: 0, target: 50, unit: 'units' }, { day: 'Jun 22', value: 48, target: 50, unit: 'units' }, { day: 'Jun 23', value: 31, target: 50, unit: 'units' }, { day: 'Jun 24', value: 0, target: 50, unit: 'units' }, { day: 'Jun 25', value: 57, target: 50, unit: 'units' }, { day: 'Jun 26', value: 26, target: 50, unit: 'units' }, { day: 'Jun 29', value: 29, target: 50, unit: 'units' }, { day: 'Jun 30', value: 30, target: 50, unit: 'units' }, { day: 'Jul 1', value: 51, target: 50, unit: 'units' }, { day: 'Jul 7', value: 29, target: 50, unit: 'units' }, { day: 'Jul 8', value: 0, target: 50, unit: 'units' }, { day: 'Jul 9', value: 0, target: 50, unit: 'units' }, { day: 'Jul 10', value: 0, target: 50, unit: 'units' }, { day: 'Jul 13', value: 29, target: 50, unit: 'units' }, { day: 'Jul 14', value: 49, target: 50, unit: 'units' }, { day: 'Jul 15', value: 35, target: 50, unit: 'units' }, { day: 'Jul 16', value: 35, target: 50, unit: 'units' }, { day: 'Jul 17', value: 25, target: 50, unit: 'units' }, { day: 'Jul 18', value: 0, target: 50, unit: 'units' }, { day: 'Jul 20', value: 21, target: 50, unit: 'units' }, { day: 'Jul 21', value: 25, target: 51, unit: 'units' }, { day: 'Jul 22', value: 39, target: 51, unit: 'units' }, { day: 'Jul 23', value: 28, target: 51, unit: 'units' }, { day: 'Jul 24', value: 30, target: 52, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 24 field start', minimum: '3,908 modules/day (required for Sep 6)', above: 0, below: 18, latest: 'Jul 24: 3,134 (Workforce 1,730 + Brumont 1,404)', note: 'Four straight days near 3,000+; record 3,601 (Jul 20). Brumont re-man 14 -> 18 is the gap to 3,908.', daily: [{ day: 'Jul 3', value: 234, target: 3738, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 3738, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 3738, unit: 'modules' }, { day: 'Jul 8', value: 936, target: 3738, unit: 'modules' }, { day: 'Jul 9', value: 1308, target: 3738, unit: 'modules' }, { day: 'Jul 10', value: 1802, target: 3738, unit: 'modules' }, { day: 'Jul 11', value: 517, target: 3738, unit: 'modules' }, { day: 'Jul 13', value: 2922, target: 3738, unit: 'modules' }, { day: 'Jul 14', value: 2335, target: 3738, unit: 'modules' }, { day: 'Jul 15', value: 780, target: 3738, unit: 'modules' }, { day: 'Jul 16', value: 858, target: 3738, unit: 'modules' }, { day: 'Jul 17', value: 2226, target: 3738, unit: 'modules' }, { day: 'Jul 18', value: 0, target: 3738, unit: 'modules' }, { day: 'Jul 20', value: 3601, target: 3738, unit: 'modules' }, { day: 'Jul 21', value: 3082, target: 3754, unit: 'modules' }, { day: 'Jul 22', value: 2887, target: 3776, unit: 'modules' }, { day: 'Jul 23', value: 3456, target: 3776, unit: 'modules' }, { day: 'Jul 24', value: 3134, target: 3785, unit: 'modules' }] },
    ...
    schedule: [
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 84.7, baseline: 48.4, note: '4,793 piles remain (block-map 22,900 + 3,659 field): holding July 28 would need ~2,397/day vs ~560 capacity — finish projects ~Aug 7. Jul 25 (Sat): 236 (all Zone G; 3 rig breakdowns, 2 open into Monday); Jul 24: 364. Rig repairs and the missing Latnovva logs are the escalated levers.' },
