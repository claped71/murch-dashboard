...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 12, 2026',
      piles:    { installed: 21144, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 729, capacity: 560, name: 'Piles', unit: 'piles/day' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (21,144 executed, 67.4%), GameChange SAT tracker assembly incl. purlins (535 done, 21.5% — 235 QA-released, 300 pending Quality), and module placement (5,499 executed, 3.2%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      { area: '<u>Pile production acceleration — Zones B / F / D-G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: '10,208 piles remain to the Jul 28 gate (21,144 of 31,352 executed, 67.4%). Four straight days above the 560/day line: 646, 669, 680 and 680 — the Jul 11 Saturday 680 achieved with a partial fleet (United 6 rigs, 2 damaged; Latnovva 2 rigs at a best-yet 117/rig-day).', minimum: '>= 729 piles/day now required to hold Jul 28 (10,208 piles over 14 remaining working days, Mon-Sat) — above the 560/day stated capacity; at 560/day the gate lands ~Aug 4', gate: 'Area F hard soil, rig availability, and daily pile-stock re-feed. United reports 7 ramming machines; Latnovva had one damaged rig and one rig being assembled.', owners: 'LATNOVVA / United | Audelio Zuniga | Manuel Ramirez | Joshua Spalding' },
      ...
      { area: '<u>Module installation ramp — Area A</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: 'Module ramp is climbing: 1,308 Thu, record 1,802 Fri, 517 on the Brumont-only Saturday — 5,499 total executed. Modules must finish Sep 6 — one week after tracker completion.', minimum: 'Hold >= 2,000 modules/day with both crews and ramp toward the 5,531/day full-field acceleration rate (~3,458/day now required)', gate: 'QA-released complete tracker rows + measured module-spacing QC control (Golden Row slot-tolerance finding) + crew ramp on schedule.', owners: 'Workforce | Audelio Zuniga | Daniel Morilla (QA/QC) | Manuel Ramirez' },
    ...
    civilKpis: [
      ...
      { title: 'SET tracker', metric: '25 complete / 5 in progress', note: 'Jul 11 SET tracker: 25 complete, 5 in progress, 233 pending (~9.5% by activity count); steel-structures advance certified. Control building on site since Jul 7. Jul 12 (Sun): transformer-foundation containment berm complete at the substation — foundation ready ahead of the main power transformer delivery.' }
    ],
    civilActivities: [
    ...
    contractors: [
      { name: 'LATNOVVA / assigned areas', scope: 19260, installed: 13226, remaining: 6034, done: 68.7, zones: 'Zones A, B, C, D, G, EW + shared Area E control', status: 'Watch', note: "Area-based control allocation only; it is not a new manpower or subcontractor headcount report." },
      ...
      { name: 'United', scope: 7658, installed: 3852, remaining: 3806, done: 50.3, zones: 'Zone F', status: 'Active', note: 'Executed: 3,852 in Zone F (50.3%) — 3,406 Jul 11 workbook + 446 Sat field. Jul 11 (Sat): 446 piles with 6 rigs (2 damaged).' },
      { name: 'Project Total', scope: 31352, installed: 21144, remaining: 10208, done: 67.4, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 21,144 — Audelio's Jul 11 workbook (20,464, official basis) plus the 680 Saturday field-reported piles (United 446 F / Latnovva 234 B), pending workbook incorporation." }
    ],
    zones: [
      ...
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 1654, remaining: 1134, done: 59.3, status: 'Active', note: 'Executed: 1,654 (59.3%) — workbook 1,420 + 234 Sat field. Earlier Latnovva B field production (Jul 8-10) still pending allocation in the roll-up; verify with Audelio.' },
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 3852, remaining: 3806, done: 50.3, status: 'Active', note: 'Executed: 3,852 (50.3%) — 3,406 Jul 11 workbook + 446 Sat field. Zone F closing fast; hard-soil risk beaten by rate.' },
    ...
    production: [
      ...
      { name: 'Module installation', remaining: '165,971 modules', target: '5,531 modules/day acceleration target', latest: 'Jul 11 (Sat): 517 modules — Brumont-only Saturday crew; Workforce did not work Saturday', cumulative: '5,499 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'Record weekday ramp Thu/Fri (1,308 then 1,802) before the Saturday single-crew 517. Still below the ~3,458/day now required. Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. Module work requires fully released tracker rows.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 11 measured days', minimum: '560 piles/day', above: 4, below: 13, latest: 'Jul 11 (Sat): 680 piles — FOURTH straight day above 560 (United 446 / Latnovva 234)', note: 'Four consecutive days above the 560 line: 646, 669, 680, 680 — the Saturday 680 with a partial fleet (United 6 rigs, 2 damaged, 74/rig-day; Latnovva 2 rigs at 117/rig-day, best rate yet). ~729/day required for Jul 28; cumulative 20,464 official + 680 Sat pending workbook.', daily: [{ day: 'Jun 18', value: 20, target: 560, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 560, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 560, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 560, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 560, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 560, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 560, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 560, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 560, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 560, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 560, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 560, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 560, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 560, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 560, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 560, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 560, unit: 'piles' }] },
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', note: 'Single consolidated delivery line through the July 16 final tracker-material date. Site pile stock: 25,509 delivered vs 21,144 executed — 4,365-pile buffer (~7.8 days). Receiving cap 14 pile + 8 racking loads/day; loads count as scheduled until POD/site receipt. Purlin stock sufficient — delivery is not a production restriction.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', note: '10,208 piles remain after the Saturday shift (20,464 official + 680 Sat field): holding July 28 requires ~729 piles/day vs 560 stated capacity. FOUR straight days above the line (646, 669, 680, 680 — Saturday with a partial fleet). Rig repairs (United 2 down) and the 3rd Latnovva rig are the escalated levers.' },
      ...
      { activity: 'SET equipment required-on-site gate', contractor: 'SET team / Procurement / Suppliers', start: '2026-06-24', end: '2026-07-10', status: 'Critical', note: 'Jul 11 SET tracker: 25 complete, 5 in progress, 233 pending. Control building on site; Jul 12: transformer-foundation containment berm complete — foundation ready for the main power transformer, which is still in fabrication. Several electrical items remain committed after the Jul 10 gate — procurement acceleration still needed.' },
      ...
      { activity: 'Final module installation completion', contractor: 'Workforce', start: '2026-07-03', end: '2026-09-06', status: 'Critical', note: 'Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. 5,499 modules executed through Jul 11 (record 1,802 on Jul 10); ~3,458/day now required — full-field production depends on released tracker rows and the module crew ramp.' },
