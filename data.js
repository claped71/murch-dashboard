...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 10, 2026',
      piles:    { installed: 19943, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 713, capacity: 560, name: 'Piles', unit: 'piles/day' },
    ...
    contractorScore: [
      { date: 'Jul 9', contractor: 'United', trade: 'Piles', output: 519, resource: '23 people · 7 rigs — best United day (74/rig-day)', perUnit: 74, criterion: 80, critLabel: '80 piles/rig-day' },
    ...
    contractors: [
      { name: 'LATNOVVA / assigned areas', scope: 19260, installed: 13292, remaining: 5968, done: 69.0, zones: 'Zones A, B, C, D, G, EW + shared Area E control', status: 'Watch', note: "Area-based control allocation only; it is not a new manpower or subcontractor headcount report." },
      ...
      { name: 'United', scope: 7658, installed: 2585, remaining: 5073, done: 33.8, zones: 'Zone F', status: 'Active', note: 'Jul 9: 519 piles with 7 rigs (74/rig-day) — best United day yet; 2,585 installed in Zone F.' },
      { name: 'Project Total', scope: 31352, installed: 19943, remaining: 11409, done: 63.6, zones: "All zones | Construction Manager report", status: 'Critical', note: "Audelio / Construction Manager July 6 Delivery/Mechanical workbook is the official installed-production basis." }
    ],
    zones: [
      ...
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 1720, remaining: 1068, done: 61.7, status: 'Active', note: 'Jul 9: another 150 piles with 2 rigs; 1,720 installed (61.7%). One inverter station in progress in B.' },
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 2585, remaining: 5073, done: 33.8, status: 'Active', note: 'Jul 9: 519 piles with 7 rigs — best day. 2,585 installed (33.8%); hard-soil risk being beaten by rate.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '11,409 piles', target: '~713 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 9 complete: 669 piles — second straight day above 560 (United 519 at 74/rig-day, best day; Latnovva 150 with 2 rigs)', cumulative: '19,943 / 31,352 installed (63.6%) — Jul 8 official basis + Jul 9 field-complete day', status: 'Critical', note: 'July 7 official output was 399 piles. United held 54 piles/rig-day; Latnovva produced 16 piles with a single machine — an unacceptable rate that must be escalated. Holding Jul 28 requires ~713/day over the 16 remaining working days. Two straight days above 560 (640, 669), but the 3rd Latnovva rig has still NOT worked — escalation stands; the 9-rig fleet at ~74/rig-day gives ~665/day vs ~713 required. Areas A, C and EW COMPLETE; B 1,720 (61.7%); E 8,012 (94.7%); F 2,585 (33.8%).' },
      { name: 'Pile delivery / site stock', remaining: '5,843 piles undelivered', target: 'Receipts must exceed 560 piles/day burn', latest: 'Jul 6 workbook: delivered piles increased to 25,509', cumulative: '25,509 delivered; 5,566 available above installed', status: 'Watch', note: 'Available stock equals delivered piles less officially installed piles (19,943 through Jul 9). The buffer covers about 9.9 production days at the acceleration-capacity assumption.' },
      ...
      { name: 'ITS HDD boring', remaining: '10 of 20 bores', target: 'Minimum 1 completed bore/day', latest: 'Week Jul 3-9: 315 ft (78.8 ft/day avg)', cumulative: '12 / 20 bores complete (60%); 4,184.2 ft installed', status: 'Watch', note: 'Jul 10 ITS workbook: +1 bore and +315 ft. Eight bores left; boring remains the slower ITS front.' },
      { name: 'ITS MV plowing', remaining: '30 of 46 segments', target: 'Minimum 1 completed segment/day', latest: 'Week Jul 3-9: 18,018 ft plowed (4,505 ft/day avg) — best week yet', cumulative: '23 / 46 segments complete (50%); 74,838 ft installed', status: 'On Track', note: 'Jul 10 ITS workbook: +2 segments and +13,692 ft since Jul 9 — plowing crossed the halfway mark and fully supports the electrical sequence.' },
    ...
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 9 measured days', minimum: '560 piles/day', above: 2, below: 13, latest: 'Jul 9: 669 piles (United 519 / Latnovva 150)', note: 'Two consecutive days above the 560 capacity line (640, 669). United hit 74/rig-day — near criterion. ~713/day still required for Jul 28; cumulative 19,943 (63.6%).', daily: [{ day: 'Jun 18', value: 20, target: 560, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 560, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 560, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 560, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 560, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 560, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 560, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 560, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 560, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 560, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 560, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 560, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 560, unit: 'piles' }, { day: 'Jul 8', value: 640, target: 560, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 560, unit: 'piles' }] },
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', note: 'Single consolidated delivery line: rolling pile, racking and purlin loads run through the July 16 final planned tracker-material date. Latest: 8 timed loads confirmed for Jul 10 (Shreeya, 07:00-13:45; 5 Landstar HT + 3 NTG). Receiving cap 14 pile + 8 racking loads/day with appointment discipline; loads count as scheduled until POD/site receipt. Site pile stock: 25,509 delivered vs 19,943 installed — 5,566-pile buffer (~9.9 days); purlin stock already sufficient, so delivery is no longer a production restriction.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', note: '11,409 piles remain (19,943 installed, 63.6%, through Jul 9): holding July 28 requires ~713 piles/day vs the stated 560/day capacity. Two straight days above the line (640, 669); United at 74/rig-day near criterion. Latnovva 3rd rig escalated — with it running, the 10-rig fleet reaches the required rate.' },
      ...
      { activity: 'SET equipment required-on-site gate', contractor: 'SET team / Procurement / Suppliers', start: '2026-06-24', end: '2026-07-10', status: 'Critical', note: 'Jul 8 SET tracker: 23 complete, 3 in progress, 237 pending. Control building on site (installed Jul 7, gate met); transformer still in fabrication and several electrical items remain committed after the Jul 10 required-on-site gate — procurement acceleration still needed.' },
