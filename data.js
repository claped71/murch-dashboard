...
// CACHE BUSTER: Jul 24, 2026 (Fri) — Jul 23: piles +284 (United 30 motor F + 192 G + ECCS 62 E; +15 CB/TP electrical outside scope), trackers +28, modules +3,456 (Brumont 2,000 + Workforce 1,456). Jul 24: trackers +30 (ECCS E), modules +3,134 (Workforce 1,730 + Brumont 1,404), no pile production reported. Basis: piles 25,959 (82.8%, req 1,798/day to Jul 28 — finish projects ~Aug 7); trackers 851 (34.2%, req 53/day); modules 30,780 (18.0%, req 3,803/day). SET 20.0%, piers 6/17. All 9 GameChange tube trucks landed Fri Jul 24; 16 purple tubes remain (Wed Jul 29).
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 24, 2026',
      piles:    { installed: 25959, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 1798, capacity: null, name: 'Piles', unit: 'piles/day' },
      trackers: { installed: 851, released: 235, total: 2486, gate: '2026-08-30', gateLabel: 'Aug 30', required: 53, capacity: 48, name: 'Trackers incl. purlins', unit: 'rows/day' },
      modules:  { installed: 30780, total: 171470, gate: '2026-09-06', gateLabel: 'Sep 6', required: 3803, capacity: null, name: 'Modules', unit: 'mod/day' },
      electrical: { installed: 0, total: 274720, gate: '2026-09-18', gateLabel: 'Sep 18', required: 5723, capacity: null, name: 'LV Electrical', unit: 'lf/day' },
    ...
    contractorScore: [
      { date: 'Jul 24 Fri', contractor: 'Workforce', trade: 'Trackers', output: 0, resource: '15-person racking crew — dampers & actuators installed on mounted trackers (final completion components)', perUnit: 0, criterion: 53, critLabel: 'Finishing work: dampers/actuators are the last components before a row can close incl. purlins — no full rows closed Jul 24; the Jul 23 EW rows advance toward completion' },
      { date: 'Jul 24 Fri', contractor: 'ECCS', trade: 'Trackers', output: 30, resource: '53 people · zone E', perUnit: 30, criterion: 53, critLabel: '53 rows/day now required — 30 in Zone E; best back-to-back tracker days since Jul 14 (28 + 30)' },
      { date: 'Jul 24 Fri', contractor: 'Workforce', trade: 'Modules', output: 1730, resource: '16 people modules (zone C) + 15 people racking (dampers & actuators on erected trackers)', perUnit: 1730, criterion: 2000, critLabel: '2,000 mod/day target — 1,730; racking crew on dampers/actuators, no new rows' },
      { date: 'Jul 24 Fri', contractor: 'Brumont', trade: 'Modules', output: 1404, resource: '14 people · zone C — lost 4 people vs Jul 23', perUnit: 1404, criterion: 2000, critLabel: '2,000 mod/day target — 1,404; crew shrank from 18 to 14, output followed' },
      { date: 'Jul 24 Fri', contractor: 'United', trade: 'Piles', output: 0, resource: 'No daily production log posted for Jul 24', perUnit: 0, criterion: 80, critLabel: 'NO PILE REPORT Jul 24 — zero piles logged project-wide; chase the United/Latnovva daily logs' },
      { date: 'Jul 23 Thu', contractor: 'United', trade: 'Piles', output: 222, resource: '27 people · 6 rigs (2 damaged) — 192 Zone G + 30 motor F; plus 5 CB + 10 TP electrical; refusal-pile reinstall + tap-downs', perUnit: 56, criterion: 80, critLabel: '80 piles/rig-day — 56/rig on 4 running rigs; Zone G ramp is real (192)' },
      { date: 'Jul 23 Thu', contractor: 'Workforce', trade: 'Trackers', output: 9, resource: '14-person racking crew — 17 tracker rows advanced to 50% in Zone EW (~8.5 row-equivalents)', perUnit: 9, criterion: 51, critLabel: '17 rows at 50% (EW) ≈ 9 row-equivalents produced — counted into the completed cumulative only when the rows close incl. purlins' },
      { date: 'Jul 23 Thu', contractor: 'ECCS', trade: 'Trackers', output: 28, resource: '54 people · 28 trackers + 62 tracker piles zone E', perUnit: 28, criterion: 51, critLabel: '51 rows/day — 28 in Zone E plus 62 piles; dual-front day' },
      { date: 'Jul 23 Thu', contractor: 'Brumont', trade: 'Modules', output: 2000, resource: '18 people · zone C', perUnit: 2000, criterion: 2000, critLabel: '2,000 mod/day target — ON target for the 2nd straight day' },
      { date: 'Jul 23 Thu', contractor: 'Workforce', trade: 'Modules', output: 1456, resource: '15 people modules (zone C) + 14 people racking (17 rows at 50%, zone EW)', perUnit: 1456, criterion: 2000, critLabel: '2,000 mod/day target — 1,456; combined day 3,456 modules, best since Jul 20' },
      { date: 'Jul 22 Wed', contractor: 'Brumont', trade: 'Modules', output: 2055, resource: '18 people · zone C', perUnit: 2055, criterion: 2000, critLabel: '2,000 mod/day target — 2,055, ABOVE target; first sub to clear it' },
      { date: 'Jul 22 Wed', contractor: 'ECCS', trade: 'Trackers', output: 39, resource: '54 people · 39 trackers zone C + 35 tracker piles E + 20 CB piles + 1 inverter foundation zone G', perUnit: 39, criterion: 51, critLabel: '51 rows/day — 39 in the released Zone C front; best tracker day since Jul 14' },
      { date: 'Jul 22 Wed', contractor: 'United', trade: 'Piles', output: 167, resource: '27 people · 7 rigs (1 damaged) — 104 motor piles F + 63 G; plus 5 CB + 60 TP electrical', perUnit: 28, criterion: 80, critLabel: '80 piles/rig-day — 28/rig; heavy electrical-pile share (65) and dispersed F remainder' },
      { date: 'Jul 22 Wed', contractor: 'Workforce', trade: 'Modules', output: 832, resource: '15 people modules (zone A) + 15 people racking (11 rows pre-assembled zone EW)', perUnit: 832, criterion: 2000, critLabel: '2,000 mod/day target — crew split with the EW racking front; combined day 2,887 modules' },
      { date: 'Jul 22 Wed', contractor: 'LATNOVVA', trade: 'Piles', output: 0, resource: '12 people · 1 rig — tension-pile CORRECTION work zone A (rework, no new production)', perUnit: 0, criterion: 80, critLabel: '80 piles/rig-day — day spent on electrical tension-pile corrections in zone A' }
    ],
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (25,959 executed, 82.8%), GameChange SAT tracker assembly incl. purlins (851 done, 34.2% — 235 QA-released, 616 pending Quality; released count stale since Jul 20), and module placement (30,780 executed, 18.0%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    photos: [
      { src: 'https://claped71.github.io/murch-dashboard/assets/recent/thumb-recent-40.jpg?v=20260722-pierE5', fallbackSrc: 'https://claped71.github.io/murch-dashboard/assets/recent/recent-40.jpg', date: 'July 21, 2026', title: 'MILESTONE — first substation pier under construction: Pier E5 (2 of 17)', note: 'Geotagged Jul 21, 19:06 (N 42° 12\' 36", W 86° 0\' 57", Lawrence MI): the delayed substation pier construction is finally RUNNING. Pier E5 formed with the anchor-bolt cage set — 2 of 17 piers, built by DIG IT (AB Power subcontractor) under Axel Cano (SET Site Manager). Plan: 3-4 more piers formed Jul 22 ; by Jul 23 the first 2 of 17 piers are complete including concrete, at a steady 3-4 piers/day. The SET tracker is at 16.7% overall (civil 52.7%, structural 5.7%, electrical 5.2%).' },
    ...
    weeklyPlan: [
      { area: '<u>Tracker assembly and QA release — Zones C1/C2 / A / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: 'THE controlling front for the week — it sets the ceiling on the module crews. 851 rows done (235 QA-released, 616 pending Quality — released count stale since Jul 20) of 2,486 (34.2%). BREAKTHROUGH: Daniel Morilla confirmed Monday Jul 20 that Zones C1 and C2 release for trackers today with the Client — the first QA releases since Jul 10. Convert the 616-row pending backlog into released workfront this week and keep assembling; releases, not assembly, still govern the module ramp — the module crews are already installing ahead of the formally released count.',
        minimum: '>= 53 completed rows/day to hold Aug 30 (1,635 rows over 31 working days, Mon-Sat). Three assembly fronts now: ECCS ran 28 + 30 completed rows Jul 23-24 (barely half the floor), Workforce racking advanced 17 EW rows to 50% and is closing them with dampers/actuators, and the United racking crew is staffing up (~1.5 wks to full rate). Completed-row credit lands when rows close incl. purlins. QA is the real floor: clear the 616-row pending backlog now that C1/C2 are unlocked.',
        gate: 'QA turnover of finished rows (now unblocking with C1/C2), not the assembly rate. Carry-over: recover the Area F quality documents for zones released internally without the subcontractor paperwork. Field cumulative (851) still reconciling vs the workbook (715 pre-assembled / 311 complete).',
      ...
      { area: '<u>Pile production — rig availability, Zones B / F, open D / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '5,393 piles remain to the Jul 28 gate (25,959 of 31,352 executed, 82.8%). Saturday Jul 18 ran 608 — United 415 (Zone F) + Latnovva 193 (Zone B) — the best per-rig day in a week (104 and 97 per rig), but the Jul 28 gate is unrecoverable at ~560/day fleet capacity and slips to ~early August (~Aug 4-5). Jul 23 ran 284 (United 192 G + 30 F + ECCS 62 E) and Jul 24 logged NO pile production — the finish now projects ~Aug 7 (Jose, Jul 22). Close Zone B (165 left), finish Zone F (429 left) and feed the Zone G ramp (277 done of 3,356).',
        minimum: 'Holding Jul 28 would need ~1,798 piles/day (5,393 over 3 working days) — 3x capacity, unrecoverable. Realistic floor: get every rig running and sustain the fleet maximum daily (~600-700), targeting ~4,000+ piles this week, then re-baseline the pile finish to early August. Saturdays must be worked — Jul 18 trackers and modules were idle.',
        gate: 'Rig repairs are the binding constraint — United on 4 of 6 (2 damaged), Latnovva on 2. Material is not a restriction: 28,343 piles delivered, a 2,384-unit buffer.',
      ...
      { area: '<u>Module installation ramp — Zones A / C</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '30,780 of 171,470 executed (18.0%). Jul 23: 3,456 (Brumont 2,000 + Workforce 1,456); Jul 24: 3,134 (Workforce 1,730 + Brumont 1,404 — Brumont lost 4 people). Record 3,601 on Jul 20. Workforce finishes its first 10 MW and takes the next 10 (Luis, Jul 23).',
        minimum: '>= 3,803 modules/day required to hold the Sep 6 finish (140,690 over 37 working days), ramping toward the ~5,500/day full-field rate — the crews have run 2,887-3,456 for four straight days; the last ~700/day comes from Brumont re-manning and Saturdays worked.',
      ...
      { area: '<u>LV electrical installation — Chemik air-freight gated</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        ...
        minimum: 'Start Chemik trunk (>= 775 lf/day) on air shipments PL_260601/260709 (ETA Jul 23); ramp homerun (>= ~4,400 lf/day) as cable lands and module blocks release. Finishing the full pull by the Sep 18 DC/LV close now needs ~5,723 lf/day — 21 points of schedule already gone (Jose, Jul 22): START.',
      ...
      { area: '<u>GameChange tracker-material deliveries</u>',
        target: 'POSTS COMPLETE (5 loads Mon Jul 20 + 5 Tue Jul 21). NEW CONSTRAINT — RED TORQUE TUBES OUT since Jul 21 (Manuel to GameChange, Jul 22): racking crews skip the rows needing red tubes and return later, slowing assembly. GameChange commits 239 red tubes Fri Jul 24 and a final 97 Sat/Mon (Jul 25/27). Close the open POD (PL-3295-084-HT) and hold GameChange to the no-staging-on-public-roads rule (Road Commission watching).',
        minimum: 'DONE — GameChange moved ALL 9 torque-tube trucks to Fri Jul 24 (avoiding Saturday offload costs); after Friday only 16 purple tubes remain, committed Wed Jul 29. OPEN CLAIM: one purple torque-tube bundle missing from load PL-3295-094-HT (Manuel, Jul 24) — chase the replacement date.',
        gate: 'Red-tube resupply LANDED Fri Jul 24 — tube availability no longer caps assembly; crew ramp does (United racking crew building up, ~1.5 wks to full rate per Manuel). Loads count as scheduled until POD/site receipt.',
        owners: 'GameChange (Shreeya Devkota) | Manuel Ramirez | Karina Mucino' },
      { area: '<u>SET, inverter foundations and inverter arrival</u>',
        target: 'SET at 20.0% overall (civil 59.3%, structural 11.3%, electrical 5.2%); piers 6 of 17 complete (Jul 24). Close the last 4 inverter pile foundations — D10, E12, F16, G20 (190 of 230 piles, 82.6%) — before the end-July arrival of the 23 inverter units. AB Power has presented no work or material-delivery plan; Greensol is pulling partial scope to Michael Power and self-procuring material.',
        minimum: 'All 23 inverter foundations released before first delivery; hold the 3-4 piers/day pace that took SET from 16.7% to 20.0% in three days (piers 2/17 -> 6/17).',
      ...
      { area: '<u>Electrical MV plowing and HDD closeout</u>',
        target: 'ITS is ahead of the electrical sequence: 36 of 46 plow segments complete (120,738 ft) and 17 of 20 MV bores closed (5,162 ft). DC cable-duct bores underway: 2 of 14 COMPLETE (391 LF — DC15HB-04 + DC12HB-08) with DC03HB-02 in progress. A second, larger drill arrived — from Jul 24 two rigs run in parallel: one on DC ducts, one on the MV wetland bores. Close the last 3 MV bores and the remaining 10 plow segments.',
      ...
      { area: '<u>Civil Area G release and internal roads</u>',
        target: 'Finish Area G basins, then start Area G cut/fill — Area G is released for pile driving and material distribution and is the next pile workfront (3,356 piles, 0 installed). Perimeter fence at 95% (only Zone G and gates remain); internal roads at 72%. Rosario Jul 23: cut/fill 100% complete, sediment basins 83%, PS foundations 86%.',
    ...
    contractors: [
      ...
      { name: 'United', scope: 11014, installed: 7506, remaining: 3508, done: 68.1, zones: 'Zones F + G', status: 'Active', note: 'Executed: 7,506 piles — Zone F 7,229 (94.4%) + Zone G 277 (ramping hard: 192 on Jul 23). Jul 23: 222 tracker piles on 6 rigs (2 damaged) plus 5 CB + 10 TP electrical piles; refusal-pile reinstalls and tap-downs continue. NO daily log posted Jul 24. Combined F+G 68.1%. United holds full mechanical (piles + trackers + modules) in F & G; racking crew building up (~1.5 wks to full rate).' },
      { name: 'Project Total', scope: 31352, installed: 25959, remaining: 5393, done: 82.8, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 25,959 — official block-map 22,900 plus 3,059 field logs not yet mapped. Jul 23 (Thu): 284 tracker piles (United 192 G + 30 motor F + ECCS 62 E) + 15 electrical CB/TP piles outside the 31,352. Jul 24 (Fri): NO pile production reported — no United/Latnovva log posted. Latnovva has not reported since Jul 22 (tension-pile corrections)." }
    ],
    zones: [
      ...
      { zone: 'Zone E', contractor: 'ECCS / Latnovva', scope: 8456, installed: 8204, remaining: 252, done: 97.0, status: 'Active', note: 'Jul 23: 8,204 installed (+62 ECCS tracker piles); no Zone E pile report Jul 24.' },
      ...
      { zone: 'Zone G', contractor: 'United', scope: 3356, installed: 277, remaining: 3079, done: 8.3, status: 'Active', note: 'STARTED Jul 21 (22); Jul 22: +63; Jul 23: +192 — 277 total, the ramp Manuel predicted is real. FULL Zone G start needs only the SIGNED CHANGE ORDER (ChO) — chase signature. ECCS also completed 1 inverter foundation in Zone G Jul 21. United holds full mechanical in F & G. Area G released for pile driving; cut/fill after basin completion.' }
    ],
    production: [
      { name: 'Project pile installation', remaining: '5,393 piles', target: '~1,798 piles/day required for Jul 28 (560/day stated capacity) — finish projects ~Aug 7', latest: 'Jul 23 (Thu): 284 tracker piles — United 192 (G) + 30 motor (F) + ECCS 62 (E); +15 electrical CB/TP piles outside the 31,352. Jul 24 (Fri): NO pile production reported', cumulative: '25,959 / 31,352 executed (82.8%) — 22,900 official block-map + 3,059 field logs not yet mapped', status: 'Critical', note: 'Executed 25,959 of 31,352 (82.8%). The official block-map roll-up is 22,900; field daily logs add 3,059 piles not yet mapped (mostly Zone B, where Latnovva self-reports lead the block map). Jul 23 (Thu) logged 284 counted tracker piles (United 192 Zone G + 30 motor Zone F on 6 rigs, 2 damaged; ECCS 62 Zone E) against the 1,798/day now required over 3 working days to Jul 28 — the gate projects to ~Aug 7 (Jose, Jul 22). Jul 24 (Fri): NO pile log posted (United/Latnovva) — zero piles recorded; chase the daily logs. Another 15 electrical piles (5 CB, 10 TP) stay outside the 31,352. RECONCILIATION FLAG (Jul 20): Audelio DELIVERY workbook is internally inconsistent on piles — the PROGRESS summary shows 22,900 installed, but his detail tabs (Production Q PILE DRIVING + COMPLETED-by-zone block logs) sum to only 17,678, lagging badly in the active zones (Zone F detail 1,743 vs 5,805 summary; Zone B 500 vs 1,457), and a planning tab shows ~15,550. The field WhatsApp daily logs (25,959) are the controlling production basis; Audelio has been asked to reconcile the summary-vs-detail gap in his file.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the 834 piles/day install burn', latest: 'Jul 24 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; 2,384 available above the 25,959 executed', status: 'On Track', note: 'Available stock equals delivered piles less executed piles — 2,384 units.  Delivery is no longer the pile-programme constraint.' },
      ...
      { name: 'Civil grading / cut-fill', remaining: 'Complete', target: '— No approved daily target in source', latest: 'Rosario Jul 23: cut/fill 100% complete (finished Jul 17)', cumulative: '100% complete — Rosario Jul 23 (Lounsbury)', status: 'Complete', note: 'Current percentage follows Rosario Ruiz civil baseline; Week 26 adds Area G release for pile driving and material distribution.' },
      { name: 'Internal roads', remaining: '28% of scope', target: '— No approved daily target in source', latest: 'Rosario Jul 23 civil progress (Topland)', cumulative: '72% complete — target end Jul 31', status: 'Active', note: 'Current percentage follows Rosario Ruiz civil baseline for Areas A-B-C-E; roads continue to control logistics access.' },
      { name: 'Tracker completion incl. purlins', remaining: '1,635 to build · 2,251 to QA-release', target: '53 completed rows/day now required for Aug 30', latest: 'Jul 24 (Fri): 30 completed rows (ECCS, E); Workforce racking on dampers/actuators (final components) · Jul 23 (Thu): 28 completed (ECCS, E) + Workforce 17 rows to 50% in EW (~9 row-equiv, close pending)', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 851 rows — 235 released by Quality and 616 pending QA approval; the released count is STALE since Jul 20 (C1/C2 released with Client that day — updated split owed by Daniel/Jose). NOTE: cumulative under reconciliation — the workbook shows 715 pre-assembled / 311 complete; Maurin walked all rows Jul 14 and Daniel is recounting manually.', cumulative: '851 done (34.2%): 235 QA-released + 616 pending Quality / 2,486 total', status: 'Critical' },
      { name: 'ITS HDD boring', remaining: '3 of 20 MV bores · 12 of 14 DC bores', target: 'Minimum 1 completed bore/day', latest: 'Jul 24: MV boring holds 17 / 20 (85%, 5,162 ft); DC cable-duct bores 2 / 14 COMPLETE (391 LF — DC15HB-04 + DC12HB-08, both Jul 22) with DC03HB-02 in progress; 2nd (larger) drill on site — two rigs from Jul 24: one DC, one MV wetlands', cumulative: '17 / 20 MV bores (85%, 5,162 ft) + 2 / 14 DC bores (391 LF)', status: 'Watch', note: 'Jul 24 ITS control: MV 17 done / 1 in progress / 2 pending; DC 2 done / 1 in progress / 11 pending. Crew 11-12 on Jul 23-24. Jul 17 review: EGLE will not accept swapping the remaining bores for plowing; the last 4 continue, extended ~100 ft each (2x100 ft) to clear the wetland.' },
      { name: 'ITS MV plowing', remaining: '10 of 46 segments', target: 'Minimum 1 completed segment/day', latest: 'Jul 24: plowing holds 36 / 46 (76.6%) — crew concentrated on the DC + wetland bores (two drills running)', cumulative: '36 / 46 segments complete (76.6%); 120,738 ft installed', status: 'On Track', note: 'Jul 20 ITS control: 36 done / 0 in progress / 10 pending. Line status: MV11A 7/10, MV11B 10/12, MV12A 10/13, MV12B 9/11. Plowing comfortably leads the electrical sequence.' },
      { name: 'SET construction', remaining: '80.0% of overall scope', target: '— No approved daily progress target in source', latest: 'Jul 24 SET tracker: overall 20.0% (civil 59.3%, structural 11.3%, electrical 5.2%) — piers 6 of 17 complete incl. concrete', cumulative: '20.0% overall (civil 59.3%, structural 11.3%, electrical 5.2%) per the Jul 24 SET tracker', status: 'Critical', note: 'Overall SET progress from 16.7% (Jul 21) to 20.0% (Jul 24) — pier production holding 3-4/day formed (2/17 Jul 22 -> 5/17 Jul 23 -> 6/17 Jul 24). Transformer and structural steel remain in fabrication — the controlling items for energization. Jul 17 procurement review: AB Power has presented no SET work plan and no material-delivery plan; Greensol is pulling partial scope to a third party (Michael Power) and self-buying missing materials (BUS-connectors urgent). Portico steel structure arriving Jul 16-17; oil-pit grating (tramex) procured separately to close the SET payment milestone and avoid Heelstone objections.' },
      { name: 'Panel delivery', remaining: '14,230 modules to deliver', target: '— No approved daily delivery target in source', latest: '— Latest daily receipt not reported', cumulative: '157,240 / 171,470 delivered (91.7%)', status: 'On Track', note: 'Jul 24 Construction Manager workbook cumulative delivery quantity; 126,460 modules on site above the 30,780 executed.' },
      { name: 'Module installation', remaining: '140,690 modules', target: '3,803 modules/day required for Sep 6 (5,531/day full-field capacity)', latest: 'Jul 24 (Fri): 3,134 modules — Workforce 1,730 + Brumont 1,404 (both zone C; Brumont lost 4 people). Jul 23: 3,456 (Brumont 2,000 + Workforce 1,456)', cumulative: '30,780 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'Four straight days at 2,887-3,456; Jul 20 remains the record at 3,601. ~3,803/day now required — the ramp is close but not there. Workforce finishes its first 10 MW block and takes the next 10 (Luis, Jul 23). The QA-released tracker split is stale since Jul 20 — updated release count owed. Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 24 measured days', minimum: '1,798 piles/day (required for Jul 28)', above: 0, below: 28, latest: 'Jul 23 (Thu): 284 — United 192 (G) + 30 motor (F) + ECCS 62 (E). Jul 24 (Fri): NO pile production reported', note: 'Jul 23 logged 284 counted piles; Jul 24 had NO pile log (United/Latnovva) — zero recorded. Far short of the 1,798/day single goal; the finish projects ~Aug 7 (Jose, Jul 22). (560/day is nominal crew capacity, not a target.) Executed 25,959 = official block-map 22,900 + 3,059 field logs not yet mapped.', daily: [{ day: 'Jun 18', value: 20, target: 1022, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 1022, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 1022, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 1022, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 1022, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 1022, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 1022, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 1022, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 1022, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 1022, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 1022, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 1022, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 1022, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 1022, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 1022, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 1022, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 1022, unit: 'piles' }, { day: 'Jul 16', value: 504, target: 1022, unit: 'piles' }, { day: 'Jul 17', value: 472, target: 1022, unit: 'piles' }, { day: 'Jul 18', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 20', value: 622, target: 1022, unit: 'piles' }, { day: 'Jul 21', value: 253, target: 1176, unit: 'piles' }, { day: 'Jul 22', value: 202, target: 1419, unit: 'piles' }, { day: 'Jul 23', value: 284, target: 1419, unit: 'piles' }, { day: 'Jul 24', value: 0, target: 1349, unit: 'piles' }] },
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 24', minimum: '53 rows/day (required for Aug 30)', above: 4, below: 24, latest: 'Jul 24 (Fri): 30 completed rows (ECCS, E) + Workforce racking installing dampers/actuators on mounted rows. Jul 23: 28 completed (ECCS) + Workforce 17 rows to 50% in EW (~9 row-equiv). 851 done (235 released / 616 pending)', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 851 rows — 235 released by Quality and 616 pending QA approval; the released split is STALE since the Jul 20 C1/C2 release — updated count owed by QA. TWO racking fronts besides ECCS: Workforce racking (2nd crew of the same sub that installs modules) advanced 17 rows to 50% in EW on Jul 23 (~9 row-equivalents) and installed dampers/actuators — the final completion components — on mounted rows Jul 24; those EW rows enter the completed count when they close incl. purlins. United racking crew ramping (~1.5 wks to full rate, Manuel Jul 23). Cumulative under reconciliation — workbook shows 715 pre-assembled / 311 complete.', daily: [{ day: 'Jun 17', value: 15, target: 50, unit: 'units' }, { day: 'Jun 18', value: 35, target: 50, unit: 'units' }, { day: 'Jun 19', value: 26, target: 50, unit: 'units' }, { day: 'Jun 20', value: 31, target: 50, unit: 'units' }, { day: 'Jun 21', value: 0, target: 50, unit: 'units' }, { day: 'Jun 22', value: 48, target: 50, unit: 'units' }, { day: 'Jun 23', value: 31, target: 50, unit: 'units' }, { day: 'Jun 24', value: 0, target: 50, unit: 'units' }, { day: 'Jun 25', value: 57, target: 50, unit: 'units' }, { day: 'Jun 26', value: 26, target: 50, unit: 'units' }, { day: 'Jun 29', value: 29, target: 50, unit: 'units' }, { day: 'Jun 30', value: 30, target: 50, unit: 'units' }, { day: 'Jul 1', value: 51, target: 50, unit: 'units' }, { day: 'Jul 7', value: 29, target: 50, unit: 'units' }, { day: 'Jul 8', value: 0, target: 50, unit: 'units' }, { day: 'Jul 9', value: 0, target: 50, unit: 'units' }, { day: 'Jul 10', value: 0, target: 50, unit: 'units' }, { day: 'Jul 13', value: 29, target: 50, unit: 'units' }, { day: 'Jul 14', value: 49, target: 50, unit: 'units' }, { day: 'Jul 15', value: 35, target: 50, unit: 'units' }, { day: 'Jul 16', value: 35, target: 50, unit: 'units' }, { day: 'Jul 17', value: 25, target: 50, unit: 'units' }, { day: 'Jul 18', value: 0, target: 50, unit: 'units' }, { day: 'Jul 20', value: 21, target: 50, unit: 'units' }, { day: 'Jul 21', value: 25, target: 51, unit: 'units' }, { day: 'Jul 22', value: 39, target: 51, unit: 'units' }, { day: 'Jul 23', value: 28, target: 51, unit: 'units' }, { day: 'Jul 24', value: 30, target: 52, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 24 field start', minimum: '3,803 modules/day (required for Sep 6)', above: 0, below: 18, latest: 'Jul 24 (Fri): 3,134 modules — Workforce 1,730 + Brumont 1,404 (Zone C)', note: 'Jul 23: 3,456 (Brumont 2,000 + Workforce 1,456); Jul 24: 3,134 (Brumont down 4 people). Record 3,601 on Jul 20; four straight days at 2,887-3,456 but still short of the 3,803/day single goal. (5,531/day is the full-field capacity, not a target.) Released tracker rows remain the watch item — the QA split is stale since Jul 20.', daily: [{ day: 'Jul 3', value: 234, target: 3738, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 3738, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 3738, unit: 'modules' }, { day: 'Jul 8', value: 936, target: 3738, unit: 'modules' }, { day: 'Jul 9', value: 1308, target: 3738, unit: 'modules' }, { day: 'Jul 10', value: 1802, target: 3738, unit: 'modules' }, { day: 'Jul 11', value: 517, target: 3738, unit: 'modules' }, { day: 'Jul 13', value: 2922, target: 3738, unit: 'modules' }, { day: 'Jul 14', value: 2335, target: 3738, unit: 'modules' }, { day: 'Jul 15', value: 780, target: 3738, unit: 'modules' }, { day: 'Jul 16', value: 858, target: 3738, unit: 'modules' }, { day: 'Jul 17', value: 2226, target: 3738, unit: 'modules' }, { day: 'Jul 18', value: 0, target: 3738, unit: 'modules' }, { day: 'Jul 20', value: 3601, target: 3738, unit: 'modules' }, { day: 'Jul 21', value: 3082, target: 3754, unit: 'modules' }, { day: 'Jul 22', value: 2887, target: 3776, unit: 'modules' }, { day: 'Jul 23', value: 3456, target: 3776, unit: 'modules' }, { day: 'Jul 24', value: 3134, target: 3785, unit: 'modules' }] },
      { task: 'ITS MV plowing', period: 'Jun 17-Jul 17', minimum: '1 completed segment/day', above: 11, below: 14, latest: 'Jul 24 export: 0 new segments — 36 of 46 holds; both drills on the DC + MV wetland bores', note: 'Jul 15 ITS tracker: 36 of 46 segments complete (76.6%), 0 in progress. 120,738 ft installed. MV11A 7/10, MV11B 10/12, MV12A 10/13, MV12B 9/11.', daily: [{ day: 'Jun 17', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 18', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 19', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 20', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 21', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 22', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 23', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 24', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 25', value: 3, target: 1, unit: 'seg' }, { day: 'Jun 26', value: 4, target: 1, unit: 'seg' }, { day: 'Jun 27', value: 1, target: 1, unit: 'seg' }, { day: 'Jun 28', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 29', value: 2, target: 1, unit: 'seg' }, { day: 'Jun 30', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 1', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 2', value: 1, target: 1, unit: 'seg' }, { day: 'Jul 6', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 7', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 8', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 9', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 10', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 11', value: 1, target: 1, unit: 'seg' }, { day: 'Jul 13', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 14', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 15', value: 3, target: 1, unit: 'seg' }, { day: 'Jul 16', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 17', value: 0, target: 1, unit: 'seg' }] },
      { task: 'ITS HDD boring', period: 'Jul 2-Jul 20 measured days', minimum: '1 completed bore/day', above: 4, below: 8, latest: 'Jul 24: MV boring 17 of 20 (85%, 5,162 ft); DC bores 2 of 14 complete (391 LF), 1 in progress — two drills running from Jul 24', note: 'Jul 24 ITS control: MV 17 done / 1 in progress / 2 pending (5,162 ft); DC 2 complete Jul 22 (DC15HB-04 210.6 LF + DC12HB-08 180.6 LF). Second, larger drill on site — one rig on DC ducts, one on MV wetland bores.', daily: [{ day: 'Jul 2', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 6', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 7', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 8', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 9', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 10', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 11', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 13', value: 2, target: 1, unit: 'bores' }, { day: 'Jul 14', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 15', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 16', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 17', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 20', value: 1, target: 1, unit: 'bores' }] }
    ],
    successors: [
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', progress: 90, baseline: 55, note: 'TUBES RESOLVED: GameChange delivered ALL 9 torque-tube trucks Fri Jul 24 (moved up from a Sat/Mon split to avoid weekend offload costs) — after Friday only 16 purple tubes remain to complete the BOM, committed Wed Jul 29. OPEN CLAIM: one purple torque-tube bundle missing from load PL-3295-094-HT (Manuel, Jul 24). Workbook Jul 24: tubes 20,908 of 28,869 delivered (72.4%) — pre-Friday-trucks cut. Prior open items: POD pending on PL-3295-084-HT; GameChange trucks staging on public roads (Road Commission monitoring, fines passed to GameChange). Site pile stock: 28,343 delivered vs 25,959 executed — 2,384-pile buffer. Receiving cap 14 pile + 8 racking loads/day; loads count as scheduled until POD/site receipt.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 82.8, baseline: 48.4, note: '5,393 piles remain (official block-map 22,900 + 3,059 field logs not yet mapped): holding July 28 would need ~1,798 piles/day vs ~560 crew capacity — the finish now projects ~Aug 7 (Jose, Jul 22). Jul 23: 284 (United 192 G + 30 F + ECCS 62 E, 4 of 6 United rigs running); Jul 24: NO pile production reported. Rig repairs and the missing daily logs are the escalated levers.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', progress: 34.2, baseline: 0, note: 'Jul 23-24: 28 + 30 rows (ECCS, Zone E) — 851 done / 235 QA-released / 616 pending QA (released split stale since the Jul 20 C1/C2 release). United racking crew ramping (~1.5 wks to full rate); Workforce racking on dampers/actuators Jul 24. Cumulative under reconciliation vs the workbook (715 pre-assembled / 311 complete). QA release cadence is the controlling item for the module front.' },
      ...
      { activity: 'Final module installation completion', contractor: 'Workforce', start: '2026-07-03', end: '2026-09-06', status: 'Critical', progress: 18.0, baseline: 0, note: 'Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. 30,780 modules executed through Jul 24 (Jul 23: 3,456; Jul 24: 3,134; record 3,601 Jul 20); ~3,803/day now required — four straight days near 3,000+; the gap closes with Brumont re-manning and Saturday work.' },
    ...
    equipmentNotes: [
      ...
      { contractor: 'United', equipment: '6 ramming machines on site — 2 damaged (4 running).', output: 'Jul 23 (Thu): 222 tracker piles (192 G + 30 motor F) + 15 electrical CB/TP piles — 27 people; refusal-pile reinstalls + tap-downs. NO log posted Jul 24.' },
    ...
    risks: [
      ...
      { title: 'H&S — wildfire-smoke air-quality alert LIFTED (Jul 20)', level: 'On Track', owner: 'EHS / H&S Manager / Site Management / Greensol / Luis Romero', note: 'H&S item. RESOLVED: the Michigan EGLE statewide air-quality alert (Canadian/Ontario wildfire smoke, issued Jul 14) expired at the end of Monday Jul 20 and was NOT renewed; site-area AQI is back in the normal Moderate range (Jul 22 forecast). On site the event has eased: the only smoke-related stoppage was ECCS pulled off ~3pm Jul 17 (shortening the tracker/Zone E pile day); no further stoppages since, and Saturday Jul 18 crews (United, Latnovva) worked a normal day. Masks remain available; H&S continues to monitor daily AQI. The Jul 17 stoppage stays documented for a potential force-majeure / time-extension claim (Jul 17 procurement acta).' },
      ...
      { title: 'Pile production is sliding — rigs down, Latnovva silent, and Jul 24 logged ZERO piles', level: 'Critical', owner: 'United / LATNOVVA / Audelio Zuniga / Manuel Ramirez', note: 'Pile stock is comfortable — 28,343 delivered vs 25,959 executed, a 2,384-unit buffer. The constraint is mechanical and reporting: United ran 4 of 6 rigs Jul 23 (2 damaged) for 222 piles, Latnovva has not reported production since Jul 22, and NO pile log was posted for Jul 24. Jose (Jul 22): "We are drastically reducing pile production — we are now heading to Aug 7. Make the effort to hit the piling completion milestone." Holding Jul 28 would need ~1,798/day vs ~560 capacity; the working projection is ~Aug 7. Rig repairs, the Latnovva/United daily logs, and Saturday work are the recovery levers.' },
      { title: 'Trackers remain the controlling front: 28-30 rows/day vs 53 required', level: 'Critical', owner: 'ECCS / Daniel Morilla / Manuel Ramirez / United / Workforce', note: 'ECCS logged 28 + 30 completed rows Jul 23-24 (Zone E) — the best back-to-back days since Jul 14, but barely half the 53/day required for Aug 30. The SECOND Workforce crew (racking) is also producing trackers — 17 EW rows to 50% Jul 23, dampers/actuators Jul 24 — reported on the scoreboard and credited to the cumulative as the rows close. 851 done / 235 released / 616 pending — the released split is STALE since the Jul 20 C1/C2 release; an updated QA count is owed. Manuel (Jul 23): United is now receiving racking people — expect a step-up in ~1.5 weeks; Workforce racking ran 17 rows at 50% (EW) Jul 23 and dampers/actuators Jul 24; Jose pressed the team Jul 23 to repeat the mechanical recovery on the electrical side. Torque tubes are no longer the constraint (all 9 trucks landed Jul 24). Field cumulative under reconciliation vs the workbook (715 pre-assembled / 311 complete).' },
      { title: 'QA release backlog now binds the module front — and Area F was released without sub documents', level: 'Critical', owner: 'Daniel Morilla (QA/QC) / ECCS / Manuel Ramirez', note: '616 completed tracker rows await Quality approval on top of the 235 released (split stale since Jul 20), after a freeze Jul 10-18 (rows driven but not levelled/aligned). Daniel confirmed Monday Jul 20 that Zones C1 and C2 release today with the Client — the first releases since Jul 10; crews stay concentrated on tracker QA to clear the A6/A7 backlog and Area F progress. Open item flagged by QA: some Area F zones were released internally without the subcontractor submitting quality documents — those documents must be recovered. The released buffer ahead of modules is only ~1.3 days, so released rows are the binding constraint.' },
      { title: 'SET foundation, delivery dates, and equipment commitments all need closure', level: 'Critical', owner: 'Axel Cano / AB Power / Karina Mucino / Joshua Spalding / Project Management', note: 'Jul 24 SET tracker shows 20.0% overall progress (civil 59.3%, structural 11.3%, electrical 5.2%), up from 16.7% on Jul 21 — piers 6 of 17 complete incl. concrete. The control building is set and the transformer-foundation containment berm was completed Jul 12. Main transformer AND breakers are still awaited (0% of main equipment on site vs the Jul 10 100% gate); structural steel also remains in fabrication, and several electrical items show committed dates after the July 10 required-on-site gate.' },
