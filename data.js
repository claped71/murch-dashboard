...
window.MURCH_DATA = {
    ...
    photos: [
      { src: 'https://claped71.github.io/murch-dashboard/assets/recent/thumb-recent-40.jpg?v=20260722-pierE5', fallbackSrc: 'https://claped71.github.io/murch-dashboard/assets/recent/recent-40.jpg', date: 'July 21, 2026', title: 'MILESTONE — first substation pier under construction: Pier E5 (1 of 17)', note: 'Geotagged Jul 21, 19:06 (N 42° 12\' 36", W 86° 0\' 57", Lawrence MI): the delayed substation pier construction is finally RUNNING. Pier E5 formed with the anchor-bolt cage set — 1 of 17 piers, built by DIG IT (AB Power subcontractor) under Axel Cano (SET Site Manager). Plan: 3-4 more piers formed Jul 22 and the first concrete pour Thursday Jul 23, then a steady 3-4 piers/day ready for concrete. With this start the SET tracker moves to 16.3% overall (civil 51.1%, structural 5.7%, electrical 5.2%).' },
    ...
    weeklyPlan: [
      ...
      { area: '<u>SET, inverter foundations and inverter arrival</u>',
        target: 'SET at 16.3% overall (civil 51.1%, structural 5.7%, electrical 5.2%). Close the last 4 inverter pile foundations — D10, E12, F16, G20 (190 of 230 piles, 82.6%) — before the end-July arrival of the 23 inverter units. AB Power has presented no work or material-delivery plan; Greensol is pulling partial scope to Michael Power and self-procuring material.',
        minimum: 'All 23 inverter foundations released before first delivery; hold the SET civil rate that lifted overall progress from 11.8% to 16.3% in the last week.',
    ...
    civilKpis: [
      ...
      { title: 'SET tracker', metric: '16.3% overall', note: 'Jul 21 SET tracker: overall progress 16.3% (civil 51.1%, structural 5.7%, electrical 5.2%) — up from 11.8% on Jul 13. Control building on site since Jul 7. Jul 12 (Sun): transformer-foundation containment berm complete at the substation. Jul 12: all 18 inverter stations available on site have their base plates welded.' }
    ],
    civilActivities: [
      ...
      { activity: 'Foundation SET', company: 'AB Power', done: 16.3, remaining: 83.7, status: 'Active', note: 'Jul 20 SET workbook: overall substation progress 16.0% (up from 11.8% on Jul 13); civil 51.1%, structural 5.7%, electrical 5.2%. Containment berm and transformer foundation complete Jul 12. PIERS STARTED Jul 21 by Dig It (AB Power sub) — 1 of 17 (E5); plan 3-4/day, first pour Thu Jul 23. AB Power SET scope at risk — no work or delivery plan (Jul 17 review); partial scope moving to Michael Power.' }
    ],
    contractors: [
    ...
    production: [
      ...
      { name: 'ITS HDD boring', remaining: '3 of 20 bores', target: 'Minimum 1 completed bore/day', latest: 'Jul 22: ITS crew working the DC boring — 17 / 20 complete (85%), 1 in progress, 2 pending', cumulative: '17 / 20 bores complete (85%); 5,026 ft installed', status: 'Watch', note: 'Jul 20 ITS control: 17 done / 1 in progress / 2 pending. DC bore restarted Jul 21 after the Bore 10 frac-outs; 3 bores remain. Jul 17 review: EGLE will not accept swapping the remaining bores for plowing; the last 4 continue, extended ~100 ft each (2x100 ft) to clear the wetland.' },
      { name: 'ITS MV plowing', remaining: '10 of 46 segments', target: 'Minimum 1 completed segment/day', latest: 'Jul 22: no plowing production — ITS crew concentrated on the DC boring; 36 / 46 complete (76.6%)', cumulative: '36 / 46 segments complete (76.6%); 120,738 ft installed', status: 'On Track', note: 'Jul 20 ITS control: 36 done / 0 in progress / 10 pending. Line status: MV11A 7/10, MV11B 10/12, MV12A 10/13, MV12B 9/11. Plowing comfortably leads the electrical sequence.' },
      { name: 'SET construction', remaining: '83.7% of overall scope', target: '— No approved daily progress target in source', latest: 'Jul 21 SET tracker: overall 16.3% (civil 51.1%, structural 5.7%, electrical 5.2%) — up from 11.8% Jul 13', cumulative: '16.3% overall (civil 51.1%, structural 5.7%, electrical 5.2%) per the Jul 21 SET tracker', status: 'Critical', note: 'Overall SET progress from 11.8% (Jul 13) to 16.3% (Jul 21) — piers now underway, driven by civil. Transformer and structural steel remain in fabrication — the controlling items for energization. Jul 17 procurement review: AB Power has presented no SET work plan and no material-delivery plan; Greensol is pulling partial scope to a third party (Michael Power) and self-buying missing materials (BUS-connectors urgent). Portico steel structure arriving Jul 16-17; oil-pit grating (tramex) procured separately to close the SET payment milestone and avoid Heelstone objections.' },
    ...
    schedule: [
      ...
      { activity: 'ITS HDD boring', contractor: 'ITS', start: '2026-06-12', end: '2026-08-15', status: 'Active', progress: 85, baseline: 0, note: 'Jul 20 ITS control: 17 of 20 bores complete (85%), 1 in progress, 2 pending — +1 bore Jul 20; DC bore restarted Jul 21 after the Bore 10 frac-outs. 5,026 ft installed. EGLE denied swapping the remaining bores for plowing (Jul 17) — the last continue with ~100 ft extensions each past the wetland.' },
    ...
    equipmentNotes: [
      ...
      { contractor: 'Dig It', equipment: 'SET pier formwork and foundation equipment (AB Power subcontractor).', output: 'Jul 21: formed substation Pier E5 — first of 17 piers; plan 3-4 piers/day, first concrete pour Thu Jul 23.' },
    ...
    risks: [
      ...
      { title: 'SET foundation, delivery dates, and equipment commitments all need closure', level: 'Critical', owner: 'Axel Cano / AB Power / Karina Mucino / Joshua Spalding / Project Management', note: 'Jul 21 SET tracker shows 16.3% overall progress (civil 51.1%, structural 5.7%, electrical 5.2%), up from 11.8% on Jul 13. The control building is set and the transformer-foundation containment berm was completed Jul 12. Main transformer AND breakers are still awaited (0% of main equipment on site vs the Jul 10 100% gate); structural steel also remains in fabrication, and several electrical items show committed dates after the July 10 required-on-site gate.' },
