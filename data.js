...
const assetVersion = '20260708-cb-install';
...
window.MURCH_DATA = {
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (17,642 installed, 56.3% — Jul 8 basis), GameChange SAT tracker assembly incl. purlins (535 done — 235 QA-released, 300 pending Quality), and module placement. D&F pre-drilling complete (7,694/7,694).' },
    ...
    photos: [
      { src: asset('assets/recent/thumb-recent-28.jpg'), fallbackSrc: assetFallback('assets/recent/recent-28.jpg'), date: 'July 7, 2026', title: 'Control building set at substation', note: 'Axel Cano: substation control building delivered and installed on its foundation the night of July 7 — the July 10 required-on-site gate is met.' },
      { src: asset('assets/recent/thumb-recent-29.jpg'), fallbackSrc: assetFallback('assets/recent/recent-29.jpg'), date: 'July 7, 2026', title: 'Control building night installation', note: 'Crane set of the control building at the SET area, door and HVAC side visible; foundation anchor points engaged.' },
    ...
    risks: [
      { title: 'Pile delivery buffer improved, but July 7 loads still need POD confirmation', level: 'Watch', owner: 'GameChange / Shreeya Devkota / Karina Mucino / Manuel Ramirez / Audelio Zuniga', note: 'The Jul 8 workbook shows 7,867 piles available above installed production, about 14.0 days at the 560-pile/day acceleration capacity. Shreeya confirmed 11 named loads for July 7; treat them as scheduled until POD/site receipt, material type, and actual quantities are confirmed.' },
