...
window.MURCH_DATA = {
    ...
    risks: [
      ...
      { title: 'Jul 9 is the proof day: 10-rig fleet must hold ~711 piles/day with ZERO margin', level: 'Critical', owner: 'Audelio Zuniga / United / Latnovva / Manuel Ramirez', note: 'Jul 8 delivered 640 piles — first day above the 560 capacity line (United 490 at 70/rig-day; Latnovva 150 with 2 rigs at 75/rig-day; both near the 80/day criterion). The Latnovva 3rd rig, in assembly, is expected to work Jul 9: the 10-rig fleet at ~72/rig-day gives ~715-720/day, matching the ~711/day required for the Jul 28 gate for the first time. BUT the margin is zero working days: any weather day, rig breakdown, or sub-criterion day between now and Jul 28 must be recovered SAME-DAY via overtime or Saturday extension. If the third rig does not start Jul 9, escalate immediately — the week cannot be lost.' },
