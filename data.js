...
window.MURCH_DATA = {
    ...
    weeklyPlan: [
      ...
      { area: 'Tracker assembly and completed row release', target: 'July 7 output was only 22 tracker units (235 cumulative complete). Close Area A4 release, open Area C, and recover to the 48 units/day control rate.', minimum: '>= 48 tracker units/day sustained all week and ramp toward 40 completed rows/day', gate: 'Complete tracker kits allocated by block and same-week QA turnover of finished rows.', owners: 'ECCS | Audelio Zuniga | Manuel Ramirez' },
    ...
    production: [
      ...
      { name: 'Tracker completion incl. purlins', remaining: '2,251 complete trackers', target: '48 completed tracker rows/day acceleration target', latest: 'Jul 7: 22 tracker units (ECCS) — below the 48/day target', cumulative: '235 complete trackers; 493 pre-assembled rows / 2,486 total', status: 'Critical', note: 'Purlins are installed together with the trackers (delivery no longer a restriction); completion is controlled through completed tracker rows. Best-estimate completion for all trackers is August 30.' },
    ...
    dailyProductionHistory: [
      ...
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 7', minimum: '48 tracker units/day', above: 4, below: 10, latest: 'Jul 7: 22 tracker units (ECCS)', note: 'Purlin installation is integrated into this tracker control metric: a tracker row is only counted complete once its purlins are installed. Complete tracker cumulative count is 235 after 22 units on July 7 — still below the 48/day target.', daily: [{ day: 'Jun 17', value: 15, target: 48, unit: 'units' }, { day: 'Jun 18', value: 35, target: 48, unit: 'units' }, { day: 'Jun 19', value: 26, target: 48, unit: 'units' }, { day: 'Jun 20', value: 31, target: 48, unit: 'units' }, { day: 'Jun 21', value: 0, target: 48, unit: 'units' }, { day: 'Jun 22', value: 48, target: 48, unit: 'units' }, { day: 'Jun 23', value: 31, target: 48, unit: 'units' }, { day: 'Jun 24', value: 0, target: 48, unit: 'units' }, { day: 'Jun 25', value: 57, target: 48, unit: 'units' }, { day: 'Jun 26', value: 26, target: 48, unit: 'units' }, { day: 'Jun 29', value: 29, target: 48, unit: 'units' }, { day: 'Jun 30', value: 30, target: 48, unit: 'units' }, { day: 'Jul 1', value: 51, target: 48, unit: 'units' }, { day: 'Jul 7', value: 22, target: 48, unit: 'units' }] },
    ...
    schedule: [
      ...
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', note: 'Cumulative 235 complete trackers after 22 units by ECCS on July 7 (below the 48/day target); 493 pre-assembled rows. Purlins are installed together with the trackers — delivery is no longer a restriction and purlin work finishes with tracker completion. Best-estimate completion for all trackers is August 30.' },
