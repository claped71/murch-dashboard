...
window.MURCH_DATA = {
    ...
    contractorScore: [
      { date: 'Jul 29 Wed', contractor: 'ECCS', trade: 'Trackers', output: 35, resource: '53 people zone E — 35 rows closed at 100% + 34 rows at step 3 of 5 (23.8 row-equivalents); Zone E now 379 / 56.2%', perUnit: 35, criterion: 58, critLabel: '58 rows/day required for Aug 30 — best ECCS day since Jul 14 (30 -> 35) but still 40% under rate; 34 more rows sit at 75% and convert tomorrow' },
      { date: 'Jul 29 Wed', contractor: 'United', trade: 'Piles + Racking', output: 361, resource: '55 people (up from 44) — 361 piles all Zone G (now 1,577 / 47.0%); racking: 82 rows at step 1 of 5 in Zone F = 12.3 row-equivalents', perUnit: 361, criterion: 500, critLabel: 'Hard Zone G ground still caps the rate, but +22 over Jul 28 on 11 more people. First United racking quantity: 82 F rows opened at 20% — no rows CLOSED, so zero credit against the gate, but 12.3 row-equivalents earned on the productivity measure' },
      ...
      { date: 'Jul 29 Wed', contractor: 'Workforce (racking)', trade: 'Trackers', output: 0, resource: '15 people — the 20 Zone EW rows at step 3 of 5 (purlins in, dampers/actuators out) = 14.0 row-equivalents; no row closed', perUnit: 0, criterion: 58, critLabel: 'PERCENTAGE WENT BACKWARDS: the same 20 EW rows were logged at 95% on Jul 28 and at 75% on Jul 29 — a free-text percentage that lost 20 points with no row closed. RESOLVED: step reporting adopted Jul 30 — these rows are step 3 of 5' },
    ...
    zones: [
      { zone: 'Zone A', contractor: 'ECCS (assembly complete)', scope: 311, installed: 311, released: 311, remaining: 0, done: 100.0, wipRows: 0, wipStep: null, wipEquiv: 0, earnedPct: 100.0, status: 'Complete', note: 'Tracker assembly complete and 100% QA-released (incl. purlins). First zone fully closed for modules.' },
      { zone: 'Zone C', contractor: 'ECCS (assembly complete)', scope: 227, installed: 226, released: 222, remaining: 1, done: 99.6, wipRows: 0, wipStep: null, wipEquiv: 0, earnedPct: 99.6, status: 'On Track', note: 'One row open; 222 of 227 QA-released (97.8%) since the Jul 20 C1/C2 client release. Module front active here.' },
      { zone: 'Zone E', contractor: 'ECCS', scope: 674, installed: 379, released: 73, remaining: 295, done: 56.2, wipRows: 34, wipStep: 3, wipEquiv: 23.8, earnedPct: 59.8, status: 'Critical', note: 'Active assembly front — Jul 29: 35 rows closed at 100% (best day since Jul 14) plus 34 rows standing at 75%, against the 58/day project requirement. Released still 73 rows covering E1/E2 only — 306 built rows in E now sit unreleased.' },
      { zone: 'Zone EW', contractor: 'Workforce (racking)', scope: 67, installed: 0, released: 0, remaining: 67, done: 0, wipRows: 20, wipStep: 3, wipEquiv: 14.0, earnedPct: 20.9, status: 'Active', note: 'Jul 29: the same 20 rows reported at 75% after being logged at 95% on Jul 28 — the percentage moved BACKWARDS and no row has closed. 15 people. Rows count only complete incl. purlins.' },
      { zone: 'Zone F', contractor: 'United (racking ramp)', scope: 595, installed: 0, released: 0, remaining: 595, done: 0, wipRows: 82, wipStep: 1, wipEquiv: 12.3, earnedPct: 2.1, status: 'Mobilizing', note: 'Jul 29: FIRST United tracker quantity — 82 rows opened at 20% (saddles/bearings). No row closed yet; ~1.5 wks to full rate.' },
      ...
      { zone: 'TOTAL', contractor: 'All tracker crews', scope: 2486, installed: 916, released: 606, remaining: 1570, done: 36.8, wipRows: 136, wipStep: null, wipEquiv: 50.1, earnedPct: 38.9, status: 'Critical', note: '916 built (36.8%) · 606 QA-released (310 pending) · 136 rows in progress worth 50.1 row-equivalents on the 5-step ladder -> 966.1 earned (38.9%) · 58 completed rows/day required for the Aug 30 gate. The gate is decided by BUILT rows only; earned progress is the productivity view.' }
    ],
    ...
    trackerWip: {
      ...
      openRows: 136,
      equivalents: 50.1,
      equivalentsAsReported: 56.9,
      earnedPct: 38.9,
      gatePct: 36.8,
      items: [
        { zone: 'Zone E', contractor: 'ECCS', rows: 34, stepReached: 3, stepName: 'Purlins (both types) installed', pctStep: 70, equiv: 23.8, pctReported: 75, note: 'Reported alongside the 35 rows closed at 100% on Jul 29. Steps 4 and 5 outstanding — expected to convert to complete rows next working day.' },
        { zone: 'Zone EW', contractor: 'Workforce (racking)', rows: 20, stepReached: 3, stepName: 'Purlins (both types) installed', pctStep: 70, equiv: 14.0, pctReported: 75, note: 'Dampers and actuators (step 4) are the outstanding work. These are the rows that were reported at 95% on Jul 28 and 75% on Jul 29 — the swing that triggered the move to step reporting.' },
        { zone: 'Zone F', contractor: 'United (racking)', rows: 82, stepReached: 1, stepName: 'Bearings / saddles set on piles', pctStep: 15, equiv: 12.3, pctReported: 20, note: 'First United racking quantity. Under the gate measure alone this day scores ZERO tracker output for 55 people — the reason the productivity measure exists.' }
      ],
      steps: [
