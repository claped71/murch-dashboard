...
// CACHE BUSTER: Jul 31, 2026 (Fri) EOD FINAL - piles 28,678 (91.5%) / trackers 986 built (39.7%), 296 CLIENT-released, earned 42.4% / modules 44,283 (25.8%). Jul 31: MODULES BEAT THE RATE FOR THE FIRST TIME - 4,136 (Workforce 2,036 + Brumont 2,100, all Zone E) against 4,104 required, 84.4 modules per installer, up from 73.4. ECCS closed 40 tracker rows, best since Jul 14, against 59 required. United 337 piles Zone G (+7 inverter piles Zone D) and STILL ZERO tracker rows closed in four days - 68 Zone F rows now standing at step 3 of 5. Workforce filed NO racking crew at all: the 20 Zone EW rows go a fourth day untouched. Latnovva 11 people on refusal work, no pile count. Inverters 18 of 23 set and welded (+5). SET 24.7%, piers 14/17. ITS zero ft bored and zero ft plowed - segments hold 36/46 a fourth day. LATE LV REPORT (Angel Urbina 19:16): +25 LBDs -> 103/419 (24.6%), MW E-W Area A1 100%, and the field declares itself READY TO PULL CABLE Sat Aug 1 weather permitting - the first real movement on the 0 lf front. All State reports 17 inverters welded vs 18 on the AB Powers matrix (1-station discrepancy to confirm). NEW: GAMECHANGE REPORTS A PILE SHORT SHIPMENT (Jul 29) - replacement lead time several weeks; the pile-delivery-complete position is now open. WIP SNAPSHOT RULE: unfinished-tracker counts are a photograph of open rows per crew, never additive.
...
window.MURCH_DATA = {
    control: {
      ...
      trackers: { installed: 986, released: 296, releasedGS: 492, total: 2486, gate: '2026-08-30', gateLabel: 'Aug 30', required: 60, capacity: 48, name: 'Trackers incl. purlins', unit: 'rows/day', wipRows: 98, wipEquivalent: 68.6, earnedEquivalent: 1054.6, earnedPct: 42.4, earnedBasis: '5-step weighted ladder (adopted Jul 30, 2026)', releaseBasis: 'RELEASED = CLIENT-approved (Heelstone) per the Jul 30 QA sheet - NO new QA cut was filed on Jul 31, so the release figures are one day stale. Greensol-approved is carried separately as releasedGS.' },
      modules:  { installed: 44283, total: 171470, gate: '2026-09-06', gateLabel: 'Sep 6', required: 4103, capacity: null, name: 'Modules', unit: 'mod/day' },
      electrical: { installed: 0, total: 274720, gate: '2026-09-18', gateLabel: 'Sep 18', required: 6541, capacity: null, name: 'LV Electrical', unit: 'lf/day', earnedPct: 1.9, earnedBasis: 'weighted composite of the LV control line (cable 55%, boxes 10%, supports 10%, terminations 20%, testing 5%)' },
    ...
    manpowerNote: 'NO HEADCOUNT BOARD WAS FILED FOR Jul 31 - the mix below is the Jul 30 board carried forward. Jul 31 REPORTED headcount, including the late electrical block from Angel Urbina: ECCS 53 (trackers) + United 55 + Workforce 29 (ALL on modules) + Brumont 20 + ECCS electrical 15 (12 field + 3 admin) + ITS 12 + Latnovva 11 = 195 people. THE WORKFORCE RACKING CREW DISAPPEARED FROM THE REPORT: 14 people were on Zone EW racking on Jul 30 and Jul 31 shows 29 people, all on modules. Either the crew was reallocated to panels - which would explain the module jump - or it was not reported. Confirm with Manuel before Monday. The electrical report came in late, at 19:16, and is now included. PRIOR Jul 30 site board = 253 (Jul 29: 248). ECCS 66 (53 trackers + 13 LV) - United 55 - Workforce 48 - GreenSol 20 (carried forward, card left blank on the board) - Brumont 19 - ITS 13 - Latnovva 9 - ABPower 8 - Dig It 5 - Topland 4 - Hi Tech 3 - Kalamazoo 2 - SWCA 1. Crane 2 is equipment, not headcount. PRODUCTION WAS FILED FOR ONLY ~190 OF THE 253 PEOPLE ON SITE: the United report of 507 piles and 37 open racking rows arrived late in the day, and United counted 51 of its own people against 55 on the board; LATNOVVA (9 people) STILL FILED NOTHING, and ABPower, Dig It, Topland, Hi Tech, Kalamazoo and SWCA filed nothing at all. Missing output is a reporting failure, not a zero-production day.',
    contractorScore: [
      ...
      { date: 'Jul 30 Thu', contractor: 'United', trade: 'Piles + Racking', output: 507, resource: '51 people reported (board carries 55) - 507 piles all Zone G (now 2,084 / 62.1%); racking: 37 rows standing at step 3 of 5 in Zone F = 25.9 row-equivalents', perUnit: 507, criterion: 430, critLabel: 'BEST UNITED DAY OF THE PROJECT - 507 against the 430/day needed to hold ~Aug 7, in ground that was capping the rate a week ago. Zone G has gone 47.0% to 62.1% in two days. RACKING ADVANCED A FULL LADDER STEP: the Zone F open rows moved from step 1 (saddles) to step 3 (purlins in) - 37 rows now sit two steps from closing. Per the snapshot rule the 37 REPLACES the 82 reported Jul 29; no row has been reported complete, so 45 rows have left the open register unexplained.' },
      { date: 'Jul 30 Thu', contractor: 'Latnovva', trade: 'Piles', output: 0, resource: 'NO PRODUCTION LOG FILED - 9 people on the site board', perUnit: 0, criterion: 0, critLabel: 'STILL NOT FILED - a reporting failure, not a zero-production day. 9 people on the board and nothing reported. Zone B remains 36 piles from close, one short day of work.' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles \u00b7 2,486 trackers', note: 'Piles 91.5% \u00b7 trackers 39.7% \u00b7 modules 25.8%.' },
    ...
    weeklyPlan: [
      { area: '<u>Tracker assembly & QA release</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '986 / 2,486 done (39.7%) — 296 CLIENT-released, 492 Greensol-approved. ECCS closed 40 rows Jul 31 (best since Jul 14); United 68 F rows open at step 3 with ZERO closed in four days; 20 EW rows untouched for four days. Week ask >= 360 rows.',
        minimum: '>= 60/day for Aug 30 — 1,500 rows over 25 working days. Running 40 on the only crew that is closing anything.',
        gate: 'TWO GATES NOW. (1) Client release: 296 accepted of 986 built, blocked on the damper change-out. (2) United and Workforce closing rate: 88 of the 98 open rows sit with crews that have closed nothing in four days. Convert F (68 rows) and EW (20 rows) first — all at step 3 of 5, two steps from complete.',
      ...
      { area: '<u>Pile production — B / F / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '28,678 / 31,352 (91.5%) — 2,674 left. Close B (36, under one shift), F (11) and E (224); G 446+/day (935 left); D opens ~Aug 5-7.',
        minimum: '>= 446/day from Aug 1 holds ~Aug 7 (Jul 31: 337 — back under rate after two days above it).',
        gate: 'MATERIAL IS NOW A GATE AGAIN: GameChange is chasing the quantity and colour breakdown of a reported pile SHORT SHIPMENT, replacement lead time several weeks. Plus the Zone G change-order signature and Latnovva filing an actual number for Zone B.',
      ...
      { area: '<u>Module installation ramp</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '44,283 / 171,470 (25.8%) — Jul 31: 4,136, THE FIRST DAY AT OR ABOVE RATE. Both crews cleared 2,000; Brumont re-manned 14 to 20. Week ask >= 24,600; SATURDAYS MANDATORY (Jose).',
        minimum: '>= 4,103/day for Sep 6 — 49 installers at 84.4 modules each now delivers it. Hold Workforce at 29 and Brumont at 20 and the rate holds; drop either and it does not.',
        gate: 'QA RELEASE, not crew size. ZERO rows are released in Zone E and every module of the last two days went in there — roughly 375 built rows now carry modules with no client acceptance.',
      ...
      { area: '<u>LV electrical — START</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: 'Jul 31 (Angel, 19:16): <strong>+25 LBDs -> 103/419 (24.6%)</strong>, the best LBD day so far; MW E-W Area A1 completed to 100%. <strong>THE CREW REPORTS THE FRONT STAGED AND READY TO PULL CABLE ON SAT AUG 1 IF WEATHER ALLOWS.</strong> Still ZERO measured footage. GOAL: Area A LV-cabled for the Mike/client visit.',
        minimum: '>= 6,541 lf/day from Aug 1 to hold Sep 18 (still 0 lf on the clock — the rate has risen 300 lf/day in one week purely from elapsed time).',
        gate: 'GET A MEASURED FOOTAGE FILED ON SATURDAY. Then Chemik arrival dates (air confirmed Jul 28, fabrication done this week) and the E-W routing review (Unistrut) before standardizing.',
        owners: 'ECCS \u00b7 East Carolina \u00b7 Self-Perform | Luis Romero | Clara Lopez' },
      { area: '<u>GameChange deliveries</u>',
        target: 'RE-OPENED. GameChange (Shreeya, Jul 29) is urgently chasing the EXACT SHORTFALL QUANTITY AND COLOUR BREAKDOWN of piles the site team reported short shipped — to decide whether it is a POD discrepancy or a real shortfall. Replacement posts take SEVERAL WEEKS to produce. Nothing has been filed back. Separately, 16 purple tubes were due Jul 29 with no site receipt reported.',
        minimum: 'File the pile shortfall count and colour breakdown MONDAY. Claim PL-3295-094-HT (1 purple bundle) still unanswered; re-sign corrected BOL + upload ~21 missing PODs.',
        gate: 'A confirmed pile shortfall would put a multi-week hole in the last 2,674 piles — this is now the highest-consequence open procurement item after the substation steel.',
        owners: 'GameChange (Shreeya Devkota) | Manuel Ramirez | Karina Mucino' },
      { area: '<u>SET & inverter foundations</u>',
        target: 'SET 24.7% (AB Powers Jul 31); PIERS 14/17 — last 3 drilled Mon Aug 3, concrete Tue Aug 4, which finishes every substation foundation. INVERTERS 18/23 set and welded (+5 on Jul 31, all of Zone F closed in a day); last 5 due Monday. Station pile-sets 21/23 — close 10-D and 16-F.',
        minimum: 'All 23 stations set by Tue Aug 4; then start terminations, which stand at ZERO of 23.',
        gate: 'Structural steel — Greensol formally rejected the AB Powers delivery programme Jul 30 and the revised one is owed. Time the escalation to Aug 4, when foundations are complete and steel is the only excuse left.',
        owners: 'AB Power / Michael Power / Dig It | Axel Cano | Joshua Spalding' },
      { area: '<u>MV plowing & HDD</u>',
        target: 'MV bores 17/20 \u00b7 segments 36/46 (120,738 ft) \u00b7 DC ducts 3/14 — FOUR consecutive days with zero bores and zero segments; the ITS sheet records 0 ft for the whole week. MVHB-12 committed to Sunday. Close >= 2 MV bores + 5 segments next week.',
        minimum: '>= 1 bore + 1 segment/day. The plow machine is idle while all 13 people finish the wetland bore — split the crew.',
      ...
      { area: '<u>Civil Area G & roads</u>',
        target: 'Internal roads 72% — the Jul 31 target date has now PASSED with no closure filed; G basins 83% then start G cut/fill; fence 95%. Rosario owes a Week 31 civil cut.',
    ...
    contractors: [
      ...
      { name: 'Project Total', scope: 31352, installed: 28678, remaining: 2674, done: 91.5, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 28,678 (91.5%) — Jul 28 workbook roll-up 26,736 + 1,942 field-reported over Jul 28-31. Jul 31 = 337 (United, all Zone G), below the 430/day rate after three days of climbing. Latnovva filed 11 people and one rig on refusal work with NO pile count, so Zone B is again missing. 2,674 remain; ~446/day over the 6 working days to Aug 7. STOCK POSITION NOW OPEN — GameChange is chasing a reported pile short shipment (Jul 29)." }
    ],
    zones: [
      ...
      { zone: 'Zone E', contractor: 'ECCS', scope: 674, installed: 449, released: 0, releasedGS: 0, remaining: 225, done: 66.6, wipRows: 10, wipStep: 3, wipEquiv: 7.0, earnedPct: 67.7, status: 'Critical', note: 'Jul 31: 40 rows closed, the best ECCS day since Jul 14, and the open-row snapshot fell 28 to 10 — the WIP converted into completions rather than disappearing. RELEASE IS STILL ZERO: no Greensol and no client approval anywhere in Zone E against 449 built rows, and the entire Jul 31 module output of 4,136 went in here again. Roughly 144 rows in E now carry modules with no release of any kind.' },
      { zone: 'Zone EW', contractor: 'Workforce (racking)', scope: 67, installed: 0, released: 0, releasedGS: 0, remaining: 67, done: 0, wipRows: 20, wipStep: 3, wipEquiv: 14.0, earnedPct: 20.9, status: 'Critical', note: 'FOURTH CONSECUTIVE DAY WITH NO ROW CLOSED — and on Jul 31 no racking crew was reported at all: all 29 Workforce people filed on modules. The same 20 rows have sat at step 3 of 5 since Jul 28 with only dampers, actuators and punch outstanding. They are still the cheapest rows on the board to convert and nobody is standing on them.' },
      ...
      { zone: 'TOTAL', contractor: 'All tracker crews', scope: 2486, installed: 986, released: 296, releasedGS: 492, remaining: 1500, done: 39.7, wipRows: 98, wipStep: null, wipEquiv: 68.6, earnedPct: 42.4, status: 'Critical', note: '986 built (39.7%) · RELEASE UNCHANGED — no QA cut was filed on Jul 31, so 296 accepted by Heelstone (11.9%) and 492 approved by Greensol are one day stale; 690 built rows now carry no client acceptance · 98 rows in progress worth 68.6 row-equivalents -> 1,054.6 earned (42.4%) · 60 completed rows/day required for Aug 30. ALL 98 OPEN ROWS SIT AT STEP 3 OF 5 across E, EW and F. Only ECCS converted WIP into completions on Jul 31; United and Workforce closed nothing. Open rows are a SNAPSHOT per crew, never cumulative.' }
    ],
    ...
    modulesByZone: [
      ...
      { zone: 'Zone E', contractor: 'Workforce + Brumont', scope: 52234, installed: 9473, remaining: 42761, done: 18.1, status: 'Critical', note: 'Jul 31: +4,136 (Workforce 2,036 + Brumont 2,100), the entire day\'s module output and the first day the module front has beaten its required rate. ZERO tracker rows in Zone E are released by Greensol or by the client, so all ~144 rows now carrying modules here are unreleased.' },
      ...
      { zone: 'TOTAL', contractor: 'All module crews', scope: 171470, installed: 44283, remaining: 127187, done: 25.8, status: 'Critical', note: '44,283 executed (25.8%) — 4,103/day over the 31 working days to Sep 6. JUL 31 WAS THE FIRST DAY AT OR ABOVE THE REQUIRED RATE: 4,136 against 4,104, from 49 installers at 84.4 modules each (up from 73.4). All of it went into unreleased Zone E rows.' }
    ],
    mvProgress: {
      asOf: 'Jul 31, 2026',
    ...
    electricalTotal: {
      ...
      earnedPct: 25.3,
      components: [
        { name: 'LV / DC installation', weight: 45, gate: 0.0, earned: 2.5, note: '274,720 lf of cable, 419 boxes. 103 boxes mounted (+25 on Jul 31); still zero measured cable footage, but the crew reports the front ready to pull on Sat Aug 1.' },
      ...
      note: 'One electrical total across all four fronts: 16.8% on completed units, 25.3% including verified work in progress — the earned figure moved 2.0 points on Jul 31 on the five inverter stations set and 25 more LBDs. MV carries almost the whole figure — strip it out and the other three fronts together stand at about 3 points of the 100. This is the number to watch against the Oct 16 interconnection date.'
    },
    projectTotal: {
      asOf: 'Jul 31, 2026',
      gatePct: 52.1,
    ...
    earnedMethod: {
      ...
      scopes: [
        ...
        { scope: 'Modules', instrument: 'Atomic unit count', gate: '44,283 / 171,470 = 25.8%', earned: 'n/a — no intermediate state', note: 'Placed and torqued or not placed.' },
        { scope: 'Tracker rows', instrument: '5-step weighted ladder', gate: '986 / 2,486 = 39.7%', earned: '1,054.6 equivalents = 42.4%', note: 'See trackerWip. 98 rows open across three zones, all at step 3 of 5.' },
    ...
    lvComposite: {
      asOf: 'Jul 31, 2026 (Angel Urbina, filed 19:16)',
      ...
      components: [
        ...
        { component: 'LBD / box mounting', scope: '419 boxes', weight: 10, executedPct: 24.6, contribution: 2.46, note: '103 boxes mounted — <strong>+25 on Jul 31</strong>, the best LBD day so far, by the same 3-person crew, on top of 78 at Jul 30 (Area A complete at 50/50). The area and inverter allocation of the Jul 30 and Jul 31 additions has still not been filed. The only LV component with real progress.' },
        { component: 'Aerial supports and messenger wire', scope: 'QUANTITY NOT YET IN THE TAKE-OFF', weight: 10, executedPct: null, contribution: null, note: 'Jul 31: MW E-W Area A1 completed to 100% by 6 people, and the crew reports the front STAGED AND READY FOR THE CABLE PULL on Sat Aug 1 if weather allows. Jul 30: N-S supports 100% in A1/A3/A5, E-W supports 100% in A6/A7, messenger wire A3 100%, MW N-S 100%, MW E-W Area A5 at 50%. ALL OF IT EARNS NOTHING because the take-off carries no unit quantity for this component. Owed by Luis Romero / Clara Lopez, and now the cheapest available correction on the whole electrical total. NOTE the sub-area labels are not stable between daily reports (A2/A4 on Jul 29, A6/A7 on Jul 30) — a fixed area list with a denominator is needed before any support percentage is published.' },
      ...
      note: 'The LV gate is denominated purely in linear feet of cable, so every box mounted, every support set and every foot of messenger wire installed to date reports as ZERO progress. That is wrong as a measure of work done, and the composite fixes it by weighting the control-line components by labour content. But the honest result is uncomfortable and worth stating plainly: the composite lifts LV from 0.0% only to 2.5% — or about 5.0% once the support work is quantified. Giving this scope an equivalent progress does not improve the picture, it confirms it. With 6,541 lf/day required from Aug 1 to hold Sep 18 and not one measured foot of cable placed, LV/DC is the largest single exposure on the energization path, ahead of trackers and modules.',
    ...
    trackerWip: {
      ...
      openRows: 98,
      equivalents: 68.6,
      equivalentsAsReported: 73.5,
      earnedPct: 42.4,
      gatePct: 39.7,
      items: [
        { zone: 'Zone E', contractor: 'ECCS', rows: 10, stepReached: 3, stepName: 'Purlins (both types) installed', pctStep: 70, equiv: 7.0, pctReported: 75, note: 'Reported alongside the 40 rows closed at 100% on Jul 31. THE SNAPSHOT FELL 28 to 10 WITH 40 CLOSURES FILED — this is the pattern the rule is meant to reward: open rows converted into completions rather than disappearing unexplained. Steps 4 and 5 outstanding on the 10 that remain.' },
        { zone: 'Zone EW', contractor: 'Workforce (racking)', rows: 20, stepReached: 3, stepName: 'Purlins (both types) installed', pctStep: 70, equiv: 14.0, pctReported: 75, note: 'Dampers and actuators (step 4) are the outstanding work. FOURTH CONSECUTIVE DAY WITH NO ROW CLOSED on these same 20 rows, and on Jul 31 NO RACKING CREW WAS REPORTED AT ALL — all 29 Workforce people filed on modules. Carried unchanged because a missing report is not evidence of movement. At step 3 of 5 these remain the cheapest movement available on the Aug 30 gate.' },
        { zone: 'Zone F', contractor: 'United (racking)', rows: 68, stepReached: 3, stepName: 'Purlins (both types) installed', pctStep: 70, equiv: 47.6, pctReported: 75, note: 'Jul 31 SNAPSHOT: 68 rows at step 3 of 5. Manuel confirmed on request that 68 is the CUMULATIVE open figure for United, of which 31 advanced to step 3 on the day — so the snapshot rule is being applied correctly and the number is auditable. Four working days on trackers and NOT ONE ROW CLOSED. The whole 68 sits two steps from completion: dampers, actuators, torque and punch. This is the single largest block of nearly-finished rows on the project.' }
      ],
      steps: [
      ...
      rule: 'TWO MEASURES, NEVER MIXED. (1) GATE / CONTRACT MEASURE — a tracker row counts at 100% only, purlins included: 986 of 2,486 (39.7%). This is the only figure that drives the Aug 30 gate, the S-curves, the module release and any client or Heelstone submission. Partial rows earn NOTHING here. (2) PRODUCTIVITY MEASURE — row-equivalents earned per subcontractor per day, so a day of genuine work never scores as zero: 98 rows are open across three zones, worth 68.6 row-equivalents on the step ladder, putting earned progress at 42.4% against the 39.7% gate figure. All 98 now sit at STEP 3 OF 5 — purlins in, dampers and actuators outstanding. OPEN-ROW COUNTS ARE SNAPSHOTS PER CREW, never cumulative across days. Report both, labelled, side by side.',
      reportingRule: 'ADOPTED Jul 30, 2026 (Jose): partial tracker rows are reported by STEP REACHED, not by a percentage. Each daily block gives, per zone, the number of rows sitting at each step of the 5-step ladder; the equivalents are derived from the fixed weights above. Every step is a physically verifiable state a superintendent can confirm in one pass, so the figure is auditable and cannot drift backwards. A row leaves this register the moment it is credited complete — no double counting. AND (Jose, Jul 30) A REPORTED COUNT OF UNFINISHED ROWS IS A SNAPSHOT OF THE TOTAL PARTIAL ROWS STANDING FOR THAT CREW, NOT AN INCREMENT: it replaces the previous open figure and is never added to earlier days. QA release is NOT a step: release is a separate gate applied only to finished rows. On the ladder the current 98 open rows are worth 68.6 equivalents against 73.5 under the old free-text percentages — that 12% gap is the optimism the previous method carried.'
    },
    production: [
      { name: 'Project pile installation', remaining: '2,674 piles', target: 'Floor 446/day holds ~Aug 7 (2,674 remain, 6 working days)', latest: 'Jul 31: 337 (United, all Zone G) — below rate. Jul 30: 627', cumulative: '28,678 / 31,352 executed (91.5%) — workbook roll-up 26,736 + 1,942 field (Jul 28-31)', status: 'Critical', note: 'BACK BELOW RATE after two days above it — 337 against 430 required. Only one of the three pile fronts filed a number: ECCS put its whole 53-person crew on tracker assembly, and Latnovva reported 11 people and 1 rig on refusal work with no quantity, leaving Zone B stuck 36 piles from close for a third day. United also drove 7 inverter piles in Zone D, outside the 31,352 scope. MATERIAL IS NOW A QUESTION, NOT A CERTAINTY: GameChange wrote on Jul 29 asking for the exact quantity and colour breakdown of piles the site team reported SHORT SHIPPED, warning that replacement posts take several weeks to produce. File that count Monday.' },
      ...
      { name: 'Tracker completion incl. purlins', remaining: '1,500 to build Â· 2,190 to client release', target: '60 completed rows/day now required for Aug 30', latest: 'Jul 31: 40 (ECCS, E) — best since Jul 14; United snapshot 68 open F rows at step 3 and STILL none closed after four days; Workforce filed no racking crew at all', note: 'RELEASE RE-BASED Jul 30 to the CLIENT-approved column of the QA sheet: 296 rows accepted by Heelstone, 492 approved by Greensol, 986 built. The 606 previously published was the QA sheet’s executed column, not a release. Client acceptance exists only in Zone A. NO NEW QA CUT WAS FILED ON Jul 31, so the release figures are one day stale. Separately tracked (trackerWip): 98 open rows worth 68.6 row-equivalents, earned 42.4% against this 39.7% gate, all of them at step 3 of 5. ONLY ECCS CONVERTED WIP INTO COMPLETIONS. Open-row counts are a SNAPSHOT per crew, never cumulative.', cumulative: '986 done (39.7%): 296 client-released Â· 492 Greensol-approved / 2,486 total', status: 'Critical' },
      { name: 'ITS HDD boring', remaining: '3 of 20 MV bores · 11 of 14 DC bores', target: 'Minimum 1 completed bore/day', latest: 'Jul 31: ZERO ft bored — the ITS control sheet records 0 ft for the day and 0 ft for the week; MVHB-12 still open, committed to Sunday — 12 people', cumulative: '17 / 20 MV bores (85%, 5,462 ft) + 3 / 14 DC bores (21.4%, 647 LF)', status: 'Watch', note: 'MVHB-12 is being drilled deliberately slowly to avoid a frack-out on the wetland crossing — correct practice, and the reason MV bores have held at 17/20 for four days. Two drills since Jul 24; EGLE ruled the last MV bores stay bores.' },
      { name: 'ITS MV plowing', remaining: '10 of 46 segments', target: 'Minimum 1 completed segment/day', latest: 'Jul 31: 0 new segments and 0 ft plowed — 36/46 holds for a FOURTH straight day (whole crew on MVHB-12)', cumulative: '36 / 46 segments complete (76.6%); 120,738 ft installed', status: 'Watch', note: 'Plowing leads the electrical sequence and has not moved since Jul 27. The ITS control sheet now records zero plowed footage for the whole week. 10 segments remain and the plow machine is idle while the crew finishes the wetland bore.' },
      { name: 'SET construction', remaining: '76.3% of overall scope', target: '— No approved daily progress target in source', latest: 'Jul 31: PIERS 14 OF 17 (+3) — last 3 drilled Monday, concrete Tuesday; inverter stations 18 of 23 set and welded (+5), last 5 due Monday', cumulative: '24.7% overall (civil 76.8%, structural 10.8%, electrical 6.0%) per the Jul 31 AB Powers tracker', status: 'Critical', note: 'Civil has moved 65.6 to 73.1 to 76.8 in two days on the pier run while STRUCTURAL HAS NOT MOVED ONCE. Once the last 3 piers close on Aug 4 every substation foundation is complete and the only outstanding item is the steel — whose delivery programme Greensol formally rejected on Jul 30 as incompatible with an operational substation in week 3 of September.' },
      { name: 'Panel delivery', remaining: 'NONE — delivery complete', target: '— Scope closed, no further deliveries due', latest: 'Module deliveries CLOSED — full BOM quantity received on site', cumulative: '171,470 / 171,470 delivered (100.0%)', status: 'Complete', note: 'MODULE DELIVERY IS COMPLETE. The full 171,470-module quantity is on site; there are no pending module deliveries. 127,187 modules stand in stock above the 44,283 executed, so material is not a constraint on the module front at any point between here and the Sep 6 gate — the constraint is QA release and crew size.' },
      { name: 'Module installation', remaining: '127,187 modules', target: '4,103 modules/day required for Sep 6', latest: 'Jul 31: 4,136 (Workforce 2,036 + Brumont 2,100) — FIRST DAY AT OR ABOVE RATE, all of it in Zone E', cumulative: '44,283 modules field-reported (25.8%)', status: 'Critical', note: 'THE MODULE FRONT BEAT ITS REQUIRED RATE FOR THE FIRST TIME: 4,136 against 4,104. Two things moved at once — Brumont re-manned from 14 to 20 people, and productivity went from 73.4 to 84.4 modules per installer, right at the ceiling Jose put at 85. Both crews cleared 2,000 for the first time. 49 installers now deliver the rate, so the arithmetic that said 56 were needed is superseded by the higher per-person figure. HOLD IT: one day is not a trend, and the whole output again went into Zone E rows that carry no QA release of any kind.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 31 measured days', minimum: '446 piles/day floor holds ~Aug 7 (2,674 left over 6 working days from Aug 1)', above: 2, below: 32, latest: 'Jul 31: 337 (United, all Zone G) — below rate', note: 'BACK BELOW RATE: 337 vs 430. Zone G 62.1% to 72.1%, 935 left. ECCS put its whole crew on trackers and Latnovva filed refusal work with no count, so Zone B is still 36 from close. E 224 from close; F 11 from close; D opens ~Aug 5-7. MATERIAL IS NO LONGER A CLOSED QUESTION — GameChange is chasing a reported pile short shipment with a several-week replacement lead time.', daily: [{ day: 'Jun 18', value: 20, target: 1022, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 1022, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 1022, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 1022, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 1022, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 1022, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 1022, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 1022, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 1022, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 1022, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 1022, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 1022, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 1022, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 1022, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 1022, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 1022, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 1022, unit: 'piles' }, { day: 'Jul 16', value: 504, target: 1022, unit: 'piles' }, { day: 'Jul 17', value: 472, target: 1022, unit: 'piles' }, { day: 'Jul 18', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 20', value: 622, target: 1022, unit: 'piles' }, { day: 'Jul 21', value: 253, target: 1176, unit: 'piles' }, { day: 'Jul 22', value: 202, target: 1419, unit: 'piles' }, { day: 'Jul 23', value: 284, target: 1419, unit: 'piles' }, { day: 'Jul 24', value: 364, target: 1349, unit: 'piles' }, { day: 'Jul 25', value: 236, target: 1677, unit: 'piles' }, { day: 'Jul 27', value: 0, target: 2397, unit: 'piles' }, { day: 'Jul 28', value: 439, target: 462, unit: 'piles' }, { day: 'Jul 29', value: 539, target: 464, unit: 'piles' }, { day: 'Jul 30', value: 627, target: 430, unit: 'piles' }, { day: 'Jul 31', value: 337, target: 430, unit: 'piles' }] },
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 31', minimum: '60 rows/day (required for Aug 30)', above: 4, below: 29, latest: 'Jul 31: 40 (ECCS, E) — best since Jul 14; United 68 open F rows and none closed in four days; Workforce filed no racking crew', note: 'Row counts complete only with purlins installed. 986 built; release holds at 296 client-accepted — no QA cut was filed Jul 31. ONE crew of three converted work into completions.', daily: [{ day: 'Jun 17', value: 15, target: 50, unit: 'units' }, { day: 'Jun 18', value: 35, target: 50, unit: 'units' }, { day: 'Jun 19', value: 26, target: 50, unit: 'units' }, { day: 'Jun 20', value: 31, target: 50, unit: 'units' }, { day: 'Jun 21', value: 0, target: 50, unit: 'units' }, { day: 'Jun 22', value: 48, target: 50, unit: 'units' }, { day: 'Jun 23', value: 31, target: 50, unit: 'units' }, { day: 'Jun 24', value: 0, target: 50, unit: 'units' }, { day: 'Jun 25', value: 57, target: 50, unit: 'units' }, { day: 'Jun 26', value: 26, target: 50, unit: 'units' }, { day: 'Jun 29', value: 29, target: 50, unit: 'units' }, { day: 'Jun 30', value: 30, target: 50, unit: 'units' }, { day: 'Jul 1', value: 51, target: 50, unit: 'units' }, { day: 'Jul 7', value: 29, target: 50, unit: 'units' }, { day: 'Jul 8', value: 0, target: 50, unit: 'units' }, { day: 'Jul 9', value: 0, target: 50, unit: 'units' }, { day: 'Jul 10', value: 0, target: 50, unit: 'units' }, { day: 'Jul 13', value: 29, target: 50, unit: 'units' }, { day: 'Jul 14', value: 49, target: 50, unit: 'units' }, { day: 'Jul 15', value: 35, target: 50, unit: 'units' }, { day: 'Jul 16', value: 35, target: 50, unit: 'units' }, { day: 'Jul 17', value: 25, target: 50, unit: 'units' }, { day: 'Jul 18', value: 0, target: 50, unit: 'units' }, { day: 'Jul 20', value: 21, target: 50, unit: 'units' }, { day: 'Jul 21', value: 25, target: 51, unit: 'units' }, { day: 'Jul 22', value: 39, target: 51, unit: 'units' }, { day: 'Jul 23', value: 28, target: 51, unit: 'units' }, { day: 'Jul 24', value: 30, target: 52, unit: 'units' }, { day: 'Jul 27', value: 0, target: 55, unit: 'units' }, { day: 'Jul 28', value: 30, target: 56, unit: 'units' }, { day: 'Jul 29', value: 35, target: 57, unit: 'units' }, { day: 'Jul 30', value: 30, target: 59, unit: 'units' }, { day: 'Jul 31', value: 40, target: 59, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 31 field start', minimum: '4,103 modules/day (required for Sep 6)', above: 1, below: 22, latest: 'Jul 31: 4,136 (Workforce 2,036 + Brumont 2,100) — FIRST DAY ABOVE RATE', note: 'THE FIRST DAY THE MODULE FRONT HAS EVER BEATEN ITS REQUIRED RATE: 4,136 vs 4,104. Both crews cleared 2,000 for the first time; Brumont re-manned 14 to 20. Productivity 84.4 modules per installer, up from 73.4 — at the ceiling Jose called realistic. Every module again went into Zone E, which has no QA release of any kind.', daily: [{ day: 'Jul 3', value: 234, target: 3738, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 3738, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 3738, unit: 'modules' }, { day: 'Jul 8', value: 936, target: 3738, unit: 'modules' }, { day: 'Jul 9', value: 1308, target: 3738, unit: 'modules' }, { day: 'Jul 10', value: 1802, target: 3738, unit: 'modules' }, { day: 'Jul 11', value: 517, target: 3738, unit: 'modules' }, { day: 'Jul 13', value: 2922, target: 3738, unit: 'modules' }, { day: 'Jul 14', value: 2335, target: 3738, unit: 'modules' }, { day: 'Jul 15', value: 780, target: 3738, unit: 'modules' }, { day: 'Jul 16', value: 858, target: 3738, unit: 'modules' }, { day: 'Jul 17', value: 2226, target: 3738, unit: 'modules' }, { day: 'Jul 18', value: 0, target: 3738, unit: 'modules' }, { day: 'Jul 20', value: 3601, target: 3738, unit: 'modules' }, { day: 'Jul 21', value: 3082, target: 3754, unit: 'modules' }, { day: 'Jul 22', value: 2887, target: 3776, unit: 'modules' }, { day: 'Jul 23', value: 3456, target: 3776, unit: 'modules' }, { day: 'Jul 24', value: 3134, target: 3785, unit: 'modules' }, { day: 'Jul 27', value: 0, target: 3908, unit: 'modules' }, { day: 'Jul 28', value: 3100, target: 4020, unit: 'modules' }, { day: 'Jul 29', value: 3109, target: 4047, unit: 'modules' }, { day: 'Jul 30', value: 3158, target: 4104, unit: 'modules' }, { day: 'Jul 31', value: 4136, target: 4104, unit: 'modules' }] },
      { task: 'ITS MV plowing', period: 'Jun 17-Jul 17', minimum: '1 completed segment/day', above: 11, below: 18, latest: 'Jul 31: 0 segments and 0 ft plowed — whole crew on MVHB-12', note: 'Plowing holds 36/46 (120,738 ft) — FOUR straight days with no segment closed, and the ITS sheet records zero plowed footage for the week.', daily: [{ day: 'Jun 17', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 18', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 19', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 20', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 21', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 22', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 23', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 24', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 25', value: 3, target: 1, unit: 'seg' }, { day: 'Jun 26', value: 4, target: 1, unit: 'seg' }, { day: 'Jun 27', value: 1, target: 1, unit: 'seg' }, { day: 'Jun 28', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 29', value: 2, target: 1, unit: 'seg' }, { day: 'Jun 30', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 1', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 2', value: 1, target: 1, unit: 'seg' }, { day: 'Jul 6', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 7', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 8', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 9', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 10', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 11', value: 1, target: 1, unit: 'seg' }, { day: 'Jul 13', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 14', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 15', value: 3, target: 1, unit: 'seg' }, { day: 'Jul 16', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 17', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 27', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 28', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 29', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 30', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 31', value: 0, target: 1, unit: 'seg' }] },
      { task: 'ITS HDD boring', period: 'Jul 2-Jul 20 measured days', minimum: '1 completed bore/day', above: 4, below: 12, latest: 'Jul 31: no bore closed and 0 ft recorded; MVHB-12 still open, committed to Sunday', note: 'MVHB-12 is being drilled slowly on purpose to avoid a frack-out on the wetland crossing. MV bores hold 17/20 for a fourth day.', daily: [{ day: 'Jul 2', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 6', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 7', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 8', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 9', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 10', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 11', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 13', value: 2, target: 1, unit: 'bores' }, { day: 'Jul 14', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 15', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 16', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 17', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 20', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 27', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 28', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 29', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 30', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 31', value: 0, target: 1, unit: 'bores' }] }
    ],
    successors: [
      ...
      { activity: 'Commissioning and MC', dependency: 'Continuous mechanical completion by zone', impact: 'On the re-cascaded dates (trackers Aug 30, modules Sep 6, LV/DC Sep 18) the Sep 25 MC target is achievable with limited float; pre-commissioning Sep 14 - Oct 15 protects the Oct 16 PIS.', mitigation: 'Convert the 98 open step-3 rows into completions, close the last 2,674 piles by ~Aug 7, HOLD the module rate now that it has been reached, and prepare weekend/OT acceleration. Saturdays remain mandatory.' }
    ],
    schedule: [
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 91.5, baseline: 48.4, note: '2,674 piles remain (28,678 executed — workbook roll-up 26,736 + 1,942 field logs Jul 28-31); ~Aug 7 finish needs 446/day over 6 working days. Jul 31: 337 — United, all Zone G, back under rate after 539 and 627. ECCS moved its whole crew to trackers; Latnovva filed refusal work with no count and Zone B is still 36 from close. Levers: the Zone G change-order signature, Saturday work, and now the GameChange pile short-shipment count.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS / United / Workforce', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', progress: 42.4, baseline: 0, note: 'Jul 31: ECCS closed 40 rows in Zone E, its best day since Jul 14, and its open-row snapshot fell 28 to 10 — the WIP converted. United and Workforce closed NOTHING: 68 Zone F rows and 20 Zone EW rows sit at step 3 of 5, four days without a single completion between them. 986 done / 296 CLIENT-released / 492 Greensol-approved (no QA cut filed Jul 31). Client acceptance exists only in Zone A. Both release AND the two non-closing crews now control the module front.' },
      { activity: 'ITS HDD boring', contractor: 'ITS', start: '2026-06-12', end: '2026-08-15', status: 'Active', progress: 85, baseline: 0, note: 'Jul 31 ITS control: MV 17 of 20 bores complete (85%, 5,462 ft) with ZERO ft recorded for the day and for the week, MVHB-12 still open and committed to Sunday (slowed deliberately to avoid a frack-out), 2 pending; DC cable-duct bores 3 of 14 COMPLETE (647 LF). Second, larger drill on site — two rigs from Jul 24 (one DC, one MV wetlands). EGLE denied swapping the remaining bores for plowing (Jul 17) — the last continue with ~100 ft extensions each past the wetland.' },
      ...
      { activity: 'Final module installation completion', contractor: 'Workforce / Brumont', start: '2026-07-03', end: '2026-09-06', status: 'Critical', progress: 25.8, baseline: 0, note: 'Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. 44,283 executed (25.8%); 4,103/day now required over 31 working days. JUL 31 WAS THE FIRST DAY AT OR ABOVE RATE — 4,136, with both crews over 2,000 for the first time and Brumont re-manned from 14 to 20. The Brumont re-manning and the productivity step from 73.4 to 84.4 modules per installer are exactly what closed the gap.' },
      { activity: 'DC Wire / LV Installation', contractor: 'East Carolina + Self-Perform', start: '2026-07-07', end: '2026-09-18', status: 'Critical', progress: 2.5, baseline: 0, note: 'Aerial messenger-wire harness / BLA-style install from tracker rows to junction boxes. Total pull 274,720 lf (0% done). Jul 21: United drove the FIRST LV support piles — 13 combiner-box (CB) + 32 tensioning/messenger-wire (TP) piles in Zone F (tracked separately from the 31,352 tracker piles). NOW MATERIAL-GATED: Chemik LV cable/harness finishes production ~Aug 7; sea transit 5-6 wks lands it mid-late Sept, incompatible with Sep 25 MC. Greening escalating for AIR freight to land material before end of August. Cable-pull kick-off Jul 21 on partial air deliveries.' },
    ...
    resourcePlan: [
      ...
      { label: 'Module full-field crew', actual: 48, committed: 48, target: 40, targetLabel: '40 by Jul 13+', note: 'Jul 31: Workforce 29 + Brumont 20 = 49 installers delivered 4,136 modules against 4,103 required — THE RATE WAS MET. Productivity 84.4 modules per installer, up from 73.4 and 70.7 on the two previous days, which is at the ceiling Jose called realistic. The earlier arithmetic that 56 installers were needed assumed 73.4/person; at 84.4 the current 49 are enough. The risk is now retention of these two crews, not recruitment of a third.' },
    ...
    milestones: [
      { name: 'Mechanical Completion', target: 'Sep 25, 2026', forecast: 'Sep 20-25, 2026', status: 'High', note: 'Re-cascaded dates (trackers Aug 30, modules Sep 6, LV/DC Sep 18) keep MC on the Sep 25 target. MODULES CAME OFF THE EXPOSURE LIST ON Jul 31 — 4,136 against 4,103/day required, the first day at rate. Piles are close behind (446/day over 6 working days, subject to the GameChange short-shipment count). The exposure is now TRACKERS at 40 vs 60/day with client release stuck at 296 of 986 built and two of three crews closing nothing, and LV still at 0 lf against 6,541/day.' },
    ...
    risks: [
      { title: 'Tracker closure \u2014 two of three crews at zero', level: 'Critical', owner: 'Manuel Ramirez | United | Workforce', note: 'United 68 open rows in F, Workforce 20 in EW \u2014 <strong>no row closed in four days</strong>. All at step 3 of 5. ECCS is the only crew converting (40 closed Jul 31). Need <strong>60 rows/day</strong> for Aug 30.' },
      ...
      { title: 'Modules running ahead of QA release', level: 'Critical', owner: 'Daniel Morilla | Maurin Moure', note: '<strong>~375 rows</strong> carry modules with no client acceptance, growing ~63/day now the crews are at rate. Damper change-out is the stated blocker. Combined racking+module inspection proposal still unanswered.' },
      { title: 'Chemik LV material \u2014 critical path to energization', level: 'Critical', owner: 'Luis Romero | Clara Lopez', note: 'Air freight agreed Jul 28; Chemik still owes arrival dates. <strong>0 lf placed against 6,541 lf/day</strong> required for Sep 18. Boxes moved to 103/419 and the crew says it is <strong>ready to pull Sat Aug 1</strong> — the first measured foot is the number to chase.' },
      { title: 'Substation structural steel', level: 'Critical', owner: 'Axel Cano | Joshua Spalding', note: 'Greensol formally rejected the AB Powers delivery programme Jul 30; revised one owed. Piers close Tue Aug 4 \u2014 after that <strong>steel is the only outstanding item</strong>. Time the escalation to that date.' },
      { title: 'MV coupling lead times', level: 'Critical', owner: 'Axel Cano | Procurement', note: '<strong>~40 weeks</strong> from every supplier contacted. Emergency sourcing plan (incl. Europe / air) still owed. 138 MV terminations sit at zero.' },
      ...
      { title: 'Piles back under rate', level: 'High', owner: 'Audelio Zuniga | United | Latnovva', note: 'Jul 31: <strong>337 vs 446/day</strong> needed. Only United filed a number \u2014 ECCS went to trackers, Latnovva filed refusal work with no quantity. Zone B still 36 piles from close.' },
      ...
      { title: 'ITS \u2014 fourth day at zero', level: 'Watch', owner: 'Angel Urbina | ITS', note: '0 ft bored and 0 ft plowed for the day and the week. MVHB-12 slowed deliberately to avoid a frack-out (correct practice) \u2014 but the plow machine is idle with <strong>10 segments open</strong>. Split the crew Monday.' },
      ...
      { title: 'Tracker and pile scope adjustments', level: 'Watch', owner: 'Luis Romero | Audelio Zuniga', note: 'Remaining 10 MW pulled from Workforce; United holds full mechanical in F and G. Missing piles: Plan B is doubling smaller sections or concrete reinforcement.' }
    ]
  };
