...
// CACHE BUSTER: Jul 18, 2026 (rev2) — Jul 17 production; ECCS off 3pm from Canadian wildfire smoke (statewide AQ alert since Jul 14, force majeure under review)
...
window.MURCH_DATA = {
    ...
    weeklyPlan: [
      { area: '<u>Tracker completion and QA release — Zones C / A / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: 'THE controlling front this week. 708 rows done (235 QA-released, 473 pending) of 2,486. ECCS logged 25 rows Jul 17 (60 people) after Tuesday’s 49 — Jose: recover numbers tomorrow. Brumont moved into Zone C against only 13 QA-released rows, and the released buffer ahead of the module crews is only ~1.3 days. Break the QA freeze (still nothing released Jul 10-15) and convert Zone C rows into released workfront ahead of the module crew.', minimum: '>= 49 completed rows/day required to hold Aug 30 (1,778 rows / 36 working days). Rate hit once (49 Tue), missed Wed (35) — hold and exceed it. QA: Daniel targeting sign-off next Monday; the field cumulative (708) is under reconciliation against the workbook TRACKER table (583).', gate: 'QA turnover of finished rows, not assembly. OPEN ACTION: some Area F zones were released internally without the subcontractor submitting quality documents — recover those documents this week.', owners: 'ECCS | Daniel Morilla (QA/QC) | Audelio Zuniga | Manuel Ramirez' },
      { area: '<u>Pile production — rig availability, Zones B / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: '7,362 piles remain to the Jul 28 gate (23,990 of 31,352 executed, 76.5%). Jul 17: 472 (United 368 + ECCS 19 + Latnovva 85) — United ran 4 of 6 rigs, Latnovva 2. The fleet is degrading, not recovering. Get the broken rigs back immediately to hold the gate.', minimum: '>= 920 piles/day (7,362 over 9 remaining working days, Mon-Sat) — far above the ~560/day crew capacity. Every sub-800 day pushes Jul 28 further out.', gate: 'Rig repairs are the binding constraint — United ran 4 of 6 and Latnovva 2 of 2 on Jul 16 (2 United rigs damaged). Material is no longer a restriction: 28,343 piles delivered, a 4,353-unit buffer (~5.5 days at the required rate).', owners: 'United / LATNOVVA | Audelio Zuniga | Manuel Ramirez | Joshua Spalding' },
      { area: '<u>Module installation ramp — Zone A into Zone C</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: 'After 2,922 Monday and 2,335 Tuesday, Jul 17: 2,226 (Brumont 1,290 + Workforce 936). 14,620 of 171,470 executed (6.7%). Jose: recover numbers Thursday. Brumont is in Zone C.', minimum: '>= 3,000 modules/day with both crews once cleanup is done; ~3,735/day required to hold the Sep 6 finish, ramping toward the 5,531/day full-field rate.', gate: 'QA-released tracker rows — the released buffer ahead of the crews is only ~1.3 days, so any tracker-QA miss stalls modules regardless of crew size. Module-spacing QC control (Golden Row slot-tolerance finding) stays in force.', owners: 'Workforce / Brumont | Audelio Zuniga | Daniel Morilla (QA/QC) | Manuel Ramirez' },
      ...
      { area: '<u>LV electrical installation — Chemik material-gated</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: 'Cable-pull kick-off Tuesday Jul 21 at the electrical meeting, using the first Chemik air deliveries. Total LV pull is 274,720 lf (Homerun 229,435 + Chemik trunk 40,313 + harness 4,972), all at 0%. ECCS awarded 11 of 23 inverters (the other 12 pending — United bid or Greensol self-perform, decision Wed Jul 22; Messenger Wire KOM Jul 21). To finish by the Sep 18 DC/LV close from a Jul 21 start needs ~5,283 lf/day (~4,412 homerun); but bulk Chemik material finishes production ~Aug 7 and by sea lands mid-late Sept, so unless it moves by AIR the window compresses and the required rate climbs to ~12,000-17,000 lf/day.', minimum: 'Start Chemik trunk (>= 775 lf/day) on the arriving air shipments (PL_260601/260709 ETA Jul 23); ramp homerun as cable lands and module blocks release; hold >= 4,400 lf/day homerun once material is continuous.', gate: 'ALL remaining Chemik packages to be AIR-FREIGHTED (project decision Jul 17) and on site before end of August — sea (production ~Aug 7 + 5-6 wks) cannot meet the milestones. Only 18% of 3-string harness shipped; rest not built until Jul 24. Then released module blocks + ECCS/East Carolina crew size.', owners: 'ECCS (11 inv) | East Carolina | Greensol Self-Perform | Luis Romero Montero | Joshua Spalding | Clara Lopez' },
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', progress: 90, baseline: 55, note: 'Consolidated delivery line; final tracker-post containers slipped to a 7/14 port arrival, so post deliveries complete the week of 7/20 (node controllers Monday). Site pile stock: 28,343 delivered vs 23,990 executed — 4,353-pile buffer (~5.5 days at the 920/day required rate). Receiving cap 14 pile + 8 racking loads/day; loads count as scheduled until POD/site receipt.' },
