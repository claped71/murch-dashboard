...
// CACHE BUSTER: Jul 30, 2026 (Thu) EOD - piles 28,285 (90.2%) / trackers 946 built (38.1%), 296 CLIENT-released / modules 40,147 (23.4%). Jul 30 field: United 451 piles Zone G (best United day, ABOVE the 438/day rate) + ECCS 120 Zone E = 571; ECCS 30 rows closed Zone E; WF panels 1,749 (E3/E4) + Brumont 1,409 (E1) = 3,158 modules; ECCS-elec 22 LBDs -> 78/419; WF racking 0 rows closed (EW, 3rd day). LATNOVVA STILL FILED NO LOG (9 people on the board). PILE STOCK EXHAUSTED: 58 above executed. WIP SNAPSHOT RULE ADOPTED: a reported count of unfinished trackers is a photograph of open rows, never added to earlier days (United Zone F 82 -> 35). Modules: DELIVERY COMPLETE 171,470/171,470.
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 30, 2026',
      piles:    { installed: 28285, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 3067, capacity: null, name: 'Piles', unit: 'piles/day' },
      trackers: { installed: 946, released: 296, releasedGS: 492, total: 2486, gate: '2026-08-30', gateLabel: 'Aug 30', required: 59, capacity: 48, name: 'Trackers incl. purlins', unit: 'rows/day', wipRows: 83, wipEquivalent: 38.9, earnedEquivalent: 984.9, earnedPct: 39.6, earnedBasis: '5-step weighted ladder (adopted Jul 30, 2026)', releaseBasis: 'RELEASED = CLIENT-approved (Heelstone) per the Jul 30 QA sheet. Greensol-approved is carried separately as releasedGS.' },
    ...
    manpowerNote: 'Jul 30 site board = 253 (Jul 29: 248). ECCS 66 (53 trackers + 13 LV) - United 55 - Workforce 48 - GreenSol 20 (carried forward, card left blank on the board) - Brumont 19 - ITS 13 - Latnovva 9 - ABPower 8 - Dig It 5 - Topland 4 - Hi Tech 3 - Kalamazoo 2 - SWCA 1. Crane 2 is equipment, not headcount. PRODUCTION WAS FILED FOR ONLY ~190 OF THE 253 PEOPLE ON SITE: the United report of 451 piles and 35 open racking rows arrived late in the day; LATNOVVA (9 people) STILL FILED NOTHING, and ABPower, Dig It, Topland, Hi Tech, Kalamazoo and SWCA filed nothing at all. Missing output is a reporting failure, not a zero-production day.',
    contractorScore: [
      ...
      { date: 'Jul 30 Thu', contractor: 'United', trade: 'Piles + Racking', output: 451, resource: '55 people - 451 piles all Zone G (now 2,028 / 60.4%); racking: 35 rows standing unfinished in Zone F', perUnit: 451, criterion: 438, critLabel: 'ABOVE RATE - best United day of the project in the hard Zone G ground, and 451 against the 438/day now needed to hold ~Aug 7. Racking: the 35 unfinished rows are a SNAPSHOT of open rows, not an addition to the 82 reported Jul 29; no row has been reported complete, so 47 rows have left the open register unexplained.' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (28,285 executed, 90.2%), GameChange SAT tracker assembly incl. purlins (946 done, 38.1% — 296 client-released, 492 Greensol-approved), and module placement (40,147 executed, 23.4%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      ...
      { area: '<u>Pile production — B / F / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '28,285 / 31,352 (90.2%) — 3,067 left. Close B (36), F (11) and E (224); G 438+/day on hard ground (1,779); D opens ~Aug 5-7.',
    ...
    contractors: [
      ...
      { name: 'United', scope: 12630, installed: 9675, remaining: 2955, done: 76.6, zones: 'Zones D + F + G + the non-ECCS Zone E remainder', status: 'Active', note: 'Jul 30: 55 people, 451 piles all Zone G -> 9,675, the best United day of the project. Racking snapshot: 35 Zone F rows standing unfinished, no row reported complete. Carries 2,955 remaining piles: G 1,328, D 1,468, E 148 and the last 11 in F. Zone D opens ~Aug 5-7.' },
      { name: 'Project Total', scope: 31352, installed: 28285, remaining: 3067, done: 90.2, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 28,285 (90.2%) — Jul 28 workbook roll-up 26,736 + 1,549 field-reported over Jul 28-30. Jul 30 = 571 (United 451 Zone G + ECCS 120 Zone E), ABOVE the 438/day required rate. LATNOVVA STILL FILED NO LOG with 9 people on the board, so Zone B is missing from this total. 3,067 remain — but only 58 piles of delivered stock stand above executed, so delivery now decides the finish, not the crews." }
    ],
    zones: [
      ...
      { zone: 'Zone F', contractor: 'United (racking ramp)', scope: 595, installed: 0, released: 0, releasedGS: 0, remaining: 595, done: 0, wipRows: 35, wipStep: 1, wipEquiv: 5.25, earnedPct: 0.9, status: 'Mobilizing', note: 'Jul 30 SNAPSHOT: 35 rows standing unfinished. A partial-row report is a photograph of the open rows, not an addition to the 82 reported Jul 29 — so the open register is 35, not 117. Still ZERO rows reported complete, so 47 rows have left the register with no completion filed; query United before assuming they closed.' },
      ...
      { zone: 'TOTAL', contractor: 'All tracker crews', scope: 2486, installed: 946, released: 296, releasedGS: 492, remaining: 1540, done: 38.1, wipRows: 83, wipStep: null, wipEquiv: 38.9, earnedPct: 39.6, status: 'Critical', note: '946 built (38.1%) · RELEASE RE-BASED Jul 30 to the CLIENT-approved column: 296 accepted by Heelstone (11.9%), 492 approved by Greensol, 650 built rows with no client acceptance · 83 rows in progress worth 38.9 row-equivalents -> 984.9 earned (39.6%) · 59 completed rows/day required for Aug 30. Open rows are a SNAPSHOT per crew, never cumulative.' }
    ],
    ...
    pilesByZone: [
      ...
      { zone: 'Zone G', contractor: 'United', scope: 3356, installed: 2028, remaining: 1328, done: 60.4, status: 'Active', note: 'Jul 30: +451 (55 people) — the best United day of the project and above the required rate despite the hard ground. Zone G has gone 47.0% to 60.4% in two days. Signed ChO still owed for full release.' },
      ...
      { zone: 'TOTAL', contractor: 'All pile crews', scope: 31352, installed: 28285, remaining: 3067, done: 90.2, status: 'Critical', note: '28,285 executed (90.2%) — Jul 30: 571 (United 451 Zone G + ECCS 120 Zone E), ABOVE the required rate. Latnovva still filed no log with 9 people on the board, so Zone B has no Jul 30 figure. 3,067 remain; 438/day over the 7 working days to Aug 7. DELIVERY, NOT PRODUCTION, IS NOW THE CONSTRAINT — only 58 piles of stock remain above executed.' }
    ],
    modulesByZone: [
    ...
    projectTotal: {
      ...
      components: [
        { name: 'Piles', weight: 28, gate: 90.2, earned: 90.2 },
        { name: 'Trackers', weight: 22, gate: 38.1, earned: 39.6 },
    ...
    earnedMethod: {
      ...
      scopes: [
        { scope: 'Piles', instrument: 'Atomic unit count', gate: '28,285 / 31,352 = 90.2%', earned: 'n/a — no intermediate state', note: 'Driven or not driven. Pull tests and inspection are QA gates, not construction steps.' },
        ...
        { scope: 'Tracker rows', instrument: '5-step weighted ladder', gate: '946 / 2,486 = 38.1%', earned: '984.9 equivalents = 39.6%', note: 'See trackerWip. 136 rows open across three zones.' },
    ...
    trackerWip: {
      ...
      items: [
        ...
        { zone: 'Zone F', contractor: 'United (racking)', rows: 35, stepReached: 1, stepName: 'Bearings / saddles set on piles', pctStep: 15, equiv: 5.25, pctReported: null, note: 'Jul 30 SNAPSHOT: 35 rows standing unfinished, down from the 82 reported Jul 29. Per the snapshot rule this REPLACES the 82 rather than adding to it. No row has been reported complete, so the 47-row drop is unexplained and must be queried before any completion is credited. Step not stated in the Jul 30 report; carried at step 1 on the Jul 29 evidence.' }
      ],
      steps: [
      ...
      rule: 'TWO MEASURES, NEVER MIXED. (1) GATE / CONTRACT MEASURE — a tracker row counts at 100% only, purlins included: 946 of 2,486 (38.1%). This is the only figure that drives the Aug 30 gate, the S-curves, the module release and any client or Heelstone submission. Partial rows earn NOTHING here. (2) PRODUCTIVITY MEASURE — row-equivalents earned per subcontractor per day, so a day of genuine work never scores as zero: 83 rows are open across three zones, worth 38.9 row-equivalents on the step ladder, putting earned progress at 39.6% against the 38.1% gate figure. OPEN-ROW COUNTS ARE SNAPSHOTS PER CREW, never cumulative across days. Report both, labelled, side by side.',
      reportingRule: 'ADOPTED Jul 30, 2026 (Jose): partial tracker rows are reported by STEP REACHED, not by a percentage. Each daily block gives, per zone, the number of rows sitting at each step of the 5-step ladder; the equivalents are derived from the fixed weights above. Every step is a physically verifiable state a superintendent can confirm in one pass, so the figure is auditable and cannot drift backwards. A row leaves this register the moment it is credited complete — no double counting. AND (Jose, Jul 30) A REPORTED COUNT OF UNFINISHED ROWS IS A SNAPSHOT OF THE TOTAL PARTIAL ROWS STANDING FOR THAT CREW, NOT AN INCREMENT: it replaces the previous open figure and is never added to earlier days. QA release is NOT a step: release is a separate gate applied only to finished rows. On the ladder the current 83 open rows are worth 38.9 equivalents against 44.6 under the old free-text percentages — that 12% gap is the optimism the previous method carried.'
    },
    production: [
      { name: 'Project pile installation', remaining: '3,067 piles', target: 'Floor 438/day holds ~Aug 7 (3,067 remain, 7 working days)', latest: 'Jul 30: 571 (United 451 Zone G + ECCS 120 Zone E) — ABOVE RATE. Jul 29: 539', cumulative: '28,285 / 31,352 executed (90.2%) — workbook roll-up 26,736 + 1,549 field (Jul 28-30)', status: 'Critical', note: 'SECOND CONSECUTIVE DAY ABOVE THE REQUIRED RATE — 571 against 438, and Zone G has gone 47.0% to 60.4% in two days on the hard ground. Latnovva still filed nothing with 9 people on the board, so Zone B (36 from close) is missing. THE CONSTRAINT HAS MOVED TO DELIVERY: 28,343 delivered against 28,285 executed leaves 58 piles of stock, a few hours of production. Without receipts the crews stop regardless of rate.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the install burn to zone close', latest: 'Jul 28 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; ONLY 58 available above the 28,285 executed', status: 'Critical', note: 'STOCK IS EFFECTIVELY EXHAUSTED. 28,343 delivered against 28,285 executed leaves 58 piles — a few hours of work at the 438/day required rate, against 3,067 still to drive. No receipt has been reported since the Jul 28 workbook. This is now the single binding constraint on the pile gate: the crews proved the rate on Jul 30 and will stop for want of material, not capacity. Escalate receipts today.' },
    ...
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 28 measured days', minimum: '438 piles/day floor holds ~Aug 7 (3,067 left over 7 working days from Jul 31)', above: 2, below: 31, latest: 'Jul 30: 571 (United 451 Zone G + ECCS 120 Zone E) — above rate', note: 'SECOND STRAIGHT DAY ABOVE THE REQUIRED RATE: 571 vs 438. Zone G 47.0% to 60.4% in two days. Latnovva still filed nothing with 9 people on the board, so Zone B is missing. E 224 from close; F 11 from close; D opens ~Aug 5-7. THE BINDING ISSUE IS NOW STOCK: 58 piles remain above executed.', daily: [{ day: 'Jun 18', value: 20, target: 1022, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 1022, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 1022, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 1022, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 1022, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 1022, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 1022, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 1022, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 1022, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 1022, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 1022, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 1022, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 1022, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 1022, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 1022, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 1022, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 1022, unit: 'piles' }, { day: 'Jul 16', value: 504, target: 1022, unit: 'piles' }, { day: 'Jul 17', value: 472, target: 1022, unit: 'piles' }, { day: 'Jul 18', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 20', value: 622, target: 1022, unit: 'piles' }, { day: 'Jul 21', value: 253, target: 1176, unit: 'piles' }, { day: 'Jul 22', value: 202, target: 1419, unit: 'piles' }, { day: 'Jul 23', value: 284, target: 1419, unit: 'piles' }, { day: 'Jul 24', value: 364, target: 1349, unit: 'piles' }, { day: 'Jul 25', value: 236, target: 1677, unit: 'piles' }, { day: 'Jul 27', value: 0, target: 2397, unit: 'piles' }, { day: 'Jul 28', value: 439, target: 462, unit: 'piles' }, { day: 'Jul 29', value: 539, target: 464, unit: 'piles' }, { day: 'Jul 30', value: 571, target: 438, unit: 'piles' }] },
    ...
    schedule: [
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 88.4, baseline: 48.4, note: '3,067 piles remain (28,285 executed — workbook roll-up 26,736 + 1,549 field logs Jul 28-29); ~Aug 7 finish needs 455/day over 8 working days. Jul 29: 539 — United 361 Zone G (55 people) + Latnovva 178 Zone B (back on site, 2 rigs, covers Jul 28-29) — the first day over the required rate since the weather stop. Zone B is 36 from close. Levers: pile stock buffer down to 629, the Zone G ChO signature, and Saturday work.' },
    ...
    todayFieldSnapshot: {
      ...
      rows: [
        ...
        { contractor: 'UNITED', people: 55, category: 'pile', note: 'Up from 44 — split between Zone G pile driving (451 on Jul 30, above rate) and the Zone F racking ramp (35 rows standing open).' },
    ...
    risks: [
      ...
      { title: 'PILE STOCK IS EXHAUSTED — 58 piles above executed, and the crews just proved the rate', level: 'Critical', owner: 'Audelio Zuniga / Procurement / GameChange / Luis Romero Montero', note: 'Jul 30 was the second consecutive day above the required rate: 571 piles (United 451 in Zone G at 55 people, the best United day of the project, plus ECCS 120 in Zone E) against 438/day needed to hold ~Aug 7. Zone G went 47.0% to 60.4% in two days on ground that was capping the rate a week ago. THAT MAKES DELIVERY THE ONLY REMAINING CONSTRAINT: 28,343 piles delivered against 28,285 executed leaves 58 in stock, a few hours of production, with 3,067 still to drive and no receipt reported since the Jul 28 workbook. The crews will stop for want of material, not capacity — escalate receipts today. Latnovva remains a separate problem: 9 people on the board on Jul 30 and no production log filed for a second front that is 36 piles from closing Zone B.' },
