...
// CACHE BUSTER: Jul 20, 2026 — weekly-plan review (week of Jul 20); no new production file, basis holds at Jul 17; pile gate Jul 28 now unrecoverable (~1,050/day needed vs ~560 cap), slips to early Aug; QA release still binds modules
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 17, 2026',
      piles:    { installed: 23990, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 920, capacity: null, name: 'Piles', unit: 'piles/day' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (23,990 executed, 76.5%), GameChange SAT tracker assembly incl. purlins (708 done, 28.5% — 235 QA-released, 473 pending Quality), and module placement (14,620 executed, 8.5%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      { area: '<u>Tracker completion and QA release — Zones C / A / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: 'THE controlling front for the week — it sets the ceiling on the module crews. 708 rows done (235 QA-released, 473 pending Quality) of 2,486 (28.5%). The QA-released buffer ahead of Brumont/Workforce is only ~68 rows / ~1.3 days, so releases — not assembly — govern modules. Break the QA freeze (nothing released Jul 10-17) and convert the Zone C pending rows into released workfront this week.', minimum: '>= 49 completed rows/day to hold Aug 30 (1,778 rows over 36 working days, Mon-Sat). ECCS has peaked at 49 once and run 25-35 since — hold and beat it. QA is the real floor: Daniel’s sign-off was due Monday Jul 20 — clear the 473-row pending backlog this week or modules stall regardless of assembly.', gate: 'QA turnover of finished rows, not assembly rate. Carried-over action: some Area F zones were released internally without the subcontractor’s quality documents — recover those documents this week. Field cumulative (708) still under reconciliation vs the workbook TRACKER table (583).', owners: 'ECCS | Daniel Morilla (QA/QC) | Audelio Zuniga | Manuel Ramirez' },
      { area: '<u>Pile production — rig availability, Zones B / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: '7,362 piles remain to the Jul 28 gate (23,990 of 31,352 executed, 76.5%). At ~560/day crew capacity only ~3,900 more are physically possible before Jul 28 — the pile gate is now unrecoverable and slips to ~early August (≈ Aug 4-5 at the current fleet) unless the broken rigs return. Jul 17 ran 472 (United 368 on 4 of 6 rigs + ECCS 19 + Latnovva 85 on 2 rigs); the fleet is degrading, not recovering.', minimum: 'Holding Jul 28 would need ~1,050 piles/day (7,362 over ~7 working days) — roughly 2x capacity. The realistic floor: get every rig running and sustain the fleet maximum daily, then re-baseline the pile finish to early August.', gate: 'Rig repairs are the binding constraint — United on 4 of 6 (2 damaged), Latnovva on 2. Material is not a restriction: 28,343 piles delivered, a 4,353-unit buffer.', owners: 'United / LATNOVVA | Audelio Zuniga | Manuel Ramirez | Joshua Spalding' },
      { area: '<u>Module installation ramp — Zones A / C</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: '14,620 of 171,470 executed (8.5%). Recent days: 2,922 (Jul 13 record), 2,335, then 2,226 on Jul 17 (Brumont 1,290 + Workforce 936); Brumont is working Zone C. Ramp both crews toward the required rate as QA releases rows.', minimum: '>= 3,735 modules/day required to hold the Sep 6 finish (156,850 over 42 working days), ramping toward the ~5,500/day full-field rate — but capped near ~3,000/day until the QA-released buffer (~1.3 days) widens.', gate: 'QA-released tracker rows — the ~1.3-day released buffer means any tracker-QA miss stalls modules regardless of crew size. Golden Row slot-tolerance QC control stays in force.', owners: 'Workforce / Brumont | Audelio Zuniga | Daniel Morilla (QA/QC) | Manuel Ramirez' },
      { area: '<u>LV electrical installation — Chemik air-freight gated</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: 'Cable-pull kicks off Tuesday Jul 21 at the electrical meeting on the first Chemik air deliveries. Total LV pull 274,720 lf (Homerun 229,435 + Chemik trunk 40,313 + harness 4,972), all at 0%. ECCS awarded 11 of 23 inverters; the other 12 pending (United bid or Greensol self-perform — decision Wed Jul 22; Messenger Wire KOM Jul 21). Start the Chemik trunk on arriving air shipments and stand up the crew.', minimum: 'Start Chemik trunk (>= 775 lf/day) on air shipments PL_260601/260709 (ETA Jul 23); ramp homerun (>= ~4,400 lf/day) as cable lands and module blocks release. Finishing the full pull by the Sep 18 DC/LV close needs ~5,300 lf/day; if bulk material slips to sea the required rate climbs to ~12,000-17,000 lf/day.', gate: 'ALL remaining Chemik packages must be AIR-FREIGHTED (project decision Jul 17) and on site before end of August — sea transit cannot meet the milestones. Only 18% of the 3-string harness has shipped; the rest is not built until Jul 24. Then released module blocks + ECCS / East Carolina crew size.', owners: 'ECCS (11 inv) | East Carolina | Greensol Self-Perform | Luis Romero Montero | Joshua Spalding | Clara Lopez' },
      { area: 'GameChange tracker-material deliveries', target: 'Final tracker-post containers had their port arrival pushed to 7/14, so post deliveries complete this week (week of 7/20); node controllers arrived Monday. Track the slip and confirm POD/site receipt for each load.', minimum: 'Receive up to 14 pile loads/day plus 8 racking loads/day if appointments and offloading hold; log receipts against the delivery control and flag the post slip to the tracker crews.', gate: 'Purlin and pile stock are comfortable; the tracker-post arrival is the item to watch against the Zone C/F assembly front. Loads count as scheduled until POD/site receipt.', owners: 'GameChange (Shreeya Devkota) | Manuel Ramirez | Karina Mucino' },
      { area: 'SET, inverter foundations and inverter arrival', target: 'SET at 11.8% overall (civil 44.9%, structural 5.7%). Close the last 4 inverter pile foundations — D10, E12, F16, G20 (190 of 230 piles, 82.6%) — before the end-July arrival of the 23 inverter units. AB Power has presented no work or material-delivery plan; Greensol is pulling partial scope to Michael Power and self-procuring material.', minimum: 'All 23 inverter foundations released before first delivery; hold the SET civil rate that lifted overall progress from 8.7% to 11.8% in a week.', gate: 'Transformer and structural steel remain in fabrication — the controlling items for energization. AB Power work-plan and material-delivery gaps must close.', owners: 'AB Power / Michael Power / SET team | Axel Cano | Joshua Spalding | Karina Mucino' },
      { area: 'Electrical MV plowing and HDD closeout', target: 'ITS is ahead of the electrical sequence: 36 of 46 plow segments complete (120,738 ft) and 16 of 20 bores closed (5,026 ft). Close the last 4 bores (~100 ft wetland extensions each) and the remaining 10 segments; keep MV11A / MV12A falling.', minimum: '>= 1 plow segment/day and >= 1 completed bore/day with measured-footage reporting (boring logged 0 ft Jul 13-15 — restore the cadence).', gate: 'Crossing approvals, access continuity and equipment availability. EGLE denied swapping the last bores for plowing, so the 4 bores continue as bores.', owners: 'ITS | Angel Urbina | Joshua Spalding' },
      { area: 'Civil Area G release and internal roads', target: 'Finish Area G basins, then start Area G cut/fill — Area G is released for pile driving and material distribution and is the next pile workfront (3,356 piles, 0 installed). Perimeter fence at 95.6% (only Zone G and gates remain); internal roads at 65.9%.', minimum: 'Daily confirmed grading production in Area G after basin closeout; keep roads easing as the logistics constraint.', gate: 'Basin completion controls Area G cut/fill; civil access, gates and drainage must stay ahead of the mechanical fronts.', owners: 'Lounsbury / Hurricane / Topland | Rosario Ruiz | Audelio Zuniga' }
    ],
    civilKpis: [
    ...
    contractors: [
      { name: 'LATNOVVA / assigned areas', scope: 15904, installed: 13786, remaining: 2118, done: 86.7, zones: 'Zones A, B, C, D, EW + shared Area E control (Zone G removed Jul 17)', status: 'Watch', note: "Area-based control allocation only; it is not a new manpower or subcontractor headcount report." },
      ...
      { name: 'United', scope: 11014, installed: 6089, remaining: 4925, done: 55.3, zones: 'Zones F + G', status: 'Active', note: 'Executed: 6,089 piles in Zone F (79.5% of F) — Jul 17: 364, United ran 4 of 6 rigs (2 damaged). Zone G (3,356 piles) newly transferred from Latnovva Jul 17, 0 started — combined F+G 55.3%. United now holds full mechanical (piles + trackers + modules) in F & G.' },
      { name: 'Project Total', scope: 31352, installed: 23990, remaining: 7362, done: 76.5, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 23,990 — official block-map 22,900 plus 1,090 field logs not yet mapped (mostly Zone B Latnovva). Jul 17: 472 (United 368 F + ECCS 19 E + Latnovva 85 B)." }
    ],
    zones: [
      ...
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 2214, remaining: 574, done: 79.4, status: 'Active', note: 'Executed: 2,214 (79.4%) — through Jul 17 (+85 Fri). Block-map still shows 1,457 here; Latnovva self-report leads. Latnovva ran 2 rigs Jul 16.' },
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 6089, remaining: 1569, done: 79.5, status: 'Active', note: 'Executed: 6,089 (79.5%) — through Jul 17 (+368 Fri). United ran 4 of 6 rigs Jul 16 (2 damaged) — rig repairs still the lever.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '7,362 piles', target: '~920 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 17 (Fri): 472 piles — United 368 (Zone F) + ECCS 19 (Zone E) + Latnovva 85 (Zone B)', cumulative: '23,990 / 31,352 executed (76.5%) — 22,900 official block-map + 1,090 field logs not yet mapped (Zone B Latnovva + Jul 16-17 production)', status: 'Critical', note: 'Executed 23,990 of 31,352 (76.5%). The official block-map roll-up is 22,900; field daily logs add 1,090 piles not yet mapped (mostly Zone B, where Latnovva self-reports lead the block map). Jul 16 produced 472 (United 368 Zone F, ECCS 19 Zone E, Latnovva 85 Zone B) — below the 920/day required over 8 working days to Jul 28. United ran 4 of 6 rigs, Latnovva 2; rig repairs remain the single biggest lever. ECCS pulled off site ~3pm Jul 17 due to Canadian (Ontario) wildfire smoke — a statewide Michigan air-quality alert (EGLE) has been in effect since Jul 14; masks distributed and force majeure under evaluation.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the 834 piles/day install burn', latest: 'Jul 15 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; 4,353 available above the 23,990 executed', status: 'On Track', note: 'Available stock equals delivered piles less executed piles — 4,353 units, about 5.5 days at the 920/day required rate. Delivery is no longer the pile-programme constraint.' },
      ...
      { name: 'Module installation', remaining: '156,850 modules', target: '3,735 modules/day required for Sep 6 (5,531/day full-field capacity)', latest: 'Jul 17 (Fri): 2,226 modules (Brumont 1,290 + Workforce 936)', cumulative: '14,620 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'Jul 17: Brumont 1,290 + Workforce 936 (record 2,922 on Jul 13, 2,335 on Jul 14). ~3,735/day now required. The binding constraint is QA-released tracker rows — the released buffer ahead of the module crews is only ~1.3 days. Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 17 measured days', minimum: '920 piles/day (required for Jul 28)', above: 0, below: 22, latest: 'Jul 17 (Fri): 472 piles — United 368 (Zone F, 4 of 6 rigs) + ECCS 19 (Zone E) + Latnovva 85 (Zone B, 2 rigs)', note: 'Jul 17 produced 472 piles (United 368 Zone F, ECCS 19 Zone E, Latnovva 85 Zone B) — still short of the 920/day single goal. (560/day is nominal crew capacity, not a target.) Executed 23,990 = official block-map 22,900 + 1,090 field logs not yet mapped (Zone B Latnovva self-report + the Jul 16 day).', daily: [{ day: 'Jun 18', value: 20, target: 920, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 920, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 920, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 920, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 920, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 920, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 920, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 920, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 920, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 920, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 920, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 920, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 920, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 920, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 920, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 920, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 920, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 920, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 920, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 920, unit: 'piles' }, { day: 'Jul 16', value: 504, target: 920, unit: 'piles' }, { day: 'Jul 17', value: 472, target: 920, unit: 'piles' }] },
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 17', minimum: '49 rows/day (required for Aug 30)', above: 4, below: 18, latest: 'Jul 17 (Fri): 25 rows in Zone C with 60 people — still below the 49/day required', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 708 rows — 235 released by Quality and 473 pending QA approval, still no new QA releases Jul 10-16 (Daniel targeting sign-off Mon Jul 20). The released-tracker buffer ahead of modules is only ~1.3 days. Cumulative is under reconciliation — the workbook TRACKER INSTALLATION table shows 583; Maurin walked all rows Jul 14 and Daniel is recounting.', daily: [{ day: 'Jun 17', value: 15, target: 49, unit: 'units' }, { day: 'Jun 18', value: 35, target: 49, unit: 'units' }, { day: 'Jun 19', value: 26, target: 49, unit: 'units' }, { day: 'Jun 20', value: 31, target: 49, unit: 'units' }, { day: 'Jun 21', value: 0, target: 49, unit: 'units' }, { day: 'Jun 22', value: 48, target: 49, unit: 'units' }, { day: 'Jun 23', value: 31, target: 49, unit: 'units' }, { day: 'Jun 24', value: 0, target: 49, unit: 'units' }, { day: 'Jun 25', value: 57, target: 49, unit: 'units' }, { day: 'Jun 26', value: 26, target: 49, unit: 'units' }, { day: 'Jun 29', value: 29, target: 49, unit: 'units' }, { day: 'Jun 30', value: 30, target: 49, unit: 'units' }, { day: 'Jul 1', value: 51, target: 49, unit: 'units' }, { day: 'Jul 7', value: 29, target: 49, unit: 'units' }, { day: 'Jul 8', value: 0, target: 49, unit: 'units' }, { day: 'Jul 9', value: 0, target: 49, unit: 'units' }, { day: 'Jul 10', value: 0, target: 49, unit: 'units' }, { day: 'Jul 13', value: 29, target: 49, unit: 'units' }, { day: 'Jul 14', value: 49, target: 49, unit: 'units' }, { day: 'Jul 15', value: 35, target: 49, unit: 'units' }, { day: 'Jul 16', value: 35, target: 49, unit: 'units' }, { day: 'Jul 17', value: 25, target: 49, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 17 field start', minimum: '3,735 modules/day (required for Sep 6)', above: 0, below: 12, latest: 'Jul 17 (Fri): 2,226 modules (Brumont 1,290 + Workforce 936)', note: 'Jul 17: Brumont 1,290 + Workforce 936. Record 2,922 on Jul 13. Still short of the single goal, 3,735/day required to hold Sep 6. (5,531/day is the full-field capacity, not a target.) Released tracker rows are the constraint — the buffer ahead of the crews is only ~1.3 days.', daily: [{ day: 'Jul 3', value: 234, target: 3735, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 3735, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 3735, unit: 'modules' }, { day: 'Jul 8', value: 936, target: 3735, unit: 'modules' }, { day: 'Jul 9', value: 1308, target: 3735, unit: 'modules' }, { day: 'Jul 10', value: 1802, target: 3735, unit: 'modules' }, { day: 'Jul 11', value: 517, target: 3735, unit: 'modules' }, { day: 'Jul 13', value: 2922, target: 3735, unit: 'modules' }, { day: 'Jul 14', value: 2335, target: 3735, unit: 'modules' }, { day: 'Jul 15', value: 780, target: 3735, unit: 'modules' }, { day: 'Jul 16', value: 858, target: 3735, unit: 'modules' }, { day: 'Jul 17', value: 2226, target: 3735, unit: 'modules' }] },
      { task: 'ITS MV plowing', period: 'Jun 17-Jul 17', minimum: '1 completed segment/day', above: 11, below: 14, latest: 'Jul 17 (Fri): no new segments reported (awaiting next ITS export) — 36 of 46 cumulative', note: 'Jul 15 ITS tracker: 36 of 46 segments complete (78.3%), 0 in progress. 120,738 ft installed. MV11A 7/10, MV11B 10/12, MV12A 10/13, MV12B 9/11.', daily: [{ day: 'Jun 17', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 18', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 19', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 20', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 21', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 22', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 23', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 24', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 25', value: 3, target: 1, unit: 'seg' }, { day: 'Jun 26', value: 4, target: 1, unit: 'seg' }, { day: 'Jun 27', value: 1, target: 1, unit: 'seg' }, { day: 'Jun 28', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 29', value: 2, target: 1, unit: 'seg' }, { day: 'Jun 30', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 1', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 2', value: 1, target: 1, unit: 'seg' }, { day: 'Jul 6', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 7', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 8', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 9', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 10', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 11', value: 1, target: 1, unit: 'seg' }, { day: 'Jul 13', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 14', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 15', value: 3, target: 1, unit: 'seg' }, { day: 'Jul 16', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 17', value: 0, target: 1, unit: 'seg' }] },
      { task: 'ITS HDD boring', period: 'Jul 2-Jul 17 measured days', minimum: '1 completed bore/day', above: 3, below: 8, latest: 'Jul 17 (Fri): no bores closed — 16 of 20 cumulative (80%); awaiting next ITS export', note: 'Jul 15 ITS tracker: 16 done / 0 in progress / 4 pending. 5,026 ft installed; 0 ft bored Jul 13-15. The last 4 bores remain.', daily: [{ day: 'Jul 2', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 6', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 7', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 8', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 9', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 10', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 11', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 13', value: 2, target: 1, unit: 'bores' }, { day: 'Jul 14', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 15', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 16', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 17', value: 0, target: 1, unit: 'bores' }] }
    ],
    successors: [
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', progress: 90, baseline: 55, note: 'Consolidated delivery line; final tracker-post containers slipped to a 7/14 port arrival, so post deliveries complete the week of 7/20 (node controllers Monday). Site pile stock: 28,343 delivered vs 23,990 executed — 4,353-pile buffer (~4 days at the ~1,050/day rate now needed to hold Jul 28). Receiving cap 14 pile + 8 racking loads/day; loads count as scheduled until POD/site receipt.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 76.5, baseline: 48.4, note: '7,362 piles remain (official block-map 22,900 + 1,090 field logs not yet mapped): holding July 28 would need ~1,050 piles/day vs ~560 crew capacity, so the gate is unrecoverable and slips to ~early August (≈ Aug 4-5). Jul 17: 472 (United 368 + ECCS 19 + Latnovva 85); United ran 4 of 6 rigs, Latnovva 2 — rig repairs remain the escalated lever.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', progress: 28.5, baseline: 0, note: 'Jul 17: 25 rows in Zone C with 60 people, below the 49/day required after Tuesday\u2019s 49 — 708 done / 235 QA-released / 473 pending QA (still no releases Jul 10-16). The released buffer ahead of modules is only ~1.3 days. Cumulative under reconciliation vs the workbook TRACKER table (583). Releasing the C rows is the controlling item for the module front.' },
      ...
      { activity: 'Final module installation completion', contractor: 'Workforce', start: '2026-07-03', end: '2026-09-06', status: 'Critical', progress: 7.2, baseline: 0, note: 'Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. 14,620 modules executed through Jul 17 (record 2,922 on Jul 13; Jul 17: 2,226 — Brumont 1,290 + Workforce 936); ~3,735/day now required — full-field production depends on released tracker rows (buffer ~1.3 days) and the module crew ramp.' },
    ...
    risks: [
      ...
      { title: 'Canadian wildfire smoke — statewide air-quality alert forcing crew stoppages', level: 'Watch', owner: 'EHS / Site Management / Greensol / Luis Romero', note: 'An active Canadian (Ontario) wildfire smoke event has put Michigan under a statewide air-quality alert (Michigan EGLE) since Jul 14. Air quality forced ECCS off site ~3pm Jul 17, shortening the tracker/Zone E pile day. Masks have been distributed and force majeure is under evaluation (Jul 17 procurement acta). Action: monitor daily AQI, document every smoke-related stoppage for a potential force-majeure / time-extension claim; expected to ease as the smoke event passes.' },
      ...
      { title: 'Rig availability, not delivery, now caps pile production', level: 'Critical', owner: 'United / LATNOVVA / Audelio Zuniga / Manuel Ramirez', note: 'Pile stock is comfortable — 28,343 delivered vs 23,990 executed, a 4,353-unit buffer (~5.5 days at the required 920/day). The constraint is mechanical: United ran 4 of 6 rigs and Latnovva 2 on Jul 17 (2 United rigs damaged), holding the day near 472. At ~560/day capacity only ~3,900 more piles are possible before Jul 28, so the gate is now unrecoverable and slips to ~early August (≈ Aug 4-5); holding Jul 28 would need ~1,050/day. Rig repairs are the recovery lever and are urgent.' },
      { title: 'Trackers remain the controlling front: 25 rows vs 49 required, and the released buffer is ~1.3 days', level: 'Critical', owner: 'ECCS / Daniel Morilla / Manuel Ramirez', note: 'ECCS logged 25 rows Jul 17 (60 people) after Tuesday\u2019s 49 — below the 49/day required for Aug 30. The QA-released buffer ahead of the module crews is only ~68 rows / ~4,700 modules ≈ 1.3 days: any tracker-QA miss stalls modules. 708 done / 235 released / 473 pending (no releases Jul 10-16; Daniel targeting sign-off Monday). The field cumulative (708) is under reconciliation against the workbook TRACKER table (583). Hold >= 49/day and clear the 473-row QA backlog — Daniel’s sign-off was due Monday Jul 20.' },
      { title: 'QA release backlog now binds the module front — and Area F was released without sub documents', level: 'Critical', owner: 'Daniel Morilla (QA/QC) / ECCS / Manuel Ramirez', note: '473 completed tracker rows await Quality approval on top of the 235 released, and nothing was released Jul 10-17 (rows driven but not levelled/aligned). Daniel’s sign-off was due Monday Jul 20 and crews are concentrated on tracker QA; the A6/A7 backlog and Area F progress must clear. Open item flagged by QA: some Area F zones were released internally without the subcontractor submitting quality documents — those documents must be recovered. The released buffer ahead of modules is only ~1.3 days, so released rows are the binding constraint.' },
