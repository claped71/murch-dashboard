...
// CACHE BUSTER: Jul 27, 2026 (Mon) EOD — WEATHER ZERO DAY: rain stopped ALL production fronts (piles/trackers/modules/ITS = 0). Only activity: inverter #1 unloaded onto its pile foundation; inverter #2 offload CANCELED (weather). Quantities hold at Jul 25 basis. Recovery Tue-Sat: piles 523/day wk (479/day floor ~Aug 7), trackers 66/day wk (56 gate), modules 4,680/day wk (4,020 gate), LV 5,972 lf/day. Maurin Jul 27 QA re-baseline (26,439 / 606 rel) stands.
...
window.MURCH_DATA = {
    ...
    weeklyPlan: [
      ...
      { area: '<u>SET & inverter foundations</u>',
        target: 'SET 20.0%; piers 6/17 — all 17 this week. Inverter #1 UNLOADED onto its foundation Jul 27; #2 offload canceled (weather) — reschedule crane. Close the last foundation (22/23).',
