...
// CACHE BUSTER: Jul 20, 2026 (PM) — Saturday Jul 18 production added: +608 piles (United 415 Zone F + Latnovva 193 Zone B); trackers & modules idle Saturday. Executed piles 25,220 (80.4%), required 1,022/day to Jul 28 (unrecoverable, slips ~early Aug). Trackers 729 hold (Daniel Jul 20: Zones C1 & C2 released today with Client — first since Jul 10); modules 18,221 hold. ITS Bore-10 frac-outs, DC bore restarts Jul 21.
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 20, 2026',
      piles:    { installed: 25220, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 1022, capacity: null, name: 'Piles', unit: 'piles/day' },
      trackers: { installed: 729, released: 235, total: 2486, gate: '2026-08-30', gateLabel: 'Aug 30', required: 50, capacity: 48, name: 'Trackers incl. purlins', unit: 'rows/day' },
      modules:  { installed: 18221, total: 171470, gate: '2026-09-06', gateLabel: 'Sep 6', required: 3738, capacity: null, name: 'Modules', unit: 'mod/day' },
    ...
    contractorScore: [
      ...
      { date: 'Jul 20 Mon', contractor: 'ECCS', trade: 'Trackers', output: 21, resource: '60 people · zone E — also drove 46 piles zone E', perUnit: 21, criterion: 50, critLabel: '50 rows/day — 21 trackers + 46 piles in Zone E' },
      ...
      { date: 'Jul 20 Mon', contractor: 'Brumont', trade: 'Modules', output: 1741, resource: '18 people · zones A & C', perUnit: 1741, criterion: 2000, critLabel: '2,000 mod/day target — 1,741; combined 3,601 modules Jul 20, near the required rate' },
      { date: 'Jul 18 Sat', contractor: 'United', trade: 'Piles', output: 415, resource: '24 people · 6 rigs, 2 damaged (4 running) — zone F', perUnit: 104, criterion: 80, critLabel: '80 piles/rig-day — 104/rig; only pile crew out Saturday, no trackers/modules' },
      { date: 'Jul 18 Sat', contractor: 'LATNOVVA', trade: 'Piles', output: 193, resource: '2 rigs — zone B', perUnit: 97, criterion: 80, critLabel: '80 piles/rig-day — 97/rig on 2 rigs Saturday' }
    ],
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (25,220 executed, 80.4%), GameChange SAT tracker assembly incl. purlins (729 done, 29.3% — 235 QA-released, 494 pending Quality), and module placement (18,221 executed, 10.6%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      { area: '<u>Tracker assembly and QA release — Zones C1/C2 / A / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: 'THE controlling front for the week — it sets the ceiling on the module crews. 729 rows done (235 QA-released, 494 pending Quality) of 2,486 (29.3%). BREAKTHROUGH: Daniel Morilla confirmed Monday Jul 20 that Zones C1 and C2 release for trackers today with the Client — the first QA releases since Jul 10. Convert the 494-row pending backlog into released workfront this week and keep assembling; the QA-released buffer ahead of Brumont/Workforce is only ~1.3 days, so releases, not assembly, govern the module ramp.',
        minimum: '>= 50 completed rows/day to hold Aug 30 (1,757 rows over 36 working days, Mon-Sat). ECCS has run 25-49 lately — hold and beat it. QA is the real floor: clear the 494-row pending backlog this week now that C1/C2 are unlocking.',
        gate: 'QA turnover of finished rows (now unblocking with C1/C2), not the assembly rate. Carry-over: recover the Area F quality documents for zones released internally without the subcontractor paperwork. Field cumulative (729) still reconciling vs the workbook TRACKER table (583).',
      ...
      { area: '<u>Pile production — rig availability, Zones B / F, open D / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '6,132 piles remain to the Jul 28 gate (25,220 of 31,352 executed, 80.4%). Saturday Jul 18 ran 608 — United 415 (Zone F) + Latnovva 193 (Zone B) — the best per-rig day in a week (104 and 97 per rig), but the Jul 28 gate is unrecoverable at ~560/day fleet capacity and slips to ~early August (~Aug 4-5). Close Zone B (381 left) and drive Zone F (1,154 left); open the released Zone D/G fronts as rigs free up.',
        minimum: 'Holding Jul 28 would need ~1,022 piles/day (6,132 over 7 working days) — roughly 2x capacity. Realistic floor: get every rig running and sustain the fleet maximum daily (~600-700), targeting ~4,000+ piles this week, then re-baseline the pile finish to early August. Saturdays must be worked — Jul 18 trackers and modules were idle.',
        gate: 'Rig repairs are the binding constraint — United on 4 of 6 (2 damaged), Latnovva on 2. Material is not a restriction: 28,343 piles delivered, a 3,123-unit buffer.',
      ...
      { area: '<u>Module installation ramp — Zones A / C</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '18,221 of 171,470 executed (10.6%). No module work Saturday Jul 18 (crews off); last run Jul 17: 2,226 (Brumont 1,290 + Workforce 936), record 2,922 on Jul 13. Ramp both crews as the C1/C2 rows release this week.',
        minimum: '>= 3,738 modules/day required to hold the Sep 6 finish (153,249 over 42 working days), ramping toward the ~5,500/day full-field rate — but capped near ~3,000/day until the QA-released buffer widens past ~1.3 days. Work Saturdays.',
    ...
    civilActivities: [
      ...
      { activity: 'PS foundations', company: 'United', done: 82.6, remaining: 17.4, status: 'Active', note: 'Jul 17 workbook: 190 of 230 inverter piles complete (82.6%). Pending stations: D10, E12, F16, G20. WELDING PROCEDURE for the inverter steel-pile foundations received Jul 21 (Daniel Morilla) — clears qualified welding to proceed. Work planned through August 10.' },
    ...
    contractors: [
      { name: 'LATNOVVA / assigned areas', scope: 15904, installed: 14111, remaining: 1793, done: 88.7, zones: 'Zones A, B, C, D, EW + shared Area E control (Zone G removed Jul 17)', status: 'Watch', note: "Area-based control allocation only; it is not a new manpower or subcontractor headcount report." },
      ...
      { name: 'Project Total', scope: 31352, installed: 25220, remaining: 6132, done: 80.4, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 25,220 — official block-map 22,900 plus 2,320 field logs not yet mapped (mostly Zone B Latnovva). Jul 20 (Mon): 622 (United 444 F + Latnovva 132 B + ECCS 46 E); +21 trackers, +3,601 modules." }
    ],
    zones: [
      ...
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 2539, remaining: 249, done: 91.1, status: 'Active', note: 'Executed: 2,539 (91.1%) — through Jul 20 (+132 Mon on a single rig). Block-map still shows 1,457 here; Latnovva self-report leads.' },
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 6948, remaining: 710, done: 90.7, status: 'Active', note: 'Executed: 6,948 (90.7%) — through Jul 20 (+444 Mon). United ran 4 of 6 rigs (2 broken) — rig repairs still the lever.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '6,132 piles', target: '~1,022 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 20 (Mon): 622 piles — United 444 (Zone F) + Latnovva 132 (Zone B) + ECCS 46 (Zone E)', cumulative: '25,220 / 31,352 executed (80.4%) — 22,900 official block-map + 2,320 field logs not yet mapped (through Jul 20 Monday)', status: 'Critical', note: 'Executed 25,220 of 31,352 (80.4%). The official block-map roll-up is 22,900; field daily logs add 2,320 piles not yet mapped (mostly Zone B, where Latnovva self-reports lead the block map). Jul 20 (Mon) produced 622 (United 444 Zone F, Latnovva 132 Zone B, ECCS 46 Zone E) — below the 1,022/day required over 6 working days to Jul 28. United ran 4 of 6 rigs, Latnovva 1; rig repairs remain the single biggest lever. RECONCILIATION FLAG (Jul 20): Audelio DELIVERY workbook is internally inconsistent on piles — the PROGRESS summary shows 22,900 installed, but his detail tabs (Production Q PILE DRIVING + COMPLETED-by-zone block logs) sum to only 17,678, lagging badly in the active zones (Zone F detail 1,743 vs 5,805 summary; Zone B 500 vs 1,457), and a planning tab shows ~15,550. The field WhatsApp daily logs (25,220) are the controlling production basis; Audelio has been asked to reconcile the summary-vs-detail gap in his file.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the 834 piles/day install burn', latest: 'Jul 15 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; 3,123 available above the 25,220 executed', status: 'On Track', note: 'Available stock equals delivered piles less executed piles — 3,123 units, about 3 days at the 1,022/day required rate. Delivery is no longer the pile-programme constraint.' },
      ...
      { name: 'Tracker completion incl. purlins', remaining: '1,757 to build · 2,251 to QA-release', target: '50 completed rows/day now required for Aug 30', latest: 'Jul 20 (Mon): 21 rows (ECCS, Zone E)', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 729 rows — 235 released by Quality and 494 pending QA approval; first QA release Jul 20 (Daniel: Zones C1 & C2 released with Client). RELEASED-TRACKER BUFFER ahead of module installation is only ~68 rows / ~4,700 modules ≈ 1.3 days at the required module rate — razor-thin. NOTE: cumulative under reconciliation — the workbook still shows 213 complete / 367 installed; Maurin walked all rows Jul 14 and Daniel is recounting manually.', cumulative: '729 done (29.3%): 235 QA-released + 494 pending Quality · 736 rows pre-assembled / 2,486 total', status: 'Critical' },
      ...
      { name: 'Panel delivery', remaining: '14,230 modules to deliver', target: '— No approved daily delivery target in source', latest: '— Latest daily receipt not reported', cumulative: '157,240 / 171,470 delivered (91.7%)', status: 'On Track', note: 'Jul 17 Construction Manager workbook cumulative delivery quantity; 139,019 modules on site above the 18,221 executed.' },
      { name: 'Module installation', remaining: '153,249 modules', target: '3,738 modules/day required for Sep 6 (5,531/day full-field capacity)', latest: 'Jul 20 (Mon): 3,601 modules — Workforce 1,860 + Brumont 1,741', cumulative: '18,221 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'Jul 20: Workforce 1,860 + Brumont 1,741 = 3,601 (best day, near the required rate; record was 2,922 on Jul 13). ~3,738/day now required. The binding constraint is QA-released tracker rows — the released buffer ahead of the module crews is only ~1.3 days. Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 20 measured days', minimum: '1,022 piles/day (required for Jul 28)', above: 0, below: 24, latest: 'Jul 20 (Mon): 622 piles — United 444 (Zone F) + Latnovva 132 (Zone B, 1 rig) + ECCS 46 (Zone E)', note: 'Jul 20 (Mon) produced 622 piles (United 444 Zone F, Latnovva 132 Zone B, ECCS 46 Zone E) — still short of the 1,022/day single goal. (560/day is nominal crew capacity, not a target.) Executed 25,220 = official block-map 22,900 + 2,320 field logs not yet mapped (field logs through Jul 20 Monday).', daily: [{ day: 'Jun 18', value: 20, target: 1022, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 1022, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 1022, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 1022, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 1022, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 1022, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 1022, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 1022, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 1022, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 1022, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 1022, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 1022, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 1022, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 1022, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 1022, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 1022, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 1022, unit: 'piles' }, { day: 'Jul 16', value: 504, target: 1022, unit: 'piles' }, { day: 'Jul 17', value: 472, target: 1022, unit: 'piles' }, { day: 'Jul 18', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 20', value: 622, target: 1022, unit: 'piles' }] },
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 20', minimum: '50 rows/day (required for Aug 30)', above: 4, below: 20, latest: 'Jul 20 (Mon): 21 rows (ECCS, Zone E) — 729 done (235 released / 494 pending)', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 729 rows — 235 released by Quality and 494 pending QA approval; first QA release Jul 20 (Daniel: Zones C1 & C2 released with Client). The released-tracker buffer ahead of modules is only ~1.3 days. Cumulative is under reconciliation — the workbook TRACKER INSTALLATION table shows 583; Maurin walked all rows Jul 14 and Daniel is recounting.', daily: [{ day: 'Jun 17', value: 15, target: 50, unit: 'units' }, { day: 'Jun 18', value: 35, target: 50, unit: 'units' }, { day: 'Jun 19', value: 26, target: 50, unit: 'units' }, { day: 'Jun 20', value: 31, target: 50, unit: 'units' }, { day: 'Jun 21', value: 0, target: 50, unit: 'units' }, { day: 'Jun 22', value: 48, target: 50, unit: 'units' }, { day: 'Jun 23', value: 31, target: 50, unit: 'units' }, { day: 'Jun 24', value: 0, target: 50, unit: 'units' }, { day: 'Jun 25', value: 57, target: 50, unit: 'units' }, { day: 'Jun 26', value: 26, target: 50, unit: 'units' }, { day: 'Jun 29', value: 29, target: 50, unit: 'units' }, { day: 'Jun 30', value: 30, target: 50, unit: 'units' }, { day: 'Jul 1', value: 51, target: 50, unit: 'units' }, { day: 'Jul 7', value: 29, target: 50, unit: 'units' }, { day: 'Jul 8', value: 0, target: 50, unit: 'units' }, { day: 'Jul 9', value: 0, target: 50, unit: 'units' }, { day: 'Jul 10', value: 0, target: 50, unit: 'units' }, { day: 'Jul 13', value: 29, target: 50, unit: 'units' }, { day: 'Jul 14', value: 49, target: 50, unit: 'units' }, { day: 'Jul 15', value: 35, target: 50, unit: 'units' }, { day: 'Jul 16', value: 35, target: 50, unit: 'units' }, { day: 'Jul 17', value: 25, target: 50, unit: 'units' }, { day: 'Jul 18', value: 0, target: 50, unit: 'units' }, { day: 'Jul 20', value: 21, target: 50, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 20 field start', minimum: '3,738 modules/day (required for Sep 6)', above: 0, below: 14, latest: 'Jul 20 (Mon): 3,601 modules — Workforce 1,860 (Zone A) + Brumont 1,741 (Zones A & C); best day, near the required rate', note: 'Jul 17: Brumont 1,290 + Workforce 936. Record 2,922 on Jul 13. Still short of the single goal, 3,738/day required to hold Sep 6. (5,531/day is the full-field capacity, not a target.) Released tracker rows are the constraint — the buffer ahead of the crews is only ~1.3 days.', daily: [{ day: 'Jul 3', value: 234, target: 3738, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 3738, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 3738, unit: 'modules' }, { day: 'Jul 8', value: 936, target: 3738, unit: 'modules' }, { day: 'Jul 9', value: 1308, target: 3738, unit: 'modules' }, { day: 'Jul 10', value: 1802, target: 3738, unit: 'modules' }, { day: 'Jul 11', value: 517, target: 3738, unit: 'modules' }, { day: 'Jul 13', value: 2922, target: 3738, unit: 'modules' }, { day: 'Jul 14', value: 2335, target: 3738, unit: 'modules' }, { day: 'Jul 15', value: 780, target: 3738, unit: 'modules' }, { day: 'Jul 16', value: 858, target: 3738, unit: 'modules' }, { day: 'Jul 17', value: 2226, target: 3738, unit: 'modules' }, { day: 'Jul 18', value: 0, target: 3738, unit: 'modules' }, { day: 'Jul 20', value: 3601, target: 3738, unit: 'modules' }] },
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', progress: 90, baseline: 55, note: 'Consolidated delivery line; final tracker-post containers slipped to a 7/14 port arrival, so post deliveries complete the week of 7/20 (node controllers Monday). Site pile stock: 28,343 delivered vs 25,220 executed — 3,123-pile buffer (~4 days at the ~1,022/day rate now needed to hold Jul 28). Receiving cap 14 pile + 8 racking loads/day; loads count as scheduled until POD/site receipt.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 78.5, baseline: 48.4, note: '6,132 piles remain (official block-map 22,900 + 2,320 field logs not yet mapped): holding July 28 would need ~1,022 piles/day vs ~560 crew capacity, so the gate is unrecoverable and slips to ~early August (≈ Aug 4-5). Jul 18 Sat: 608 (United 415 + Latnovva 193); United ran 4 of 6 rigs, Latnovva 2 — rig repairs remain the escalated lever; trackers & modules did not work Saturday.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', progress: 28.5, baseline: 0, note: 'Jul 18 Sat: no tracker work (crews off Saturday) — 729 done / 235 QA-released / 494 pending QA (first QA release Jul 20: Zones C1 & C2 with Client). The released buffer ahead of modules is only ~1.3 days. Cumulative under reconciliation vs the workbook TRACKER table (583). Releasing the C rows is the controlling item for the module front.' },
      ...
      { activity: 'Final module installation completion', contractor: 'Workforce', start: '2026-07-03', end: '2026-09-06', status: 'Critical', progress: 7.2, baseline: 0, note: 'Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. 18,221 modules executed through Jul 18 (no Sat module work; record 2,922 on Jul 13; last run Jul 17: 2,226); ~3,738/day now required — full-field production depends on released tracker rows (buffer ~1.3 days) and the module crew ramp.' },
    ...
    risks: [
      ...
      { title: 'Rig availability, not delivery, now caps pile production', level: 'Critical', owner: 'United / LATNOVVA / Audelio Zuniga / Manuel Ramirez', note: 'Pile stock is comfortable — 28,343 delivered vs 25,220 executed, a 3,123-unit buffer (~5.5 days at the required 1,022/day). The constraint is mechanical: United ran 4 of 6 rigs and Latnovva 2 on Jul 18 Sat (2 United rigs damaged); the day hit 608, but trackers and modules did not work Saturday. At ~560/day capacity only ~3,900 more piles are possible before Jul 28, so the gate is now unrecoverable and slips to ~early August (≈ Aug 4-5); holding Jul 28 would need ~1,022/day. Rig repairs are the recovery lever and are urgent.' },
      { title: 'Trackers remain the controlling front: 25 rows vs 49 required, and the released buffer is ~1.3 days', level: 'Critical', owner: 'ECCS / Daniel Morilla / Manuel Ramirez', note: 'No tracker work Saturday Jul 18 (crews off); ECCS last logged 25 rows Jul 17 (60 people) — below the 50/day required for Aug 30. The QA-released buffer ahead of the module crews is only ~68 rows / ~4,700 modules ≈ 1.3 days: any tracker-QA miss stalls modules. 729 done / 235 released / 494 pending. QA freeze breaking: Daniel confirmed Monday Jul 20 that Zones C1 and C2 release for trackers today with the Client — the first releases since Jul 10. The field cumulative (729) is under reconciliation against the workbook TRACKER table (583). Hold >= 50/day and convert the 494-row pending backlog into released rows this week.' },
      { title: 'QA release backlog now binds the module front — and Area F was released without sub documents', level: 'Critical', owner: 'Daniel Morilla (QA/QC) / ECCS / Manuel Ramirez', note: '494 completed tracker rows await Quality approval on top of the 235 released, after a freeze Jul 10-18 (rows driven but not levelled/aligned). Daniel confirmed Monday Jul 20 that Zones C1 and C2 release today with the Client — the first releases since Jul 10; crews stay concentrated on tracker QA to clear the A6/A7 backlog and Area F progress. Open item flagged by QA: some Area F zones were released internally without the subcontractor submitting quality documents — those documents must be recovered. The released buffer ahead of modules is only ~1.3 days, so released rows are the binding constraint.' },
