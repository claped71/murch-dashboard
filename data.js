...
window.MURCH_DATA = {
    ...
    schedule: [
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 78.5, baseline: 48.4, note: '5,677 piles remain (official block-map 22,900 + 2,775 field logs not yet mapped): holding July 28 would need ~1,419 piles/day vs ~560 crew capacity, so the gate is unrecoverable and slips to ~early August (≈ Aug 4-5). Jul 18 Sat: 608 (United 415 + Latnovva 193); United ran 4 of 6 rigs, Latnovva 2 — rig repairs remain the escalated lever; trackers & modules did not work Saturday.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', progress: 28.5, baseline: 0, note: 'Jul 18 Sat: no tracker work (crews off Saturday) — 793 done / 235 QA-released / 558 pending QA (first QA release Jul 20: Zones C1 & C2 with Client). The released buffer ahead of modules is only ~1.3 days. Cumulative under reconciliation vs the workbook TRACKER table (583). Releasing the C rows is the controlling item for the module front.' },
      ...
      { activity: 'Final module installation completion', contractor: 'Workforce', start: '2026-07-03', end: '2026-09-06', status: 'Critical', progress: 7.2, baseline: 0, note: 'Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. 24,190 modules executed through Jul 18 (no Sat module work; record 2,922 on Jul 13; last run Jul 17: 2,226); ~3,776/day now required — full-field production depends on released tracker rows (buffer ~1.3 days) and the module crew ramp.' },
