...
// CACHE BUSTER: Jul 16, 2026 — Jul 15 production (light QC/alignment day); rates recomputed (piles 843, modules 3,635)
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 15, 2026',
      piles:    { installed: 22919, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 843, capacity: null, name: 'Piles', unit: 'piles/day' },
      trackers: { installed: 648, released: 235, total: 2486, gate: '2026-08-30', gateLabel: 'Aug 30', required: 48, capacity: 48, name: 'Trackers incl. purlins', unit: 'rows/day' },
      modules:  { installed: 11536, total: 171470, gate: '2026-09-06', gateLabel: 'Sep 6', required: 3635, capacity: null, name: 'Modules', unit: 'mod/day' },
    ...
    contractorScore: [
      ...
      { date: 'Jul 15 Wed', contractor: 'LATNOVVA', trade: 'Piles', output: 0, resource: '~14 people · 1 running rig (2nd in repair) — zone B', perUnit: 0, criterion: 80, critLabel: 'Jul 15 output pending confirmation (Jose reconciling 93 vs 180); not yet added to the basis' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (22,919 executed, 73.1%), GameChange SAT tracker assembly incl. purlins (648 done, 26.1% — 235 QA-released, 413 pending Quality), and module placement (11,536 executed, 6.7%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      { area: '<u>Tracker completion and QA release — Zones C / A / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: 'THE controlling front this week. 648 rows done (235 QA-released, 413 pending) of 2,486. ECCS slipped back to 35 rows Jul 15 (60 people) after Tuesday’s 49 — Jose: recover numbers tomorrow. Brumont moved into Zone C against only 13 QA-released rows, and the released buffer ahead of the module crews is only ~1.3 days. Break the QA freeze (still nothing released Jul 10-15) and convert Zone C rows into released workfront ahead of the module crew.', minimum: '>= 48 completed rows/day required to hold Aug 30 (1,838 rows / 38 working days). Rate hit once (49 Tue), missed Wed (35) — hold and exceed it. QA: Daniel targeting sign-off next Monday; the field cumulative (648) is under reconciliation against the workbook (213 complete).', gate: 'QA turnover of finished rows, not assembly. OPEN ACTION: some Area F zones were released internally without the subcontractor submitting quality documents — recover those documents this week.', owners: 'ECCS | Daniel Morilla (QA/QC) | Audelio Zuniga | Manuel Ramirez' },
      { area: '<u>Pile production — rig availability, Zones B / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: '8,433 piles remain to the Jul 28 gate (22,919 of 31,352 executed, 73.1%). Jul 15 collapsed to 386 — United dropped to 2 of 5 running rigs and Latnovva stayed on one (Jul 15 Latnovva pending). The fleet is degrading, not recovering. Get the broken rigs back immediately to hold the gate.', minimum: '>= 843 piles/day (8,433 over 10 remaining working days, Mon-Sat) — far above the ~560/day crew capacity, and the weak Jul 15 pushed it up from 802. Every sub-800 day pushes Jul 28 further out.', gate: 'Rig repairs are the binding constraint — United down to 2 of 5 running and Latnovva 1 of 2. Material is no longer a restriction: 28,343 piles delivered, a 5,424-unit buffer (~6.4 days at the required rate).', owners: 'United / LATNOVVA | Audelio Zuniga | Manuel Ramirez | Joshua Spalding' },
      { area: '<u>Module installation ramp — Zone A into Zone C</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: 'After 2,922 Monday and 2,335 Tuesday, Jul 15 dropped to 780 (Workforce 702 + Brumont 78) — both crews were deliberately put on QC order and alignment. 11,536 of 171,470 executed (6.7%). Jose: recover numbers Thursday. Brumont is in Zone C.', minimum: '>= 3,000 modules/day with both crews once cleanup is done; ~3,635/day required to hold the Sep 6 finish, ramping toward the 5,531/day full-field rate.', gate: 'QA-released tracker rows — the released buffer ahead of the crews is only ~1.3 days, so any tracker-QA miss stalls modules regardless of crew size. Module-spacing QC control (Golden Row slot-tolerance finding) stays in force.', owners: 'Workforce / Brumont | Audelio Zuniga | Daniel Morilla (QA/QC) | Manuel Ramirez' },
    ...
    contractors: [
      ...
      { name: 'United', scope: 7658, installed: 5357, remaining: 2301, done: 70.0, zones: 'Zone F', status: 'Active', note: 'Executed: 5,357 in Zone F (70.0%) — workbook + field through Jul 15. Jul 15: 386 piles with only 2 of 5 rigs running (193/rig-day) — fleet dropped to 2 rigs.' },
      { name: 'Project Total', scope: 31352, installed: 22919, remaining: 8433, done: 73.1, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 22,919 — Audelio's workbook (20,550, official basis, block-map roll-up still through Jul 10 in the Jul 16 re-export) plus 2,369 field-reported piles since (Sat 680; Mon 608; Tue 695; Wed Jul 15: United 386 F — Latnovva Jul 15 pending confirmation), pending workbook incorporation." }
    ],
    zones: [
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 5357, remaining: 2301, done: 70.0, status: 'Active', note: 'Executed: 5,357 (70.0%) — workbook + field through Jul 15 (386 Wed). Zone F past 70%; but United dropped to 2 of 5 running rigs Jul 15 — rig repairs now urgent.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '8,433 piles', target: '~843 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 15 (Wed): 386 piles — United only, with just 2 of 5 rigs running (Latnovva Jul 15 pending confirmation)', cumulative: '22,919 / 31,352 executed (73.1%) — 20,550 workbook + 2,369 field-reported (Sat 680 + Mon 608 + Tue 695 + Wed 386)', status: 'Critical', note: 'The workbook roll-up (20,550) still carries field production only through Jul 10 in the Jul 16 re-export, so Sat-Wed output is added on top. Jul 15 collapsed to 386 — United dropped to 2 of 5 running rigs and Latnovva stayed on one. The required rate has risen to ~843/day over 10 working days; rig repairs are now the single biggest lever, and every weak day like Jul 15 pushes it higher.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the 843 piles/day install burn', latest: 'Jul 15 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; 5,424 available above the 22,919 executed', status: 'On Track', note: 'Available stock equals delivered piles less executed piles — 5,424 units, about 6.4 days at the 843/day required rate. Delivery is no longer the pile-programme constraint.' },
      ...
      { name: 'Tracker completion incl. purlins', remaining: '1,838 to build · 2,251 to QA-release', target: '48 completed rows/day now required for Aug 30', latest: 'Jul 15 (Wed): 35 rows in zone C with 60 people — below the 48/day required; Jose: recover tomorrow', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 648 rows — 235 released by Quality and 413 pending QA approval, still no new QA releases Jul 10-15 (Daniel targeting sign-off next Monday). RELEASED-TRACKER BUFFER ahead of module installation is only ~68 rows / ~4,700 modules ≈ 1.3 days at the required module rate — razor-thin. NOTE: cumulative under reconciliation — the workbook still shows 213 complete / 367 installed; Maurin walked all rows Jul 14 and Daniel is recounting manually.', cumulative: '648 done (26.1%): 235 QA-released + 413 pending Quality · 594+ rows pre-assembled / 2,486 total', status: 'Critical' },
      { name: 'ITS HDD boring', remaining: '4 of 20 bores', target: 'Minimum 1 completed bore/day', latest: 'Jul 15 (Wed): no bores closed, 0 ft bored — 16 / 20 complete (80%)', cumulative: '16 / 20 bores complete (80%); 5,026 ft installed', status: 'Watch', note: 'Jul 15 ITS tracker: 16 done / 0 in progress / 4 pending. No boring progress Jul 13-15; the last 4 bores (HB-01, HB-10, HB-11, HB-12) remain.' },
      { name: 'ITS MV plowing', remaining: '10 of 46 segments', target: 'Minimum 1 completed segment/day', latest: 'Jul 15 (Wed): +3 segments (MV11A-S01, MV11A-S02, MV11B-S02) and 11,586 ft — 36 / 46 complete (78.3%)', cumulative: '36 / 46 segments complete; 120,738 ft installed', status: 'On Track', note: 'Jul 15 ITS tracker: 36 done / 0 in progress / 10 pending. Line status: MV11A 7/10, MV11B 10/12, MV12A 10/13, MV12B 9/11. Plowing comfortably leads the electrical sequence.' },
      ...
      { name: 'Panel delivery', remaining: '14,230 modules to deliver', target: '— No approved daily delivery target in source', latest: '— Latest daily receipt not reported', cumulative: '157,240 / 171,470 delivered (91.7%)', status: 'On Track', note: 'Jul 16 Construction Manager workbook cumulative delivery quantity; 145,704 modules on site above the 11,536 executed.' },
      { name: 'Module installation', remaining: '159,934 modules', target: '3,635 modules/day required for Sep 6 (5,531/day full-field capacity)', latest: 'Jul 15 (Wed): 780 modules (Workforce 702 + Brumont 78) — low by instruction: both crews directed to QC order and alignment', cumulative: '11,536 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'Jul 15 was a deliberate QC/alignment day (record 2,922 on Jul 13, 2,335 on Jul 14). ~3,635/day now required. The binding constraint is QA-released tracker rows — the released buffer ahead of the module crews is only ~1.3 days. Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 15 measured days', minimum: '843 piles/day (required for Jul 28)', above: 0, below: 20, latest: 'Jul 15 (Wed): 386 piles — United only, 2 of 5 rigs running (Latnovva Jul 15 pending)', note: 'Jul 15 collapsed to 386 as United dropped to 2 running rigs — well short of the 843/day single goal, which the weak day itself pushed up from 802. (560/day is nominal crew capacity, not a target.) Cumulative 20,550 official + 2,369 field (Sat 680, Mon 608, Tue 695, Wed 386) pending workbook.', daily: [{ day: 'Jun 18', value: 20, target: 843, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 843, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 843, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 843, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 843, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 843, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 843, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 843, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 843, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 843, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 843, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 843, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 843, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 843, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 843, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 843, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 843, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 843, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 843, unit: 'piles' }, { day: 'Jul 15', value: 386, target: 843, unit: 'piles' }] },
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 15', minimum: '48 rows/day (required for Aug 30)', above: 4, below: 16, latest: 'Jul 15 (Wed): 35 rows in zone C with 60 people — back below the 48/day required after Tuesday\u2019s 49', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 648 rows — 235 released by Quality and 413 pending QA approval, still no new QA releases Jul 10-15 (Daniel targeting sign-off next Monday). The released-tracker buffer ahead of modules is only ~1.3 days. Cumulative is under reconciliation — the workbook still shows 213 complete / 367 installed; Maurin walked all rows Jul 14 and Daniel is recounting.', daily: [{ day: 'Jun 17', value: 15, target: 48, unit: 'units' }, { day: 'Jun 18', value: 35, target: 48, unit: 'units' }, { day: 'Jun 19', value: 26, target: 48, unit: 'units' }, { day: 'Jun 20', value: 31, target: 48, unit: 'units' }, { day: 'Jun 21', value: 0, target: 48, unit: 'units' }, { day: 'Jun 22', value: 48, target: 48, unit: 'units' }, { day: 'Jun 23', value: 31, target: 48, unit: 'units' }, { day: 'Jun 24', value: 0, target: 48, unit: 'units' }, { day: 'Jun 25', value: 57, target: 48, unit: 'units' }, { day: 'Jun 26', value: 26, target: 48, unit: 'units' }, { day: 'Jun 29', value: 29, target: 48, unit: 'units' }, { day: 'Jun 30', value: 30, target: 48, unit: 'units' }, { day: 'Jul 1', value: 51, target: 48, unit: 'units' }, { day: 'Jul 7', value: 29, target: 48, unit: 'units' }, { day: 'Jul 8', value: 0, target: 48, unit: 'units' }, { day: 'Jul 9', value: 0, target: 48, unit: 'units' }, { day: 'Jul 10', value: 0, target: 48, unit: 'units' }, { day: 'Jul 13', value: 29, target: 48, unit: 'units' }, { day: 'Jul 14', value: 49, target: 48, unit: 'units' }, { day: 'Jul 15', value: 35, target: 48, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 15 field start', minimum: '3,635 modules/day (required for Sep 6)', above: 0, below: 10, latest: 'Jul 15 (Wed): 780 modules (Workforce 702 + Brumont 78) — a deliberate QC order/alignment day', note: 'Jul 15 was low by instruction — both crews did module cleanup and alignment (record 2,922 on Jul 13). Still short of the single goal, 3,635/day required to hold Sep 6. (5,531/day is the full-field capacity, not a target.) Released tracker rows are the constraint — the buffer ahead of the crews is only ~1.3 days.', daily: [{ day: 'Jul 3', value: 234, target: 3635, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 3635, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 3635, unit: 'modules' }, { day: 'Jul 8', value: 936, target: 3635, unit: 'modules' }, { day: 'Jul 9', value: 1308, target: 3635, unit: 'modules' }, { day: 'Jul 10', value: 1802, target: 3635, unit: 'modules' }, { day: 'Jul 11', value: 517, target: 3635, unit: 'modules' }, { day: 'Jul 13', value: 2922, target: 3635, unit: 'modules' }, { day: 'Jul 14', value: 2335, target: 3635, unit: 'modules' }, { day: 'Jul 15', value: 780, target: 3635, unit: 'modules' }] },
      { task: 'ITS MV plowing', period: 'Jun 17-Jul 15', minimum: '1 completed segment/day', above: 11, below: 12, latest: 'Jul 15 (Wed): 3 segments closed — 36 of 46 cumulative; 11,586 ft plowed', note: 'Jul 15 ITS tracker: 36 of 46 segments complete (78.3%), 0 in progress. 120,738 ft installed. MV11A 7/10, MV11B 10/12, MV12A 10/13, MV12B 9/11.', daily: [{ day: 'Jun 17', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 18', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 19', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 20', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 21', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 22', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 23', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 24', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 25', value: 3, target: 1, unit: 'seg' }, { day: 'Jun 26', value: 4, target: 1, unit: 'seg' }, { day: 'Jun 27', value: 1, target: 1, unit: 'seg' }, { day: 'Jun 28', value: 0, target: 1, unit: 'seg' }, { day: 'Jun 29', value: 2, target: 1, unit: 'seg' }, { day: 'Jun 30', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 1', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 2', value: 1, target: 1, unit: 'seg' }, { day: 'Jul 6', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 7', value: 0, target: 1, unit: 'seg' }, { day: 'Jul 8', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 9', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 10', value: 5, target: 1, unit: 'seg' }, { day: 'Jul 11', value: 1, target: 1, unit: 'seg' }, { day: 'Jul 13', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 14', value: 2, target: 1, unit: 'seg' }, { day: 'Jul 15', value: 3, target: 1, unit: 'seg' }] },
      { task: 'ITS HDD boring', period: 'Jul 2-Jul 15 measured days', minimum: '1 completed bore/day', above: 3, below: 6, latest: 'Jul 15 (Wed): no bores closed — 16 of 20 cumulative (80%)', note: 'Jul 15 ITS tracker: 16 done / 0 in progress / 4 pending. 5,026 ft installed; 0 ft bored Jul 13-15. The last 4 bores remain.', daily: [{ day: 'Jul 2', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 6', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 7', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 8', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 9', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 10', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 11', value: 1, target: 1, unit: 'bores' }, { day: 'Jul 13', value: 2, target: 1, unit: 'bores' }, { day: 'Jul 14', value: 0, target: 1, unit: 'bores' }, { day: 'Jul 15', value: 0, target: 1, unit: 'bores' }] }
    ],
    successors: [
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', progress: 90, baseline: 55, note: 'Consolidated delivery line; final tracker-post containers slipped to a 7/14 port arrival, so post deliveries complete the week of 7/20 (node controllers Monday). Site pile stock: 28,343 delivered vs 22,919 executed — 5,424-pile buffer (~6.4 days at the 843/day required rate). Receiving cap 14 pile + 8 racking loads/day; loads count as scheduled until POD/site receipt.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 73.1, baseline: 48.4, note: '8,433 piles remain (20,550 official workbook + 2,369 field: Sat 680, Mon 608, Tue 695, Wed 386): holding July 28 requires ~843 piles/day vs ~560 crew capacity. Jul 15 collapsed to 386 as United fell to 2 of 5 running rigs; rig repairs (United 3 down, Latnovva 1 down) are the escalated levers.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', progress: 26.1, baseline: 0, note: 'Jul 15: 35 rows in Zone C with 60 people, back below the 48/day required after Tuesday\u2019s 49 — 648 done / 235 QA-released / 413 pending QA (still no releases Jul 10-15). The released buffer ahead of modules is only ~1.3 days. Cumulative under reconciliation vs the workbook (213 complete). Releasing the C rows is the controlling item for the module front.' },
      ...
      { activity: 'Final module installation completion', contractor: 'Workforce', start: '2026-07-03', end: '2026-09-06', status: 'Critical', progress: 6.7, baseline: 0, note: 'Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. 11,536 modules executed through Jul 15 (record 2,922 on Jul 13; Jul 15 only 780 — deliberate QC/alignment day); ~3,635/day now required — full-field production depends on released tracker rows (buffer ~1.3 days) and the module crew ramp.' },
    ...
    equipmentNotes: [
      ...
      { contractor: 'ECCS', equipment: 'Tracker structural installation crew; equipment count varies by workfront.', output: 'Largest crew on site (60 Jul 15); Jul 15: 35 trackers in Zone C — back below the 48/day required.' },
      { contractor: 'United', equipment: '5 ramming machines on site — 3 stopped (2 running; rig repairs urgent).', output: 'Jul 15 (Wed): 386 piles in Zone F with 23 people — only 2 of 5 rigs running (193/rig-day); fleet dropped to 2 rigs.' },
      { contractor: 'Latnovva', equipment: '2 ramming machines on site — 1 broken, leaving a single working rig (escalated).', output: 'Jul 15 (Wed): output pending confirmation (Jose reconciling 93 vs 180); 1 running rig, 2nd in repair.' },
      { contractor: 'Workforce', equipment: 'Module installation hand tools / torque equipment.', output: 'Jul 15 (Wed): 702 modules in Zone A — directed to QC order and alignment.' },
      { contractor: 'Brumont', equipment: 'Module installation tools; 18-person crew.', output: 'Jul 15 (Wed): 78 modules — directed to QC order and alignment; now in Zone C.' },
    ...
    risks: [
      { title: 'Rig availability, not delivery, now caps pile production', level: 'Critical', owner: 'United / LATNOVVA / Audelio Zuniga / Manuel Ramirez', note: 'Pile stock is comfortable — 28,343 delivered vs 22,919 executed, a 5,424-unit buffer (~6.4 days at the required 843/day). The constraint is mechanical and worsening: United fell to 2 of 5 running rigs Jul 15 and Latnovva is on 1 of 2, so the day collapsed to 386 (Latnovva Jul 15 pending). Every sub-800 day pushes the Jul 28 gate further out and lifts the required rate (now 843/day); rig repairs are the recovery lever and are now urgent.' },
      { title: 'Trackers remain the controlling front: 35 rows vs 48 required, and the released buffer is ~1.3 days', level: 'Critical', owner: 'ECCS / Daniel Morilla / Manuel Ramirez', note: 'ECCS slipped to 35 rows Jul 15 (60 people) after Tuesday\u2019s 49 — below the 48/day required for Aug 30. The QA-released buffer ahead of the module crews is only ~68 rows / ~4,700 modules ≈ 1.3 days: any tracker-QA miss stalls modules. 648 done / 235 released / 413 pending (no releases Jul 10-15; Daniel targeting sign-off Monday). The field cumulative is under reconciliation against the workbook (213 complete). Hold >= 48/day and clear the QA backlog.' },
      { title: 'QA release backlog now binds the module front — and Area F was released without sub documents', level: 'Critical', owner: 'Daniel Morilla (QA/QC) / ECCS / Manuel Ramirez', note: '413 completed tracker rows await Quality approval on top of the 235 released, and still nothing was released between Jul 10 and Jul 15 (rows driven but not levelled/aligned). Daniel is targeting sign-off next Monday and is concentrating crews on tracker QA; the A6/A7 backlog and Area F progress must clear. Open item flagged by QA: some Area F zones were released internally without the subcontractor submitting quality documents — those documents must be recovered. The released buffer ahead of modules is only ~1.3 days, so released rows are the binding constraint.' },
