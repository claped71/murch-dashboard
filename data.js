...
// CACHE BUSTER: Jul 20, 2026 (PM) — Saturday Jul 18 production added: +608 piles (United 415 Zone F + Latnovva 193 Zone B); trackers & modules idle Saturday. Executed piles 25,473 (81.3%), required 1,176/day to Jul 28 (unrecoverable, slips ~early Aug). Trackers 754 hold (Daniel Jul 20: Zones C1 & C2 released today with Client — first since Jul 10); modules 21,303 hold. ITS Bore-10 frac-outs, DC bore restarts Jul 21.
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 21, 2026',
      piles:    { installed: 25473, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 1176, capacity: null, name: 'Piles', unit: 'piles/day' },
      trackers: { installed: 754, released: 235, total: 2486, gate: '2026-08-30', gateLabel: 'Aug 30', required: 51, capacity: 48, name: 'Trackers incl. purlins', unit: 'rows/day' },
      modules:  { installed: 21303, total: 171470, gate: '2026-09-06', gateLabel: 'Sep 6', required: 3754, capacity: null, name: 'Modules', unit: 'mod/day' },
    ...
    contractorScore: [
      ...
      { date: 'Jul 21 Tue', contractor: 'ECCS', trade: 'Trackers', output: 25, resource: '58 people · zone E + 1 inverter foundation zone G (2 remaining)', perUnit: 25, criterion: 51, critLabel: '51 rows/day — 25 trackers zone E; also completed 1 inverter foundation in zone G (21 of 23 done)' },
      { date: 'Jul 21 Tue', contractor: 'LATNOVVA', trade: 'Piles', output: 84, resource: '13 people · 1 of 2 rigs running (2nd damaged) — zone B', perUnit: 84, criterion: 80, critLabel: '80 piles/rig-day — 84 on the single running rig' },
      { date: 'Jul 21 Tue', contractor: 'United', trade: 'Piles', output: 169, resource: '24 people · 6 rigs — 147 Zone F + 22 Zone G (FIRST Zone G piles); plus 13 CB + 32 TP electrical piles', perUnit: 28, criterion: 80, critLabel: '80 piles/rig-day — 28/rig on 6 rigs; remaining F piles are DISPERSED across the area (rig relocation eats the day, Manuel) + 45 electrical CB/TP piles + Zone G opening' },
      { date: 'Jul 20 Mon', contractor: 'United', trade: 'Piles', output: 444, resource: '24 people · 4 of 6 rigs running (2 broken) — zone F', perUnit: 111, criterion: 80, critLabel: '80 piles/rig-day — 111/rig on 4 running rigs' },
      { date: 'Jul 20 Mon', contractor: 'LATNOVVA', trade: 'Piles', output: 132, resource: 'single rig running (2nd broken) — zone B', perUnit: 132, criterion: 80, critLabel: '80 piles/rig-day — 132 on one rig' },
      { date: 'Jul 20 Mon', contractor: 'ECCS', trade: 'Trackers', output: 21, resource: '60 people · zone E — also drove 46 piles zone E', perUnit: 21, criterion: 51, critLabel: '51 rows/day — 21 trackers + 46 piles in Zone E' },
      { date: 'Jul 20 Mon', contractor: 'Workforce', trade: 'Modules', output: 1860, resource: '32 people · zone A', perUnit: 1860, criterion: 2000, critLabel: '2,000 mod/day target — strong 1,860' },
      { date: 'Jul 20 Mon', contractor: 'Brumont', trade: 'Modules', output: 1741, resource: '18 people · zones A & C', perUnit: 1741, criterion: 2000, critLabel: '2,000 mod/day target — 1,741; combined 3,601 modules Jul 20' }
    ],
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (25,473 executed, 81.3%), GameChange SAT tracker assembly incl. purlins (754 done, 30.3% — 235 QA-released, 519 pending Quality), and module placement (21,303 executed, 12.4%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      { area: '<u>Tracker assembly and QA release — Zones C1/C2 / A / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: 'THE controlling front for the week — it sets the ceiling on the module crews. 754 rows done (235 QA-released, 519 pending Quality) of 2,486 (30.3%). BREAKTHROUGH: Daniel Morilla confirmed Monday Jul 20 that Zones C1 and C2 release for trackers today with the Client — the first QA releases since Jul 10. Convert the 519-row pending backlog into released workfront this week and keep assembling; the QA-released buffer ahead of Brumont/Workforce is only ~1.3 days, so releases, not assembly, govern the module ramp.',
        ...
        gate: 'QA turnover of finished rows (now unblocking with C1/C2), not the assembly rate. Carry-over: recover the Area F quality documents for zones released internally without the subcontractor paperwork. Field cumulative (754) still reconciling vs the workbook TRACKER table (583).',
      ...
      { area: '<u>Pile production — rig availability, Zones B / F, open D / G</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '5,879 piles remain to the Jul 28 gate (25,473 of 31,352 executed, 81.3%). Saturday Jul 18 ran 608 — United 415 (Zone F) + Latnovva 193 (Zone B) — the best per-rig day in a week (104 and 97 per rig), but the Jul 28 gate is unrecoverable at ~560/day fleet capacity and slips to ~early August (~Aug 4-5). Close Zone B (381 left) and drive Zone F (1,154 left); open the released Zone D/G fronts as rigs free up.',
        minimum: 'Holding Jul 28 would need ~1,176 piles/day (5,879 over 7 working days) — roughly 2x capacity. Realistic floor: get every rig running and sustain the fleet maximum daily (~600-700), targeting ~4,000+ piles this week, then re-baseline the pile finish to early August. Saturdays must be worked — Jul 18 trackers and modules were idle.',
        gate: 'Rig repairs are the binding constraint — United on 4 of 6 (2 damaged), Latnovva on 2. Material is not a restriction: 28,343 piles delivered, a 2,870-unit buffer.',
      ...
      { area: '<u>Module installation ramp — Zones A / C</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>',
        target: '21,303 of 171,470 executed (12.4%). No module work Saturday Jul 18 (crews off); last run Jul 17: 2,226 (Brumont 1,290 + Workforce 936), record 2,922 on Jul 13. Ramp both crews as the C1/C2 rows release this week.',
        minimum: '>= 3,754 modules/day required to hold the Sep 6 finish (150,167 over 42 working days), ramping toward the ~5,500/day full-field rate — but capped near ~3,000/day until the QA-released buffer widens past ~1.3 days. Work Saturdays.',
    ...
    civilActivities: [
      ...
      { activity: 'PS foundations', company: 'United', done: 82.6, remaining: 17.4, status: 'Active', note: 'Jul 17 workbook: 190 of 230 inverter piles complete (82.6%). Jul 21 field: 1 more foundation done in Zone G — 21 of 23 stations complete, 2 remaining. WELDING PROCEDURE for the inverter steel-pile foundations received Jul 21 (Daniel Morilla) — clears qualified welding to proceed. Work planned through August 10.' },
    ...
    contractors: [
      ...
      { name: 'ECCS / Area E control', scope: 4434, installed: 4161, remaining: 273, done: 93.8, zones: 'Area E shared tracker workfront', status: 'On Track', note: "Area-based control allocation used only so dashboard totals reconcile with Audelio's July 6 official installed-production basis." },
      { name: 'United', scope: 11014, installed: 7117, remaining: 3897, done: 64.6, zones: 'Zones F + G', status: 'Active', note: 'Executed: 7,117 piles — Zone F 7,095 (92.7%) + Zone G 22 (STARTED Jul 21). Jul 21: 169 tracker piles (147 F + 22 G, 6 rigs) plus 13 CB + 32 TP electrical piles. Combined F+G 64.6%. United now holds full mechanical (piles + trackers + modules) in F & G.' },
      { name: 'Project Total', scope: 31352, installed: 25473, remaining: 5879, done: 81.3, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 25,473 — official block-map 22,900 plus 2,573 field logs not yet mapped (mostly Zone B Latnovva). Jul 21 (Tue) CLOSED: 253 piles (United 147 F + 22 G first Zone G + Latnovva 84 B); +25 trackers (E), +3,082 modules; United also drove 13 CB + 32 TP electrical piles (outside the 31,352)." }
    ],
    zones: [
      ...
      { zone: 'Zone E', contractor: 'ECCS / Latnovva', scope: 8456, installed: 8107, remaining: 349, done: 95.9, status: 'Active', note: 'Jul 20: 8,107 installed (+46 ECCS piles Zone E Mon).' },
      ...
      { zone: 'Zone F', contractor: 'United', scope: 7658, installed: 7095, remaining: 563, done: 92.7, status: 'Active', note: 'Executed: 7,095 (92.7%) — through Jul 21 (+147 Tue, 6 rigs; plus 13 CB + 32 TP electrical piles, not counted in the 31,352).' },
      { zone: 'Zone G', contractor: 'United', scope: 3356, installed: 22, remaining: 3334, done: 0.7, status: 'Active', note: 'STARTED Jul 21: first 22 Zone G piles (United); more expected Jul 22 (Manuel). FULL Zone G start needs only the SIGNED CHANGE ORDER (ChO) — chase signature. ECCS also completed 1 inverter foundation in Zone G Jul 21. United holds full mechanical in F & G. Area G released for pile driving; cut/fill after basin completion.' }
    ],
    production: [
      { name: 'Project pile installation', remaining: '5,879 piles', target: '~1,176 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 21 (Tue) closed: 253 piles — United 169 (147 F + 22 G, first Zone G) + Latnovva 84 (B); +45 electrical CB/TP piles (outside the 31,352)', cumulative: '25,473 / 31,352 executed (81.3%) — 22,900 official block-map + 2,573 field logs not yet mapped (through Jul 20 Monday)', status: 'Critical', note: 'Executed 25,473 of 31,352 (81.3%). The official block-map roll-up is 22,900; field daily logs add 2,573 piles not yet mapped (mostly Zone B, where Latnovva self-reports lead the block map). Jul 21 (Tue) closed at 253 (United 147 Zone F + 22 Zone G — the first Zone G piles — on 6 rigs, plus Latnovva 84 on its single running rig) against the 1,176/day required over 5 working days to Jul 28. United also drove 13 combiner-box (CB) and 32 tensioning (TP) electrical piles, which do NOT count toward the 31,352 tracker-pile total. RECONCILIATION FLAG (Jul 20): Audelio DELIVERY workbook is internally inconsistent on piles — the PROGRESS summary shows 22,900 installed, but his detail tabs (Production Q PILE DRIVING + COMPLETED-by-zone block logs) sum to only 17,678, lagging badly in the active zones (Zone F detail 1,743 vs 5,805 summary; Zone B 500 vs 1,457), and a planning tab shows ~15,550. The field WhatsApp daily logs (25,473) are the controlling production basis; Audelio has been asked to reconcile the summary-vs-detail gap in his file.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed the 834 piles/day install burn', latest: 'Jul 15 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; 2,870 available above the 25,473 executed', status: 'On Track', note: 'Available stock equals delivered piles less executed piles — 2,870 units, about 3 days at the 1,176/day required rate. Delivery is no longer the pile-programme constraint.' },
      ...
      { name: 'Tracker completion incl. purlins', remaining: '1,732 to build · 2,251 to QA-release', target: '51 completed rows/day now required for Aug 30', latest: 'Jul 21 (Tue): 25 rows (ECCS, Zone E, 58 people)', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 754 rows — 235 released by Quality and 519 pending QA approval; first QA release Jul 20 (Daniel: Zones C1 & C2 released with Client). RELEASED-TRACKER BUFFER ahead of module installation is only ~68 rows / ~4,700 modules ≈ 1.3 days at the required module rate — razor-thin. NOTE: cumulative under reconciliation — the workbook still shows 213 complete / 367 installed; Maurin walked all rows Jul 14 and Daniel is recounting manually.', cumulative: '754 done (30.3%): 235 QA-released + 519 pending Quality · 736 rows pre-assembled / 2,486 total', status: 'Critical' },
      ...
      { name: 'Panel delivery', remaining: '14,230 modules to deliver', target: '— No approved daily delivery target in source', latest: '— Latest daily receipt not reported', cumulative: '157,240 / 171,470 delivered (91.7%)', status: 'On Track', note: 'Jul 17 Construction Manager workbook cumulative delivery quantity; 135,937 modules on site above the 21,303 executed.' },
      { name: 'Module installation', remaining: '150,167 modules', target: '3,754 modules/day required for Sep 6 (5,531/day full-field capacity)', latest: 'Jul 21 (Tue): 3,082 modules — Workforce 1,700 (A) + Brumont 1,382 (C)', cumulative: '21,303 modules field-reported, pending official workbook incorporation', status: 'Critical', note: 'Jul 21: Workforce 1,700 + Brumont 1,382 = 3,082; Jul 20 remains the record at 3,601. ~3,754/day now required. The binding constraint is QA-released tracker rows — the released buffer ahead of the module crews is only ~1.3 days. Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish.' }
    ],
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 21 measured days', minimum: '1,176 piles/day (required for Jul 28)', above: 0, below: 25, latest: 'Jul 21 (Tue) closed: 253 piles — United 169 (147 F + 22 G, first Zone G) + Latnovva 84 (B); +45 electrical CB/TP piles (outside the 31,352)', note: 'Jul 21 (Tue) closed at 253 piles (United 147 F + 22 G + Latnovva 84 B) — still far short of the 1,176/day single goal. (560/day is nominal crew capacity, not a target.) Executed 25,473 = official block-map 22,900 + 2,573 field logs not yet mapped (field logs through Jul 20 Monday).', daily: [{ day: 'Jun 18', value: 20, target: 1022, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 1022, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 1022, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 1022, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 1022, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 1022, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 1022, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 1022, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 1022, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 1022, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 1022, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 1022, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 1022, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 1022, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 1022, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 1022, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 14', value: 695, target: 1022, unit: 'piles' }, { day: 'Jul 15', value: 481, target: 1022, unit: 'piles' }, { day: 'Jul 16', value: 504, target: 1022, unit: 'piles' }, { day: 'Jul 17', value: 472, target: 1022, unit: 'piles' }, { day: 'Jul 18', value: 608, target: 1022, unit: 'piles' }, { day: 'Jul 20', value: 622, target: 1022, unit: 'piles' }, { day: 'Jul 21', value: 253, target: 1176, unit: 'piles' }] },
      { task: 'Tracker production control (incl. purlin completion)', period: 'Jun 17-Jul 21', minimum: '51 rows/day (required for Aug 30)', above: 4, below: 21, latest: 'Jul 21 (Tue): 25 rows (ECCS, Zone E) — 754 done (235 released / 519 pending)', note: 'Purlin installation is integrated into this tracker control metric: a row counts once its purlins are installed. Total done is 754 rows — 235 released by Quality and 519 pending QA approval; first QA release Jul 20 (Daniel: Zones C1 & C2 released with Client). The released-tracker buffer ahead of modules is only ~1.3 days. Cumulative is under reconciliation — the workbook TRACKER INSTALLATION table shows 583; Maurin walked all rows Jul 14 and Daniel is recounting.', daily: [{ day: 'Jun 17', value: 15, target: 50, unit: 'units' }, { day: 'Jun 18', value: 35, target: 50, unit: 'units' }, { day: 'Jun 19', value: 26, target: 50, unit: 'units' }, { day: 'Jun 20', value: 31, target: 50, unit: 'units' }, { day: 'Jun 21', value: 0, target: 50, unit: 'units' }, { day: 'Jun 22', value: 48, target: 50, unit: 'units' }, { day: 'Jun 23', value: 31, target: 50, unit: 'units' }, { day: 'Jun 24', value: 0, target: 50, unit: 'units' }, { day: 'Jun 25', value: 57, target: 50, unit: 'units' }, { day: 'Jun 26', value: 26, target: 50, unit: 'units' }, { day: 'Jun 29', value: 29, target: 50, unit: 'units' }, { day: 'Jun 30', value: 30, target: 50, unit: 'units' }, { day: 'Jul 1', value: 51, target: 50, unit: 'units' }, { day: 'Jul 7', value: 29, target: 50, unit: 'units' }, { day: 'Jul 8', value: 0, target: 50, unit: 'units' }, { day: 'Jul 9', value: 0, target: 50, unit: 'units' }, { day: 'Jul 10', value: 0, target: 50, unit: 'units' }, { day: 'Jul 13', value: 29, target: 50, unit: 'units' }, { day: 'Jul 14', value: 49, target: 50, unit: 'units' }, { day: 'Jul 15', value: 35, target: 50, unit: 'units' }, { day: 'Jul 16', value: 35, target: 50, unit: 'units' }, { day: 'Jul 17', value: 25, target: 50, unit: 'units' }, { day: 'Jul 18', value: 0, target: 50, unit: 'units' }, { day: 'Jul 20', value: 21, target: 50, unit: 'units' }, { day: 'Jul 21', value: 25, target: 51, unit: 'units' }] },
      { task: 'Module installation', period: 'Jul 3-Jul 21 field start', minimum: '3,754 modules/day (required for Sep 6)', above: 0, below: 15, latest: 'Jul 21 (Tue): 3,082 modules — Workforce 1,700 (Zone A) + Brumont 1,382 (Zone C)', note: 'Jul 17: Brumont 1,290 + Workforce 936. Record 2,922 on Jul 13. Still short of the single goal, 3,754/day required to hold Sep 6. (5,531/day is the full-field capacity, not a target.) Released tracker rows are the constraint — the buffer ahead of the crews is only ~1.3 days.', daily: [{ day: 'Jul 3', value: 234, target: 3738, unit: 'modules' }, { day: 'Jul 6', value: 780, target: 3738, unit: 'modules' }, { day: 'Jul 7', value: 156, target: 3738, unit: 'modules' }, { day: 'Jul 8', value: 936, target: 3738, unit: 'modules' }, { day: 'Jul 9', value: 1308, target: 3738, unit: 'modules' }, { day: 'Jul 10', value: 1802, target: 3738, unit: 'modules' }, { day: 'Jul 11', value: 517, target: 3738, unit: 'modules' }, { day: 'Jul 13', value: 2922, target: 3738, unit: 'modules' }, { day: 'Jul 14', value: 2335, target: 3738, unit: 'modules' }, { day: 'Jul 15', value: 780, target: 3738, unit: 'modules' }, { day: 'Jul 16', value: 858, target: 3738, unit: 'modules' }, { day: 'Jul 17', value: 2226, target: 3738, unit: 'modules' }, { day: 'Jul 18', value: 0, target: 3738, unit: 'modules' }, { day: 'Jul 20', value: 3601, target: 3738, unit: 'modules' }, { day: 'Jul 21', value: 3082, target: 3754, unit: 'modules' }] },
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', progress: 90, baseline: 55, note: 'Consolidated delivery line; final tracker-post containers slipped to a 7/14 port arrival, so post deliveries complete the week of 7/20 (node controllers Monday). Site pile stock: 28,343 delivered vs 25,473 executed — 2,870-pile buffer (~4 days at the ~1,176/day rate now needed to hold Jul 28). Receiving cap 14 pile + 8 racking loads/day; loads count as scheduled until POD/site receipt.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 78.5, baseline: 48.4, note: '5,879 piles remain (official block-map 22,900 + 2,573 field logs not yet mapped): holding July 28 would need ~1,176 piles/day vs ~560 crew capacity, so the gate is unrecoverable and slips to ~early August (≈ Aug 4-5). Jul 18 Sat: 608 (United 415 + Latnovva 193); United ran 4 of 6 rigs, Latnovva 2 — rig repairs remain the escalated lever; trackers & modules did not work Saturday.' },
      { activity: 'Tracker assembly incl. purlin install', contractor: 'ECCS', start: '2026-06-08', end: '2026-08-30', status: 'At Risk', progress: 28.5, baseline: 0, note: 'Jul 18 Sat: no tracker work (crews off Saturday) — 754 done / 235 QA-released / 519 pending QA (first QA release Jul 20: Zones C1 & C2 with Client). The released buffer ahead of modules is only ~1.3 days. Cumulative under reconciliation vs the workbook TRACKER table (583). Releasing the C rows is the controlling item for the module front.' },
      ...
      { activity: 'Inverter foundation readiness', contractor: 'EPC / Civil / Electrical', start: '2026-06-20', end: '2026-07-25 provisional', status: 'Critical', progress: 91.3, baseline: 0, note: 'Jul 21 field (Manuel/ECCS): 1 inverter foundation completed in Zone G — 21 of 23 stations complete (91.3%), 2 remaining. Welding procedure for the inverter steel-pile foundations received Jul 21 (Daniel Morilla) — qualified welding cleared to proceed. Base-plate welding complete on all 18 stations delivered (Axel, Jul 12). On pace ahead of the end-July arrival of the 23 units.' },
      ...
      { activity: 'Final module installation completion', contractor: 'Workforce', start: '2026-07-03', end: '2026-09-06', status: 'Critical', progress: 7.2, baseline: 0, note: 'Modules must finish one week after tracker completion: Aug 30 trackers -> Sep 6 module finish. 21,303 modules executed through Jul 18 (no Sat module work; record 2,922 on Jul 13; last run Jul 17: 2,226); ~3,754/day now required — full-field production depends on released tracker rows (buffer ~1.3 days) and the module crew ramp.' },
    ...
    equipmentNotes: [
      ...
      { contractor: 'ECCS', equipment: 'Tracker structural installation crew; equipment count varies by workfront.', output: 'Jul 21 (Tue): 58 people — 25 trackers Zone E + 1 inverter foundation Zone G (21 of 23 done, 2 remaining).' },
      { contractor: 'United', equipment: '6 ramming machines on site — 2 damaged (4 running; rig repairs urgent).', output: 'Jul 21 (Tue): 169 tracker piles (147 F + 22 G, first Zone G) + 13 CB + 32 TP electrical piles — 24 people, 6 rigs.' },
      { contractor: 'Latnovva', equipment: '2 ramming machines on site (both running Jul 16).', output: 'Jul 21 (Tue): 84 piles in Zone B — 13 people, 1 of 2 rigs running.' },
      { contractor: 'Workforce', equipment: 'Module installation hand tools / torque equipment.', output: 'Jul 21 (Tue): 1,700 modules in Zone A — 32 people.' },
      { contractor: 'Brumont', equipment: 'Module installation tools; 18-person crew.', output: 'Jul 21 (Tue): 1,382 modules in Zone C — 18 people.' },
    ...
    risks: [
      ...
      { title: 'Rig availability, not delivery, now caps pile production', level: 'Critical', owner: 'United / LATNOVVA / Audelio Zuniga / Manuel Ramirez', note: 'Pile stock is comfortable — 28,343 delivered vs 25,473 executed, a 2,870-unit buffer (~5.5 days at the required 1,176/day). The constraint is mechanical: United ran 4 of 6 rigs and Latnovva 2 on Jul 18 Sat (2 United rigs damaged); the day hit 608, but trackers and modules did not work Saturday. At ~560/day capacity only ~3,900 more piles are possible before Jul 28, so the gate is now unrecoverable and slips to ~early August (≈ Aug 4-5); holding Jul 28 would need ~1,176/day. Rig repairs are the recovery lever and are urgent.' },
      { title: 'Trackers remain the controlling front: 25 rows vs 49 required, and the released buffer is ~1.3 days', level: 'Critical', owner: 'ECCS / Daniel Morilla / Manuel Ramirez', note: 'No tracker work Saturday Jul 18 (crews off); ECCS last logged 25 rows Jul 17 (60 people) — below the 51/day required for Aug 30. The QA-released buffer ahead of the module crews is only ~68 rows / ~4,700 modules ≈ 1.3 days: any tracker-QA miss stalls modules. 754 done / 235 released / 519 pending. QA freeze breaking: Daniel confirmed Monday Jul 20 that Zones C1 and C2 release for trackers today with the Client — the first releases since Jul 10. The field cumulative (754) is under reconciliation against the workbook TRACKER table (583). Hold >= 51/day and convert the 519-row pending backlog into released rows this week.' },
