...
// CACHE BUSTER: Jul 15, 2026 — Jul 14 production added (piles/modules/trackers/plowing); required rates recomputed
...
window.MURCH_DATA = {
    control: {
      asOf: 'Jul 14, 2026',
      piles:    { installed: 22335, total: 31352, gate: '2026-07-28', gateLabel: 'Jul 28', required: 820, capacity: 560, name: 'Piles', unit: 'piles/day' },
    ...
    contractorScore: [
      ...
      { date: 'Jul 14 Tue', contractor: 'LATNOVVA', trade: 'Piles', output: 0, resource: '14 people · 2 rigs, 1 broken — zone B', perUnit: 0, criterion: 80, critLabel: 'Jul 14 output pending confirmation (Jose chasing ~200); not yet added to the basis' },
    ...
    scope: [
      ...
      { title: 'Mechanical BOS', metric: '31,352 piles · 2,486 trackers', note: 'Pile driving (22,335 executed, 71.2%), GameChange SAT tracker assembly incl. purlins (613 done, 24.7% — 235 QA-released, 378 pending Quality), and module placement (10,756 executed, 6.3%). D&F pre-drilling complete (7,694/7,694).' },
    ...
    weeklyPlan: [
      ...
      { area: '<u>Pile production — rig availability, Zones B / F</u><span style="background:#b53030;color:#fff;padding:1px 6px;border-radius:3px;font-size:10px;font-weight:700;margin-left:6px">CRITICAL</span>', target: '9,017 piles remain to the Jul 28 gate (22,335 of 31,352 executed, 71.2%). The five-day streak above 560 ended Jul 14 at 497 — United alone in Zone F, with Latnovva Jul 14 still unconfirmed. The fleet is degrading: United runs 6 of 8 rigs and Latnovva 1 of 2. Get the broken rigs back this week or the gate slips.', minimum: '>= 820 piles/day (9,017 over 11 remaining working days, Mon-Sat) — well above the 560/day stated capacity. Every sub-800 day pushes Jul 28 further out; at 560/day the gate lands into early August.', gate: 'Rig repairs are the binding constraint — 2 United units and 1 Latnovva unit down. Material is no longer a restriction: 28,343 piles delivered, a 6,008-unit buffer (~7.3 days at the required rate).', owners: 'United / LATNOVVA | Audelio Zuniga | Manuel Ramirez | Joshua Spalding' },
    ...
    contractors: [
      ...
      { name: 'Project Total', scope: 31352, installed: 22335, remaining: 9017, done: 71.2, zones: "All zones | Construction Manager report", status: 'Critical', note: "Total executed: 22,335 — Audelio's workbook (20,550, official basis, block-map roll-up still through Jul 10 in the Jul 15 re-export) plus 1,785 field-reported piles since (Sat Jul 11: 680; Mon Jul 13: 608; Tue Jul 14: United 497 F — Latnovva Jul 14 pending confirmation), pending workbook incorporation." }
    ],
    zones: [
    ...
    production: [
      { name: 'Project pile installation', remaining: '9,017 piles', target: '~820 piles/day required for Jul 28 (560/day stated capacity)', latest: 'Jul 14 (Tue): 497 piles (United, zone F, 83/rig-day on 6 running rigs) — Latnovva Jul 14 output pending confirmation', cumulative: '22,335 / 31,352 executed (71.2%) — 20,550 workbook + 1,785 field-reported (Sat 680 + Mon 608 + Tue 497)', status: 'Critical', note: 'The workbook block-map roll-up (20,550) still carries field production only through Jul 10 in the Jul 15 re-export, so Sat/Mon/Tue output is added on top. Tue was United alone at 497 — the five-day streak above 560 ended and Latnovva Jul 14 is still unconfirmed (Jose chasing ~200). Holding Jul 28 now needs ~820/day over 11 working days (Mon-Sat); rig repairs remain the single biggest lever.' },
      { name: 'Pile delivery / site stock', remaining: '3,009 piles undelivered', target: 'Receipts must exceed 560 piles/day burn', latest: 'Jul 15 workbook: 28,343 piles delivered (90.4% of 31,352)', cumulative: '28,343 delivered; 6,008 available above the 22,335 executed', status: 'On Track', note: 'Available stock equals delivered piles less executed piles — 6,008 units, about 7.3 days at the 820/day required rate. Delivery is no longer the pile-programme constraint.' },
    ...
    dailyProductionHistory: [
      { task: 'Pile installation', period: 'Jun 18-Jul 14 measured days', minimum: '560 piles/day', above: 5, below: 14, latest: 'Jul 14 (Tue): 497 piles — United alone in zone F; Latnovva Jul 14 pending confirmation', note: 'The five-day streak above 560 (646, 669, 680, 680, 608) ended Jul 14 at 497 — United alone at 83/rig-day (6 of 8 rigs); Latnovva Jul 14 output is unconfirmed (Jose chasing ~200) and not yet added. ~820/day now required for Jul 28; cumulative 20,550 official + 1,785 field (Sat 680, Mon 608, Tue 497) pending workbook.', daily: [{ day: 'Jun 18', value: 20, target: 560, unit: 'piles' }, { day: 'Jun 19', value: 79, target: 560, unit: 'piles' }, { day: 'Jun 22', value: 251, target: 560, unit: 'piles' }, { day: 'Jun 23', value: 101, target: 560, unit: 'piles' }, { day: 'Jun 25', value: 370, target: 560, unit: 'piles' }, { day: 'Jun 26', value: 340, target: 560, unit: 'piles' }, { day: 'Jun 29', value: 261, target: 560, unit: 'piles' }, { day: 'Jun 30', value: 234, target: 560, unit: 'piles' }, { day: 'Jul 1', value: 252, target: 560, unit: 'piles' }, { day: 'Jul 2', value: 274, target: 560, unit: 'piles' }, { day: 'Jul 3', value: 134, target: 560, unit: 'piles' }, { day: 'Jul 6', value: 307, target: 560, unit: 'piles' }, { day: 'Jul 7', value: 399, target: 560, unit: 'piles' }, { day: 'Jul 8', value: 646, target: 560, unit: 'piles' }, { day: 'Jul 9', value: 669, target: 560, unit: 'piles' }, { day: 'Jul 10', value: 680, target: 560, unit: 'piles' }, { day: 'Jul 11', value: 680, target: 560, unit: 'piles' }, { day: 'Jul 13', value: 608, target: 560, unit: 'piles' }, { day: 'Jul 14', value: 497, target: 560, unit: 'piles' }] },
    ...
    schedule: [
      ...
      { activity: 'GameChange material delivery sequence', contractor: 'GameChange / NTG / Landstar', start: '2026-06-17', end: '2026-07-16', status: 'Critical', progress: 90, baseline: 55, note: 'Consolidated delivery line; final tracker-post containers slipped to a 7/14 port arrival, so post deliveries complete the week of 7/20 (node controllers Monday). Site pile stock: 28,343 delivered vs 22,335 executed — 6,008-pile buffer (~7.3 days at the 820/day required rate). Receiving cap 14 pile + 8 racking loads/day; loads count as scheduled until POD/site receipt.' },
      ...
      { activity: 'Overall pile installation acceleration', contractor: 'All pile contractors', start: '2026-06-22', end: '2026-07-28', status: 'Critical', progress: 71.2, baseline: 48.4, note: '9,017 piles remain (20,550 official workbook + 1,785 field: Sat 680, Mon 608, Tue 497): holding July 28 requires ~820 piles/day vs 560 stated capacity. The five-day streak above the line ended Jul 14 at 497 (United alone; Latnovva Jul 14 pending). Rig repairs (United 2 down, Latnovva 1 down) are the escalated levers.' },
    ...
    equipmentNotes: [
      ...
      { contractor: 'Latnovva', equipment: '2 ramming machines on site — 1 broken, leaving a single working rig (escalated).', output: 'Jul 14 (Tue): output pending confirmation (Jose chasing ~200); Jul 13 was 72 piles in Zone B — fleet down to one working rig.' },
    ...
    risks: [
      { title: 'Rig availability, not delivery, now caps pile production', level: 'Critical', owner: 'United / LATNOVVA / Audelio Zuniga / Manuel Ramirez', note: 'Pile stock is comfortable — 28,343 delivered vs 22,335 executed, a 6,008-unit buffer (~7.3 days at the required 820/day). The constraint is mechanical: United is running 6 of 8 rigs and Latnovva 1 of 2, and the five-day streak above 560 ended Jul 14 at 497 (United alone; Latnovva Jul 14 unconfirmed). Every sub-800 day pushes the Jul 28 gate further out; repairs and the replacement rig are the recovery levers.' },
