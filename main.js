...
(function () {
  const data = {
    ...
    contractors: [
      ...
      { name: 'Project Total', scope: 31352, installed: 14586, remaining: 16766, done: 46.52, zones: "All zones | Const. Management June 16 workbook", status: 'Critical', note: "Const. Management production record controls the headline when records disagree. It is 2,792 above the June 16 master headline of 11,794 and 3,494 above the June 8 QA/QC executed total of 11,092." }
    ],
    zones: [
    ...
    production: [
      { name: 'Project pile installation', remaining: '16,766 piles', required: 752, observed: 500, status: 'Critical', note: "Const. Management June 16 workbook shows 14,586 installed (46.52%). The June 16 master-required rate is approximately 752/day versus the latest five-day rate of 500.2/day and planned post-June 22 capacity of 560/day." },
      { name: 'Pile delivery / site stock', remaining: '15,601 piles undelivered', required: 0, observed: 0, status: 'Critical', note: "15,751 of 31,352 piles delivered. Const. Management installed total implies 1,165 piles remain on site, approximately 2.3 production days at 500.2/day." },
    ...
    schedule: [
      ...
      { activity: 'Current pile stock installation', contractor: 'ECCS / LATNOVVA', start: '2026-06-16', end: '2026-06-18', status: 'Critical', note: "Const. Management reports 14,586 of 15,751 delivered piles installed. Implied stock is 1,165 piles, or approximately 2.3 production days at the latest validated 500.2/day pace." },
      ...
      { activity: 'Potential piling pause', contractor: 'All pile contractors', start: '2026-06-18', end: 'Pending confirmed post receipts', status: 'Critical', note: "Const. Management June 16 installed total implies a likely stop around June 18 if the remaining 1,165-pile stock is depleted. Planned June 18-19 post receipts could reduce the interruption, but daily replenishment must be confirmed against pile burn." },
  ...
  { activity: 'United Zone F pile ramming start', contractor: 'United', start: '2026-06-22', end: '2026-06-22', status: 'Critical', note: 'United starts pile ramming on June 22, subject to the delayed pile delivery, completed marking, access, and released workfronts.' },
    ...
    risks: [
      ...
      { title: 'Production-control and QC reconciliation gaps', level: 'Critical', owner: 'Construction Controls / Mechanical Subs / QA/QC', note: "Const. Management June 16 workbook shows 14,586 installed, versus 11,794 in the paired master headline and 11,092 QC-executed. Reconcile the 2,792- and 3,494-pile gaps while retaining Const. Management number as the production headline." },
      ...
      { title: 'June 16 workbook refresh increases field production but not master headline', level: 'Critical', owner: 'Construction Controls / Field Management', note: 'Const. Management detail now reports 14,586 installed piles, while the master control headline remains 11,794. Use the field production total for status and keep the control-file gap open until formally reconciled.' },
