...
(function () {
  const data = {
    ...
    schedule: [
      ...
      { activity: 'Potential piling pause', contractor: 'All pile contractors', start: '2026-06-18', end: '2026-06-22', status: 'Critical', note: "Const. Management June 16 installed total implies a likely stop around June 18 if the remaining 1,165-pile stock is depleted. Planned June 18-19 post receipts could reduce the interruption, but daily replenishment must be confirmed against pile burn." },
