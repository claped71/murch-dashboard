...
(function () {
  const data = {
    ...
    contractors: [
      { name: 'ECCS / LATNOVVA detailed zones', scope: 16082, installed: 14586, remaining: 1496, done: 90.7, zones: 'Zones A, C, E, and EW', status: 'Watch', note: 'June 16 Audelio workbook reports 14,586 installed across active detailed zones, including 750 installed in EW. The file does not provide a defensible contractor split, so this combined view avoids an unsupported allocation.' },
      { name: 'LATNOVVA', scope: 16400, installed: 5716, remaining: 10684, done: 34.9, zones: 'Mechanical Tracking workbook scope', status: 'Critical', note: 'The June 16 master workbook shows 5,716 installed versus 12,600 planned to date, a 6,884-pile variance; current required rate is approximately 562/day for LATNOVVA scope.' },
      ...
      { name: 'Project Total', scope: 31352, installed: 14586, remaining: 16766, done: 46.52, zones: "All zones | Audelio's June 16 workbook", status: 'Critical', note: "Audelio's production record controls the headline when records disagree. It is 2,792 above the June 16 master headline of 11,794 and 3,494 above the June 8 QA/QC executed total of 11,092." }
    ],
    zones: [
      { zone: 'Zone A', contractor: 'Latnovva', scope: 3834, installed: 3737, remaining: 97, done: 97.5, status: 'On Track', note: 'Nearly complete.' },
      { zone: 'Zone C', contractor: 'Latnovva', scope: 2946, installed: 2723, remaining: 223, done: 92.4, status: 'Active', note: 'June 16 Audelio workbook.' },
      { zone: 'Zone E', contractor: 'ECCS / Latnovva', scope: 8456, installed: 7376, remaining: 1080, done: 87.2, status: 'Active', note: 'June 16 Audelio workbook; contractor split remains unreconciled.' },
      { zone: 'Zone EW', contractor: 'Latnovva', scope: 846, installed: 750, remaining: 96, done: 88.7, status: 'Active', note: 'June 16 Audelio workbook reports first EW production.' },
      { zone: 'Zone B', contractor: 'Latnovva', scope: 2788, installed: 0, remaining: 2788, done: 0, status: 'Material Hold', note: '2nd-50% work; cannot start until delayed pile delivery arrives June 22.' },
    ...
    production: [
      { name: 'Project pile installation', remaining: '16,766 piles', required: 752, observed: 500, status: 'Critical', note: "Audelio's June 16 workbook shows 14,586 installed (46.52%). The June 16 master-required rate is approximately 752/day versus the latest five-day rate of 500.2/day and planned post-June 22 capacity of 560/day." },
      { name: 'Pile delivery / site stock', remaining: '15,601 piles undelivered', required: 0, observed: 0, status: 'Critical', note: "15,751 of 31,352 piles delivered. Audelio's installed total implies 1,165 piles remain on site, approximately 2.3 production days at 500.2/day." },
      { name: 'Drill and backfill', remaining: '858 pre-drills', required: 250, observed: 316, status: 'Critical', note: "The June 16 Audelio daily log shows 6,814 complete and 858 remaining after 316 units on June 15. The PROGRESS summary still shows 1,167 remaining, so the 309-unit difference requires reconciliation." },
      ...
      { name: 'Tracker assembly', remaining: '2,379 trackers', required: 48, observed: 107, status: 'Critical', note: 'June 16 Audelio workbook reports 107 of 2,486 trackers installed (4.3%), all in Area A. Final tracker completion remains dependent on completed piles and complete purlin kits.' },
      { name: 'Torque tube installation', remaining: '26,736 tubes', required: 0, observed: 2133, status: 'Critical', note: 'June 16 Audelio workbook reports 2,133 of 28,869 torque tubes installed (7.39%), currently limited to Area A.' },
      ...
      { name: 'Panel delivery', remaining: '14,230 modules', required: 0, observed: 0, status: 'On Track', note: 'The June 16 Audelio workbook reports 157,240 of 171,470 panels delivered (91.7%).' },
      { name: '2nd-50% zones B/D/F/G', remaining: 'Material gate', required: 0, observed: 0, status: 'Material Hold', note: 'The June 15 GameChange plan schedules 540 posts June 18, 836 June 19, and 928 June 22. These dates may reduce the piling interruption, but the posts are not yet customer-confirmed on site.' },
    ...
    schedule: [
      { activity: 'D&F Pre-Drilling', contractor: 'Kalamazoo Excavating', start: '2026-05-06', end: '2026-06-20', status: 'Critical', note: "The June 16 Audelio daily log shows 6,814 complete and 858 remaining after 316 units on June 15. The PROGRESS summary still shows 1,167 remaining; reconcile before closing the lookahead." },
      { activity: 'Current pile stock installation', contractor: 'ECCS / LATNOVVA', start: '2026-06-16', end: '2026-06-18', status: 'Critical', note: "Audelio reports 14,586 of 15,751 delivered piles installed. Implied stock is 1,165 piles, or approximately 2.3 production days at the latest validated 500.2/day pace." },
      ...
      { activity: 'Potential piling pause', contractor: 'All pile contractors', start: '2026-06-18', end: 'Pending confirmed post receipts', status: 'Critical', note: "Audelio's June 16 installed total implies a likely stop around June 18 if the remaining 1,165-pile stock is depleted. Planned June 18-19 post receipts could reduce the interruption, but daily replenishment must be confirmed against pile burn." },
  ...
  { activity: 'United Zone F pile ramming start', contractor: 'United', start: '2026-06-22', end: '2026-06-22', status: 'Critical', note: 'United starts pile ramming on June 22, subject to the delayed pile delivery, completed marking, access, and released workfronts.' },
      { activity: 'Overall pile installation recovery', contractor: 'All pile contractors', start: '2026-06-16', end: '2026-07-27 provisional', status: 'Critical', note: "Audelio's June 16 workbook leaves 16,766 piles. Seven-machine capacity of 560/day is below the June 16 master-required 752/day pace; uninterrupted work from June 22 forecasts completion around July 27-28. The master workbook's latest-week forecast is August 11." },
      ...
      { activity: 'Module Installation - first wave', contractor: 'Panel Sub', start: 'After Jun 23 confirmed complete-kit receipt', end: 'TBD by released workfront', status: 'Critical', note: 'The Jun 17 Purlin load alone does not release modules. Start only after both Purlin types are physically received and installed on fully released tracker rows.' },
      { activity: 'Full purlin installation / tracker completion', contractor: 'GameChange / ECCS', start: 'After released tracker rows', end: 'TBD after Jul 16 planned final delivery', status: 'Critical', note: 'Final finish must be after tracker structural completion and after all required purlin loads are confirmed on site and installed.' },
      { activity: 'Final module installation completion', contractor: 'Panel Sub', start: 'After released rows with purlins', end: 'TBD after full purlin install', status: 'Critical', note: 'Final module completion must occur after final purlin installation. No defensible project finish date exists until the full purlin plan is confirmed.' },
    ...
    risks: [
      ...
      { title: 'GameChange post deliveries remain planned, not confirmed', level: 'Critical', owner: 'GameChange / Procurement / PM', note: 'The June 15 plan advances the first new post wave to 540 units June 18 and 836 June 19, followed by 928 June 22. Confirm receipt and workfront allocation daily; current stock has fallen to about 1,165 piles.' },
      { title: 'Production-control and QC reconciliation gaps', level: 'Critical', owner: 'Construction Controls / Mechanical Subs / QA/QC', note: "Audelio's June 16 workbook shows 14,586 installed, versus 11,794 in the paired master headline and 11,092 QC-executed. Reconcile the 2,792- and 3,494-pile gaps while retaining Audelio's number as the production headline." },
      ...
      { title: 'June 16 workbook refresh increases field production but not master headline', level: 'Critical', owner: 'Construction Controls / Field Management', note: 'Audelio detail now reports 14,586 installed piles, while the master control headline remains 11,794. Use the field production total for status and keep the control-file gap open until formally reconciled.' },
      { title: 'Pre-drilling field/master reconciliation and recovery', level: 'Critical', owner: 'Kalamazoo Excavating / Construction Mgmt', note: "The June 16 Audelio daily log shows 858 pre-drills remaining, while the same workbook's PROGRESS summary still shows 1,167 remaining. Reconcile the 309-unit difference and protect the June 20 target." },
